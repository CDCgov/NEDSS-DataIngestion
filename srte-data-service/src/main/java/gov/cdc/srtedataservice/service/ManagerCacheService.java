...
public class ManagerCacheService implements IManagerCacheService {
  ...
  public String getCache(ObjectName objectName, String key) throws DataProcessingException {
    return switch (objectName) {
      ...
      case PROGRAM_AREA_CODES_WITH_NBS_UID ->
          toStringSafe(SrteCache.programAreaCodesMapWithNbsUid.get(key));
      case JURISDICTION_CODE_WITH_NBS_UID ->
          toStringSafe(SrteCache.jurisdictionCodeMapWithNbsUid.get(key));
  ...
  private String handleComplexCacheTypes(ObjectName objectName, String key)
  ...
  public void loadCache() throws DataProcessingException, RtiCacheException {
    ...
    SrteCache.jurisdictionCodeMapWithNbsUid =
    ...
    for (ConditionCode obj : SrteCache.conditionCodes) {
      SrteCache.investigationFormConditionCode.put(
          obj.getConditionCd(), obj.getInvestigationFormCd());
    }
    ...
    SrteCache.labResultWithOrganismNameIndMap =
  ...
  //        saveToCacheHashMap( "programAreaCodesWithNbsUid",
  // SrteCache.programAreaCodesMapWithNbsUid);
  //        saveToCacheHashMap( "jurisdictionCodeWithNbsUid",
  // SrteCache.jurisdictionCodeMapWithNbsUid);
  ...
  //        saveToCacheHashMap( "labResulDescWithOrgnismName",
  // SrteCache.labResultWithOrganismNameIndMap);
  //        saveToCacheHashMap( "loinCodeWithComponentName",
  // SrteCache.loinCodeWithComponentNameMap);
  //        saveToCacheHashMap( "investigationFormConditionCode",
  // SrteCache.investigationFormConditionCode);
  //
  //    }
