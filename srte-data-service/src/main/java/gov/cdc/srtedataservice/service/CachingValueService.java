...
public class CachingValueService implements ICatchingValueService {
  ...
  public HashMap<String, String> getAllLabResultJoinWithLabCodingSystemWithOrganismNameInd() {
    ...
    List<LabResult> labResults =
        srteCustomRepository.getAllLabResultJoinWithLabCodingSystemWithOrganismNameInd();
  ...
  public HashMap<String, String> getLabResultDesc() {
    ...
    List<LabResult> labResults =
        labResultRepository.findLabResultByDefaultLabAndOrgNameN().orElse(Collections.emptyList());
  ...
  public HashMap<String, String> getAOELOINCCodes() {
    ...
    List<LOINCCode> loincCodes =
        loincCodeRepository.findLoincCodes().orElse(Collections.emptyList());
  ...
  public HashMap<String, String> getRaceCodes() {
    ...
    List<RaceCode> raceCodes =
        raceCodeRepository.findAllActiveRaceCodes().orElse(Collections.emptyList());
  ...
  public HashMap<String, String> getAllOnInfectionConditionCode() {
    ...
    List<ConditionCode> conditionCodes =
        conditionCodeRepository.findCoInfectionConditionCode().orElse(Collections.emptyList());
  ...
  public String getCodeDescTxtForCd(String code, String codeSetNm) {
    if (SrteCache.codeDescTxtMap.get(code) == null
        || SrteCache.codeDescTxtMap.get(code).isEmpty()) {
  ...
  public String findToCode(String fromCodeSetNm, String fromCode, String toCodeSetNm) {
    return elrXrefRepository
        .findToCodeByConditions(fromCodeSetNm, fromCode, toCodeSetNm)
        .map(ElrXref::getToCode)
        .orElse("");
  }
  ...
  public String getCountyCdByDesc(String county, String stateCd) {
    ...
    if (SrteCache.countyCodeByDescMap.get(cnty) == null
  ...
  public List<CodeValueGeneral> findCodeValuesByCodeSetNmAndCode(String codeSetNm, String code) {
    return codeValueGeneralRepository
        .findCodeValuesByCodeSetNmAndCode(codeSetNm, code)
  ...
  public HashMap<String, String> getCodedValue(String code) {
    ...
    if (ELRConstant.ELR_LOG_PROCESS.equals(code)) {
      codeValueGeneralList =
          codeValueGeneralRepository
              .findCodeDescriptionsByCodeSetNm(code)
      ...
      codeValueGeneralList =
          codeValueGeneralRepository
              .findCodeValuesByCodeSetNm(code)
              .orElse(Collections.emptyList());
      for (CodeValueGeneral obj : codeValueGeneralList) {
  ...
  private HashMap<String, String> getJurisdictionCode() {
    ...
    HashMap<String, String> result = new HashMap<>();
    List<JurisdictionCode> jurisdictionCodes =
        jurisdictionCodeRepository.findJurisdictionCodeValues().orElse(Collections.emptyList());
  ...
  protected HashMap<String, String> getCountyCdByDescCallRepos(String stateCd) {
    ...
    if (stateCd == null || stateCd.trim().isEmpty()) {
      stateCountyCodeValues =
          stateCountyCodeValueRepository.findByIndentLevelNbr().orElse(Collections.emptyList());
    } else {
      stateCountyCodeValues =
          stateCountyCodeValueRepository
              .findByIndentLevelNbrAndParentIsCdOrderByCodeDescTxt(stateCd)
              .orElse(Collections.emptyList());
    }
