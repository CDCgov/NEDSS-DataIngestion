...
class MsSqlContainerInitializer
  ...
  public void initialize(@NonNull final ConfigurableApplicationContext context) {
    String image =
        context
            .getEnvironment()
            .getProperty("testing.database.mssql.image", "dataingestion-di-mssql");
    ...
    System.setProperty(
        ...
        container.getJdbcUrl()
            + ";databaseName=NBS_MSGOUTE;encrypt=true;trustServerCertificate=true;");
    System.setProperty(
        "spring.datasource.odse.url",
        container.getJdbcUrl()
            + ";databaseName=NBS_ODSE;encrypt=true;trustServerCertificate=true;");
    System.setProperty(
        "spring.datasource.srte.url",
        container.getJdbcUrl()
            + ";databaseName=NBS_SRTE;encrypt=true;trustServerCertificate=true;");
  }
}
