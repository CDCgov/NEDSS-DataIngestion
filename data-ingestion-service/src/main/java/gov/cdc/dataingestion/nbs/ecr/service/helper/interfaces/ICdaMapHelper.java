...
public interface ICdaMapHelper {
  POCDMT000040Section mapOrgPlaceProviderActCommonField(
      POCDMT000040Section clinicalDocument,
      int performerSectionCounter,
      POCDMT000040Participant2 output);

  OrgPlaceDocCommonField mapOrgPlaceDocCommonField(
  ...
  XmlObject mapToUsableTSElement(String data, XmlObject output, String name)
      throws EcrCdaXmlException;
  ...
  POCDMT000040Participant2 mapToORG(EcrMsgOrganizationDto in, POCDMT000040Participant2 out)
      throws EcrCdaXmlException;
  ...
  ANY mapMultiSelectDateMapXmlElement(ANY element, String value, EcrMsgCaseAnswerDto in)
      throws EcrCdaXmlException;
