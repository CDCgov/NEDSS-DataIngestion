...
public class NbsRepositoryServiceProvider {
  ...
  public void saveEcrCdaXmlMessage(
      String nbsInterfaceUid, Integer dataMigrationStatus, String xmlMsg) {
    Optional<NbsInterfaceModel> response =
        nbsInterfaceRepo.getNbsInterfaceByIdAndDocType(
            Integer.valueOf(nbsInterfaceUid), ECR_DOC_TYPE);
  ...
  public NbsInterfaceModel saveXmlMessage(
      String msgId,
      String xmlMsg,
      HL7ParsedMessage<OruR1> hl7ParsedMessage,
      boolean dataProcessingApplied)
  ...
  public NbsInterfaceModel saveElrXmlMessage(
      String messageId, String xmlMsg, boolean dataProcessingApplied)
      throws XmlConversionException {
  ...
  public NbsInterfaceModel savingElrXmlNbsInterfaceModelHelper(
      String xmlMsg, NbsInterfaceModel item) throws XmlConversionException {
    try {
      ...
      String labClia =
          getNodeValue(doc, "/Container/HL7LabReport/HL7MSH/SendingFacility/HL7UniversalID");

      String fillerOrderNumber =
          getNodeValue(
              doc,
              "/Container/HL7LabReport/HL7PATIENT_RESULT/ORDER_OBSERVATION/ObservationRequest/FillerOrderNumber/HL7EntityIdentifier");

      String orderTestCode =
          getNodeValue(
              doc,
              "/Container/HL7LabReport/HL7PATIENT_RESULT/ORDER_OBSERVATION/ObservationRequest/UniversalServiceIdentifier/HL7Identifier");
      if (orderTestCode == null) {
        orderTestCode =
            getNodeValue(
                doc,
                "/Container/HL7LabReport/HL7PATIENT_RESULT/ORDER_OBSERVATION/ObservationRequest/UniversalServiceIdentifier/HL7AlternateIdentifier");
      }
  ...
  public String getSpecimenCollectionDateStr(Document doc) {
    String year =
        getNodeValue(
            doc,
            "/Container/HL7LabReport/HL7PATIENT_RESULT/ORDER_OBSERVATION/PatientResultOrderSPMObservation/SPECIMEN/SPECIMEN/SpecimenCollectionDateTime/HL7RangeStartDateTime/year");
    String month =
        getPaddedNodeValue(
            doc,
            "/Container/HL7LabReport/HL7PATIENT_RESULT/ORDER_OBSERVATION/PatientResultOrderSPMObservation/SPECIMEN/SPECIMEN/SpecimenCollectionDateTime/HL7RangeStartDateTime/month");
    String day =
        getPaddedNodeValue(
            doc,
            "/Container/HL7LabReport/HL7PATIENT_RESULT/ORDER_OBSERVATION/PatientResultOrderSPMObservation/SPECIMEN/SPECIMEN/SpecimenCollectionDateTime/HL7RangeStartDateTime/day");
    String hours =
        getPaddedNodeValue(
            doc,
            "/Container/HL7LabReport/HL7PATIENT_RESULT/ORDER_OBSERVATION/PatientResultOrderSPMObservation/SPECIMEN/SPECIMEN/SpecimenCollectionDateTime/HL7RangeStartDateTime/hours");
    String minutes =
        getPaddedNodeValue(
            doc,
            "/Container/HL7LabReport/HL7PATIENT_RESULT/ORDER_OBSERVATION/PatientResultOrderSPMObservation/SPECIMEN/SPECIMEN/SpecimenCollectionDateTime/HL7RangeStartDateTime/minutes");
  ...
  private NbsInterfaceModel savingNbsInterfaceModelHelper(OruR1 oru, NbsInterfaceModel nbsInterface)
      throws XmlConversionException {
    String labClia =
        (oru.getMessageHeader() != null && oru.getMessageHeader().getSendingFacility() != null)
            ? oru.getMessageHeader().getSendingFacility().getUniversalId()
            : null;

    String filterOrderNumber =
        (oru.getPatientResult() != null
                && !oru.getPatientResult().isEmpty()
    ...
    if (orderTestCodeObj != null && orderTestCodeObj.getUniversalServiceIdentifier() != null) {
      ...
      } else if (orderTestCodeObj.getUniversalServiceIdentifier().getAlternateIdentifier()
          != null) {
        orderTestCode = orderTestCodeObj.getUniversalServiceIdentifier().getAlternateIdentifier();
      }
    }

    String specimenColDateStr =
        (oru.getPatientResult() != null
                && !oru.getPatientResult().isEmpty()
                && oru.getPatientResult().get(0).getOrderObservation() != null
                && !oru.getPatientResult().get(0).getOrderObservation().isEmpty()
    ...
    savingNbsInterfaceModelTimeStampHelper(specimenColDateStr, nbsInterface);
  ...
  private void savingNbsInterfaceModelTimeStampHelper(
      String specimenColDateStr, NbsInterfaceModel nbsInterface) throws XmlConversionException {
    try {
      if (specimenColDateStr != null) {
        // Need to find the correct format for the date string like
        // '202408212230-0600','20250508145500000-0700'.Maybe the datetime is not in the correct
        // format.
        ...
        if (specimenColDateStr.indexOf("-") > 0) // NOSONAR
        {
          ...
          // 20120821140551-0500
          // this is remove additional value from timezone which suppose to have 5 character
          // (including the dash)
  ...
  public NbsInterfaceModel saveIncomingEcrMessageWithoutRR(
      String payload, String systemNm, String origDocTypeEicr) {
  ...
  public NbsInterfaceModel saveIncomingEcrMessageWithRR(
      String payload,
      String systemNm,
      String origDocTypeEicr,
      String incomingRR,
      String origDocTypeRR) {
