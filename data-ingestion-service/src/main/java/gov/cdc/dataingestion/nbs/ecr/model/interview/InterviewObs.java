...
public class InterviewObs {
  ...
  public InterviewObs(
      int questionGroupSeqNbr, int answerGroupSeqNbr, String dataType, int sequenceNbr) {
    // Map Inv OBS P1
  ...
  public InterviewObs(String dataType, int counter, int sequenceNbr) {
    // Map Inv OBS P2
    this.dataType = dataType;
  ...
  public InterviewObs(String questionSeq, int counter) {
    // Map Inv OBS P3
