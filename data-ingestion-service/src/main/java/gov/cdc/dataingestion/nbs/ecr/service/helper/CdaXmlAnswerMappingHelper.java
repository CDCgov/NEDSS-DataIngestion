...
public class CdaXmlAnswerMappingHelper implements ICdaXmlAnswerMappingHelper {
  public CdaXmlAnswerMapper mapToXmlAnswerTop(
      EcrSelectedRecord input, POCDMT000040ClinicalDocument1 clinicalDocument, int componentCounter)
  ...
  private POCDMT000040Component3 mapToExtendedData(
      EcrMsgXmlAnswerDto in, POCDMT000040Component3 out) throws EcrCdaXmlException {
    try {
      ...
      if (xmlContent != null && !xmlContent.isEmpty()) {
        ...
        if (xmlContent.contains("sdt:") && xmlContent.contains("xsi:")) {
          String wrappedXmlContent =
              "<wrapper xmlns:sdt=\"urn:hl7-org:sdtc\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\">"
                  + xmlContent
                  + "</wrapper>";
          ...
          String wrappedXmlContent =
              "<wrapper xmlns:sdt=\"urn:hl7-org:sdtc\">" + xmlContent + "</wrapper>";
