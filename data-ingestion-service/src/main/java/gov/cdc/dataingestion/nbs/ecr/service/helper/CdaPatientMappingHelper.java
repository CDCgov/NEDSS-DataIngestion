...
public class CdaPatientMappingHelper implements ICdaPatientMappingHelper {
  ...
  public CdaPatientMapper mapToPatient(
    ...
    for (var patient : input.getMsgPatients()) {
      ...
      var fieldModel =
          mapPatientPersonalInfo(clinicalDocument, patientField, homeExtn, phoneCounter);
      ...
      CdaPatientTelecom cdaPatientTeleComWpNumber =
          mapPatientWpNumber(
              clinicalDocument, wpNumber, patWorkPhoneExtensionTxt, patPhoneAsOfDt, phoneCounter);
      ...
      CdaPatientTelecom cdaPatientTeleComCelLNumber =
          mapPatientCellPhone(clinicalDocument, cellNumber, patPhoneAsOfDt, phoneCounter);
      ...
      CdaPatientTelecom cdaPatientTelecomEmail =
          mapPatientEmail(clinicalDocument, patEmailAddressTxt, patPhoneAsOfDt, phoneCounter);
      ...
      CdaPatientTelecom cdaPatientTelecomUrl =
          mapPatientUrlAddress(clinicalDocument, patUrlAddressTxt, patPhoneAsOfDt, phoneCounter);
  ...
  private CdaPatientField patientFieldCheck(
      Field field,
      POCDMT000040ClinicalDocument1 clinicalDocument,
    ...
    if (field.getName().equals("patPrimaryLanguageCd")
        && patient.getPatPrimaryLanguageCd() != null
        && !patient.getPatPrimaryLanguageCd().isEmpty()) {
      ...
      clinicalDocument.getLanguageCode().setCode(patient.getPatPrimaryLanguageCd());
        ...
        && patient.getPatLocalId() != null
        && !patient.getPatLocalId().isEmpty()) {
      clinicalDocument.getRecordTargetArray(0).getPatientRole().addNewId();
      clinicalDocument
          .getRecordTargetArray(0)
          .getPatientRole()
          .getIdArray(cdaPatientField.getPatientIdentifier())
          .setExtension(patient.getPatLocalId());
      clinicalDocument
          .getRecordTargetArray(0)
          .getPatientRole()
          .getIdArray(cdaPatientField.getPatientIdentifier())
          .setRoot("2.16.840.1.113883.4.1");
      clinicalDocument
          .getRecordTargetArray(0)
          .getPatientRole()
          .getIdArray(cdaPatientField.getPatientIdentifier())
          .setAssigningAuthorityName("LR");
      ...
      cdaPatientField.setPatientIdentifier(cdaPatientField.getPatientIdentifier() + 1);
        ...
        && patient.getPatIdMedicalRecordNbrTxt() != null
        && !patient.getPatIdMedicalRecordNbrTxt().isEmpty()) {
      clinicalDocument.getRecordTargetArray(0).getPatientRole().addNewId();
      clinicalDocument
          .getRecordTargetArray(0)
          .getPatientRole()
          .getIdArray(cdaPatientField.getPatientIdentifier())
          .setExtension(patient.getPatIdMedicalRecordNbrTxt());
      clinicalDocument
          .getRecordTargetArray(0)
          .getPatientRole()
          .getIdArray(cdaPatientField.getPatientIdentifier())
      ...
      clinicalDocument
          ...
          .getPatientRole()
          .getIdArray(cdaPatientField.getPatientIdentifier())
          .setAssigningAuthorityName("LR_MRN");
      cdaPatientField.setPatientIdentifier(cdaPatientField.getPatientIdentifier() + 1);
    } else if (field.getName().equals("patIdSsnTxt")
        && patient.getPatIdSsnTxt() != null
        && !patient.getPatIdSsnTxt().isEmpty()) {
      clinicalDocument.getRecordTargetArray(0).getPatientRole().addNewId();
      clinicalDocument
          .getRecordTargetArray(0)
          .getPatientRole()
          .getIdArray(cdaPatientField.getPatientIdentifier())
          .setExtension(patient.getPatIdSsnTxt());
      clinicalDocument
          .getRecordTargetArray(0)
          .getPatientRole()
          .getIdArray(cdaPatientField.getPatientIdentifier())
          .setRoot("2.16.840.1.114222.4.5.1");
      clinicalDocument
          .getRecordTargetArray(0)
          .getPatientRole()
          .getIdArray(cdaPatientField.getPatientIdentifier())
          .setAssigningAuthorityName("SS");
      cdaPatientField.setPatientIdentifier(cdaPatientField.getPatientIdentifier() + 1);
    } else if (field.getName().equals("patAddrStreetAddr1Txt")
        && patient.getPatAddrStreetAddr1Txt() != null
        && !patient.getPatAddrStreetAddr1Txt().isEmpty()) {
      cdaPatientField.setAddress1(
          cdaPatientField.getAddress1() + patient.getPatAddrStreetAddr1Txt());
    } else if (field.getName().equals("patAddrStreetAddr2Txt")
        && patient.getPatAddrStreetAddr2Txt() != null
        && !patient.getPatAddrStreetAddr2Txt().isEmpty()) {
      cdaPatientField.setAddress2(
          cdaPatientField.getAddress2() + patient.getPatAddrStreetAddr2Txt());
    } else if (field.getName().equals("patAddrCityTxt")
        && patient.getPatAddrCityTxt() != null
        && !patient.getPatAddrCityTxt().isEmpty()) {
      ...
      clinicalDocument
          ...
          .getAddrArray(0)
          .getCityArray(0)
          .set(cdaMapHelper.mapToCData(patient.getPatAddrCityTxt()));
      cdaPatientField.setK(cdaPatientField.getK() + 1);
    } else if (field.getName().equals("patAddrStateCd")
        && patient.getPatAddrStateCd() != null
        && !patient.getPatAddrStateCd().isEmpty()) {
      ...
      clinicalDocument
          ...
          .getAddrArray(0)
          .getStateArray(0)
          .set(cdaMapHelper.mapToCData(nstate));
      cdaPatientField.setK(cdaPatientField.getK() + 1);
    } else if (field.getName().equals("patAddrZipCodeTxt")
        && patient.getPatAddrZipCodeTxt() != null
        && !patient.getPatAddrZipCodeTxt().isEmpty()) {
      checkPatientRoleAddrPostal(clinicalDocument);
      clinicalDocument
          .getRecordTargetArray(0)
          .getPatientRole()
          .getAddrArray(0)
          .getPostalCodeArray(0)
          .set(cdaMapHelper.mapToCData(patient.getPatAddrZipCodeTxt()));
      cdaPatientField.setK(cdaPatientField.getK() + 1);
    } else if (field.getName().equals("patAddrCountyCd")
        && patient.getPatAddrCountyCd() != null
        && !patient.getPatAddrCountyCd().isEmpty()) {
      ...
      clinicalDocument
          ...
          .getAddrArray(0)
          .getCountyArray(0)
          .set(cdaMapHelper.mapToCData(val));
      cdaPatientField.setK(cdaPatientField.getK() + 1);
    } else if (field.getName().equals("patAddrCountryCd")
        && patient.getPatAddrCountryCd() != null
        && !patient.getPatAddrCountryCd().isEmpty()) {
      ...
      clinicalDocument
          ...
          .set(cdaMapHelper.mapToCData(val));
      cdaPatientField.setK(cdaPatientField.getK() + 1);
    } else if (field.getName().equals("patWorkPhoneExtensionTxt")
        && patient.getPatWorkPhoneExtensionTxt() != null) {
      cdaPatientField.setWorkPhoneExt(patient.getPatWorkPhoneExtensionTxt().toString());
    } else if (field.getName().equals("patHomePhoneNbrTxt")
        && patient.getPatHomePhoneNbrTxt() != null) {
      cdaPatientField.setHomePhoneNumber(patient.getPatHomePhoneNbrTxt());
    } else if (field.getName().equals("patWorkPhoneNbrTxt")
        && patient.getPatWorkPhoneNbrTxt() != null) {
      cdaPatientField.setWpNumber(patient.getPatWorkPhoneNbrTxt());
    } else if (field.getName().equals("patPhoneCountryCodeTxt")
        && patient.getPatPhoneCountryCodeTxt() != null) {
      cdaPatientField.setPhoneCountryCode(patient.getPatPhoneCountryCodeTxt().toString());
    } else if (field.getName().equals("patCellPhoneNbrTxt")
        && patient.getPatCellPhoneNbrTxt() != null) {
      cdaPatientField.setCellNumber(patient.getPatCellPhoneNbrTxt());
    } else if (field.getName().equals("patNamePrefixCd")
        && patient.getPatNamePrefixCd() != null
        && !patient.getPatNamePrefixCd().trim().isEmpty()) {
      cdaPatientField.setPtPrefix(patient.getPatNamePrefixCd());
    } else if (field.getName().equals("patNameFirstTxt")
        && patient.getPatNameFirstTxt() != null
        && !patient.getPatNameFirstTxt().trim().isEmpty()) {
      cdaPatientField.setPtFirstName(patient.getPatNameFirstTxt());
    } else if (field.getName().equals("patNameMiddleTxt")
        && patient.getPatNameMiddleTxt() != null
        && !patient.getPatNameMiddleTxt().trim().isEmpty()) {
      cdaPatientField.setPtMiddleName(patient.getPatNameMiddleTxt());
    } else if (field.getName().equals("patNameLastTxt")
        && patient.getPatNameLastTxt() != null
        && !patient.getPatNameLastTxt().trim().isEmpty()) {
      cdaPatientField.setPtLastName(patient.getPatNameLastTxt());
    } else if (field.getName().equals("patNameSuffixCd")
        && patient.getPatNameSuffixCd() != null
        && !patient.getPatNameSuffixCd().trim().isEmpty()) {
      cdaPatientField.setPtSuffix(patient.getPatNameSuffixCd());
    } else if (field.getName().equals("patNameAliasTxt")
        && patient.getPatNameAliasTxt() != null
        && !patient.getPatNameAliasTxt().trim().isEmpty()) {
      ...
      clinicalDocument
          ...
          .getPatient()
          .getNameArray(1)
          .setUse(new ArrayList<>(List.of("P")));
      clinicalDocument
          .getRecordTargetArray(0)
          .getPatientRole()
          .getPatient()
          .getNameArray(1)
          .getGivenArray(0)
          .set(cdaMapHelper.mapToCData(patient.getPatNameAliasTxt()));
    } else if (field.getName().equals("patCurrentSexCd")
        && patient.getPatCurrentSexCd() != null
        && !patient.getPatCurrentSexCd().isEmpty()) {
      ...
      CE administrativeGender =
          this.cdaMapHelper.mapToCEAnswerType(patient.getPatCurrentSexCd(), questionCode);
      clinicalDocument
          .getRecordTargetArray(0)
          .getPatientRole()
          .getPatient()
          .setAdministrativeGenderCode(administrativeGender);
      ...
      clinicalDocument
          ...
          .getPatientRole()
          .getPatient()
          .setBirthTime(cdaMapHelper.mapToTsType(patient.getPatBirthDt().toString()));
    } else if (field.getName().equals("patMaritalStatusCd")
        && patient.getPatMaritalStatusCd() != null
        && !patient.getPatMaritalStatusCd().isEmpty()) {
    ...
    } else if (field.getName().equals("patRaceCategoryCd")
        && patient.getPatRaceCategoryCd() != null
        && !patient.getPatRaceCategoryCd().isEmpty()) {
      mapPatientRaceCategory(patient, clinicalDocument);
    } else if (field.getName().equals("patRaceDescTxt")
        && patient.getPatRaceDescTxt() != null
        && !patient.getPatRaceDescTxt().isEmpty()) {
      mapToPatientRaceDesc(clinicalDocument, patient);
    } else if (field.getName().equals("patEthnicGroupIndCd")
        && patient.getPatEthnicGroupIndCd() != null
        && !patient.getPatEthnicGroupIndCd().isEmpty()) {
      checkPatientRole(clinicalDocument);
    ...
    } else if (field.getName().equals("patBirthCountryCd")
        && patient.getPatBirthCountryCd() != null
        && !patient.getPatBirthCountryCd().isEmpty()) {
      ...
      clinicalDocument
          ...
          .getPlace()
          .getAddr()
          .setCountyArray(countyArr);
    } else if (field.getName().equals("patAddrCensusTractTxt")
        && patient.getPatAddrCensusTractTxt() != null
        && !patient.getPatAddrCensusTractTxt().isEmpty()) {
      mapPatientAddrCensusTract(clinicalDocument, patient);
      cdaPatientField.setK(cdaPatientField.getK() + 1);
    } else if (field.getName().equals("patEmailAddressTxt")
        && patient.getPatEmailAddressTxt() != null
        && !patient.getPatEmailAddressTxt().trim().isEmpty()) {
      cdaPatientField.setEmail(patient.getPatEmailAddressTxt());
    } else if (field.getName().equals("patUrlAddressTxt")
        && patient.getPatUrlAddressTxt() != null
        && !patient.getPatUrlAddressTxt().trim().isEmpty()) {
      ...
      var clinicalDocumentMapper =
          mapPatientStructureComponent(
              cdaPatientField.getPatientComponentCounter(),
              clinicalDocument,
              cdaPatientField.getInv168());
      clinicalDocument = clinicalDocumentMapper.getClinicalDocument();
      cdaPatientField.setPatientComponentCounter(
          clinicalDocumentMapper.getPatientComponentCounter());
      POCDMT000040Component3 comp =
          clinicalDocument
              .getComponent()
              .getStructuredBody()
              .getComponentArray(cdaPatientField.getPatientComponentCounter());
      int patEntityCounter =
          clinicalDocument
              .getComponent()
              .getStructuredBody()
              .getComponentArray(0)
      ...
      clinicalDocument
          .getComponent()
          .getStructuredBody()
          .setComponentArray(cdaPatientField.getPatientComponentCounter(), compPatient);
    }
  ...
  private void patientFieldCheckKMapping(
      int k, POCDMT000040ClinicalDocument1 clinicalDocument, EcrMsgPatientDto patient, Field field)
      throws EcrCdaXmlException {
    if (k > 1) {
      ...
      clinicalDocument
          ...
          .getPatientRole()
          .getAddrArray(0)
          .setUse(new ArrayList<String>(List.of("H")));
    }
    ...
    if (k > 1 && field.getName().equals("patAddrAsOfDt") && patient.getPatAddrAsOfDt() != null) {
      ...
      var ad =
          cdaMapHelper.mapToUsableTSElement(
              patient.getPatAddrAsOfDt().toString(), element, USEABLE_PERIOD);
      clinicalDocument.getRecordTargetArray(0).getPatientRole().setAddrArray(0, (AD) ad);
    }
  }

  private CdaPatientField mapPatientPersonalInfo(
      POCDMT000040ClinicalDocument1 clinicalDocument,
      CdaPatientField patientField,
      String homeExtn,
      int phoneCounter)
      throws EcrCdaXmlException {
    if (!patientField.getPtPrefix().isEmpty()) {
      ...
      clinicalDocument
          ...
          .getNameArray(0)
          .getPrefixArray(0)
          .set(cdaMapHelper.mapToCData(patientField.getPtPrefix()));
    }
    if (!patientField.getPtFirstName().isEmpty()) {
      mapPatientFirstName(clinicalDocument, patientField.getPtFirstName());
    }
    if (!patientField.getPtMiddleName().isEmpty()) {
      mapPatientMiddleName(clinicalDocument, patientField.getPtMiddleName());
    }
    ...
    if (!patientField.getPtLastName().isEmpty()) {
      ...
      clinicalDocument
          ...
          .getNameArray(0)
          .getFamilyArray(0)
          .set(cdaMapHelper.mapToCData(patientField.getPtLastName()));
    }
    if (!patientField.getPtSuffix().isEmpty()) {
      ...
      clinicalDocument
          ...
          .getNameArray(0)
          .getSuffixArray(0)
          .set(cdaMapHelper.mapToCData(patientField.getPtSuffix()));
    }
  ...
  @SuppressWarnings("java:S3776")
  private ValueMapper getPatientVariableNameAndValue(Field field, EcrMsgPatientDto patient) {
    String colName = "";
    String value = "";
    ...
    } else if (field.getName().equals("patAddrCommentTxt")
        && isFieldValid(patient.getPatAddrCommentTxt())) {
      colName = "PAT_ADDR_COMMENT_TXT";
      value = patient.getPatAddrCommentTxt();
    } else if (field.getName().equals("patAdditionalGenderTxt")
        && isFieldValid(patient.getPatAdditionalGenderTxt())) {
      colName = "PAT_ADDITIONAL_GENDER_TXT";
      value = patient.getPatAdditionalGenderTxt();
    } else if (field.getName().equals("patSpeaksEnglishIndCd")
        && isFieldValid(patient.getPatSpeaksEnglishIndCd())) {
      colName = "PAT_SPEAKS_ENGLISH_IND_CD";
      value = patient.getPatSpeaksEnglishIndCd();
    } else if (field.getName().equals("patIdStateHivCaseNbrTxt")
        && isFieldValid(patient.getPatIdStateHivCaseNbrTxt())) {
      colName = "PAT_ID_STATE_HIV_CASE_NBR_TXT";
      value = patient.getPatIdStateHivCaseNbrTxt();
    } else if (field.getName().equals("patEthnicityUnkReasonCd")
        && isFieldValid(patient.getPatEthnicityUnkReasonCd())) {
      colName = "PAT_ETHNICITY_UNK_REASON_CD";
      value = patient.getPatEthnicityUnkReasonCd();
    } else if (field.getName().equals("patSexUnkReasonCd")
        && isFieldValid(patient.getPatSexUnkReasonCd())) {
      colName = "PAT_SEX_UNK_REASON_CD";
      value = patient.getPatSexUnkReasonCd();
    } else if (field.getName().equals("patPhoneCommentTxt")
        && isFieldValid(patient.getPatPhoneCommentTxt())) {
      colName = "PAT_PHONE_COMMENT_TXT";
      value = patient.getPatPhoneCommentTxt();
    } else if (field.getName().equals("patDeceasedIndCd")
        && isFieldValid(patient.getPatDeceasedIndCd())) {
      colName = "PAT_DECEASED_IND_CD";
      value = patient.getPatDeceasedIndCd();
    } else if (field.getName().equals("patDeceasedDt")
        && isFieldValid(patient.getPatDeceasedDt())) {
      colName = "PAT_DECEASED_DT";
      value = patient.getPatDeceasedDt().toString();
    } else if (field.getName().equals("patPreferredGenderCd")
        && isFieldValid(patient.getPatPreferredGenderCd())) {
    ...
    } else if (field.getName().equals("patReportedAgeUnitCd")
        && isFieldValid(patient.getPatReportedAgeUnitCd())) {
      colName = "PAT_REPORTED_AGE_UNIT_CD";
      value = patient.getPatReportedAgeUnitCd();
    } else if (field.getName().equals("patCommentTxt")
        && isFieldValid(patient.getPatCommentTxt())) {
      colName = "PAT_COMMENT_TXT";
      value = patient.getPatCommentTxt();
    } else if (field.getName().equals("patBirthSexCd")
        && isFieldValid(patient.getPatBirthSexCd())) {
  ...
  private void mapPatientStructureComponentCompCheck(
      POCDMT000040ClinicalDocument1 clinicalDocument) {
  ...
  private CdaPatientMapper mapPatientStructureComponent(
      int patientComponentCounter, POCDMT000040ClinicalDocument1 clinicalDocument, String inv168)
      throws EcrCdaXmlException {
    if (patientComponentCounter < 0) {
      ...
      if (clinicalDocument.getComponent().getStructuredBody().getComponentArray().length == 0) {
        ...
        patientComponentCounter =
            clinicalDocument.getComponent().addNewStructuredBody().getComponentArray().length + 1;
        clinicalDocument.getComponent().getStructuredBody().addNewComponent();
      }
      ...
      if (clinicalDocument
              .getComponent()
              .getStructuredBody()
              .getComponentArray(patientComponentCounter)
              .getSection()
          == null) {
        clinicalDocument
            .getComponent()
      ...
      clinicalDocument
          ...
          .getSection()
          .getTitle()
          .set(cdaMapHelper.mapToCData("SOCIAL HISTORY INFORMATION"));
    }
  ...
  private void checkPatientRoleBirthCountry(POCDMT000040ClinicalDocument1 clinicalDocument) {
    checkPatientRole(clinicalDocument);
  ...
  private void checkPatientRoleGenderCode(POCDMT000040ClinicalDocument1 clinicalDocument) {
    ...
    if (clinicalDocument
        ...
        .getPatientRole()
        .getPatient()
        .isSetAdministrativeGenderCode()) {
      clinicalDocument
          .getRecordTargetArray(0)
          .getPatientRole()
          .getPatient()
          .addNewAdministrativeGenderCode();
    }
  }

  private void checkPatientRoleNameArray(POCDMT000040ClinicalDocument1 clinicalDocument) {
    checkPatientRole(clinicalDocument);
    if (clinicalDocument.getRecordTargetArray(0).getPatientRole().getPatient().getNameArray().length
        == 0) {
  ...
  private CdaPatientTelecom mapPatientWpNumber(
      POCDMT000040ClinicalDocument1 clinicalDocument,
      String wpNumber,
      String patWorkPhoneExtensionTxt,
      String patPhoneAsOfDt,
    ...
    try {
      if (!wpNumber.isEmpty()) {
        int pCount = 0;
        if (clinicalDocument.getRecordTargetArray(0).getPatientRole().getTelecomArray().length
            == 0) {
          clinicalDocument.getRecordTargetArray(0).getPatientRole().addNewTelecom();
        } else {
          pCount =
              clinicalDocument.getRecordTargetArray(0).getPatientRole().getTelecomArray().length
                  + 1
                  - 1;
          clinicalDocument.getRecordTargetArray(0).getPatientRole().addNewTelecom();
        }
        ...
        if (!patPhoneAsOfDt.isEmpty()) {
          TEL element =
              clinicalDocument.getRecordTargetArray(0).getPatientRole().getTelecomArray(pCount);
          element.set(XmlObject.Factory.parse(STUD));
          var out = cdaMapHelper.mapToUsableTSElement(patPhoneAsOfDt, element, USEABLE_PERIOD);
          clinicalDocument
              .getRecordTargetArray(0)
              .getPatientRole()
              .setTelecomArray(pCount, (TEL) out);
        }

        clinicalDocument
            .getRecordTargetArray(0)
            .getPatientRole()
            .getTelecomArray(pCount)
            .setUse(new ArrayList<String>(List.of("WP")));
        clinicalDocument
            .getRecordTargetArray(0)
            .getPatientRole()
            .getTelecomArray(pCount)
  ...
  private CdaPatientTelecom mapPatientCellPhone(
      POCDMT000040ClinicalDocument1 clinicalDocument,
      String cellNumber,
      String patPhoneAsOfDt,
      int phoneCounter)
    ...
    try {
      if (!cellNumber.isEmpty()) {
        ...
        clinicalDocument
            ...
            .getPatientRole()
            .getTelecomArray(pCount)
            .setUse(new ArrayList<String>(List.of("MC")));
        clinicalDocument
            .getRecordTargetArray(0)
            .getPatientRole()
            .getTelecomArray(pCount)
  ...
  private CdaPatientTelecom mapPatientEmail(
      POCDMT000040ClinicalDocument1 clinicalDocument,
      String patEmailAddressTxt,
      String patPhoneAsOfDt,
      int phoneCounter)
    ...
    try {
      if (!patEmailAddressTxt.isEmpty()) {
        ...
        clinicalDocument
            ...
            .getPatientRole()
            .getTelecomArray(pCount)
            .setUse(new ArrayList<String>(List.of("HP")));
        clinicalDocument
            .getRecordTargetArray(0)
            .getPatientRole()
            .getTelecomArray(pCount)
            .setValue(MAIL_TO + patEmailAddressTxt);
        if (!patPhoneAsOfDt.isEmpty()) {
          TEL element =
              clinicalDocument.getRecordTargetArray(0).getPatientRole().getTelecomArray(pCount);
          // CHECK mapToUsableTSElement
  ...
  private void mapPatientRaceCategory(
      EcrMsgPatientDto patient, POCDMT000040ClinicalDocument1 clinicalDocument)
      throws EcrCdaXmlException {
    ...
    for (String val : raceCatList) {
      ...
      if (!questionCode.isEmpty()) {
        ...
        clinicalDocument
            ...
            .getPatientRole()
            .getPatient()
            .setRaceCode2Array(raceCode2List.toArray(new CE[0]));
      }
    }
  }

  private CdaPatientTelecom mapPatientUrlAddress(
      POCDMT000040ClinicalDocument1 clinicalDocument,
      String patUrlAddressTxt,
      String patPhoneAsOfDt,
      int phoneCounter)
  ...
  private void mapPatientAddress1(POCDMT000040ClinicalDocument1 clinicalDocument, String address1)
      throws EcrCdaXmlException {
    ...
    if (!address1.isEmpty()) {
      ...
      clinicalDocument
          ...
          .getPatientRole()
          .getAddrArray(c1)
          .getStreetAddressLineArray(c2)
          .set(cdaMapHelper.mapToCData(address1));
    }
  }

  private void mapPatientAddress2(POCDMT000040ClinicalDocument1 clinicalDocument, String address2)
      throws EcrCdaXmlException {
    ...
    if (!address2.isEmpty()) {
      ...
      clinicalDocument
          ...
          .getAddrArray(c1)
          .getStreetAddressLineArray(c2)
          .set(cdaMapHelper.mapToCData(address2));
    }
  }

  private void mapToPatientRaceDesc(
      POCDMT000040ClinicalDocument1 clinicalDocument, EcrMsgPatientDto patient) {
    var counter = 0;
    checkPatientRole(clinicalDocument);
    if (clinicalDocument
            .getRecordTargetArray(0)
  ...
  private void mapPatientAddrCensusTract(
      POCDMT000040ClinicalDocument1 clinicalDocument, EcrMsgPatientDto patient) {
    checkPatientRoleAddrArray(clinicalDocument);
    ...
    clinicalDocument
        ...
        .getPatientRole()
        .getAddrArray(0)
        .setCensusTractArray(c, census);
  }

  private void mapPatientFirstName(
      POCDMT000040ClinicalDocument1 clinicalDocument, String patientFirstName)
      throws EcrCdaXmlException {
    checkPatientRoleNameArray(clinicalDocument);
    var count = 0;
    if (clinicalDocument
    ...
    clinicalDocument
        ...
        .getPatient()
        .getNameArray(0)
        .setUse(new ArrayList<String>(List.of("L")));
    clinicalDocument
        .getRecordTargetArray(0)
        .getPatientRole()
        .getPatient()
        .getNameArray(0)
        .getGivenArray(count)
        .set(cdaMapHelper.mapToCData(patientFirstName));
  }

  private void mapPatientMiddleName(
      POCDMT000040ClinicalDocument1 clinicalDocument, String patientMiddleName)
      throws EcrCdaXmlException {
    checkPatientRoleNameArray(clinicalDocument);
    var count = 0;
    if (clinicalDocument
    ...
    clinicalDocument
        ...
        .getNameArray(0)
        .getGivenArray(count)
        .set(cdaMapHelper.mapToCData(patientMiddleName));
  }

  private void mapPatientHomePhoneNumber(
      POCDMT000040ClinicalDocument1 clinicalDocument,
  ...
  private POCDMT000040Component3 mapToPatientNested(
      int counter, String colName, String data, POCDMT000040Component3 component3)
      throws EcrCdaXmlException {
    ...
    POCDMT000040Observation observation =
        component3.getSection().getEntryArray(count).getObservation();
