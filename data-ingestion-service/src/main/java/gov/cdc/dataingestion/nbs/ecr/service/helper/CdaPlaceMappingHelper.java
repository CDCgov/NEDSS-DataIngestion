...
public class CdaPlaceMappingHelper implements ICdaPlaceMappingHelper {
  ...
  public CdaPlaceMapper mapToPlaceTop(
    ...
    if (input.getMsgPlaces() != null && !input.getMsgPlaces().isEmpty()) {
      for (int i = 0; i < input.getMsgPlaces().size(); i++) {
        section = mapToPlaceTopFieldCheck(input, section, performerComponentCounter, i);
      }
    }
  ...
  private POCDMT000040Section mapToPlaceTopFieldCheck(
      EcrSelectedRecord input, POCDMT000040Section section, int performerComponentCounter, int i)
      throws EcrCdaXmlException {
    if (section == null) {
    ...
    section = this.cdaMapHelper.mapOrgPlaceProviderActCommonField(section, c, output);
  ...
  private POCDMT000040Participant2 mapToPlace(EcrMsgPlaceDto in, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    String state = "";
    ...
    for (Map.Entry<String, Object> entry : in.getDataMap().entrySet()) {
      ...
      param.setOut(out);
      var placeField = mapToPlaceFieldCheckP1(in, out, name, value, param);
    ...
    param2.setOut(out);
    var field2 = mapToPlaceFieldCheckP2(out, param2, teleCounter);
    out = field2.getOut();
  ...
  private PlaceField mapToPlaceFieldCheckP2(
      POCDMT000040Participant2 out, PlaceField param, int teleCounter) throws EcrCdaXmlException {
    ...
    if (!workPhone.isEmpty()) {
      ...
      mapToPlaceFieldCheckP2WorkPhone(
          teleCounter, out, workCountryCode, workPhone, workExtn, teleAsOfDate);
      teleCounter = teleCounter + 1;
    }
    if (!workEmail.isEmpty()) {
      mapToPlaceFieldCheckP2Email(teleCounter, out, workEmail, teleAsOfDate);
      teleCounter = teleCounter + 1;
    }
    if (!workURL.isEmpty()) {
      mapToPlaceFieldCheckP2Url(teleCounter, out, workURL, teleAsOfDate);
    }
  ...
  private void mapToPlaceFieldCheckP2Url(
      int teleCounter, POCDMT000040Participant2 out, String workURL, String teleAsOfDate) {
  ...
  private void mapToPlaceFieldCheckP2Email(
      int teleCounter, POCDMT000040Participant2 out, String workEmail, String teleAsOfDate) {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewTelecom();
    } else {
      out.getParticipantRole().addNewTelecom();
  ...
  private void mapToPlaceFieldCheckP2WorkPhone(
      int teleCounter,
  ...
  private void mapToPlaceFieldCheckP2AddressComment(
      String placeAddressComments, POCDMT000040Participant2 out) throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
    ...
    out.getParticipantRole()
        .getAddrArray(0)
        .setAdditionalLocatorArray(0, AdxpAdditionalLocator.Factory.newInstance());
    out.getParticipantRole()
        .getAddrArray(0)
        .getAdditionalLocatorArray(0)
        .set(cdaMapHelper.mapToCData(placeAddressComments));
  }
  ...
  private void mapToPlaceFieldCheckP2Census(String censusTract, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewAddr();
    } else {
    ...
    out.getParticipantRole()
        .getAddrArray(0)
        .setCensusTractArray(0, AdxpCensusTract.Factory.newInstance());
    out.getParticipantRole()
        .getAddrArray(0)
        .getCensusTractArray(0)
        .set(cdaMapHelper.mapToPCData(censusTract));
  }

  private void mapToPlaceFieldCheckP2Country(String country, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewAddr();
    } else {
    ...
    out.getParticipantRole()
        .getAddrArray(0)
        .getCountryArray(0)
        .set(cdaMapHelper.mapToCData(country));
  }

  private void mapToPlaceFieldCheckP2Zip(String zip, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewAddr();
    } else {
    ...
    out.getParticipantRole()
        ...
        .set(cdaMapHelper.mapToPCData(zip));
  }

  private void mapToPlaceFieldCheckP2County(String county, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewAddr();
    } else {
  ...
  private void mapToPlaceFieldCheckP2State(String state, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewAddr();
    } else {
    ...
    out.getParticipantRole()
        ...
        .set(cdaMapHelper.mapToCData(state));
  }

  private void mapToPlaceFieldCheckP2City(String city, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewAddr();
    } else {
  ...
  private void mapToPlaceFieldCheckP2Address2(String streetAddress2, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewAddr();
    } else {
    ...
    if (out.getParticipantRole().getAddrArray().length > 1) {
      ...
      out.getParticipantRole()
          ...
          .set(cdaMapHelper.mapToCData(streetAddress2));
    } else {
      out.getParticipantRole()
          .getAddrArray(0)
  ...
  private PlaceField mapToPlaceFieldCheckP1Helper4(
      String value, String name, EcrMsgPlaceDto in, PlaceField param) {
    String workPhone = param.getWorkPhone();
    String teleAsOfDate = param.getTeleAsOfDate();
    String censusTract = param.getCensusTract();
    String postalAsOfDate = param.getPostalAsOfDate();
    ...
    if (name.equals("plaPhoneExtensionTxt")
        && value != null
        && !in.getPlaPhoneExtensionTxt().isEmpty()) {
  ...
  private PlaceField mapToPlaceFieldCheckP1Helper1(
      String value, String name, EcrMsgPlaceDto in, PlaceField param) {
    String zip = param.getZip();
    String state = param.getState();
    String city = param.getCity();
    ...
    if (name.equals("plaAddrStreetAddr1Txt")
        && value != null
        && !in.getPlaAddrStreetAddr1Txt().isEmpty()) {
      streetAddress1 = in.getPlaAddrStreetAddr1Txt();
    }
    if (name.equals("plaAddrStreetAddr2Txt")
        && value != null
        && !in.getPlaAddrStreetAddr2Txt().isEmpty()) {
  ...
  private POCDMT000040Participant2 mapToPlaceFieldCheckP1Helper5(
      String value, String name, EcrMsgPlaceDto in, POCDMT000040Participant2 out) {
  ...
  private POCDMT000040Participant2 mapToPlaceFieldCheckP1Helper2(
      String value, String name, EcrMsgPlaceDto in, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (name.equals("plaTypeCd") && value != null && !in.getPlaTypeCd().isEmpty()) {
      ...
      out.getParticipantRole().addNewCode();
      out.getParticipantRole()
          .setCode(this.cdaMapHelper.mapToCEAnswerType(in.getPlaTypeCd(), questionCode));
    }
    if (name.equals("plaCommentTxt") && value != null && !in.getPlaCommentTxt().isEmpty()) {
      ...
      out.getParticipantRole()
          .getPlayingEntity()
          .getDesc()
          .set(cdaMapHelper.mapToCData(in.getPlaCommentTxt()));
    }

    return out;
  }

  private POCDMT000040Participant2 mapToPlaceFieldCheckP1Helper3(
      String value, String name, EcrMsgPlaceDto in, POCDMT000040Participant2 out) {
  ...
  private PlaceField mapToPlaceFieldCheckP1(
      EcrMsgPlaceDto in, POCDMT000040Participant2 out, String name, String value, PlaceField param)
      throws EcrCdaXmlException {
    ...
    mapToPlaceFieldCheckP1Helper3(value, name, in, out);

    if (name.equals("plaCommentTxt") && value != null && !in.getPlaCommentTxt().isEmpty()) {
      placeAddressComments = in.getPlaCommentTxt();
    }
    if (name.equals("plaPhoneCountryCodeTxt")
        && value != null
        && !in.getPlaPhoneCountryCodeTxt().isEmpty()) {
      workCountryCode = in.getPlaPhoneCountryCodeTxt();
    }
    if (name.equals("plaEmailAddressTxt")
        && value != null
        && !in.getPlaEmailAddressTxt().isEmpty()) {
    ...
    if (name.equals("plaPhoneCommentTxt")
        && value != null
        && !in.getPlaPhoneCommentTxt().isEmpty()) {
      placeComments = in.getPlaPhoneCommentTxt();
    }

    mapToPlaceFieldCheckP1Helper2(value, name, in, out);
    mapToPlaceFieldCheckP1Helper5(value, name, in, out);
