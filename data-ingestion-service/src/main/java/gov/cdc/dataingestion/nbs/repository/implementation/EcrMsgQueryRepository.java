...
public class EcrMsgQueryRepository implements IEcrMsgQueryRepository {
  ...
  public List<EcrMsgCaseParticipantDto> fetchMsgCaseParticipantForApplicableEcr(
      Integer containerId, String invLocalId) throws EcrCdaXmlException {
  ...
  public List<EcrMsgCaseAnswerDto> fetchMsgCaseAnswerForApplicableEcr(
      Integer containerId, String invLocalId) throws EcrCdaXmlException {
  ...
  public List<EcrMsgCaseAnswerDto> fetchMsgCaseAnswerRepeatForApplicableEcr(
      Integer containerId, String invLocalId) throws EcrCdaXmlException {
    String queryString = loadSqlFromFile("ecr_msg_case_answer_repeat.sql");
    return setListCaseAns(queryString, containerId, invLocalId);
  }

  private List<EcrMsgCaseAnswerDto> setListCaseAns(
      String queryString, Integer containerId, String invLocalId) {
    Query query = entityManager.createNativeQuery(queryString);
    query.setParameter(MSG_UID, containerId);
    query.setParameter(INV_LOCAL_ID, invLocalId);
    List<EcrMsgCaseAnswerDto> dtos = new ArrayList<>();
  ...
  public List<EcrMsgXmlAnswerDto> fetchMsgXmlAnswerForApplicableEcr(
      Integer containerId, String invLocalId) throws EcrCdaXmlException {
  ...
  public List<EcrMsgProviderDto> fetchMsgInterviewProviderForApplicableEcr(
      Integer containerId, String ixsLocalId) throws EcrCdaXmlException {
  ...
  public List<EcrMsgCaseAnswerDto> fetchMsgInterviewAnswerForApplicableEcr(
      Integer containerId, String ixsLocalId) throws EcrCdaXmlException {
    String queryString = loadSqlFromFile("ecr_msg_interview_answer.sql");
    return setListCaseAns(queryString, containerId, ixsLocalId);
  }

  public List<EcrMsgCaseAnswerDto> fetchMsgInterviewAnswerRepeatForApplicableEcr(
      Integer containerId, String ixsLocalId) throws EcrCdaXmlException {
  ...
  public List<EcrMsgProviderDto> fetchMsgTreatmentProviderForApplicableEcr(
      Integer containerId, String trtLocalId) throws EcrCdaXmlException {
  ...
  public List<EcrMsgOrganizationDto> fetchMsgTreatmentOrganizationForApplicableEcr(
      Integer containerId, String trtLocalId) throws EcrCdaXmlException {
