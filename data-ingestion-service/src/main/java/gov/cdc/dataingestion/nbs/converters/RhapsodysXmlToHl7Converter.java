...
public class RhapsodysXmlToHl7Converter {
  ...
  private static final String ATTRIBUTES_SEPARATOR =
      "^"; // Ex: Id, First Name, Last Name; 7654^JONES^INDIANA
  private static final String INNTER_ATTRIBUTES_SEPARATOR =
      "&"; // EX: Lab tech comments, multiple last names
  ...
  private String streamCommonOrders(HL7ORCType hl7ORCType) {
    ...
    sb.append(
        streamHL7TSType(
            hl7ORCType.getDateTimeOfTransaction())); // ORC.9 - Date/Time of Transaction: TS
    sb.append(COLUMNS_SEPARATOR);
    ...
    sb.append(COLUMNS_SEPARATOR);
    sb.append(
        streamHL7XCNTypeList(hl7ORCType.getOrderingProvider())); // ORC.12 - Ordering Provider : XCN
    sb.append(COLUMNS_SEPARATOR);
    ...
    sb.append(
        streamHL7TSType(
            hl7ORCType.getOrderEffectiveDateTime())); // ORC.15 - Order Effective Date/Time : TS
    sb.append(COLUMNS_SEPARATOR);
    ...
    sb.append(COLUMNS_SEPARATOR);
    sb.append(
        streamHL7XONTypeList(
            hl7ORCType.getOrderingFacilityName())); // ORC.21 - Ordering Facility Name : XON
    sb.append(COLUMNS_SEPARATOR);
    sb.append(
        streamHL7XADTypeList(
            hl7ORCType.getOrderingFacilityAddress())); // ORC.22 - Ordering Facility Address: XAD
    sb.append(COLUMNS_SEPARATOR);
    sb.append(
        streamHL7XTNTypeList(
            hl7ORCType
                .getOrderingFacilityPhoneNumber())); // ORC.23 - Ordering Facility Phone Number: XTN
    sb.append(COLUMNS_SEPARATOR);
    sb.append(
        streamHL7XADTypeList(
            hl7ORCType.getOrderingProviderAddress())); // ORC.24 - Ordering Provider Address: XAD
    sb.append(COLUMNS_SEPARATOR);
  ...
  private String streamHL7TSType(HL7TSType hl7TSType, boolean shortForm) {
    ...
    sb.append(
        String.format(
            "%04d%02d%02d", hl7TSType.getYear(), hl7TSType.getMonth(), hl7TSType.getDay()));
  ...
  private String streamHL7XTNType(HL7XTNType hl7XTNType) {
    ...
    if ((null != hl7XTNType.getHL7CountryCode())
        && (null != hl7XTNType.getHL7CountryCode().getHL7Numeric())) {
      sb.append(hl7XTNType.getHL7CountryCode().getHL7Numeric().intValue());
    }

    sb.append(ATTRIBUTES_SEPARATOR);

    if ((null != hl7XTNType.getHL7AreaCityCode())
        && (null != hl7XTNType.getHL7AreaCityCode().getHL7Numeric())) {
      sb.append(hl7XTNType.getHL7AreaCityCode().getHL7Numeric().intValue());
    }

    sb.append(ATTRIBUTES_SEPARATOR);

    if ((null != hl7XTNType.getHL7LocalNumber())
        && (null != hl7XTNType.getHL7LocalNumber().getHL7Numeric())) {
      sb.append(hl7XTNType.getHL7LocalNumber().getHL7Numeric().intValue());
    }

    sb.append(ATTRIBUTES_SEPARATOR);

    if ((null != hl7XTNType.getHL7Extension())
        && (null != hl7XTNType.getHL7Extension().getHL7Numeric())) {
  ...
  private String streamHL7XONType(HL7XONType xonType) {
    ...
    if (null != xonType.getHL7OrganizationNameTypeCode()
        && (!xonType.getHL7OrganizationNameTypeCode().isEmpty())) {
    ...
    if (null != xonType.getHL7IdentifierTypeCode()
        && (!xonType.getHL7IdentifierTypeCode().isEmpty())) {
    ...
    if (null != xonType.getHL7NameRepresentationCode()
        && (!xonType.getHL7NameRepresentationCode().isEmpty())) {
      sb.append(xonType.getHL7NameRepresentationCode());
    }

    sb.append(ATTRIBUTES_SEPARATOR);

    if (null != xonType.getHL7OrganizationIdentifier()
        && (!xonType.getHL7OrganizationIdentifier().isEmpty())) {
