...
public class CdaProviderMappingHelper implements ICdaProviderMappingHelper {
  ...
  public CdaProviderMapper mapToProviderTop(
  ...
  private void mapToProviderTopFieldCheckActCheck(
      POCDMT000040Section clinicalDocument, int performerSectionCounter) {
  ...
  private ProviderFieldCheck mapToProviderTopFieldCheck(
      EcrSelectedRecord input,
      POCDMT000040Section clinicalDocument,
      int i,
      String inv168,
    ...
    if (input.getMsgProviders().get(i).getPrvAuthorId() != null
      ...
      POCDMT000040Participant2 out =
          clinicalDocument.getEntryArray(performerSectionCounter).getAct().getParticipantArray(0);
      POCDMT000040Participant2 output =
          this.cdaMapHelper.mapToPSN(input.getMsgProviders().get(i), out);

      clinicalDocument =
          this.cdaMapHelper.mapOrgPlaceProviderActCommonField(
              clinicalDocument, performerSectionCounter, output);
      ...
      clinicalDocument
          ...
          .getAct()
          .getCode()
          .setDisplayName(ACT_CODE_DISPLAY_NAME);
    }
