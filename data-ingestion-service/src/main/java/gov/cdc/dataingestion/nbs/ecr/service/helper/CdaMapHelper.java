...
public class CdaMapHelper implements ICdaMapHelper {
  ...
  public POCDMT000040Section mapOrgPlaceProviderActCommonField(
    ...
    clinicalDocument
        .getEntryArray(performerSectionCounter)
        .getAct()
        .setClassCode(XActClassDocumentEntryAct.ACT);
    clinicalDocument
        .getEntryArray(performerSectionCounter)
        .getAct()
        .setMoodCode(XDocumentActMood.EVN);
  ...
  public OrgPlaceDocCommonField mapOrgPlaceDocCommonField(
      POCDMT000040Section clinicalDocument, int performerComponentCounter)
  ...
  public MapParticipantRole mapToParticipantRoleCheck(POCDMT000040SubstanceAdministration output) {
    int c = 0;
  ...
  public ANY mapMultiSelectDateMapXmlElement(ANY element, String value, EcrMsgCaseAnswerDto in)
      throws EcrCdaXmlException {
  ...
  public XmlObject mapToUsableTSElement(String data, XmlObject output, String name)
      throws EcrCdaXmlException {
  ...
  public String mapToQuestionId(String data) throws EcrCdaXmlException {
    ...
    var qIdentifier =
        ecrLookUpService.fetchQuestionIdentifierMapByCriteriaByCriteria("COLUMN_NM", data);
    if (qIdentifier != null) {
  ...
  public PhdcAnswerDao mapToCodedAnswer(String data, String questionCode)
    ...
    // RhapsodyTableLookup(output, tableName, resultColumnName, defaultValue, queryColumn1,
    // queryValue1, queryColumn2, queryValue2, ...)
    var phdcAnswer =
        ecrLookUpService.fetchPhdcAnswerByCriteriaForTranslationCode(questionCode, data);
    if (phdcAnswer != null) {
  ...
  public POCDMT000040CustodianOrganization mapToElementValue(
      String data, POCDMT000040CustodianOrganization output, String name) {
    XmlCursor cursor = output.newCursor();
   ...
   * TEST NEEDED
   * */
  public POCDMT000040Observation mapToObservation(
      String questionCode, String data, POCDMT000040Observation observation)
      throws EcrCdaXmlException {
    ...
    if (result != null) {
      ...
      var obs = mapToObservationLookupCheck(result, param);
      ...
      if (!result.getDataType().isEmpty()) {
        if (result.getDataType().equalsIgnoreCase(DATA_TYPE_CODE)) {
          mapToObservationDateTypeCoded(observation, data, result);
        } else {
          mapToObservationDataTypeNotCoded(result, observation, data, defaultQuestionIdentifier);
        }
      }
    } else {
  ...
  private void mapToObservationDateTypeCoded(
      POCDMT000040Observation observation, String data, PhdcQuestionLookUpDto result)
      throws EcrCdaXmlException {
  ...
  private void mapToObservationDataTypeNotCoded(
    ...
    try {
      if (result.getDataType().equalsIgnoreCase("PART")) {
        ...
        var val =
            ecrLookUpService.fetchPhdcQuestionByCriteriaWithColumn(
                "Question_Identifier", defaultQuestionIdentifier);
  ...
  private Observation mapToObservationLookupCheck(PhdcQuestionLookUpDto result, Observation param)
      throws EcrCdaXmlException {
    ...
    QuestionIdentifierMapDto identifierMap =
        ecrLookUpService.fetchQuestionIdentifierMapByCriteriaByCriteria(
            "Question_Identifier", questionCode);
  ...
  public PhdcQuestionLookUpDto mapToCodedQuestionType(String questionIdentifier)
    ...
    if (!questionIdentifier.isEmpty()) {
      ...
      if (result != null) {
        ...
        if (result.getQuesCodeSystemDescTxt() != null
            && !result.getQuesCodeSystemDescTxt().isEmpty()) {
  ...
  public POCDMT000040Participant2 mapToPSN(EcrMsgProviderDto in, POCDMT000040Participant2 out)
    ...
    for (Map.Entry<String, Object> entry : in.getDataMap().entrySet()) {
      ...
      var psn = mapToPSNFieldCheckAndMap(in, out, name, param);
    ...
    if (!telephone.isEmpty()) {
      var tele = mapToPSNTelephone(telephone, out, extn, teleCounter);
      out = tele.getOut();
      teleCounter = tele.getTeleCounter();
    }
    if (!email.isEmpty()) {
      var emailInfo = mapToPSNEmail(email, out, teleCounter);
  ...
  private PsnTelephone mapToPSNEmail(String email, POCDMT000040Participant2 out, int teleCounter) {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewTelecom();
    } else {
      out.getParticipantRole().addNewTelecom();
    }
    out.getParticipantRole()
        .getTelecomArray(teleCounter)
  ...
  private PsnTelephone mapToPSNTelephone(
      String telephone, POCDMT000040Participant2 out, String extn, int teleCounter) {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewTelecom();
    } else {
      out.getParticipantRole().addNewTelecom();
  ...
  private void mapToPSNCountry(String country, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
  ...
  private void mapToPSNZip(String zip, POCDMT000040Participant2 out) throws EcrCdaXmlException {
    ...
    out.getParticipantRole()
        .getAddrArray(0)
        .setPostalCodeArray(0, AdxpPostalCode.Factory.newInstance());
    out.getParticipantRole().getAddrArray(0).getPostalCodeArray(0).set(mapVal);
  }

  private void mapToPSNCounty(String county, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewAddr();
    } else {
  ...
  private void mapToPSNAddress2(String address2, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewAddr();
    } else {
    ...
    if (out.getParticipantRole().getAddrArray(0).getStreetAddressLineArray().length > 1) {
      ...
      out.getParticipantRole()
          .getAddrArray(0)
          .setStreetAddressLineArray(1, AdxpStreetAddressLine.Factory.newInstance());
      out.getParticipantRole().getAddrArray(0).getStreetAddressLineArray(1).set(mapVal);
    } else {
      out.getParticipantRole().getAddrArray(0).addNewStreetAddressLine();
      out.getParticipantRole()
          .getAddrArray(0)
          .setStreetAddressLineArray(0, AdxpStreetAddressLine.Factory.newInstance());
      out.getParticipantRole().getAddrArray(0).getStreetAddressLineArray(0).set(mapVal);
    }
  }

  private void mapToPSNAddress1(String address1, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewAddr();
    } else {
  ...
  private void mapToPSNSuffix(String suffix, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
    ...
    out.getParticipantRole()
        .getPlayingEntity()
        .getNameArray(0)
        .setSuffixArray(0, EnSuffix.Factory.newInstance());
    out.getParticipantRole().getPlayingEntity().getNameArray(0).getSuffixArray(0).set(mapVal);
  }

  private void mapToPSNPrefix(String prefix, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewPlayingEntity().addNewName();
    }
    ...
    out.getParticipantRole()
        .getPlayingEntity()
        .getNameArray(0)
        .setPrefixArray(0, EnPrefix.Factory.newInstance());
    out.getParticipantRole().getPlayingEntity().getNameArray(0).getPrefixArray(0).set(mapVal);
  }

  private void mapToPSNFirstName(String firstName, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewPlayingEntity().addNewName();
    } else {
    ...
    out.getParticipantRole()
        .getPlayingEntity()
        .getNameArray(0)
        .setGivenArray(0, EnGiven.Factory.newInstance());
  ...
  private void mapToPSNLastName(String lastName, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewPlayingEntity().addNewName();
    }
    ...
    out.getParticipantRole()
        .getPlayingEntity()
        .getNameArray(0)
        .setFamilyArray(0, EnFamily.Factory.newInstance());
  ...
  private Psn mapToPSNFieldCheckAndMap(
      EcrMsgProviderDto in, POCDMT000040Participant2 out, String name, Psn param)
      throws EcrCdaXmlException {
    ...
    param2 = mapToPSNFieldCheckAndMapGenericP1(in, out, name, param);
    ...
    if (name.equals("prvAddrCountyCd")
        && in.getPrvAddrCountyCd() != null
        && !in.getPrvAddrCountyCd().isEmpty()) {
      param.setAuthCounty(in.getPrvAddrCountyCd());
      county = mapToAddressType(in.getPrvAddrCountyCd(), COUNTY);
    } else if (name.equals("prvAddrStateCd")
        && in.getPrvAddrStateCd() != null
        && !in.getPrvAddrStateCd().isEmpty()) {
      param.setAuthState(in.getPrvAddrStateCd());
      state = mapToAddressType(in.getPrvAddrStateCd(), STATE);
    } else if (name.equals("prvAddrZipCodeTxt")
        && in.getPrvAddrZipCodeTxt() != null
        && !in.getPrvAddrZipCodeTxt().isEmpty()) {
      zip = in.getPrvAddrZipCodeTxt();
      param.setAuthZip(zip);
    } else if (name.equals("prvAddrCountryCd")
        && in.getPrvAddrCountryCd() != null
        && !in.getPrvAddrCountryCd().isEmpty()) {
      param.setAuthCountry(in.getPrvAddrCountryCd());
      country = mapToAddressType(in.getPrvAddrCountryCd(), COUNTRY);
    } else if (name.equals("prvPhoneNbrTxt")
        && in.getPrvPhoneNbrTxt() != null
        && !in.getPrvPhoneNbrTxt().isEmpty()) {
    ...
    } else if (name.equals("prvIdQuickCodeTxt")
        && in.getPrvIdQuickCodeTxt() != null
        && !in.getPrvIdQuickCodeTxt().isEmpty()) {
      mapToPSNFieldCheckAndMapQuickCode(in, out);
  ...
  private boolean mapToPSNFieldCheckAndMapValidateField(String name, EcrMsgProviderDto in) {
    return name.equals("prvEmailAddressTxt")
        && in.getPrvEmailAddressTxt() != null
        && !in.getPrvEmailAddressTxt().isEmpty();
  }

  private Psn mapToPSNFieldCheckAndMapGenericP1(
      EcrMsgProviderDto in, POCDMT000040Participant2 out, String name, Psn param) {
    String firstName = param.getFirstName();
    String prefix = param.getPrefix();
    String lastName = param.getLastName();
    ...
    if (name.equals("prvLocalId") && in.getPrvLocalId() != null && !in.getPrvLocalId().isEmpty()) {
      mapToPSNFieldCheckAndMapLocalId(in, out);
      param.setLocalId(in.getPrvLocalId());
      param.setAuthLocalId(in.getPrvLocalId());
    } else if (name.equals("prvNameFirstTxt")
        && in.getPrvNameFirstTxt() != null
        && !in.getPrvNameFirstTxt().isEmpty()) {
      firstName = in.getPrvNameFirstTxt();
      param.setAuthFirstName(firstName);
    } else if (name.equals("prvNamePrefixCd")
        && in.getPrvNamePrefixCd() != null
        && !in.getPrvNamePrefixCd().isEmpty()) {
      prefix = in.getPrvNamePrefixCd();
      param.setAuthPrefix(prefix);
    } else if (name.equals("prvNameLastTxt")
        && in.getPrvNameLastTxt() != null
        && !in.getPrvNameLastTxt().isEmpty()) {
      lastName = in.getPrvNameLastTxt();
      param.setAuthLastName(lastName);
    } else if (name.equals("prvNameSuffixCd")
        && in.getPrvNameSuffixCd() != null
        && !in.getPrvNameSuffixCd().isEmpty()) {
      suffix = in.getPrvNameSuffixCd();
      param.setAuthSuffix(suffix);
    } else if (name.equals("prvNameDegreeCd")
        && in.getPrvNameDegreeCd() != null
        && !in.getPrvNameDegreeCd().isEmpty()) {
  ...
  private void mapToPSNFieldCheckAndMapQuickCode(
      EcrMsgProviderDto in, POCDMT000040Participant2 out) {
    if (out.getParticipantRole() == null) {
  ...
  private void mapToPSNFieldCheckAndMapLocalId(EcrMsgProviderDto in, POCDMT000040Participant2 out) {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewId();
    } else {
      out.getParticipantRole().addNewId();
  ...
  public POCDMT000040Participant2 mapToORG(EcrMsgOrganizationDto in, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    String state = "";
    ...
    for (Map.Entry<String, Object> entry : in.getDataMap().entrySet()) {
      ...
      param.setAuthExtn(authExtn);
      var orgModel = mapToORGFieldCheckP1(in, out, name, param);
  ...
  private void mapToORGFieldCountry(String country, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewAddr();
    } else {
  ...
  private void mapToORGFieldZip(String zip, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewAddr();
    } else {
  ...
  private void mapToORGFieldStreetCounty(String county, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewAddr();
    } else {
  ...
  private void mapToORGFieldStreetState(String state, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewAddr();
    } else {
  ...
  private void mapToORGFieldStreetCity(String city, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewAddr();
    } else {
  ...
  private void mapToORGFieldStreetAddress2(String streetAddress2, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewAddr();
    } else {
    ...
    if (out.getParticipantRole().getAddrArray(0).getStreetAddressLineArray().length > 1) {
      ...
      out.getParticipantRole()
          .getAddrArray(0)
          .getStreetAddressLineArray(1)
          .set(mapToCData(streetAddress2));
    } else {
      out.getParticipantRole()
          .getAddrArray(0)
          .setStreetAddressLineArray(0, AdxpStreetAddressLine.Factory.newInstance());
      out.getParticipantRole()
          .getAddrArray(0)
          .getStreetAddressLineArray(0)
          .set(mapToCData(streetAddress2));
    }
  }

  private void mapToORGFieldStreetAddress(String streetAddress1, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
    if (out.getParticipantRole() == null) {
      out.addNewParticipantRole().addNewAddr();
    } else {
    ...
    out.getParticipantRole()
        .getAddrArray(0)
        .getStreetAddressLineArray(0)
        .set(mapToCData(streetAddress1));
  }

  @SuppressWarnings("java:S3776")
  private Org mapToORGFieldCheckP1(
      EcrMsgOrganizationDto in, POCDMT000040Participant2 out, String name, Org param)
      throws EcrCdaXmlException {
    String state = param.getState();
    ...
    if (name.equals("orgLocalId") && in.getOrgLocalId() != null) {
      ...
      mapToORGFieldCheckP1CliaNbr(in, out);
    }
  ...
  private void mapToORGFieldCheckP1CliaNbr(EcrMsgOrganizationDto in, POCDMT000040Participant2 out) {
  ...
  private void mapToORGFieldCheckP1OrgName(EcrMsgOrganizationDto in, POCDMT000040Participant2 out)
      throws EcrCdaXmlException {
  ...
  private void mapToORGFieldCheckP1LocalId(EcrMsgOrganizationDto in, POCDMT000040Participant2 out) {
