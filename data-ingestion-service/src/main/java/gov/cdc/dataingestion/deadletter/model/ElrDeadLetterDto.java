...
public class ElrDeadLetterDto {
   ...
   * Stacktrace that is coming back from Kafka is appended with kafka listener stacktrace, hence,
   * right now we do this to extract the root message
   */
  @NotNull private String processingSourceStackTrace(String stackTrace) {
    // Leading ^ and tailing [^\n]*+
