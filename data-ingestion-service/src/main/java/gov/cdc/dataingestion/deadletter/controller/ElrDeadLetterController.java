...
public class ElrDeadLetterController {
  ...
  public ResponseEntity<ElrDeadLetterDto> getErrorMessage(@PathVariable("dlt-id") String id)
      throws DeadLetterTopicException {
  ...
  public ResponseEntity<ElrDeadLetterDto> messageReInject(
      @PathVariable("dlt-id") String dltId, @RequestBody final String payload)
  ...
  @Operation(
      summary =
          "Get ELR Ingestion error messages by Date range. The Start date must be earlier than or equal to the End date.",
  ...
  public ResponseEntity<List<ElrDeadLetterDto>> getErrorMessagesByDate(
      @RequestHeader("startDate") String startDate, @RequestHeader(name = "endDate") String endDate)
