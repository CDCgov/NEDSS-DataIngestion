...
public class ElrReportsController {
  ...
  @Operation(
      ...
      parameters = {
        ...
        @Parameter(
            ...
            name = "customMapper",
            description =
                "The optional custom mapper field that find and replaces the text in the ELR message."
  ...
  public ResponseEntity<String> save(
      ...
      @RequestHeader("msgType") String type,
      @RequestHeader(name = "version", defaultValue = "1") String version,
      @RequestHeader(name = "customMapper", defaultValue = "") String customMapper)
      throws KafkaProducerException {
    if (type.isEmpty()) {
      throw new ResponseStatusException(
          HttpStatus.BAD_REQUEST, "Required headers should not be null");
    } else {
    ...
    if (type.equalsIgnoreCase(HL7_ELR)) {
      ...
      throw new ResponseStatusException(
          HttpStatus.BAD_REQUEST, "Please provide valid value for msgType header");
    }
  }
  ...
  public ResponseEntity<String> hl7Validator(@RequestBody final String payload)
