...
public class TimeMetricsBuilder {
  ...
  public TimeMetricsBuilder(MeterRegistry meterRegistry) {
    ...
    this.elrRawEventTimer = Timer.builder("elr_raw_event_timer").register(meterRegistry);
    this.elrRawXmlEventTimer = Timer.builder("elr_raw_xml_event_timer").register(meterRegistry);
    this.elrValidatedTimer = Timer.builder("elr_validated_timer").register(meterRegistry);
    this.xmlPrepTimer = Timer.builder("xml_prep_timer").register(meterRegistry);
  }
