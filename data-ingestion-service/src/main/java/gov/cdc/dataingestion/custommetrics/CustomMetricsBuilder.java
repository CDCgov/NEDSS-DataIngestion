...
public class CustomMetricsBuilder {
  ...
  public CustomMetricsBuilder(MeterRegistry meterRegistry) {
    this.customMessagesProcessed =
        Counter.builder("custom_messages_processed").register(meterRegistry);
    this.customMessagesValidated =
        Counter.builder("custom_messages_validated").register(meterRegistry);
    this.customMessagesValidatedSuccess =
        Counter.builder("custom_messages_validated_success").register(meterRegistry);
    this.customMessagesValidatedFailure =
        Counter.builder("custom_messages_validated_failure").register(meterRegistry);
    this.customDuplicateHl7Found =
        Counter.builder("custom_duplicate_hl7_found").register(meterRegistry);
    this.customXmlConversionRequested =
        Counter.builder("custom_xml_conversion_requested").register(meterRegistry);
    this.customXmlConvertedSuccess =
        Counter.builder("custom_xml_converted_success").register(meterRegistry);
    this.customXmlConvertedFailure =
        Counter.builder("custom_xml_converted_failure").register(meterRegistry);
    this.customTokensRequested = Counter.builder("custom_tokens_requested").register(meterRegistry);
  }
