...
def generate_unique_patient_messages(num_messages, output_folder):
    ...
    for _ in range(num_messages):
        ...
        fake_message = (
            ...
            f"OBX|1|SN|77190-7A^TITER^LN^080133|1|100^1^:^1|mL|10-100|H|||F||||20D0649525^LABCORP BIRMINGHAM^CLIA||||20060401||||Lab1^L^^^^CLIA&2.16.840.1.114222.4.3.2.5.2.100&ISO^^^^1234|1234 Cornell Park Dr^^Blue Ash^OH^45241|9876543^JONES^BOB^F^^^MD\r"
