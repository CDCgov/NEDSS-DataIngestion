...
def generate_unique_patient_messages(num_messages, output_folder):
    ...
    for _ in range(num_messages):
        ...
        fake_message = (
            f"MSH|^~\\&|LABCORP-CORP^OID^ISO|LABCORP^20D0649525^CLIA|ALDOH^OID^ISO|AL^OID^ISO|200604040100||ORU^R01^ORU_R01|20120509010020114_251{id_number}|D|2.5.1|||NE|NE|USA||||V251_IG_LB_LABRPTPH_R1_INFORM_2010FEB^^2.16.840.1.114222.4.3.2.5.2.5^ISO\r"
