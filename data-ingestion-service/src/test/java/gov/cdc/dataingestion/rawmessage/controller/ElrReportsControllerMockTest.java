...
class ElrReportsControllerMockTest {
  ...
  @Mock private IHL7Service hl7Service;

  @InjectMocks private ElrReportsController elrReportsController;
  ...
  void testSave_Invalid_Type() {
    ...
    assertThrows(
        ResponseStatusException.class, () -> elrReportsController.save(payload, type, version, ""));
  }
