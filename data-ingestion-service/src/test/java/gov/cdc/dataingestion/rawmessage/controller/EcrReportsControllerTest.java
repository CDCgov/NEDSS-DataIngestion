...
class EcrReportsControllerTest {
  ...
  @MockitoBean private NbsRepositoryServiceProvider nbsRepositoryServiceProvider;
  ...
  void testSaveIncomingEcrWithRR() throws Exception {
    ...
    when(nbsRepositoryServiceProvider.saveIncomingEcrMessageWithRR(
            anyString(), anyString(), anyString(), anyString(), anyString()))
        .thenReturn(mockModel);

    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/api/ecrs")
    ...
    verify(nbsRepositoryServiceProvider)
        .saveIncomingEcrMessageWithRR("eicrContent", "testSystem", "EICR", "rrContent", "RR");
  }
  ...
  void testSaveIncomingEcrWithoutRR() throws Exception {
    ...
    when(nbsRepositoryServiceProvider.saveIncomingEcrMessageWithoutRR(
    ...
    verify(nbsRepositoryServiceProvider)
        .saveIncomingEcrMessageWithoutRR("eicrContent", "testSystem", "EICR");
  }
  ...
  void testSaveIncomingEcrWithMalformedXml() throws Exception {
    ...
    verify(nbsRepositoryServiceProvider, never())
        .saveIncomingEcrMessageWithRR(
            anyString(), anyString(), anyString(), anyString(), anyString());
    verify(nbsRepositoryServiceProvider, never())
        .saveIncomingEcrMessageWithoutRR(anyString(), anyString(), anyString());
  }
}
