...
class OBRSplitterTest {
  ...
  @Mock private IObxIdStdLookupRepository obxIdStdLookupRepository;

  @InjectMocks private OBRSplitter splitter;

  private String testHL7Single =
  ...
  void splitElr_singleObr() throws DiHL7Exception {
    HL7ParsedMessage<OruR1> parsedMessageOrig =
        Hl7ToRhapsodysXmlConverter.getInstance().parsedStringToHL7(testHL7Single);
  ...
  void splitElr_multiObr() throws DiHL7Exception {
    HL7ParsedMessage<OruR1> parsedMessageOrig =
        Hl7ToRhapsodysXmlConverter.getInstance().parsedStringToHL7(testHL7Multi);
    List<HL7ParsedMessage<OruR1>> result = splitter.splitElr(parsedMessageOrig);
  ...
  void splitElr_byOBX() throws DiHL7Exception {
    HL7ParsedMessage<OruR1> parsedMessageOrig =
        Hl7ToRhapsodysXmlConverter.getInstance().parsedStringToHL7(testHL7ForOBX);
  ...
  void splitElr_obr_parentchild() throws DiHL7Exception {
    ...
    HL7ParsedMessage<OruR1> parsedMessageOrig =
        Hl7ToRhapsodysXmlConverter.getInstance().parsedStringToHL7(testHL7ParentChild);
    List<HL7ParsedMessage<OruR1>> result = splitter.splitElr(parsedMessageOrig);
    assertEquals(2, result.size());
  }
}
