...
class HL7ServiceTest {
  @Mock private IHL7v2Validator hl7v2Validator;

  @InjectMocks private HL7Service target;
  ...
  void testHl7Validator() throws DiHL7Exception {
    String hl7Msg =
        "MSH|^~\\&|UHS|Centennial Hills Hospital Medical Center^TBD^CLIA|NV|NVDOH|20150224114200||ORU^R01|2015022411420626264_1001_6|P|2.3.1|||||USA\n"
    ...
    String hl7MsgAfterStringSet =
        "MSH|^~\\&|UHS|Centennial Hills Hospital Medical Center^TBD^CLIA|NV|NVDOH|20150224114200||ORU^R01|2015022411420626264_1001_6|P|2.3.1|||||USA\r"
    ...
    when(hl7v2Validator.messageStringFormat(hl7Msg)).thenReturn(hl7MsgAfterStringSet);
