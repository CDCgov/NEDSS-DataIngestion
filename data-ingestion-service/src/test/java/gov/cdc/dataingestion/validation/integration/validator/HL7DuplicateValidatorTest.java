...
class HL7DuplicateValidatorTest {
  ...
  void setUp() {
    ...
    hl7DuplicateValidator =
        new HL7DuplicateValidator(
            iValidatedELRRepositoryMock, kafkaProducerServiceMock, customMetricsBuilderMock);
  }
  ...
  @Test
  void testValidateHL7DocumentSuccess()
  ...
  void testValidateHL7DocumentThrowsException() throws KafkaProducerException {
    ...
    doNothing()
        .when(kafkaProducerServiceMock)
        .sendMessageAfterCheckingDuplicateHL7(any(ValidatedELRModel.class), anyString(), anyInt());
  ...
  @NotNull private static ValidatedELRModel getValidatedELRModel() {
    String data =
