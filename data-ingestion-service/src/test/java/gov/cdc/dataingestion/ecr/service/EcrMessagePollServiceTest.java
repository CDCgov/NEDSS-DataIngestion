...
class EcrMessagePollServiceTest {
  ...
  @Mock EcrMsgContainerDto ecrMsgContainerDto = mock(EcrMsgContainerDto.class);

  @InjectMocks private EcrMessagePollService ecrMessagePollService;
  ...
  void testFetchMessageContainerDataWithNullResult() throws EcrCdaXmlException {
    ...
    verify(nbsRepositoryServiceProvider, never())
        .saveEcrCdaXmlMessage(anyString(), anyInt(), anyString());
  }
