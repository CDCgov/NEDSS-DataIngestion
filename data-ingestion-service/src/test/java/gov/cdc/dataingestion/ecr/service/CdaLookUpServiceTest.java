...
class CdaLookUpServiceTest {
  @Mock private IEcrLookUpRepository ecrLookUpRepository;
  @InjectMocks private CdaLookUpService target;
  ...
  void fetchConstantLookUpByCriteriaWithColumn_Test() throws EcrCdaXmlException {
    ...
    dto.setUsage("test");
    when(ecrLookUpRepository.fetchConstantLookUpByCriteriaWithColumn(column, value))
        .thenReturn(dto);
  ...
  void fetchPhdcAnswerByCriteriaForTranslationCode_Test() throws EcrCdaXmlException {
    ...
    when(ecrLookUpRepository.fetchPhdcAnswerByCriteriaForTranslationCode(column, value))
        .thenReturn(dto);
    ...
    Assertions.assertEquals(
        dto.getAnsFromCodeSystemDescTxt(), result.getAnsFromCodeSystemDescTxt());
  ...
  void fetchPhdcQuestionByCriteria_Test() throws EcrCdaXmlException {
    ...
    when(ecrLookUpRepository.fetchPhdcQuestionByCriteria(value)).thenReturn(dto);
  ...
  void fetchPhdcQuestionByCriteriaWithColumn_Test() throws EcrCdaXmlException {
    ...
    when(ecrLookUpRepository.fetchPhdcQuestionByCriteriaWithColumn(column, value)).thenReturn(dto);
  ...
  void fetchQuestionIdentifierMapByCriteriaByCriteria_Test() throws EcrCdaXmlException {
    ...
    when(ecrLookUpRepository.fetchQuestionIdentifierMapByCriteriaByCriteria(column, value))
        .thenReturn(dto);
    ...
    Assertions.assertEquals(dto.getQuestionIdentifier(), result.getQuestionIdentifier());
    Assertions.assertEquals(
        dto.getDynamicQuestionIdentifier(), result.getDynamicQuestionIdentifier());
  }
}
