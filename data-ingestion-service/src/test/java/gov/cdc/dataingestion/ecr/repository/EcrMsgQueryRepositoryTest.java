...
class EcrMsgQueryRepositoryTest {
  @InjectMocks private EcrMsgQueryRepository target;
  ...
  void fetchMsgPatientForApplicableEcr_Test() throws Exception {
    ...
    // Act
    List<EcrMsgPatientDto> results =
        target.fetchMsgPatientForApplicableEcr(1); // You can change the argument as needed
  ...
  void fetchMsgCaseParticipantForApplicableEcr_Test() throws Exception {
    ...
    List<Object[]> mockResults = new ArrayList<>();
    mockResults.add(new Object[] {"1", "2", "3", "4", 5, "6", "7", 8, 9});
    when(mockQuery.getResultList()).thenReturn(mockResults);
    ...
    // Act
    List<EcrMsgCaseParticipantDto> results =
        target.fetchMsgCaseParticipantForApplicableEcr(containerId, invLocalId);
  ...
  void fetchMsgCaseAnswerForApplicableEcr_Test() throws Exception {
    ...
    // Act
    List<EcrMsgCaseAnswerDto> results =
        target.fetchMsgCaseAnswerForApplicableEcr(containerId, invLocalId);
  ...
  void fetchMsgCaseAnswerRepeatForApplicableEcr_Test() throws Exception {
    ...
    // Act
    List<EcrMsgCaseAnswerDto> results =
        target.fetchMsgCaseAnswerRepeatForApplicableEcr(containerId, invLocalId);
  ...
  void testFetchMsgXmlAnswerForApplicableEcr() throws EcrCdaXmlException {
    ...
    when(mockQuery.getResultList())
        .thenReturn(Arrays.asList(new Object[] {"data1", "xml1"}, new Object[] {"data2", "xml2"}));

    // When
    List<EcrMsgXmlAnswerDto> result =
        target.fetchMsgXmlAnswerForApplicableEcr(containerId, invLocalId);
  ...
  void testFetchMsgOrganizationForApplicableEcr() throws EcrCdaXmlException {
    ...
    Object[] objArray = {
      ...
      "orgAddrCountryCd",
      "orgAddrStateCd",
      "orgAddrStreetAddr1Txt",
      "orgAddrStreetAddr2Txt",
      "orgAddrZipCodeTxt",
      "orgClassCd",
      "orgCommentTxt",
      "orgEmailAddressTxt",
      "orgIdCliaNbrTxt",
      "orgIdFacilityIdentifierTxt",
      "orgIdQuickCodeTxt",
      "orgPhoneCommentTxt",
      "orgPhoneCountryCodeTxt",
      1,
      "orgPhoneNbrTxt",
      "orgRoleCd",
      "orgUrlAddressTxt"
  ...
  void testFetchMsgPlaceForApplicableEcr() throws EcrCdaXmlException {
    ...
    Object[] objArray = {
      ...
      "plaAddrCountryCd",
      "plaAddrStateCd",
      "plaAddrStreetAddr1Txt",
      "plaAddrStreetAddr2Txt",
      "plaAddrZipCodeTxt",
      "plaAddrCommentTxt",
      "plaCensusTractTxt",
      "plaCommentTxt",
      ...
      "plaNameTxt",
      new Timestamp(System.currentTimeMillis()),
      "plaPhoneCountryCodeTxt",
      "plaPhoneExtensionTxt",
      "plaPhoneNbrTxt",
      "plaPhoneCommentTxt",
      "plaTypeCd",
      "plaUrlAddressTxt"
  ...
  void testFetchMsgInterviewForApplicableEcr() throws EcrCdaXmlException {
    ...
    Object[] interviewArray = {
      ...
      new Timestamp(System.currentTimeMillis()),
      "ixsInterviewLocCd",
      "ixsIntervieweeRoleCd",
      "ixsInterviewTypeCd",
      "ixsStatusCd"
    };

    when(entityManager.createNativeQuery(anyString())).thenReturn(query);
    when(query.getResultList()).thenReturn(Arrays.asList(new Object[][] {interviewArray}));
  ...
  void testFetchMsgInterviewProviderForApplicableEcr() throws EcrCdaXmlException {
    ...
    when(mockQuery.getResultList()).thenReturn(Arrays.asList(new Object[][] {providerArray}));

    when(entityManager.createNativeQuery(anyString())).thenReturn(mockQuery);

    // When
    List<EcrMsgProviderDto> result =
        target.fetchMsgInterviewProviderForApplicableEcr(containerId, ixsLocalId);
  ...
  void testFetchMsgInterviewAnswerForApplicableEcr() throws EcrCdaXmlException {
    ...
    String ixsLocalId = "testIxsLocalId";
    Object[] answerArray = {
      "questionGroupSeqNumber",
      "answerGroupSeqNumber",
      "seqNumber",
      "dataType",
      "questionId",
      1234,
    ...
    Query mockQuery = mock(Query.class);
    when(mockQuery.setParameter(anyString(), any())).thenReturn(mockQuery);
    when(mockQuery.getResultList()).thenReturn(Arrays.asList(new Object[][] {answerArray}));

    when(entityManager.createNativeQuery(anyString())).thenReturn(mockQuery);

    // When
    List<EcrMsgCaseAnswerDto> result =
        target.fetchMsgInterviewAnswerForApplicableEcr(containerId, ixsLocalId);
  ...
  void fetchMsgInterviewAnswerRepeatForApplicableEcr_Test() throws EcrCdaXmlException {
    ...
    // When
    List<EcrMsgCaseAnswerDto> result =
        target.fetchMsgInterviewAnswerRepeatForApplicableEcr(containerId, ixsLocalId);
  ...
  void testFetchMsgTreatmentForApplicableEcr() throws EcrCdaXmlException {
    ...
    Query mockQuery = mock(Query.class);
    when(mockQuery.setParameter(anyString(), any())).thenReturn(mockQuery);
    when(mockQuery.getResultList()).thenReturn(Arrays.asList(new Object[][] {treatmentArray}));
  ...
  void testFetchMsgTreatmentProviderForApplicableEcr() throws EcrCdaXmlException {
    ...
    // When
    List<EcrMsgProviderDto> result =
        target.fetchMsgTreatmentProviderForApplicableEcr(containerId, anyString());
  ...
  void testFetchMsgTreatmentOrganizationForApplicableEcr() throws EcrCdaXmlException {
    ...
    Query mockQuery = mock(Query.class);
    when(mockQuery.setParameter(anyString(), any())).thenReturn(mockQuery);
    when(mockQuery.getResultList()).thenReturn(Arrays.asList(new Object[][] {organizationArray}));

    when(entityManager.createNativeQuery(anyString())).thenReturn(mockQuery);

    // When
    List<EcrMsgOrganizationDto> result =
        target.fetchMsgTreatmentOrganizationForApplicableEcr(containerId, anyString());
  ...
  private void testFetchMsgTreatmentOrganizationForApplicableEcrAssertion(
      EcrMsgOrganizationDto resultDto) {
  ...
  void testUpdateMatchEcrRecordForProcessing() throws EcrCdaXmlException {
    ...
    when(entityManager.createNativeQuery(anyString()))
        .thenReturn(mockQuery); // Mocking any SQL that could be loaded.
    ...
    verify(mockQuery)
        .setParameter(
            "MSG_CONTAINER_UID", containerUid); // Verify that the parameter was set correctly.
