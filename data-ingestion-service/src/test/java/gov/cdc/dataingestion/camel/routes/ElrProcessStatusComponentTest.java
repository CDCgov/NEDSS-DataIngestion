...
class ElrProcessStatusComponentTest {
  ...
  @InjectMocks private ElrProcessStatusComponent elrProcessStatusComponent;
  ...
  void testProcessForNbsFailure() {
    ...
    edxActivityLogStatus.setRecordStatusTime(
        TimeStampHelper.convertTimestampToString(TimeStampHelper.getCurrentTimeStamp("UTC")));
  ...
  void testProcessForNbsFailureWithLogCommentWithMorethan200() {
    ...
    String logComment =
        "Test Log Comment123 Test Log Comment123 Test Log Comment123 Test Log Comment234 Test Log Comment345 Test Log Comment456 Test Log Comment567 Test Log Comment678 Test Log Comment678 Test Log Comment78901";
