...
class NbsRepositoryServiceProviderTest {
  @Mock private NbsInterfaceRepository nbsInterfaceRepo;

  @InjectMocks private NbsRepositoryServiceProvider target;
  ...
  void saveToNbsTestWithFractionOfSecondAndPlusSpecificTimeZone() throws XmlConversionException {
    ...
    oru.getPatientResult()
        ...
        .getSpecimenCollectionDateTime()
        .getRangeStartDateTime()
        .setTime("19800107000000.6081+0606");
  ...
  @SuppressWarnings({"java:S5976"})
  @Test
  void saveToNbsTestWithFractionOfSecondThreeAndPlusSpecificTimeZone()
    ...
    oru.getPatientResult()
        ...
        .getSpecimenCollectionDateTime()
        .getRangeStartDateTime()
        .setTime("19800107000000.608+0606");
  ...
  @SuppressWarnings({"java:S5976"})
  @Test
  void saveToNbsTestWithFractionOfSecondThreeAndMinusSpecificTimeZone()
      throws XmlConversionException {
    String id = "whatever";
    String xmlMsg = testXmlData;
    HL7ParsedMessage parsedMessage = new HL7ParsedMessage();
  ...
  @SuppressWarnings({"java:S5976"})
  @Test
  void saveToNbsTestWithSpecific_with_wrong_TimeZone1() throws XmlConversionException {
    String id = "whatever";
    String xmlMsg = testXmlData;
    HL7ParsedMessage parsedMessage = new HL7ParsedMessage();
    OruR1 oru = new OruR1();
  ...
  @SuppressWarnings({"java:S5976"})
  @Test
  void saveToNbsTestWithSpecific_with_wrong_TimeZone2() throws XmlConversionException {
    String id = "whatever";
    String xmlMsg = testXmlData;
    HL7ParsedMessage parsedMessage = new HL7ParsedMessage();
    OruR1 oru = new OruR1();
  ...
  void testGetSpecimenCollectionDateStr_ValidDocument() throws Exception {
    ...
    String xmlMsg =
        "<Container><HL7LabReport><HL7PATIENT_RESULT><ORDER_OBSERVATION>"
  ...
  void testGetNodeValue_ValidNode() throws Exception {
    ...
    String result =
        target.getNodeValue(doc, "/Container/HL7LabReport/HL7MSH/SendingFacility/HL7UniversalID");
