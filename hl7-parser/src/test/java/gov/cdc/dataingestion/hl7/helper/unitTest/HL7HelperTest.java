...
class HL7HelperTest {
  ...
  private void hl7StringParserWith251_ReturnValidMessage_RandomV2Helper1(OruR1 oru) {
    ...
    Assertions.assertEquals(
        "20230615", oru.getMessageHeader().getAlternateCharacterSetHandlingScheme());
    // endregion

    Assertions.assertEquals(
        "20230615", oru.getSoftwareSegment().get(0).getSoftwareCertifiedVersionOrReleaseNumber());
    ...
    Assertions.assertEquals(
        "20230615", oru.getSoftwareSegment().get(0).getSoftwareProductInformation());

    Assertions.assertEquals(
        "1", oru.getPatientResult().get(0).getPatient().getNoteAndComment().get(0).getSetIdNte());
    Assertions.assertEquals(
        "20230615",
        oru.getPatientResult().get(0).getPatient().getNoteAndComment().get(0).getSourceOfComment());
    ...
    Assertions.assertEquals(
        "3", oru.getPatientResult().get(0).getPatient().getNoteAndComment().get(0).getSetIdNte());
    Assertions.assertEquals(
        "AA",
        oru.getPatientResult().get(0).getPatient().getNoteAndComment().get(0).getSourceOfComment());
  }
  ...
  private void hl7StringParserWith251_ReturnValidMessage_RandomV2Helper2(OruR1 oru) {
    ...
    Assertions.assertEquals(
        "X", nextKin.getNkName().get(0).getSecondAndFurtherGivenNameOrInitial());
  ...
  private void hl7StringParserWith251_ReturnValidMessage_RandomV2Helper2_1(NextOfKin nextKin) {
    ...
    Assertions.assertNull(
        nextKin.getNkName().get(0).getNameContext().getNameOfAlternateCodingSystem());
  ...
  private void hl7StringParserWith251_ReturnValidMessage_RandomV2Helper3(OruR1 oru) {
    ...
    var patientAdditionalDemo =
        oru.getPatientResult().get(0).getPatient().getPatientAdditionalDemographic();
    ...
    Assertions.assertEquals(
        "20230615", patientAdditionalDemo.getProtectionIndicatorEffectiveDate());
    Assertions.assertEquals("20230615", patientAdditionalDemo.getImmunizationRegistryStatus());
    Assertions.assertEquals(
        "20230615", patientAdditionalDemo.getImmunizationRegistryStatusEffectiveDate());
  ...
  private void hl7StringParserWith251_ReturnValidMessage_RandomV2Helper4(OruR1 oru) {
    ...
    Assertions.assertEquals(
        "Varies[20230615]", observationResult.getReservedForHarmonizationWithV261());
    Assertions.assertEquals(
        "Varies[20230615]", observationResult.getReservedForHarmonizationWithV262());
    Assertions.assertEquals(
        "Varies[20230615]", observationResult.getReservedForHarmonizationWithV263());
    // endregion
  }
  ...
  private void hl7StringParserWith251_ReturnValidMessage_RandomV2Helper6(OruR1 oru) {
    ...
    Assertions.assertEquals(
        "20230615", timeQtyRelation.get(0).getCyclicGroupMaximumNumberOfRepeats());
    Assertions.assertEquals(
        "20230615", timeQtyRelation.get(0).getSpecialServiceRequestRelationship());
    // endregion
  }
  ...
  private void hl7StringParserWith251_ReturnValidMessage_RandomV2Helper7(OruR1 oru) {
    ...
    hl7StringParserWith251_ReturnValidMessage_RandomV2Helper7_1(
        financeCx, financeCp, financeCne, finance);
    hl7StringParserWith251_ReturnValidMessage_RandomV2Helper7_2(
        financeXcn, financePl, financeCwe, financeCx);
    // endregion
  }

  private void hl7StringParserWith251_ReturnValidMessage_RandomV2Helper7_1(
      Cx financeCx, Cp financeCp, Cne financeCne, FinancialTransaction finance) {
  ...
  private void hl7StringParserWith251_ReturnValidMessage_RandomV2Helper7_2(
      Xcn financeXcn, Pl financePl, Cwe financeCwe, Cx financeCx) {
  ...
  void hl7Validation_Invalid_MissingMSH() {
    ...
    String expectedMessage =
        "Invalid Message Determine encoding for message. The following is the first 50 chars of the message for reference, although this may not be where the issue is: PID|||7005728^^^TML^MR||TEST^RACHEL^DIAMOND||19310";
  ...
  void hl7Validation_Invalid_ExceedingRequiredLength() {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.validation.ValidationException: Validation failed: Primitive value '0123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789' requires to be shorter than 200 characters at EVN-1(0)";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_Invalid_OBX_ExceededLength() {
    ...
    String expectedMessage =
        "Invalid Message 'EXCEEDED_LENGTH' in record 1 is invalid for version 2.5.1 at OBX-2(0)";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_Invalid_DateTime() {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.validation.ValidationException: Validation failed: Primitive value '2009AAA05011106' requires to be empty or a HL7 datetime string at OBR-14(0)";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_Invalid_Number() {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.validation.ValidationException: Validation failed: Primitive value 'TEST NUMBER' requires to be empty or a number with optional decimal digits at OBX-9(0)";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_Invalid_NoPatientName() {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing /PATIENT_RESULT(0)/PATIENT(0)/PID/PatientName";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_Invalid_NoOrderObservationGroup() {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: /PATIENT_RESULT(0)/ORDER_OBSERVATION Group is Empty";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_Invalid_NoObrIdentifierCode() {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing /PATIENT_RESULT(0)/ORDER_OBSERVATION(0)/OBR/UniversalServiceID";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void processingSFTWithSPMMessage_Test() throws DiHL7Exception {
    String message =
        "MSH|^~\\&|LABCORP-CORP^OID^ISO|LABCORP^34D0655059^CLIA|SCDOH^OID^ISO|SC^OID^ISO|201204200100||ORU^R01^ORU_R01|20120605034370001A|D|2.3.1|||||||||PHLabReport-NoAck^ELR_Receiver^2.16.840.1.113883.9.11^ISO\n"
    ...
    Assertions.assertEquals(
        "R01", data.getParsedMessage().getMessageHeader().getMessageType().getTriggerEvent());
  }

  @Test
  void processingNonSFTWithSPMMessage_Test() throws DiHL7Exception {
    String message =
        "FHS|^~\\&|ELR|M.E. HETL|MEDOH|ME|20150224||FHSeg|Generated by ELR Route|FHSAppGen20150224|Application Generate\n"
  ...
  void hl7Validation_MSH_emptyDate7_Test() {
    String message =
        "MSH|^~\\&|LABCORP-CORP EMPTY DATE TEST^OID^ISO|LABCORP^34D0655059^CLIA|SCDOH^OID^ISO|SC^OID^ISO|||ORU^R01^ORU_R01|20120605034370001A|D|2.3.1|||||||||PHLabReport-NoAck^ELR_Receiver^2.16.840.1.113883.9.11^ISO\n"
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing /MSH/DateTimeOfMessage/Time/Year";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_MSH_msgControlId_10_Test() {
    String message =
        "MSH|^~\\&|LABCORP-CORP-CONTROL-ID^OID^ISO|LABCORP^34D0655059^CLIA|SCDOH^OID^ISO|SC^OID^ISO|20210128162413-0500||ORU^R01^ORU_R01||D|2.3.1|||||||||PHLabReport-NoAck^ELR_Receiver^2.16.840.1.113883.9.11^ISO\n"
            + "SFT|Mirth Corp.|2.0|Mirth Connect|789654||20110101\n"
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing /MSH/MessageControlID";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_MSH_processingId_11() {
    String message =
        "MSH|^~\\&|LABCORP-CORP^OID^ISO|LABCORP^34D0655059^CLIA|SCDOH^OID^ISO|SC^OID^ISO|20210128162413-0500||ORU^R01^ORU_R01|20120605034370001A||2.3.1|||||||||PHLabReport-NoAck^ELR_Receiver^2.16.840.1.113883.9.11^ISO\n"
            + "SFT|Mirth Corp.|2.0|Mirth Connect|789654||20110101\n"
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing /MSH/ProcessingID";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_SFT_no_vendorOrg_1_Test() throws DiHL7Exception {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing SFT/SoftwareVendorOrganization";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_SFT_no_versionNo_2() throws DiHL7Exception {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing SFT/SoftwareCertifiedVersionOrReleaseNumber";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7validation_SFT_no_prdName_3() throws DiHL7Exception {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing SFT/SoftwareProductName";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_SFT_no_binaryId_3_Test() throws DiHL7Exception {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing SFT/SoftwareBinaryID";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_NK1_no_setId() {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing /PATIENT_RESULT(0)/PATIENT(0)/NK1/SetID";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_OBX_no_obsId_3() {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing /PATIENT_RESULT(0)/ORDER_OBSERVATION(0)/OBSERVATION(0)/OBX/ObservationIdentifier";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_OBX_no_obsResultStatus_11() {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing /PATIENT_RESULT(0)/ORDER_OBSERVATION(0)/OBSERVATION(0)/OBX/ObservationResultStatus";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_SPM_no_specimenType_4() {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing /PATIENT_RESULT(0)/ORDER_OBSERVATION(0)/SPECIMEN(0)/SPM/SpecimenType";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_ORC_no_orderControl() {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing /PATIENT_RESULT(0)/ORDER_OBSERVATION(0)/ORC/OrderControl";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_CTD_no_contactRole_1() {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing /PATIENT_RESULT(0)/ORDER_OBSERVATION(0)/CTD/ContactRole";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_CTI_no_studyId_1() {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing /PATIENT_RESULT(0)/ORDER_OBSERVATION(0)/CTI/SponsorStudyID";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_FT1_no_trnDate_4() {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing /PATIENT_RESULT(0)/ORDER_OBSERVATION(0)/FT1/TransactionDate";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_FT1_no_trnType_6() {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing /PATIENT_RESULT(0)/ORDER_OBSERVATION(0)/FT1/TransactionType";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void hl7Validation_FT1_no_trnCode_7() {
    ...
    String expectedMessage =
        "Invalid Message ca.uhn.hl7v2.HL7Exception: Required field missing /PATIENT_RESULT(0)/ORDER_OBSERVATION(0)/FT1/TransactionCode";
    Assertions.assertEquals(expectedMessage, exception.getMessage());
  }
  ...
  void MessageValidation_Exception_NotSupportedVersion() {
    String data =
        "MSH|^~\\&|ULTRA|TML|OLIS|OLIS|200905011130||ORU^R01|20169838-v25|T|2.3\r"
            + "PID|||7005728^^^TML^MR||TEST^RACHEL^DIAMOND||19310313|F|||200 ANYWHERE ST^^TORONTO^ON^M6G 2T9||(416)888-8888||||||1014071185^KR\r"
            + "PV1|1||OLIS||||OLIST^BLAKE^DONALD^THOR^^^^^921379^^^^OLIST\r"
            + "ORC|RE||T09-100442-RET-0^^OLIS_Site_ID^ISO|||||||||OLIST^BLAKE^DONALD^THOR^^^^L^921379\r"
            + "OBR|0||T09-100442-RET-0^^OLIS_Site_ID^ISO|RET^RETICULOCYTE COUNT^HL79901 literal|||200905011106|||||||200905011106||OLIST^BLAKE^DONALD^THOR^^^^L^921379||7870279|7870279|T09-100442|MOHLTC|200905011130||B7|F||1^^^200905011106^^R\r"
