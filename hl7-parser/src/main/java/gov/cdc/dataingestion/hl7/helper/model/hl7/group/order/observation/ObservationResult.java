...
public class ObservationResult {
  ...
  public ObservationResult(ca.uhn.hl7v2.model.v251.segment.OBX obx) {
    ...
    this.reservedForHarmonizationWithV262 =
        obx.getReservedForHarmonizationWithV26Number2().toString();
    this.reservedForHarmonizationWithV263 =
        obx.getReservedForHarmonizationWithV26Number3().toString();
    ...
    this.performingOrganizationMedicalDirector =
        new Xcn(obx.getPerformingOrganizationMedicalDirector());
  }
}
