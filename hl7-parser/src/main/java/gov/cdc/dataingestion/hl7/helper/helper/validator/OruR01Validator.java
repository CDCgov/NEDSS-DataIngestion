...
public class OruR01Validator {
    ...
    if (!segment.isEmpty()) {
      ...
      if (StringUtils.isEmpty(versionNo)) {
        throw new HL7Exception(
            REQ_FLD_MISSING + locationName + "/SoftwareCertifiedVersionOrReleaseNumber");
      }
  ...
  private static void patientValidator(Group group, String groupNameWithLocation)
      throws HL7Exception {
    ...
    for (int i = 0; i < patientCounter; i++) {
      ...
      if (StringUtils.isEmpty(patientName)) {
        throw new HL7Exception(
            REQ_FLD_MISSING + groupNameWithLocation + PATIENT + "(" + i + ")/PID/PatientName");
      }
      // NK1 - optional
      ...
      if (!nk1.isEmpty()) {
        ...
        if (StringUtils.isEmpty(nk1Value)) {
          throw new HL7Exception(
              REQ_FLD_MISSING + groupNameWithLocation + PATIENT + "(" + i + ")/NK1/SetID");
        }
      }
    }
  }

  private static void orderObservationValidator(Group group, String parentGroup)
      throws HL7Exception {
  ...
  private static void obrValidator(Group orderOBSGroup, int orderObsNo, String parentGroup)
      throws HL7Exception {
  ...
  /** Optional segment */
  private static void orcValidator(Group orderObsGroup, int orderObsNo, String parentGroup)
      throws HL7Exception {
  ...
  /** Optional segment */
  private static void ctdValidator(Group orderObsGroup, int orderObsNo, String parentGroup)
      throws HL7Exception {
  ...
  /** Optional segment */
  private static void ctiValidator(Group orderObsGroup, int orderObsNo, String parentGroup)
      throws HL7Exception {
  ...
  /** Optional segment */
  private static void ft1Validator(Group orderObsGroup, int orderObsNo, String parentGroup)
      throws HL7Exception {
  ...
  private static void obxValidator(Group orderObsGroup, int orderObsNo, String parentGroup)
      throws HL7Exception {
  ...
  private static void spmValidator(Group orderObsGroup, int orderObsNo, String parentGroup)
      throws HL7Exception {
