...
public class NextOfKin {
  ...
  public NextOfKin(ca.uhn.hl7v2.model.v251.segment.NK1 nk1) {
    ...
    this.nextOfKinAssociatedPartiesJobTitle =
        nk1.getNextOfKinAssociatedPartiesJobTitle().getValue();
    this.nextOfKinAssociatedPartiesJobCode =
        new Jcc(nk1.getNextOfKinAssociatedPartiesJobCodeClass());
    this.nextOfKinAssociatedPartiesEmployee =
        new Cx(nk1.getNextOfKinAssociatedPartiesEmployeeNumber());
    ...
    this.nextOfKinAssociatedPartyIdentifier =
        getCxList(nk1.getNextOfKinAssociatedPartySIdentifiers());
