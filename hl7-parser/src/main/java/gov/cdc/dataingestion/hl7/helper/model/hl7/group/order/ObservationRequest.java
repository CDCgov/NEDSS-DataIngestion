...
public class ObservationRequest {
  ...
  public ObservationRequest(ca.uhn.hl7v2.model.v251.segment.OBR obr) {
    ...
    this.transportLogisticsOfCollectedSample =
        getCeList(obr.getTransportLogisticsOfCollectedSample());
    ...
    this.placerSupplementalServiceInformation =
        getCeList(obr.getPlacerSupplementalServiceInformation());
    this.fillerSupplementalServiceInformation =
        getCeList(obr.getFillerSupplementalServiceInformation());
    this.medicallyNecessaryDuplicateProcedureReason =
        new Cwe(obr.getMedicallyNecessaryDuplicateProcedureReason());
