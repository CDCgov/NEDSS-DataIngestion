...
import static gov.cdc.dataingestion.hl7.helper.helper.ModelListHelper.getIdStringList;
...
public class MessageHeader {
  ...
  public MessageHeader(MSH msh) {
    ...
    this.alternateCharacterSetHandlingScheme =
        msh.getAlternateCharacterSetHandlingScheme().getValue();
