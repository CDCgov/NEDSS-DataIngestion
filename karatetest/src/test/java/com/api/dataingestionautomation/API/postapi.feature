@postMessagesFeature
@parallel=false
Feature: Read various HL7 messages from JSON file and Post them using a REST API into DI service and NBS system.This is with validationActive flag as true.
