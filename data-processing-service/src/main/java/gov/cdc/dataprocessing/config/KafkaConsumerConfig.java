...
public class KafkaConsumerConfig {
  ...
  private Map<String, Object> baseConsumerConfigs(String groupId) {
    ...
    // config.put(ConsumerConfig.MAX_POLL_INTERVAL_MS_CONFIG, 300000); // Allow 5 minutes for
    // processing
  ...
  private ConcurrentKafkaListenerContainerFactory<String, String> createContainerFactoryNonBatch(
      String groupId) {
    ConcurrentKafkaListenerContainerFactory<String, String> factory =
        new ConcurrentKafkaListenerContainerFactory<>();
    factory.setConsumerFactory(createConsumerFactory(groupId));
  ...
  public ConcurrentKafkaListenerContainerFactory<String, String>
      kafkaListenerContainerFactoryStep1() {
    return createContainerFactory(groupId);
  }

  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, String>
      kafkaListenerContainerFactoryStep2() {
    return createContainerFactory(groupIdPhc);
  }

  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, String>
      kafkaListenerContainerFactoryStep3() {
    return createContainerFactory(groupIdLab);
  }

  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, String>
      kafkaListenerContainerFactoryStep4() {
    return createContainerFactory(groupIdEdx);
  }

  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, String>
      kafkaListenerContainerFactoryDltStep1() {
    return createContainerFactoryNonBatch("dlt-step-1");
  }

  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, String>
      kafkaListenerContainerFactoryDltStep2() {
