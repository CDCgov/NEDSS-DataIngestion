...
public class Observation_SummaryRepositoryImpl implements Observation_SummaryRepository // NOSONAR
{
  ...
  public String findAllActiveLabReportUidListForManage_SQL =
      "SELECT "
          + // NOSONAR
          ...
          + "WHERE ar.target_class_cd = '"
          + NEDSSConstant.PUBLIC_HEALTH_CASE_CLASS_CODE
          + "' "
          + "AND ar.source_class_cd = '"
          + NEDSSConstant.OBSERVATION_CLASS_CODE
          + "' "
          + "AND ar.type_cd = '"
          + NEDSSConstant.LAB_REPORT
          + "' "
          + "AND ar.record_status_cd = '"
  ...
  //    @Transactional
  @Override
  public Collection<Observation_Summary> findAllActiveLabReportUidListForManage(
  ...
  //    @Transactional
  @Override
  public Optional<Collection<Observation_Lab_Summary_ForWorkUp_New>> findLabSummaryForWorkupNew(
      Long personParentUid, String whereClause) {
    var sql = SELECT_LABSUMMARY_FORWORKUPNEW + whereClause;
    var res =
        entityManager
            .createQuery(sql, Observation_Lab_Summary_ForWorkUp_New.class)
