...
public class EntityIdJdbcRepository {
  ...
  public void batchCreateEntityIds(List<EntityId> entityIds) {
            ...
            .map(
                e ->
                    new MapSqlParameterSource()
                        ...
                        .addValue(
                            "assigning_authority_desc_txt", e.getAssigningAuthorityDescription())
    ...
    jdbcTemplateOdse.batchUpdate(
        INSERT_SQL_ENTITY_ID, parameters.toArray(new MapSqlParameterSource[0]));
  }
  ...
  public List<EntityId> findEntityIds(Long entityUid) {
    ...
    return jdbcTemplateOdse.query(
        SELECT_ENTITY_ID_BY_ENTITY_ID, params, new BeanPropertyRowMapper<>(EntityId.class));
  }
  ...
  public List<EntityId> findEntityIdsActive(Long entityUid) {
    ...
    return jdbcTemplateOdse.query(
        SELECT_ENTITY_ID_BY_ENTITY_ID_ACTIVE, params, new BeanPropertyRowMapper<>(EntityId.class));
  }
}
