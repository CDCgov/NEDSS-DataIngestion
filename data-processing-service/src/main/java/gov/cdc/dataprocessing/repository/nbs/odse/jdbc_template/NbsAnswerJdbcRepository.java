...
public class NbsAnswerJdbcRepository {
  ...
  public NbsAnswerJdbcRepository(
  ...
  public void deleteByNbsAnswerUid(Long nbsAnswerUid) {
    MapSqlParameterSource params =
        new MapSqlParameterSource().addValue(NBS_ANSWER_UID_JAVA, nbsAnswerUid);
    jdbcTemplateOdse.update(DELETE_NBS_ANSWER_BY_UID, params);
  }

  public List<NbsAnswer> findByActUid(Long uid) {
    MapSqlParameterSource params = new MapSqlParameterSource().addValue("uid", uid);
    return jdbcTemplateOdse.query(
        SELECT_NBS_ANSWER_BY_ACT_UID, params, new BeanPropertyRowMapper<>(NbsAnswer.class));
  }
}
