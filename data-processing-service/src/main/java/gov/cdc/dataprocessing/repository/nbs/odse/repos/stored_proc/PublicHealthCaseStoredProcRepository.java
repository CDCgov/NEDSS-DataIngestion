...
public class PublicHealthCaseStoredProcRepository {
  ...
  @Transactional
  public Collection<PublicHealthCaseDto> associatedPublicHealthCaseForMprForCondCd(
      Long mprUid, String conditionCode) throws DataProcessingException {
    Collection<PublicHealthCaseDto> models = new ArrayList<>();
    try {

      StoredProcedureQuery storedProcedure =
          entityManager.createStoredProcedureQuery("ASSO_PHC_FOR_MPR_COND_SP");

      // Register the parameters
      storedProcedure.registerStoredProcedureParameter(
          "conditionCd", String.class, ParameterMode.IN);
  ...
  @Transactional
  public Map<String, EDXEventProcessDto> getEDXEventProcessMap(Long nbsDocumentUid)
      throws DataProcessingException {
    Map<String, EDXEventProcessDto> eventProcessMap = new HashMap<>();
    try {

      StoredProcedureQuery storedProcedure =
          entityManager.createStoredProcedureQuery("GETEDXEVENTPROCESSBYDOCID_SP");

      // Register the parameters
      storedProcedure.registerStoredProcedureParameter(
          "nbsDocumentUid", Long.class, ParameterMode.IN);
