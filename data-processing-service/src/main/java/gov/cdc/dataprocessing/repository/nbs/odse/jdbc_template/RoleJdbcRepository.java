...
public class RoleJdbcRepository {
  ...
  public List<Role> findRolesByParentUid(Long subjectEntityUid) {
    MapSqlParameterSource params =
        new MapSqlParameterSource(SUBJECT_ENTITY_UID_DB, subjectEntityUid);

    return jdbcTemplateOdse.query(
        SELECT_ROLE_BY_SUBJECT_ENTITY_UID, params, new BeanPropertyRowMapper<>(Role.class));
  }
  ...
  public List<Role> findActiveBySubjectEntityUid(Long subjectEntityUid) {
    MapSqlParameterSource params =
        new MapSqlParameterSource(SUBJECT_ENTITY_UID_JAVA, subjectEntityUid);
    return jdbcTemplateOdse.query(
        SELECT_ACTIVE_ROLES_BY_ENTITY_UID, params, new BeanPropertyRowMapper<>(Role.class));
  }
