...
public class ParticipationStoredProcRepository {
  private static final Logger logger =
      LoggerFactory.getLogger(ParticipationStoredProcRepository.class); // NOSONAR
  ...
  public void insertParticipation(ParticipationDto participationDto) {
    try {
      ...
      StoredProcedureQuery storedProcedure =
          entityManager.createStoredProcedureQuery("addParticipation_sp");

      // Register the parameters
      storedProcedure.registerStoredProcedureParameter(
          SUBJECT_ENTITY_UID_DB, Long.class, ParameterMode.IN);
      ...
      storedProcedure.registerStoredProcedureParameter(
          ADD_REASON_CD_DB, String.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          "addtime", Timestamp.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          ADD_USER_ID_DB, Long.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          "awareness_cd", String.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          "awareness_desc_txt", String.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter("cd", String.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          "duration_amt", String.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          "duration_unit_cd", String.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          "from_time", Timestamp.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          LAST_CHG_REASON_CD_DB, String.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          LAST_CHG_TIME_DB, Timestamp.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          LAST_CHG_USER_ID_DB, Long.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          RECORD_STATUS_CD_DB, String.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          RECORD_STATUS_TIME_DB, Timestamp.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter("role_seq", Integer.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          STATUS_CD_DB, String.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          STATUS_TIME_DB, Timestamp.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          "to_time", Timestamp.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          "type_desc_txt", String.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          USER_AFFILIATION_TXT_DB, String.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          "subject_class_cd", String.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          "act_class_cd", String.class, ParameterMode.IN);
      ...
      storedProcedure.setParameter(
          USER_AFFILIATION_TXT_DB, participationDto.getUserAffiliationTxt());
