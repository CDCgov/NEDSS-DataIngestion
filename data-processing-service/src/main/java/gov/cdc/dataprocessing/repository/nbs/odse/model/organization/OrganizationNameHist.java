...
public class OrganizationNameHist {
  ...
  //    @JoinColumns({
  //            @JoinColumn(name = "organization_uid", referencedColumnName = "organization_uid",
  // nullable = false),
  //            @JoinColumn(name = "organization_name_seq", referencedColumnName =
  // "organization_name_seq", nullable = false)
  //    })
