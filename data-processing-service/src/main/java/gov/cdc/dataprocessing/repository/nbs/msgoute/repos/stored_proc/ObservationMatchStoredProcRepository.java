...
public class ObservationMatchStoredProcRepository {
  ...
  @Transactional
  public Long getMatchedObservation(EdxLabInformationDto edxLabInformationDto)
    ...
    Timestamp specimenCollectionDate =
        observationContainer.getTheObservationDto().getEffectiveFromTime();
    String orderedTestCode = observationContainer.getTheObservationDto().getCd();
    if (checkInvalidFillerSpecimenAndOrderedTest(
        fillerNumber, specimenCollectionDate, orderedTestCode, clia)) {
    ...
    try {
      ...
      StoredProcedureQuery storedProcedure =
          entityManager.createStoredProcedureQuery("GetObservationMatch_SP");
      ...
      storedProcedure.registerStoredProcedureParameter(
          "orderedTestCd", String.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          "specimenCollectionDate", Timestamp.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          "numberOfGoBackYears", Integer.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          "Observation_uid", Long.class, ParameterMode.OUT);
  ...
  protected boolean checkInvalidFillerSpecimenAndOrderedTest(
      String fillerNumber, Timestamp specimenCollectionDate, String orderedTestCode, String clia) {
    return fillerNumber == null
