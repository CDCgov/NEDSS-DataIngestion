...
public interface NbsActEntityRepository extends JpaRepository<NbsActEntity, Long> {
  /**
   * private final String SELECT_ACT_ENTITY_COLLECTION="SELECT nbs_act_entity_uid
   * \"nbsActEntityUid\", add_time \"addTime\", add_user_id \"addUserId\", last_chg_time
   * \"lastChgTime\", last_chg_user_id \"lastChgUserId\", act_uid \"actUid\", entity_uid
   * \"entityUid\", type_cd \"typeCd\", entity_version_ctrl_nbr \"entityVersionCtrlNbr\" FROM "+
