...
public class ParticipationJdbcRepository {
  ...
  public ParticipationJdbcRepository(
  ...
  public List<Participation> findByActUid(Long actUid) {
    ...
    return jdbcTemplateOdse.query(
        SELECT_PARTICIPATION_BY_ACT_UID, params, new BeanPropertyRowMapper<>(Participation.class));
  }

  public List<Participation> findBySubjectUid(Long subjectEntityUid) {
    MapSqlParameterSource params =
        new MapSqlParameterSource().addValue(SUBJECT_ENTITY_UID_JAVA, subjectEntityUid);
  ...
  public List<Participation> selectParticipationBySubjectEntityUid(Long subjectEntityUid) {
    ...
    return jdbcTemplateOdse.query(
        SELECT_PARTICIPATION_BY_SUBJECT_ENTITY_ID,
        params,
        new BeanPropertyRowMapper<>(Participation.class));
  }

  public List<Participation> selectParticipationBySubjectAndActUid(
      Long subjectEntityUid, Long actUid) {
    MapSqlParameterSource params =
        new MapSqlParameterSource()
            .addValue(SUBJECT_ENTITY_UID_JAVA, subjectEntityUid)
            .addValue(ACT_UID_JAVA, actUid);
    ...
    return jdbcTemplateOdse.query(
        SELECT_PARTICIPATION_BY_SUBJECT_ENTITY_ID_AND_ACT_UID,
        params,
        new BeanPropertyRowMapper<>(Participation.class));
  }
}
