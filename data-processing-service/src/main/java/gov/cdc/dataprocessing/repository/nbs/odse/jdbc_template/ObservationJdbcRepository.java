...
public class ObservationJdbcRepository {
  ...
  public ObservationJdbcRepository(
  ...
  public Observation findObservationByUid(Long observationUid) {
    MapSqlParameterSource params =
        new MapSqlParameterSource().addValue(OBSERVATION_UID_DB, observationUid);
    return jdbcTemplateOdse.queryForObject(
        SELECT_OBSERVATION_BY_UID, params, new BeanPropertyRowMapper<>(Observation.class));
  }

  public List<Observation_Question> retrieveObservationQuestion(Long targetActUid) {
    MapSqlParameterSource params =
        new MapSqlParameterSource().addValue("target_act_uid", targetActUid);
  ...
  public List<ObservationReason> findByObservationReasons(Long observationUid) {
    ...
    return jdbcTemplateOdse.query(
        SELECT_BY_OBS_REASONS, params, new BeanPropertyRowMapper<>(ObservationReason.class));
  }
  ...
  public List<ObservationInterp> findByObservationInterp(Long observationUid) {
    ...
    return jdbcTemplateOdse.query(
        SELECT_BY_OBS_INTERP_UID, params, new BeanPropertyRowMapper<>(ObservationInterp.class));
  }
  ...
  public List<ObsValueCoded> findByObservationCodedUid(Long observationUid) {
    ...
    return jdbcTemplateOdse.query(
        SELECT_BY_OBS_CODED_UID, params, new BeanPropertyRowMapper<>(ObsValueCoded.class));
  }
  ...
  public List<ObsValueTxt> findByObservationTxtUid(Long observationUid) {
    ...
    return jdbcTemplateOdse.query(
        SELECT_BY_OBS_TXT, params, new BeanPropertyRowMapper<>(ObsValueTxt.class));
  }
  ...
  public List<ObsValueDate> findByObservationDateUid(Long observationUid) {
    ...
    return jdbcTemplateOdse.query(
        SELECT_BY_OBS_DATE_UID, params, new BeanPropertyRowMapper<>(ObsValueDate.class));
  }
  ...
  public List<ObsValueNumeric> findByObservationNumericUid(Long observationUid) {
    ...
    return jdbcTemplateOdse.query(
        SELECT_BY_OBS_NUMERIC_UID, params, new BeanPropertyRowMapper<>(ObsValueNumeric.class));
  }
}
