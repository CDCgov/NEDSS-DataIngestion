...
public class PublicHealthCaseJdbcRepository {
  ...
  public PublicHealthCaseJdbcRepository(
  ...
  public PublicHealthCase findById(Long publicHealthCaseUid) {
    MapSqlParameterSource params =
        new MapSqlParameterSource().addValue(PUBLIC_HEALTH_CASE_UID_JAVA, publicHealthCaseUid);

    return jdbcTemplateOdse.queryForObject(
        SELECT_PHC_BY_UID, params, new BeanPropertyRowMapper<>(PublicHealthCase.class));
  }
