...
public class PersonJdbcRepository {
  ...
  public Long findMprUid(Long parentUid) {
    String sql =
        "SELECT person_parent_uid FROM Person WHERE person_uid = :person_uid AND record_status_cd='ACTIVE'";
  ...
  public List<Person> findPersonsByParentUid(Long parentUid) {
    ...
    return jdbcTemplateOdse.query(
        SELECT_PERSON_BY_PARENT_UID, params, new BeanPropertyRowMapper<>(Person.class));
  }
  ...
  public Person findByPersonUid(Long personUid) {
    ...
    return jdbcTemplateOdse.queryForObject(
        SELECT_PERSON_BY_PERSON_UID, params, new BeanPropertyRowMapper<>(Person.class));
  }

  public void createPersonName(PersonName personName) {
    jdbcTemplateOdse.update(
        INSERT_SQL_PERSON_NAME,
        new MapSqlParameterSource()
  ...
  public List<PersonName> findPersonNameByPersonUid(Long personUid) {
    ...
    return jdbcTemplateOdse.query(
        SELECT_PERSON_NAME_BY_PERSON_UID, params, new BeanPropertyRowMapper<>(PersonName.class));
  }

  public void createPersonRace(PersonRace personRace) {
    jdbcTemplateOdse.update(
        INSERT_SQL_PERSON_RACE,
        new MapSqlParameterSource()
  ...
  public List<PersonRace> findPersonRaceByPersonUid(Long personUid) {
    ...
    return jdbcTemplateOdse.query(
        SELECT_PERSON_RACE_BY_PERSON_UID, params, new BeanPropertyRowMapper<>(PersonRace.class));
  }

  public void createPersonEthnicGroup(PersonEthnicGroup personEthnicGroup) {
    jdbcTemplateOdse.update(
        INSERT_SQL_PERSON_ETHNIC,
        new MapSqlParameterSource()
  ...
  public List<PersonEthnicGroup> findPersonEthnicByPersonUid(Long personUid) {
    ...
    return jdbcTemplateOdse.query(
        SELECT_PERSON_ETHNIC_BY_PERSON_UID,
        params,
        new BeanPropertyRowMapper<>(PersonEthnicGroup.class));
  }
  ...
  public Person selectByPersonUid(Long personUid) {
    MapSqlParameterSource params = new MapSqlParameterSource().addValue(PERSON_UID_JAVA, personUid);

    return jdbcTemplateOdse.queryForObject(
        SELECT_BY_UID, params, new BeanPropertyRowMapper<>(Person.class));
  }
  ...
  public List<PersonName> findBySeqIdByParentUid(Long parentUid) {
    MapSqlParameterSource params = new MapSqlParameterSource().addValue("parentUid", parentUid);
  ...
  public List<PersonRace> findByPersonRaceUid(Long parentUid) {
    ...
    return jdbcTemplateOdse.query(
        FIND_PERSON_RACE_BY_UID, params, new BeanPropertyRowMapper<>(PersonRace.class));
  }
