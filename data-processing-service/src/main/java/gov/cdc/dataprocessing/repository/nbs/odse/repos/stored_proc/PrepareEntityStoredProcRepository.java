...
public class PrepareEntityStoredProcRepository {
  ...
  @Transactional
  public PrepareEntity getPrepareEntity(
    ...
    try {
      ...
      StoredProcedureQuery storedProcedure =
          entityManager.createStoredProcedureQuery("GetNextState_sp");

      // Register the parameters
      storedProcedure.registerStoredProcedureParameter(
          "businessTriggerCode", String.class, ParameterMode.IN);
      ...
      storedProcedure.registerStoredProcedureParameter(
          ADD_USER_ID_JAVA, String.class, ParameterMode.OUT);
      storedProcedure.registerStoredProcedureParameter(
          "addUserTime", Timestamp.class, ParameterMode.OUT);
      storedProcedure.registerStoredProcedureParameter(
          "recordStatusState", String.class, ParameterMode.OUT);
      storedProcedure.registerStoredProcedureParameter(
          "objectStatusState", String.class, ParameterMode.OUT);
      ...
      String recordStatusState =
          (String) storedProcedure.getOutputParameterValue("recordStatusState");
      String objectStatusState =
          (String) storedProcedure.getOutputParameterValue("objectStatusState");
