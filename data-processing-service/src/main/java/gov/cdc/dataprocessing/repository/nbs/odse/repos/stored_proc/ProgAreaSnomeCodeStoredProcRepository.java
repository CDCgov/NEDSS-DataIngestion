...
public class ProgAreaSnomeCodeStoredProcRepository {
  ...
  public Map<String, Object> getSnomed(String code, String type, String clia)
    ...
    try {
      ...
      StoredProcedureQuery storedProcedure =
          entityManager.createStoredProcedureQuery("msgProgAreaLoincSnomed_sp");
      ...
      storedProcedure.registerStoredProcedureParameter(
          "loinc_snomed", String.class, ParameterMode.OUT);
      storedProcedure.registerStoredProcedureParameter(
          COUNT_LOWERCASE, Integer.class, ParameterMode.OUT);
  ...
  @Transactional
  public Map<String, Object> getProgAreaCd(String code, String type, String clia)
      throws DataProcessingException {
    Map<String, Object> map = new HashMap<>();
    try {

      StoredProcedureQuery storedProcedure =
          entityManager.createStoredProcedureQuery("msgProgArea_sp");
      ...
      storedProcedure.registerStoredProcedureParameter("clia", String.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
          "prog_area", String.class, ParameterMode.OUT);
      storedProcedure.registerStoredProcedureParameter(
          COUNT_LOWERCASE, Integer.class, ParameterMode.OUT);
