...
public class EntityLocatorJdbcRepository {
  ...
  public EntityLocatorJdbcRepository(
  ...
  public void createPostalLocator(PostalLocator postalLocator) {
    jdbcTemplateOdse.update(
        ...
        new MapSqlParameterSource()
            ...
            .addValue(
                "census_minor_civil_division_cd", postalLocator.getCensusMinorCivilDivisionCd())
  ...
  public void createEntityLocatorParticipation(
      EntityLocatorParticipation entityLocatorParticipation) {
    jdbcTemplateOdse.update(
        INSERT_SQL_ENTITY_LOCATOR_PARTICIPATION,
        new MapSqlParameterSource()
  ...
  public List<EntityLocatorParticipation> findEntityLocatorParticipations(Long entityUid) {
    ...
    return jdbcTemplateOdse.query(
        SELECT_ENTITY_LOCATOR_PARTICIPATIONS_BY_ENTITY_UID,
        params,
  ...
  public List<PostalLocator> findByPostalLocatorUids(List<Long> uids) {
    ...
    return jdbcTemplateOdse.query(
        SELECT_POSTAL_LOCATOR_BY_UIDS, params, new BeanPropertyRowMapper<>(PostalLocator.class));
  }
  ...
  public List<TeleLocator> findByTeleLocatorUids(List<Long> uids) {
    MapSqlParameterSource params = new MapSqlParameterSource("uids", uids);
    return jdbcTemplateOdse.query(
        SELECT_TELE_LOCATOR_BY_UIDS, params, new BeanPropertyRowMapper<>(TeleLocator.class));
  }
}
