...
public class NbsInterfaceStoredProcRepository {
  ...
  //    @Transactional
  public void updateSpecimenCollDateSP(Long nbsInterfaceUid, Timestamp specimentCollectionDate)
      throws DataProcessingException {
    try {

      StoredProcedureQuery storedProcedure =
          entityManager.createStoredProcedureQuery("UpdateSpecimenCollDate_SP");

      // Register the parameters
      storedProcedure.registerStoredProcedureParameter(
          "NBSInterfaceUid", Integer.class, ParameterMode.IN);
      storedProcedure.registerStoredProcedureParameter(
