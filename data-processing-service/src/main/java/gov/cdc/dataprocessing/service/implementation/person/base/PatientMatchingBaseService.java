...
public class PatientMatchingBaseService extends MatchingBaseService {
  ...
  public Long setPatientRevision(
      PersonContainer personVO, String businessTriggerCd, String personType)
    ...
    if (personDT.getPersonParentUid() == null) {
      ...
      if (businessTriggerCd != null
          && (businessTriggerCd.equals("PAT_CR") || businessTriggerCd.equals("PAT_EDIT"))) {
        this.updateWithRevision(personVO, personType);
      }

      if (personVO.getThePersonDto().getLocalId() == null
          || personVO.getThePersonDto().getLocalId().trim().isEmpty()) {
    ...
    personUid =
        this.setPersonInternal(personVO, NBSBOLookup.PATIENT, businessTriggerCd, personType);

    return personUid;
  }

  @SuppressWarnings({"java:S3776", "java:S6541"})
  private Long setPersonInternal(
    ...
    if (personVO.isItNew() || personVO.isItDirty()) {
      ...
      if (personVO.getThePersonDto().isItNew()
          && !(businessObjLookupName.equalsIgnoreCase(
              NEDSSConstant.businessObjLookupNamePROVIDER))) {
      ...
      RootDtoInterface personDT =
          getPrepareAssocModelHelper()
              .prepareVO(
                  ...
                  "PERSON",
                  "BASE",
                  personVO.getThePersonDto().getVersionCtrlNbr());
  ...
  private boolean updateWithRevision(PersonContainer newRevision, String personType)
      throws DataProcessingException {
    Long mprUID = null;
    if (newRevision == null) {
      throw new DataProcessingException(
          "Please provide a not null person object, newRevision is Null");
    } else {
      // Get the mpr uid
    ...
    if (mprUID == null && newRevision.getThePersonDto() != null) {
      throw new DataProcessingException(
          "A person parent uid expected for this person uid: "
              + newRevision.getThePersonDto().getPersonUid());
    }
  ...
  private boolean storeMPR(PersonContainer mpr, String businessTriggerCd, String personType)
      throws DataProcessingException {
    return setMPR(mpr, businessTriggerCd, personType) != null;
  }

  @SuppressWarnings("java:S1199")
  private Long setMPR(PersonContainer personVO, String businessTriggerCd, String personType)
      throws DataProcessingException {
    Long personUID = null;
  ...
  protected boolean process(MPRUpdateContainer mprUpdateVO) {
    ...
    Collection<EntityLocatorParticipationDto> col =
        mpr.getTheEntityLocatorParticipationDtoCollection();
  ...
  private PersonContainer cloneVO(PersonContainer personVO) throws DataProcessingException {
    try {
  ...
  protected PersonId updateExistingPerson(
      PersonContainer personContainer, String businessTriggerCd, Long personParentUid)
      throws DataProcessingException {
    ...
    if (personContainer.getThePersonDto() != null) {
      ...
      if (personDto.getCd() != null && personDto.getCd().equals(NEDSSConstant.PAT)) {
        if (personContainer.getThePersonNameDtoCollection() != null
          ...
          Collection<PersonNameDto> personNameDtoColl =
            ...
            if (personNameDto.getNmUseCd() != null
              ...
              if (asofDate == null
                ...
                if (personNameDto.getLastNm() != null
                  ...
                  namedobcursexStr =
                      personNameDto.getLastNm()
                          + carrot
                          + personNameDto.getFirstNm()
                          + carrot
                          + personDto.getBirthTime()
                          + carrot
                          + personDto.getCurrSexCd();
                  asofDate = personNameDto.getAsOfDate();
                }
              } else if (asofDate.before(personNameDto.getAsOfDate())) {
                namedobcursexStr =
                    processingPersonName(personNameDto, personDto, asofDate, namedobcursexStr);
              }
            }
          }
        }
  ...
  protected String processingPersonName(
  ...
  protected void setPersonHashCdPatient(PersonContainer personContainer) {
    ...
    try {
      if (personContainer
          .getThePersonDto()
          .getRecordStatusCd()
          .equalsIgnoreCase(NEDSSConstant.RECORD_STATUS_ACTIVE)) {
      ...
      logger.error(
          "Exception in setPatientToEntityMatch -> unhandled exception: {}", e.getMessage());
    }
  }
  ...
  protected PersonId setAndCreateNewPerson(PersonContainer psn) throws DataProcessingException {
    ...
    if (elpDTCol != null) {
      colEntityLocatorParticipation =
          getEntityHelper().iterateELPDTForEntityLocatorParticipation(elpDTCol);
  ...
  private PersonId getPersonInternalAddressingRevisionAndMpr(Long personUID)
      throws DataProcessingException {
    PersonId personId;
  ...
  private void prepUpdatingExistingPerson(PersonContainer personContainer)
      throws DataProcessingException {
    PersonDto personDto = personContainer.getThePersonDto();
  ...
  protected void setPersonToMatchEntityPatient(PersonContainer personContainer)
      throws DataProcessingException {
  ...
  protected List<String> nameAddressStreetOneNOK(PersonContainer personContainer) {
    ...
    if (personContainer.getTheEntityLocatorParticipationDtoCollection() != null
      ...
      for (EntityLocatorParticipationDto entLocPartDT :
          personContainer.getTheEntityLocatorParticipationDtoCollection()) {
        if (entLocPartDT.getClassCd() != null
          ...
          if (postLocDT != null
              && (postLocDT.getStreetAddr1() != null && !postLocDT.getStreetAddr1().isEmpty())
            ...
            nameAddStr =
                carrot
                    + postLocDT.getStreetAddr1()
                    + carrot
                    + postLocDT.getCityDescTxt()
                    + carrot
                    + postLocDT.getStateCd()
                    + carrot
                    + postLocDT.getZipCd();
          }
        }
  ...
  protected List<String> telePhoneTxtNOK(PersonContainer personContainer) {
    ...
    if (personContainer.getTheEntityLocatorParticipationDtoCollection() != null
      ...
      for (EntityLocatorParticipationDto entLocPartDT :
          personContainer.getTheEntityLocatorParticipationDtoCollection()) {
        if (entLocPartDT.getClassCd() != null
            && entLocPartDT.getClassCd().equals(NEDSSConstant.TELE)
            && entLocPartDT.getRecordStatusCd() != null
            && entLocPartDT
                .getRecordStatusCd()
                .equalsIgnoreCase(NEDSSConstant.RECORD_STATUS_ACTIVE)) {
