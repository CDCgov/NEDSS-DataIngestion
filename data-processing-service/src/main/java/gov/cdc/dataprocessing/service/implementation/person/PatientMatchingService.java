...
@Service
public class PatientMatchingService extends PatientMatchingBaseService
    implements IPatientMatchingService {
  ...
  public EdxPatientMatchDto getMatchingPatient(PersonContainer personContainer)
  ...
  private EdxPatientMatchDto doModernizedMatching(PersonContainer personContainer)
      throws DataProcessingException {
    ...
    handleCreatePerson(
        personContainer, MatchType.EXACT.equals(response.matchType()), response.match());

    return new EdxPatientMatchDto();
  }

  private EdxPatientMatchDto doNbsClassicMatching(PersonContainer personContainer)
      throws DataProcessingException {
  ...
  EdxPatientMatchDto tryMatchByLocalId(PersonContainer personContainer)
      throws DataProcessingException {
    ...
    EdxPatientMatchDto edxPatientMatchDto =
        getEdxPatientMatchRepositoryUtil().getEdxPatientMatchOnMatchString(cd, localId);
    if (edxPatientMatchDto != null
  ...
  EdxPatientMatchDto tryMatchByIdentifier(PersonContainer personContainer)
      throws DataProcessingException {
    String cd = personContainer.getThePersonDto().getCd();
  ...
  EdxPatientMatchDto tryMatchByDemographics(PersonContainer personContainer)
      throws DataProcessingException {
  ...
  private void handleCreatePerson(
      PersonContainer personContainer, boolean matchFound, Long matchUid)
      throws DataProcessingException {
  ...
  private void createPatientRevision(PersonContainer personContainer)
      throws DataProcessingException {
