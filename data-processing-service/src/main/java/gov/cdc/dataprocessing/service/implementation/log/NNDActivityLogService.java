...
public class NNDActivityLogService implements INNDActivityLogService {
  ...
  public NNDActivityLogService(
      NNDActivityLogRepository nndActivityLogRepository, @Lazy UidPoolManager uidPoolManager) {
    this.nndActivityLogRepository = nndActivityLogRepository;
    this.uidPoolManager = uidPoolManager;
  }

  public void saveNddActivityLog(NNDActivityLogDto nndActivityLogDto)
