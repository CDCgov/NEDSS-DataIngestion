...
public class LookupService implements ILookupService {
  ...
  public LookupService(
      LookupMappingRepository lookupMappingRepository,
  ...
  public TreeMap<Object, Object> getToPrePopFormMapping(String formCd)
  ...
  private static void createPrePopFromMap(Collection<LookupMappingDto> coll)
      throws DataProcessingException {
    int count = 0;
    int loopcount = 0;
    int sizecount = 0;
        ...
        if (qMetadata.getFromFormCd() != null) {
          ...
          if (loopcount == 0) {
            ...
            String fromQuestionId =
                qMetadata.getFromQuestionIdentifier() == null
                    ? ""
  ...
  @SuppressWarnings({"java:S3776", "java:S6541"})
  private static void createPrePopToMap(Collection<LookupMappingDto> coll)
      throws DataProcessingException {
    int count = 0;
    int loopcount = 0;
    int sizecount = 0;
      ...
      for (LookupMappingDto lookupMappingDto : coll) {
        ...
        if (qMetadata.getToFormCd() != null) {
          ...
          if (loopcount == 0) {
            ...
            String toQuestionId =
                qMetadata.getToQuestionIdentifier() == null
                    ? ""
      ...
      for (MetaAndWaCommonAttribute metaAndWaCommonAttribute : coll) {
        ...
        if (qMetadata.getInvestigationFormCd() != null) {
          ...
          if (loopcount == 0) {
            ...
            String questionId =
                qMetadata.getQuestionIdentifier() == null ? "" : qMetadata.getQuestionIdentifier();
            ...
            if (currentFormCode.equals(previousFormCode)) {
              String questionId =
                  qMetadata.getQuestionIdentifier() == null
                      ? ""
                      : qMetadata.getQuestionIdentifier();
              if (!questionId.isEmpty()) {
                map[count].put(questionId, qMetadata);
              }
            } else {
