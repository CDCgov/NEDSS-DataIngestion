package gov.cdc.dataprocessing.service.implementation.uid_generator.localUid;
...
import gov.cdc.dataprocessing.service.model.localUid.LocalUidCacheModel;
...
//        var localUidModel = createNewLocalUid(localIdClass, gaApplied);
    ...
    private LocalUidModel createNewLocalUid(LocalIdClass localIdClass, boolean gaApplied) throws DataProcessingException {
        ...
        LocalUidGeneratorDto gaLocalId = gaApplied ? fetchLocalId(LocalIdClass.GA) : null;
