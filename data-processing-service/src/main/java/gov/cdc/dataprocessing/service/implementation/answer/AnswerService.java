...
public class AnswerService implements IAnswerService {
  ...
  public AnswerService(
      NbsActJdbcRepository nbsActJdbcRepository, NbsAnswerJdbcRepository answerJdbcRepository) {
  ...
  public PageContainer getNbsAnswerAndAssociation(Long uid) {
    ...
    nbsAnswerMap =
        (HashMap<Object, NbsAnswerDto>) answerDTReturnMap.get(NEDSSConstant.NON_REPEATING_QUESTION);
    nbsRepeatingAnswerMap =
        (HashMap<Object, Object>) answerDTReturnMap.get(NEDSSConstant.REPEATING_QUESTION);
  ...
  public Map<Object, Object> getPageAnswerDTMaps(Long actUid) {
    ...
    while (it.hasNext()) {
      ...
      nbsQuestionUid =
          processingPageAnswerMap(
              pageAnsDT, nbsRepeatingAnswerMap, nbsQuestionUid, coll, nbsAnswerMap);
  ...
  protected Long processingPageAnswerMap(
      NbsAnswerDto pageAnsDT,
      Map<Object, Object> nbsRepeatingAnswerMap,
      Long nbsQuestionUid,
      Collection<NbsAnswerDto> coll,
    ...
    if (pageAnsDT.getAnswerGroupSeqNbr() != null && pageAnsDT.getAnswerGroupSeqNbr() > -1) {
      if (nbsRepeatingAnswerMap.get(pageAnsDT.getNbsQuestionUid()) == null) {
        ...
        Collection<NbsAnswerDto> collection =
            (Collection<NbsAnswerDto>) nbsRepeatingAnswerMap.get(pageAnsDT.getNbsQuestionUid());
        collection.add(pageAnsDT);
        nbsRepeatingAnswerMap.put(pageAnsDT.getNbsQuestionUid(), collection);
      }
    } else if ((pageAnsDT.getNbsQuestionUid().compareTo(nbsQuestionUid) == 0)
        && pageAnsDT.getSeqNbr() != null
        && pageAnsDT.getSeqNbr() > 0) {
      coll.add(pageAnsDT);
  ...
  public void insertPageVO(PageContainer pageContainer, ObservationDto rootDTInterface) {
    if (pageContainer != null && pageContainer.getAnswerDTMap() != null) {
      ...
      if (pageContainer.getPageRepeatingAnswerDTMap() != null) {
        Collection<Object> interviewRepeatingAnswerDTColl =
            pageContainer.getPageRepeatingAnswerDTMap().values();
  ...
  public void storeActEntityDTCollectionWithPublicHealthCase(
      Collection<NbsActEntityDto> pamDTCollection, PublicHealthCaseDto rootDTInterface) {
  ...
  void storeActEntityDTCollection(
      Collection<NbsActEntityDto> pamDTCollection, ObservationDto rootDTInterface) {
    if (!pamDTCollection.isEmpty()) {
      for (NbsActEntityDto pamCaseEntityDT : pamDTCollection) {
        if (pamCaseEntityDT.isItDelete()) {
          nbsActJdbcRepository.deleteNbsEntityAct(pamCaseEntityDT.getNbsActEntityUid());
  ...
  protected void delete(ObservationDto rootDTInterface) {
    ...
    var actEntityResult =
        nbsActJdbcRepository.getNbsActEntitiesByActUid(rootDTInterface.getObservationUid());
  ...
  protected void insertPageEntityHistoryDTCollection(
      Collection<NbsActEntityDto> nbsCaseEntityDTColl, ObservationDto oldrootDTInterface) {
