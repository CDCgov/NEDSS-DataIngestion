...
public class ActRelationshipService implements IActRelationshipService {
  ...
  public Collection<ActRelationshipDto> loadActRelationshipBySrcIdAndTypeCode(
      Long uid, String type) {
  ...
  public void saveActRelationship(ActRelationshipDto actRelationshipDto)
    ...
    if (actRelationshipDto.isItNew() || actRelationshipDto.isItDirty()) {
      ...
      dataModifierReposJdbc.deleteActRelationshipByPk(
          actRelationshipDto.getTargetActUid(),
          actRelationshipDto.getSourceActUid(),
          actRelationshipDto.getTypeCd());
    }
  }
}
