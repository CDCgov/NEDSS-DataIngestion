...
public class ObservationMatchingService implements IObservationMatchingService {
  ...
  public ObservationMatchingService(
      ObservationMatchStoredProcRepository observationMatchStoredProcRepository,
  ...
  public ObservationDto checkingMatchingObservation(EdxLabInformationDto edxLabInformationDto)
    ...
    if (msgStatus == null) {
      edxLabInformationDto.setObservationMatch(false);
      logger.error(
          "Error!! null status cd: msgInObs status= {} odsObs status= {}", msgStatus, odsStatus);
      return null;
    }
    ...
    if (isValidStatusMatch(odsStatus, msgStatus)) {
      ...
      if (odsTime != null && odsTime.after(msgTime)) {
        ...
        throw new DataProcessingException(
            "An Observation Lab test match was found for Accession # "
                + fillerNumber
                + ", but the activity time is out of sequence.");
      }
    ...
    return handleInvalidCombination(
        odsStatus, msgStatus, edxLabInformationDto, matchedObs, fillerNumber);
  }

  protected boolean isValidStatusMatch(String ods, String msg) {
    return (ods.equals(EdxELRConstant.ELR_OBS_STATUS_CD_NEW)
  ...
  protected ObservationDto handleInvalidCombination(
      String odsStatus,
      String msgStatus,
    ...
    if (odsStatus.equals(EdxELRConstant.ELR_OBS_STATUS_CD_SUPERCEDED)
      ...
      throw new DataProcessingException(
          LAB_REPORT_STR
              + localId
              + " was not updated. Final report with Accession # "
              + fillerNumber
              + " was sent after a corrected report was received.");
    }
    ...
    if (odsStatus.equals(EdxELRConstant.ELR_OBS_STATUS_CD_COMPLETED)
      ...
      throw new DataProcessingException(
          LAB_REPORT_STR
              + localId
              + " was not updated. Preliminary report with Accession # "
              + fillerNumber
              + " was sent after a final report was received.");
    }
    ...
    dto.setFinalPostCorrected(true);
    logger.error(
        "Error!! Invalid status combination: msgInObs status= {} odsObs status= {}",
        msgStatus,
        odsStatus);
    throw new DataProcessingException(
        LAB_REPORT_STR
  ...
  public void processMatchedProxyVO(
    ...
    Collection<ObservationContainer> observationCollection =
        matchedlabResultProxyVO.getTheObservationContainerCollection();
    ...
    while (it.hasNext()) {
      ...
      if (obsDomainCdSt1 != null && obsDomainCdSt1.equalsIgnoreCase(EdxELRConstant.ELR_ORDER_CD)) {
        ...
        if (edxLabInformationDT.getRootObservationContainer() != null
            && edxLabInformationDT.getRootObservationContainer().getTheObservationDto() != null) {
        ...
        if (observationContainer.getTheObservationDto().getCtrlCdDisplayForm() != null
            && (observationContainer
                    .getTheObservationDto()
                    .getCd()
                    .equalsIgnoreCase(EdxELRConstant.ELR_LAB_CD)
                || observationContainer
                    .getTheObservationDto()
                    .getCtrlCdDisplayForm()
                    .equalsIgnoreCase(EdxELRConstant.ELR_LAB_COMMENT))) {
          observationContainer.setItDirty(true);
          continue;
        } else {
      ...
      for (ActRelationshipDto actRelationshipDto :
        ...
        if (actRelationshipDto.getTypeCd() != null
            && actRelationshipDto.getTypeCd().equals(EdxELRConstant.ELR_AR_LAB_COMMENT)) {
      ...
      for (ParticipationDto participationDto :
          observationContainer.getTheParticipationDtoCollection()) {
      ...
      for (PersonContainer personVO : coll) {
        if (personVO.getThePersonDto() != null
            ...
            && personVO
                .getThePersonDto()
                .getCdDescTxt()
                .equalsIgnoreCase(EdxELRConstant.ELR_PATIENT_DESC)) {
    ...
    Collection<OrganizationContainer> orgColl =
        matchedlabResultProxyVO.getTheOrganizationContainerCollection();
    if (orgColl != null) {
    ...
    Collection<MaterialContainer> matColl =
        matchedlabResultProxyVO.getTheMaterialContainerCollection();
    if (matColl != null) {
    ...
    if (labResultProxyVO.getTheActRelationshipDtoCollection() != null) {
      for (ActRelationshipDto actRelationshipDto :
          labResultProxyVO.getTheActRelationshipDtoCollection()) {
        if (actRelationshipDto
                    .getTargetActUid()
                    .compareTo(edxLabInformationDT.getRootObserbationUid())
                == 0
  ...
  protected ObservationDto matchingObservation(EdxLabInformationDto edxLabInformationDto)
      throws DataProcessingException {
    Long observationUid =
        observationMatchStoredProcRepository.getMatchedObservation(edxLabInformationDto);
