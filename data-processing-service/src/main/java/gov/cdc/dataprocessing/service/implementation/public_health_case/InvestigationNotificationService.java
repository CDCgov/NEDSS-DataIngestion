...
public class InvestigationNotificationService implements IInvestigationNotificationService {
  private static final Logger logger =
      LoggerFactory.getLogger(InvestigationNotificationService.class); // NOSONAR
  ...
  public EDXActivityDetailLogDto sendNotification(Object pageObj, String nndComment)
      throws DataProcessingException {
    NotificationProxyContainer notProxyVO;
    // Create the Notification object
    PublicHealthCaseContainer publicHealthCaseContainer =
        switch (pageObj) {
          case PageActProxyContainer pageActProxyContainer ->
              pageActProxyContainer.getPublicHealthCaseContainer();
          case PamProxyContainer pamProxyContainer ->
              pamProxyContainer.getPublicHealthCaseContainer();
          ...
          case null, default -> {
            ...
            throw new DataProcessingException(
                "Cannot create Notification for unknown page type: "
                    + pageObj.getClass().getCanonicalName());
          }
        };
  ...
  protected EDXActivityDetailLogDto sendProxyToEJB(
      NotificationProxyContainer notificationProxyVO, Object pageObj) {
    ...
    try {
      ...
      PublicHealthCaseDto phcDT =
          notificationProxyVO.getThePublicHealthCaseContainer().getThePublicHealthCaseDto();
      ...
      String investigationFormCd =
          cacheApiService.getSrteCacheString(
              ObjectName.INVESTIGATION_FORM_CONDITION_CODE.name(), phcDT.getCd());
      ...
      Map<?, ?> result;
      result =
          validatePAMNotficationRequiredFieldsGivenPageProxy(
              pageObj, publicHealthCaseUid, subMap, investigationFormCd);
      ...
      if (!formatErr) {
        eDXActivityDetailLogDT.setComment(
            "Notification created (UID: " + realNotificationUid + ")");
      }
  ...
  /**
   * Returns the list of Fields that are required (and not filled) to Create Notification from PAM
   * Cases
   */
  @SuppressWarnings({"java:S3776", "java:S6541", "java:S1871"})
  //    protected Map<Object, Object> validatePAMNotficationRequiredFieldsGivenPageProxy(Object
  // pageObj, Long publicHealthCaseUid,
  //                                                                                  Map<Object,
  // Object>  reqFields, String formCd) throws DataProcessingException {
  //
  ...
  //            publicHealthCaseDto =
  // proxyVO.getPublicHealthCaseContainer().getThePublicHealthCaseDto();
  ...
  //            if(pageObj == null  || pageObj instanceof PublicHealthCaseContainer)
  //            {
  //                pageProxyVO =  investigationService.getPageProxyVO(NEDSSConstant.CASE,
  // publicHealthCaseUid);
  //            }
  //            else
  //            {
  ...
  // pageActProxyContainer.getPublicHealthCaseContainer().getTheParticipationDTCollection();
  //            }
  //            else
  //            {
  //                participationDTCollection =
  ...
  //            publicHealthCaseDto =
  // pageActProxyContainer.getPublicHealthCaseContainer().getThePublicHealthCaseDto();
  //            actIdColl =
  // pageActProxyContainer.getPublicHealthCaseContainer().getTheActIdDTCollection();
  //        }
  //
  //
  //        PersonContainer personVO = getPersonVO(NEDSSConstant.PHC_PATIENT,
  // participationDTCollection,personVOCollection );
  ...
  //            String dLocation = metaData.getDataLocation() == null ? "" :
  // metaData.getDataLocation();
  //            String label = metaData.getQuestionLabel() == null ? "" :
  ...
  //                        missingFields.put(metaData.getQuestionIdentifier(),
  // metaData.getQuestionLabel());
  //                    }
  //                }
  ...
  //                        for (EntityLocatorParticipationDto elp :
  // personVO.getTheEntityLocatorParticipationDtoCollection()) {
  ...
  //                                    try {
  //                                        Object obj = method.invoke(postalLocator, (Object[])
  // null);
  //                                        checkObject(obj, missingFields, metaData);
  //                                    } catch (Exception e) {
  //                                        throw new DataProcessingException(e.getMessage(), e);
  ...
  //                        for (PersonRaceDto personRaceDto :
  // personVO.getThePersonRaceDtoCollection()) {
  ...
  //                            String value = adt.getRootExtensionTxt() == null ? "" :
  // adt.getRootExtensionTxt();
  //                            if (typeCd.equalsIgnoreCase(NEDSSConstant.ACT_ID_STATE_TYPE_CD) &&
  // value.isEmpty() && (label.toLowerCase().contains(STATE_STR))) {
  ...
  //                                }
  //                            } else if
  // (typeCd.equalsIgnoreCase(NEDSSConstant.ACT_ID_STATE_TYPE_CD)
  ...
  //                {
  //                    if (answerMap == null || answerMap.isEmpty() || (answerMap.get(nbsQueUid) ==
  // null && answerMap.get(metaData.getQuestionIdentifier()) == null)) {
  //                        missingFields.put(metaData.getQuestionIdentifier(),
  // metaData.getQuestionLabel());
  //                    }
  //                }
  //                else if (dLocation.toLowerCase().startsWith("nbs_case_answer.") &&
  // (formCd.equalsIgnoreCase(NEDSSConstant.INV_FORM_RVCT)) &&
  //                        answerMap == null || Objects.requireNonNull(answerMap).isEmpty() ||
  // (answerMap.get(nbsQueUid) == null && answerMap.get(metaData.getQuestionIdentifier()) == null))
  //                {
  //                    missingFields.put(metaData.getQuestionIdentifier(),
  // metaData.getQuestionLabel());
  //                }
  ...
  protected Map<Object, Object> validatePAMNotficationRequiredFieldsGivenPageProxy(
      Object pageObj, Long publicHealthCaseUid, Map<Object, Object> reqFields, String formCd)
      throws DataProcessingException {
  ...
  protected void validateNbsAnswer(
  ...
  protected void validateReflection(
      Object target,
      String dLocation,
      NbsQuestionMetadata metaData,
      Map<Object, Object> missingFields)
  ...
  protected void validatePostalLocator(
      ValidationContext context,
      String dLocation,
      NbsQuestionMetadata metaData,
      Map<Object, Object> missingFields)
    ...
    if (context.personVO != null
        && context.personVO.getTheEntityLocatorParticipationDtoCollection() != null) {
      for (EntityLocatorParticipationDto elp :
          context.personVO.getTheEntityLocatorParticipationDtoCollection()) {
        if (elp.getThePostalLocatorDto() != null
            && metaData.getDataUseCd() != null
            && metaData.getDataUseCd().equalsIgnoreCase(elp.getUseCd())) {
  ...
  @SuppressWarnings("java:S112")
  protected void validatePersonRace(
      ValidationContext context,
      String dLocation,
      NbsQuestionMetadata metaData,
      Map<Object, Object> missingFields)
    ...
    if (context.actIdColl != null) {
      for (ActIdDto adt : context.actIdColl) {
        ...
        boolean shouldValidate =
            (typeCd.equalsIgnoreCase(NEDSSConstant.ACT_ID_STATE_TYPE_CD)
                    && value.isEmpty()
                    && label.toLowerCase().contains(LOWER_CASE_STATE))
                || (typeCd.equalsIgnoreCase(NEDSSConstant.ACT_ID_STATE_TYPE_CD)
                    && formCd.equalsIgnoreCase(NEDSSConstant.INV_FORM_RVCT)
                    && label.toLowerCase().contains(LOWER_CASE_STATE))
                || (typeCd.equalsIgnoreCase(UPPER_CASE_CITY)
                    && value.isEmpty()
                    && label.toLowerCase().contains(LOWER_CASE_CITY));
  ...
  protected void validateNbsCaseAnswer(
      ValidationContext context,
      Long nbsQueUid,
      NbsQuestionMetadata metaData,
      Map<Object, Object> missingFields) {
  ...
  protected ValidationContext buildValidationContext(Object pageObj, Long uid, String formCd)
      throws DataProcessingException {
    ...
    if (formCd.equalsIgnoreCase(NEDSSConstant.INV_FORM_RVCT)
        || formCd.equalsIgnoreCase(NEDSSConstant.INV_FORM_VAR)) {
      PamProxyContainer proxy =
          (pageObj instanceof PamProxyContainer)
              ? (PamProxyContainer) pageObj
              : new PamProxyContainer();
      BasePamContainer pamVO = proxy.getPamVO();
      ctx.answerMap = pamVO != null ? pamVO.getPamAnswerDTMap() : null;
      ctx.participationDTCollection =
          proxy.getTheParticipationDTCollection() != null
              ? proxy.getTheParticipationDTCollection()
              : new ArrayList<>();
      ctx.personVOCollection = proxy.getThePersonVOCollection();
      ctx.publicHealthCaseDto =
          proxy.getPublicHealthCaseContainer() != null
              ? proxy.getPublicHealthCaseContainer().getThePublicHealthCaseDto()
              : null;
      ctx.actIdColl =
          proxy.getPublicHealthCaseContainer() != null
              ? proxy.getPublicHealthCaseContainer().getTheActIdDTCollection()
              : null;
    } else {
      PageActProxyContainer proxy =
          (pageObj instanceof PageActProxyContainer)
      ...
      ctx.participationDTCollection =
          proxy.getTheParticipationDtoCollection() != null
    ...
    ctx.personVO =
        getPersonVO(
            NEDSSConstant.PHC_PATIENT, ctx.participationDTCollection, ctx.personVOCollection);
  ...
  protected void checkObject(
      Object obj, Map<Object, Object> missingFields, NbsQuestionMetadata metaData) {
  ...
  protected PersonContainer getPersonVO(
      String typeCd,
      Collection<ParticipationDto> participationDTCollection,
      Collection<PersonContainer> personVOCollection) {
    ...
    if (participationDTCollection != null) {
      ...
      for (anIterator1 = participationDTCollection.iterator(); anIterator1.hasNext(); ) {
        ...
        if (participationDT.getTypeCd() != null
            && (participationDT.getTypeCd()).compareTo(typeCd) == 0) {
          for (anIterator2 = personVOCollection.iterator(); anIterator2.hasNext(); ) {
            personVO = anIterator2.next();
            if (personVO.getThePersonDto().getPersonUid().longValue()
