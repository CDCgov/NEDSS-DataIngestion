...
public class OrganizationMatchingService implements IOrganizationMatchingService {
  ...
  public OrganizationMatchingService(
  ...
  public EDXActivityDetailLogDto getMatchingOrganization(
    ...
    String entityExistFail =
        "Organization not found. New Organization created with organization uid: ";
    ...
    if (localId != null) {
      EdxEntityMatchDto edxEntityMatchingDT =
          edxPatientMatchRepositoryUtil.getEdxEntityMatchOnMatchString(
              NEDSSConstant.ORGANIZATION_CLASS_CODE, localId);
      if (edxEntityMatchingDT != null && edxEntityMatchingDT.getEntityUid() != null) {
        ...
        edxActivityDetailLogDto.setComment(entityExistSuccess + edxEntityMatchingDT.getEntityUid());
        ...
        edxActivityDetailLogDto.setLogType(
            String.valueOf(EdxRuleAlgorothmManagerDto.STATUS_VAL.Success));
    ...
    if (!identifierList.isEmpty()) {
      for (String o : identifierList) {
        ...
        EdxEntityMatchDto edxEntityMatchingDT =
            edxPatientMatchRepositoryUtil.getEdxEntityMatchOnMatchString(
                NEDSSConstant.ORGANIZATION_CLASS_CODE, identifier);
        if (edxEntityMatchingDT != null && edxEntityMatchingDT.getEntityUid() != null) {
          if (localEdxEntityMatchDT != null) {
            localEdxEntityMatchDT.setEntityUid(edxEntityMatchingDT.getEntityUid());
            edxPatientMatchRepositoryUtil.saveEdxEntityMatch(localEdxEntityMatchDT);
          }
          edxActivityDetailLogDto.setRecordId(String.valueOf(edxEntityMatchingDT.getEntityUid()));
          edxActivityDetailLogDto.setComment(
              entityExistSuccess + edxEntityMatchingDT.getEntityUid());
          edxActivityDetailLogDto.setRecordType(String.valueOf(MsgType.Organization));
          edxActivityDetailLogDto.setRecordName(PHCR_IMPORT_SRT);
          edxActivityDetailLogDto.setLogType(
              String.valueOf(EdxRuleAlgorothmManagerDto.STATUS_VAL.Success));
    ...
    if (nameAddStrSt1 != null) {
      ...
      EdxEntityMatchDto edxEntityMatchingDT =
          edxPatientMatchRepositoryUtil.getEdxEntityMatchOnMatchString(
              NEDSSConstant.ORGANIZATION_CLASS_CODE, nameAddStrSt1);
      if (edxEntityMatchingDT != null && edxEntityMatchingDT.getEntityUid() != null) {
        if (localEdxEntityMatchDT != null) {
          localEdxEntityMatchDT.setEntityUid(edxEntityMatchingDT.getEntityUid());
          edxPatientMatchRepositoryUtil.saveEdxEntityMatch(localEdxEntityMatchDT);
    ...
    if (nameTelePhone != null) {
      EdxEntityMatchDto edxEntityMatchingDT =
          edxPatientMatchRepositoryUtil.getEdxEntityMatchOnMatchString(
              NEDSSConstant.ORGANIZATION_CLASS_CODE, nameTelePhone);
      if (edxEntityMatchingDT != null && edxEntityMatchingDT.getEntityUid() != null) {
        if (localEdxEntityMatchDT != null) {
          localEdxEntityMatchDT.setEntityUid(edxEntityMatchingDT.getEntityUid());
          edxPatientMatchRepositoryUtil.saveEdxEntityMatch(localEdxEntityMatchDT);
    ...
    entityUid =
        organizationRepositoryUtil.setOrganization(organizationContainer, businessTriggerCd);
    ...
    edxActivityDetailLogDto.setComment(entityExistFail + edxActivityDetailLogDto.getRecordId());
    edxActivityDetailLogDto.setRecordType(String.valueOf(MsgType.Organization));
    edxActivityDetailLogDto.setRecordName(PHCR_IMPORT_SRT);
    edxActivityDetailLogDto.setLogType(
        String.valueOf(EdxRuleAlgorothmManagerDto.STATUS_VAL.Success));
  ...
  private List<String> getIdentifier(OrganizationContainer organizationContainer) {
    ...
    if (organizationContainer.getTheEntityIdDtoCollection() != null
      ...
      Collection<EntityIdDto> entityIdDTColl = organizationContainer.getTheEntityIdDtoCollection();
      for (EntityIdDto entityIdDT : entityIdDTColl) {
        if ((entityIdDT.getStatusCd().equalsIgnoreCase(NEDSSConstant.STATUS_ACTIVE))) {
          ...
          if ((entityIdDT.getRootExtensionTxt() != null)
            ...
            identifier =
                entityIdDT.getRootExtensionTxt()
                    + carrot
                    ...
                    + carrot
                    + entityIdDT.getAssigningAuthorityIdType();
          } else {
            try {
  ...
  public String nameAddressStreetOne(OrganizationContainer organizationContainer) {
    ...
    if (nameAddStr != null) nameAddStr = getNameString(organizationContainer) + nameAddStr;
    return nameAddStr;
  }
  ...
  private String getNameString(OrganizationContainer organizationContainer) {
    ...
    if (organizationContainer.getTheOrganizationNameDtoCollection() != null
      ...
      Collection<OrganizationNameDto> organizationNameDtoColl =
      ...
      for (OrganizationNameDto organizationNameDto : organizationNameDtoColl) {
        if (organizationNameDto.getNmUseCd() != null
            && organizationNameDto.getNmUseCd().equals(NEDSSConstant.LEGAL)) {
        ...
        if (entLocPartDT.getClassCd() != null
          ...
          if (entLocPartDT.getCd() != null && entLocPartDT.getCd().equals(NEDSSConstant.PHONE)) {
            if (entLocPartDT.getTheTeleLocatorDto() != null) {
              ...
              if (teleLocDT.getPhoneNbrTxt() != null && !teleLocDT.getPhoneNbrTxt().isEmpty())
