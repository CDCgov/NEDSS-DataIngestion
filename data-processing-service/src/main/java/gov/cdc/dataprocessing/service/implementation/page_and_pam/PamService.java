...
public class PamService implements IPamService {
    ...
    public Long setPamProxyWithAutoAssoc(PamProxyContainer pamProxyVO, Long observationUid, String observationTypeCd) throws DataProcessingException, IOException, ClassNotFoundException {
    ...
    private Long setPamProxy(PamProxyContainer pamProxyVO) throws DataProcessingException, IOException, ClassNotFoundException {
