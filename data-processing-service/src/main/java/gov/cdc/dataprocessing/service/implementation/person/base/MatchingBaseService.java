...
public class MatchingBaseService {
  ...
  public List<String> getIdentifier(PersonContainer personContainer)
    ...
    try {
      if (personContainer.getTheEntityIdDtoCollection() != null
        ...
        for (EntityIdDto idDto : entityIdDtoColl) {
          ...
          if (((idDto.getStatusCd() != null
                      && idDto.getStatusCd().equalsIgnoreCase(NEDSSConstant.STATUS_ACTIVE))
            ...
            if ((idDto.getRootExtensionTxt() != null)
              ...
              identifier
                  .append(idDto.getRootExtensionTxt())
                  .append(carrot)
        ...
        if (personContainer.getThePersonNameDtoCollection() != null
          ...
          while (personNameIterator.hasNext()) {
            ...
            if (personNameDto.getNmUseCd() != null
              ...
              namesStr =
                  processingPersonNameBasedOnAsOfDate(personNameDto, namesStr, asofDate); // NOSONAR
            }
          }
        }
      }
  ...
  protected String processingPersonNameBasedOnAsOfDate(
      PersonNameDto personNameDto, String namesStr, Timestamp asofDate) {
    String caret = "^";
