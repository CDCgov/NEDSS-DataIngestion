...
public class MaterialService implements IMaterialService {
  ...
  public MaterialContainer loadMaterialObject(Long materialUid) {
    ...
    materialContainer.setTheEntityLocatorParticipationDTCollection(
        entityLocatorParticipationDtoCollection);
  ...
  public Long saveMaterial(MaterialContainer materialContainer) throws DataProcessingException {
    ...
    Collection<EntityLocatorParticipationDto> elpDTCol =
        materialContainer.getTheEntityLocatorParticipationDTCollection();
  ...
  private Long updateMaterial(MaterialContainer materialContainer) throws DataProcessingException {
    ...
    if (materialContainer.getTheMaterialDto() != null) {
      ...
      persistingMaterial(
          material, materialContainer.getTheMaterialDto().getMaterialUid(), timestamp);

      if (materialContainer.getTheEntityIdDtoCollection() != null) {
        persistingEntityId(
            materialContainer.getTheMaterialDto().getMaterialUid(),
            materialContainer.getTheEntityIdDtoCollection());
      }

      if (materialContainer.getTheEntityLocatorParticipationDTCollection() != null) {
        persistingEntityLocatorParticipation(
            materialContainer.getTheMaterialDto().getMaterialUid(),
            materialContainer.getTheEntityLocatorParticipationDTCollection(),
            true);
      }
      ...
      if (materialContainer.getTheManufacturedMaterialDtoCollection() != null) {
        persistingManufacturedMaterial(
            materialContainer.getTheMaterialDto().getMaterialUid(),
            materialContainer.getTheManufacturedMaterialDtoCollection());
      }
    }
  ...
  private Long insertNewMaterial(MaterialContainer materialContainer)
    ...
    if (materialContainer.getTheMaterialDto() != null) {
      ...
      if (materialContainer.getTheEntityIdDtoCollection() != null) {
        persistingEntityId(
            uid.getGaTypeUid().getSeedValueNbr(), materialContainer.getTheEntityIdDtoCollection());
      }

      if (materialContainer.getTheEntityLocatorParticipationDTCollection() != null) {
        persistingEntityLocatorParticipation(
            uid.getGaTypeUid().getSeedValueNbr(),
            materialContainer.getTheEntityLocatorParticipationDTCollection(),
            false);
      }
  ...
  private void persistingEntityLocatorParticipation(
      Long uid, Collection<EntityLocatorParticipationDto> entityCollection, boolean updateApplied)
      throws DataProcessingException {
    if (updateApplied) {
  ...
  private void persistingManufacturedMaterial(
      Long uid, Collection<ManufacturedMaterialDto> manufacturedMaterialDtoCollection)
      throws DataProcessingException {
