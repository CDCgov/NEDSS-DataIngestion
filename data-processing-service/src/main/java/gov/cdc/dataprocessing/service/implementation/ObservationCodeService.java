...
public class ObservationCodeService implements IObservationCodeService {
     ...
     */
    public ArrayList<String> deriveTheConditionCodeList(LabResultProxyContainer labResultProxyVO, ObservationVO orderTest) throws DataProcessingException {
...
//        }
     ...
     */
    // AK - 7/25/04
    private ArrayList<String> getConditionsFromSNOMEDCodes(String reportingLabCLIA, Collection<ObsValueCodedDT> obsValueCodedDtColl) throws DataProcessingException {
        ...
        if (obsValueCodedDtColl != null) {
            ...
            while (codedDtIt.hasNext()) {
                String snomedCd = "";
                String conditionCd = "";
                ObsValueCodedDT codedDt =  codedDtIt.next();
     ...
     * @return conditionCd : String
     */
    private String getConditionCodeForLocalTestCode(String reportingLabCLIA, ObservationVO resultTestVO) {
