...
public class PersonService implements IPersonService {
  ...
  public PersonContainer processingNextOfKin(
    ...
    if (personContainer.getThePersonDto().getPersonUid() != null) {
      ...
      uidService.setFalseToNewPersonAndOrganization(
          labResultProxyContainer, falseUid, personContainer.getThePersonDto().getPersonUid());
  ...
  public PersonContainer processingPatient(
    ...
    if (edxPatientMatchFoundDT != null
        && !edxPatientMatchFoundDT.isMultipleMatch()
        && personContainer.getPatientMatchedFound()) // NOSONAR
    {
      edxLabInformationDto.setPatientMatch(true);
    }
    if (personContainer.getThePersonDto().getPersonParentUid() != null) {
      edxLabInformationDto.setPersonParentUid(
  ...
  public PersonContainer processingProvider(
      LabResultProxyContainer labResultProxyContainer,
      EdxLabInformationDto edxLabInformationDto,
      PersonContainer personContainer,
    ...
    if (personContainer.getRole() != null
        && personContainer.getRole().equalsIgnoreCase(EdxELRConstant.ELR_OP_CD)) {
  ...
  private PersonNameDto parsingPersonName(PersonContainer personContainer)
      throws DataProcessingException {
  ...
  public Long getMatchedPersonUID(LabResultProxyContainer matchedlabResultProxyVO) {
    ...
    Collection<PersonContainer> personCollection =
        matchedlabResultProxyVO.getThePersonContainerCollection();
    if (personCollection != null) {

      for (PersonContainer personVO : personCollection) {
        String perDomainCdStr = personVO.getThePersonDto().getCdDescTxt();
        if (perDomainCdStr != null
            && perDomainCdStr.equalsIgnoreCase(EdxELRConstant.ELR_PATIENT_DESC)) {
  ...
  public void updatePersonELRUpdate(
    ...
    Collection<EntityLocatorParticipationDto> updatedtheEntityLocatorParticipationDTCollection =
        new ArrayList<>();
      ...
      for (PersonContainer personVO : personCollection) {
        ...
        if (perDomainCdStr != null
          ...
          if (personVO.getThePersonNameDtoCollection() != null
              && !personVO.getThePersonNameDtoCollection().isEmpty()) {
          ...
          if (personVO.getThePersonEthnicGroupDtoCollection() != null
              && !personVO.getThePersonEthnicGroupDtoCollection().isEmpty()) {
            for (PersonEthnicGroupDto personEthnicGroupDT :
                personVO.getThePersonEthnicGroupDtoCollection()) {
          ...
          if (personVO.getTheEntityIdDtoCollection() != null
              && !personVO.getTheEntityIdDtoCollection().isEmpty()) {
          ...
          if (personVO.getTheEntityLocatorParticipationDtoCollection() != null
            ...
            for (EntityLocatorParticipationDto entityLocPartDT :
      ...
      for (PersonContainer personVO : labResultProxyVO.getThePersonContainerCollection()) {
        ...
        if (perDomainCdStr != null
          ...
          if (perDomainCdStr != null
            ...
            Collection<PersonRaceDto> personRaceCollection =
            ...
            if (personVO.getThePersonEthnicGroupDtoCollection() == null
              ...
              personVO
                  ...
                  .addAll(updatedPersonEthnicGroupCollection);
            }
            if (personVO.getTheEntityIdDtoCollection() != null
                && !personVO.getTheEntityIdDtoCollection().isEmpty()) {
              for (EntityIdDto entityIDDT : personVO.getTheEntityIdDtoCollection()) {
            ...
            if (!cloneEntityLocatorForParentUid.isEmpty()) {
              personVO
                  .getTheEntityLocatorParticipationDtoCollection()
                  .addAll(cloneEntityLocatorForParentUid);
            }
          }
