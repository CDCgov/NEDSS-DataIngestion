...
public class UidService implements IUidService {
  ...
  /**
   * This method checks for the negative uid value for any ACT & ENTITY DT then compare them with
   * respective negative values in ActRelationshipDto and ParticipationDto as received from the
   * investigationProxyVO(determined in the addInvestigation method). As it has also got the
   * actualUID (determined in the addInvestigation method) it replaces them accordingly.
   */
  ...
  public void setFalseToNewForObservation(BaseContainer proxyVO, Long falseUid, Long actualUid) {
    ...
    if (participationColl != null) {
      for (participationDTIterator = participationColl.iterator();
          participationDTIterator.hasNext(); ) {
    ...
    if (actRelationShipColl != null) {
      for (actRelationshipDTIterator = actRelationShipColl.iterator();
          actRelationshipDTIterator.hasNext(); ) {
    ...
    if (roleColl != null && !roleColl.isEmpty()) {
      for (roleDtoIterator = roleColl.iterator(); roleDtoIterator.hasNext(); ) {
        ...
        if (roleDT.getScopingEntityUid() != null
            && falseUid != null
            && roleDT.getScopingEntityUid().compareTo(falseUid) == 0) {
  ...
  /**
   * This method update uid for items in the following collection Participation collection Act
   * Relationship collection Role collection - This is crucial in Observation Flow
   */
  @SuppressWarnings("java:S3776")
  public void setFalseToNewPersonAndOrganization(
      LabResultProxyContainer labResultProxyContainer, Long falseUid, Long actualUid) {
    ...
    Collection<ParticipationDto> participationColl =
        labResultProxyContainer.getTheParticipationDtoCollection();
    Collection<ActRelationshipDto> actRelationShipColl =
        labResultProxyContainer.getTheActRelationshipDtoCollection();
    Collection<RoleDto> roleColl = labResultProxyContainer.getTheRoleDtoCollection();

    if (participationColl != null) {
      for (participationIterator = participationColl.iterator();
          participationIterator.hasNext(); ) {
    ...
    if (actRelationShipColl != null) {
      for (actRelationshipIterator = actRelationShipColl.iterator();
          actRelationshipIterator.hasNext(); ) {
    ...
    if (roleColl != null) {
      for (roleIterator = roleColl.iterator(); roleIterator.hasNext(); ) {
        ...
        if (roleDto.getScopingEntityUid() != null
            && roleDto.getScopingEntityUid().compareTo(falseUid) == 0) {
  ...
  @SuppressWarnings("java:S3776")
  public void setFalseToNewForPageAct(
      PageActProxyContainer pageProxyVO, Long falseUid, Long actualUid) {
    ...
    Collection<NbsActEntityDto> pamCaseEntityColl =
        pageProxyVO.getPageVO().getActEntityDTCollection();
    ...
    if (actRelationShipColl != null) {
      for (anIteratorActRe = actRelationShipColl.iterator(); anIteratorActRe.hasNext(); ) {
    ...
    if (pamCaseEntityColl != null) {
      for (anIteratorNbsActEntity = pamCaseEntityColl.iterator();
          anIteratorNbsActEntity.hasNext(); ) {
  ...
  public void setFalseToNewForPam(PamProxyContainer pamProxyVO, Long falseUid, Long actualUid) {
    ...
    Collection<ActRelationshipDto> actRelationShipColl =
        pamProxyVO.getPublicHealthCaseContainer().getTheActRelationshipDTCollection();
    Collection<NbsActEntityDto> pamCaseEntityColl =
  ...
  public ActRelationshipDto setFalseToNewForNotification(
      NotificationProxyContainer notificationProxyVO, Long falseUid, Long actualUid) {

    Iterator<Object> anIterator;
    ActRelationshipDto actRelationshipDT = null;
    Collection<Object> actRelationShipColl =
        notificationProxyVO.getTheActRelationshipDTCollection();
