...
public class JurisdictionService implements IJurisdictionService {
  ...
  public void assignJurisdiction(
    ...
    if (patientContainer != null) {
      jurisdictionMap =
          resolveLabReportJurisdiction(
              patientContainer, providerContainer, organizationContainer, null);
    }

    if (jurisdictionMap != null
        && jurisdictionMap.get(ELRConstant.JURISDICTION_HASHMAP_KEY) != null) {
  ...
  public String deriveJurisdictionCd(BaseContainer proxyVO, ObservationDto rootObsDT)
      throws DataProcessingException {
    ...
    for (ParticipationDto partDT : partColl) {
      ...
      if (typeCd != null
          ...
          && subjectClassCd != null
          && subjectClassCd.equalsIgnoreCase(NEDSSConstant.PERSON_CLASS_CODE)) {
      ...
      } else if (typeCd != null && (typeCd.equalsIgnoreCase(NEDSSConstant.PAR102_TYP_CD))) {
    ...
    if (reportingFacilityUid != null) {
      // it was assigned to orderingFacilityVO in the first implementation.not sure if it was
      // correct.
    ...
    if (patientVO != null) {
      jMap =
          resolveLabReportJurisdiction(
              patientVO, providerVO, orderingFacilityVO, reportingFacilityVO);
    }
  ...
  private HashMap<String, String> resolveLabReportJurisdiction(
      PersonContainer patientContainer,
      PersonContainer providerContainer,
      OrganizationContainer organizationContainer,
    ...
    patientJurisdictionCollection =
        findJurisdiction(
            patientContainer.getTheEntityLocatorParticipationDtoCollection(), "H", "PST");
    ...
    if (patientJurisdictionCollection.size() <= 1) {
      ...
      if (jurisdiction == null && providerContainer != null) {
        ...
        providerJurisdictionCollection =
            findJurisdiction(
                providerContainer.getTheEntityLocatorParticipationDtoCollection(), "WP", "PST");
      ...
      if (jurisdiction == null) {
        if (organizationContainer != null) {
          ...
          organizationJurisdictionCollection =
              findJurisdiction(
        ...
        if (organizationJurisdictionCollection != null
            && organizationJurisdictionCollection.size() == 1) {
          // Check the result to make sure that there is a value for the organization's
          // jurisdiction.
      ...
      if (jurisdiction == null) {
        ...
        if (organizationContainer2 != null) {
          ...
          organizationJurisdictionCollection =
              findJurisdiction(
                  organizationContainer2.getTheEntityLocatorParticipationDtoCollection(),
                  "WP",
                  "PST");
        }
        if (organizationJurisdictionCollection != null
  ...
  @SuppressWarnings("java:S3776")
  private Collection<String> findJurisdiction(
      Collection<EntityLocatorParticipationDto> entityLocatorPartColl,
      String useCd,
      String classCd) {
          ...
          if (postalDt != null) {
            ...
            if (coll.isEmpty()) {
              ...
              if (postalDt.getCityDescTxt() != null) {
                var resCity =
                    jurisdictionParticipationRepository.findJurisdictionForCity(
                        postalDt.getCityDescTxt(), postalDt.getStateCd(), "C");
              ...
              if (coll.isEmpty()) {
                var resJus =
                    jurisdictionParticipationRepository.findJurisdiction(postalDt.getCntyCd(), "N");
                if (resJus.isPresent()) {
                  coll = resJus.get();
                }
              }
  ...
  /**
   * Uses a StringTokenizer to parse a zip code using "-" as a delimeter. Returns the first token of
   * the zip.
   *
