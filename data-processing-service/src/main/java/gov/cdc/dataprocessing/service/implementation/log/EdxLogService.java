...
public class EdxLogService implements IEdxLogService {
  ...
  public EdxLogService(
      EdxActivityLogRepository edxActivityLogRepository,
  ...
  public void saveEdxActivityLogs(EDXActivityLogDto edxActivityLogDto) {
    ...
    Long activityLogId;
    Optional<EdxActivityLog> dbActivityLogOptional =
        edxActivityLogRepository.findBySourceUid(edxActivityLog.getSourceUid());
    ...
    if (edxActivityLogDto.getEDXActivityLogDTWithVocabDetails() != null) {
      Collection<EDXActivityDetailLogDto> edxActivityDetailLogsList =
          edxActivityLogDto.getEDXActivityLogDTWithVocabDetails();
  ...
  public void updateActivityLogDT(
    ...
    if (edxLabInformationDto.getFillerNumber() != null
        && edxLabInformationDto.getFillerNumber().length() > 100) {
  ...
  public void addActivityDetailLogs(EdxLabInformationDto edxLabInformationDto, String detailedMsg) {
    try {
      ArrayList<EDXActivityDetailLogDto> detailList =
          (ArrayList<EDXActivityDetailLogDto>)
              edxLabInformationDto.getEdxActivityLogDto().getEDXActivityLogDTWithVocabDetails();
      if (detailList == null) {
      ...
      if (edxLabInformationDto.isInvalidXML()) {
        setActivityDetailLog(
            detailList,
            id,
            EdxRuleAlgorothmManagerDto.STATUS_VAL.Failure,
            EdxELRConstant.INVALID_XML);
        errorReturned = true;
        ...
        String msg =
            EdxELRConstant.LABTEST_SEQUENCE.replace("%1", edxLabInformationDto.getFillerNumber());
        ...
        String msg =
            EdxELRConstant.FINAL_POST_CORRECTED
                .replace("%1", edxLabInformationDto.getLocalId())
                .replace("%2", edxLabInformationDto.getFillerNumber());
        setActivityDetailLog(detailList, id, EdxRuleAlgorothmManagerDto.STATUS_VAL.Failure, msg);
        errorReturned = true;
      } else if (edxLabInformationDto.isPreliminaryPostFinal()) {
        String msg =
            EdxELRConstant.PRELIMINARY_POST_FINAL
                .replace("%1", edxLabInformationDto.getLocalId())
                .replace("%2", edxLabInformationDto.getFillerNumber());
        setActivityDetailLog(detailList, id, EdxRuleAlgorothmManagerDto.STATUS_VAL.Failure, msg);
        errorReturned = true;
        ...
        String msg =
            EdxELRConstant.PRELIMINARY_POST_CORRECTED
                .replace("%1", edxLabInformationDto.getLocalId())
                .replace("%2", edxLabInformationDto.getFillerNumber());
        setActivityDetailLog(detailList, id, EdxRuleAlgorothmManagerDto.STATUS_VAL.Failure, msg);
        errorReturned = true;
        ...
        String msg =
            EdxELRConstant.NO_LAB_CREATE_PERMISSION.replace(
                "%1", edxLabInformationDto.getUserName());
        setActivityDetailLog(detailList, id, EdxRuleAlgorothmManagerDto.STATUS_VAL.Failure, msg);
        errorReturned = true;
      } else if (!edxLabInformationDto.isUpdateLabPermission()) {
        String msg =
            EdxELRConstant.NO_LAB_UPDATE_PERMISSION.replace(
                "%1", edxLabInformationDto.getUserName());
        setActivityDetailLog(detailList, id, EdxRuleAlgorothmManagerDto.STATUS_VAL.Failure, msg);
        errorReturned = true;
      } else if (!edxLabInformationDto.isMarkAsReviewPermission()) {
        String msg =
            EdxELRConstant.NO_LAB_MARK_REVIEW_PERMISSION.replace(
                "%1", edxLabInformationDto.getUserName());
        setActivityDetailLog(detailList, id, EdxRuleAlgorothmManagerDto.STATUS_VAL.Failure, msg);
      } else if (!edxLabInformationDto.isCreateInvestigationPermission()) {
        String msg =
            EdxELRConstant.NO_INV_PERMISSION.replace("%1", edxLabInformationDto.getUserName());
        setActivityDetailLog(detailList, id, EdxRuleAlgorothmManagerDto.STATUS_VAL.Failure, msg);
        setActivityDetailLog(
            detailList, id, EdxRuleAlgorothmManagerDto.STATUS_VAL.Success, EdxELRConstant.OFCI);
      } else if (!edxLabInformationDto.isCreateNotificationPermission()) {
        String msg =
            EdxELRConstant.NO_NOT_PERMISSION.replace("%1", edxLabInformationDto.getUserName());
        setActivityDetailLog(detailList, id, EdxRuleAlgorothmManagerDto.STATUS_VAL.Failure, msg);
        setActivityDetailLog(
            detailList, id, EdxRuleAlgorothmManagerDto.STATUS_VAL.Success, EdxELRConstant.OFCN);
      } else if (edxLabInformationDto.isFieldTruncationError()) {
        setActivityDetailLog(
            detailList, id, EdxRuleAlgorothmManagerDto.STATUS_VAL.Failure, detailedMsg);
        ...
        setActivityDetailLog(
            detailList, id, EdxRuleAlgorothmManagerDto.STATUS_VAL.Failure, detailedMsg);
        if (edxLabInformationDto.getLabResultProxyContainer() == null) errorReturned = true;
        if (edxLabInformationDto.isLabIsCreate() && !edxLabInformationDto.isLabIsCreateSuccess())
          errorReturned = true;
        else if ((edxLabInformationDto.isLabIsUpdateDRRQ()
                || edxLabInformationDto.isLabIsUpdateDRSA())
            && !edxLabInformationDto.isLabIsUpdateSuccess()) errorReturned = true;
      ...
      if (edxLabInformationDto.isMultipleSubjectMatch()) {
        String msg =
            EdxELRConstant.SUBJECTMATCH_MULT
                .replace("%1", edxLabInformationDto.getEntityName())
                .replace("%2", String.valueOf(edxLabInformationDto.getPersonParentUid()));
        setActivityDetailLog(
            detailList,
      ...
      if (edxLabInformationDto.isPatientMatch()) {
        String msg =
            EdxELRConstant.SUBJECT_MATCH_FOUND
                .replace("%1", String.valueOf(edxLabInformationDto.getPatientUid()))
                .replace("%2", String.valueOf(edxLabInformationDto.getPersonParentUid()));
        setActivityDetailLog(
            detailList,
            String.valueOf(edxLabInformationDto.getPersonParentUid()),
      ...
      if (!edxLabInformationDto.isMultipleSubjectMatch()
          && !edxLabInformationDto.isPatientMatch()
          && edxLabInformationDto.getPersonParentUid() != 0) {
        String msg =
            EdxELRConstant.SUJBECTMATCH_NO
                .replace("%1", String.valueOf(edxLabInformationDto.getPersonParentUid()))
                .replace("%2", String.valueOf(edxLabInformationDto.getPersonParentUid()));
        setActivityDetailLog(
            detailList,
            String.valueOf(edxLabInformationDto.getPersonParentUid()),
      ...
      if (edxLabInformationDto.isNextOfKin()) {
        ...
        var nokInfo =
            edxLabInformationDto
                .getLabResultProxyContainer()
                .getThePersonContainerCollection()
                .stream()
                .filter(nok -> nok.getRole().equals(NEDSSConstant.NOK))
                .findFirst();
        String nokUid;
        String nokParentUid;
        ...
        setActivityDetailLog(
            detailList, id, EdxRuleAlgorothmManagerDto.STATUS_VAL.Success, message);
      } else {
        setActivityDetailLog(
            detailList,
            id,
            EdxRuleAlgorothmManagerDto.STATUS_VAL.Failure,
            EdxELRConstant.NO_NEXT_OF_KIN);
      }
      if (edxLabInformationDto.isProvider()) {
        setActivityDetailLog(
            ...
            id,
            EdxRuleAlgorothmManagerDto.STATUS_VAL.Success,
            EdxELRConstant.IS_PROVIDER);
      } else {
        setActivityDetailLog(
            detailList,
            id,
            EdxRuleAlgorothmManagerDto.STATUS_VAL.Failure,
            EdxELRConstant.IS_NOT_PROVIDER);
      }
      ...
      if (edxLabInformationDto.isLabIsCreateSuccess()
          && edxLabInformationDto.getProgramAreaName() != null) {
        setActivityDetailLog(
            detailList,
            id,
            EdxRuleAlgorothmManagerDto.STATUS_VAL.Success,
      ...
      if (edxLabInformationDto.isLabIsCreateSuccess()) {
        ...
        setActivityDetailLog(
            ...
            id,
            EdxRuleAlgorothmManagerDto.STATUS_VAL.Success,
            EdxELRConstant.DOC_CREATE_SUCCESS);
      }
      if (edxLabInformationDto.isObservationMatch()) {
        setActivityDetailLog(
            ...
            id,
            EdxRuleAlgorothmManagerDto.STATUS_VAL.Success,
            EdxELRConstant.OBSERVATION_MATCH);
      } else {
        String msg =
            EdxELRConstant.OBSERVATION_NOT_MATCH.replace(
                "%1", Long.toString(edxLabInformationDto.getRootObserbationUid()));
        setActivityDetailLog(detailList, id, EdxRuleAlgorothmManagerDto.STATUS_VAL.Success, msg);
      }
      ...
      if (!edxLabInformationDto.isMissingOrderingProviderandFacility()
          && edxLabInformationDto.isMissingOrderingProvider()) {
        setActivityDetailLog(
            detailList,
            id,
            EdxRuleAlgorothmManagerDto.STATUS_VAL.Success,
      ...
      if (!edxLabInformationDto.getWdsReports().isEmpty()) {
        ...
        if (!item.getWdsValueNumericReportList().isEmpty()) {
          ...
          sb.append("Matched on Numeric type. ")
              .append(underCond)
              .append(wdsNumeric.getWdsCode())
              .append("(WDS value) ")
              .append(wdsNumeric.getOperator())
              .append(" ")
              .append(wdsNumeric.getInputCode1())
              .append(" (Input value 1) & ")
              .append(wdsNumeric.getInputCode2())
              .append(" (Input value 2)");
        } else if (!item.getWdsValueTextReportList().isEmpty()) {
          var wdsText = item.getWdsValueTextReportList().getFirst();
          sb.append("Matched on Text Value type. ")
              .append(underCond)
              .append(wdsText.getWdsCode())
              .append("(WDS value) matching with ")
              .append(wdsText.getInputCode());
        } else if (item.getWdsValueCodedReport() != null) {
          sb.append("Matched on Coded Value type. ")
              .append(underCond)
              .append(item.getWdsValueCodedReport().getWdsCode())
              .append("(WDS value) matching with ")
  ...
  private void setActivityDetailLog(
      ArrayList<EDXActivityDetailLogDto> detailLogs,
      String id,
      EdxRuleAlgorothmManagerDto.STATUS_VAL status,
      String comment) {
  ...
  public void addActivityDetailLogsForWDS(
      EdxLabInformationDto edxLabInformationDto, String detailedMsg) {
    try {
      ArrayList<EDXActivityDetailLogDto> detailList =
          (ArrayList<EDXActivityDetailLogDto>)
              edxLabInformationDto.getEdxActivityLogDto().getEDXActivityLogDTWithVocabDetails();
      ...
      if (edxLabInformationDto.isInvestigationSuccessfullyCreated()) {
        String msg =
            EdxELRConstant.INV_SUCCESS_CREATED.replace(
                "%1", String.valueOf(edxLabInformationDto.getPublicHealthCaseUid()));
        setActivityDetailLog(
            detailList,
            String.valueOf(edxLabInformationDto.getPublicHealthCaseUid()),
            EdxRuleAlgorothmManagerDto.STATUS_VAL.Success,
            msg);
      }
      if (edxLabInformationDto.isLabAssociatedToInv()) {
        String msg =
            EdxELRConstant.LAB_ASSOCIATED_TO_INV.replace(
                "%1", String.valueOf(edxLabInformationDto.getPublicHealthCaseUid()));
        setActivityDetailLog(
            detailList,
            String.valueOf(edxLabInformationDto.getPublicHealthCaseUid()),
      ...
      if (edxLabInformationDto.isNotificationSuccessfullyCreated()) {
        String msg =
            EdxELRConstant.NOT_SUCCESS_CREATED.replace(
                "%1", String.valueOf(edxLabInformationDto.getNotificationUid()));
        setActivityDetailLog(
            detailList,
            String.valueOf(edxLabInformationDto.getNotificationUid()),
            EdxRuleAlgorothmManagerDto.STATUS_VAL.Success,
            msg);
      }
