...
public class DsmLabMatchHelper {
  ...
  private Map<String, String> resultedTestCodeMap =
      new HashMap<String, String>(); // test code/test desc
  // these resulted test lists need to be collections and not maps because a test could repeat
  private List<TestCodedValue> resultedTestCodedValueList =
      new ArrayList<TestCodedValue>(); // coded values
  private List<TestNumericValue> resultedTestNumericValueList =
      new ArrayList<TestNumericValue>(); // numeric values
  private List<TestTextValue> resultedTestTextValueList =
      new ArrayList<TestTextValue>(); // text values
  ...
  /**
   * Constructor - expects algorithm payload (see DSMAlgorithm.xsd) Get the values from the
   * algorithm and populate class variables.
   *
  ...
  public DsmLabMatchHelper(Algorithm algorithmDocument) throws DataProcessingException {
    ...
    if (algorithm.getElrAdvancedCriteria() != null
        && algorithm.getElrAdvancedCriteria().getAndOrLogic() != null)
      andOrLogic = algorithm.getElrAdvancedCriteria().getAndOrLogic();
    else andOrLogic = DecisionSupportConstants.OR_AND_OR_LOGIC; // OR
    if (andOrLogic.equals(DecisionSupportConstants.OR_AND_OR_LOGIC)) this.algorithmIsOrLogic = true;
    else this.algorithmIsAndLogic = true;
    // initialize maps;
    ...
    if (algorithm.getApplyToSendingSystems() != null) {
      ...
      for (int i = 0; i < sendingSystemType.getSendingSystem().size(); i++) {
        ...
        if (receivingSystemOid != null) {
          ...
          else systemOidMap.put(receivingSystemOid, NULL_STRING);
        }
        if (receivingSystemDescTxt != null) {
          if (receivingSystemOid != null)
            systemNameMap.put(receivingSystemDescTxt, receivingSystemOid);
          else systemNameMap.put(receivingSystemDescTxt, NULL_STRING);
        }
      } // for
    }
    ...
    if (algorithm.getElrAdvancedCriteria() != null
        && algorithm.getElrAdvancedCriteria().getElrCriteria() != null) {
      List<ElrCriteriaType> elrCriteriaArray =
          algorithm.getElrAdvancedCriteria().getElrCriteria(); // getElrCriteriaArray().
      for (ElrCriteriaType elrCriteria : elrCriteriaArray) {
        CodedType elrResultTestCriteriaType = elrCriteria.getResultedTest();
        if (elrResultTestCriteriaType != null
            && elrResultTestCriteriaType.getCode() != null
            && elrResultTestCriteriaType.getCode().length() > 0) {
          ...
          if (elrCriteria.getElrCodedResultValue() != null) {
            ...
            if (elrCriteria.getElrTextResultValue().getComparatorCode() != null) {
              if (elrCriteria.getElrTextResultValue().getComparatorCode().getCode() != null)
                thisTextValue.setComparatorCode(
                    elrCriteria.getElrTextResultValue().getComparatorCode().getCode());
              if (elrCriteria.getElrTextResultValue().getComparatorCode().getCodeDescTxt() != null)
                thisTextValue.setComparatorCodeDesc(
                    elrCriteria.getElrTextResultValue().getComparatorCode().getCodeDescTxt());
            }
            ...
            if (elrCriteria.getElrNumericResultValue().getComparatorCode() != null) {
              if (elrCriteria.getElrNumericResultValue().getComparatorCode().getCode() != null)
                thisNumericValue.setComparatorCode(
                    elrCriteria.getElrNumericResultValue().getComparatorCode().getCode());
              if (elrCriteria.getElrNumericResultValue().getComparatorCode().getCodeDescTxt()
                  != null)
                thisNumericValue.setComparatorCodeDesc(
                    elrCriteria.getElrNumericResultValue().getComparatorCode().getCodeDescTxt());
            }
            // value1
            if (elrCriteria.getElrNumericResultValue().getValue1() != null) {
              try {
                BigDecimal algorithmNumericValue1 =
                    new BigDecimal(elrCriteria.getElrNumericResultValue().getValue1());
            ...
            if (elrCriteria.getElrNumericResultValue().getSeperatorCode() != null)
              thisNumericValue.setSeparatorCode(
                  elrCriteria.getElrNumericResultValue().getSeperatorCode());
            // value2
            if (elrCriteria.getElrNumericResultValue().getValue2() != null)
              try {
                BigDecimal algorithmNumericValue2 =
                    new BigDecimal(elrCriteria.getElrNumericResultValue().getValue2());
            ...
            if (elrCriteria.getElrNumericResultValue().getUnit() != null) {
              if (elrCriteria.getElrNumericResultValue().getUnit().getCode() != null)
                thisNumericValue.setUnitCode(
                    elrCriteria.getElrNumericResultValue().getUnit().getCode());
              if (elrCriteria.getElrNumericResultValue().getUnit().getCodeDescTxt() != null)
                thisNumericValue.setUnitCodeDesc(
                    elrCriteria.getElrNumericResultValue().getUnit().getCodeDescTxt());
            }
   ...
   */
  public WdsReport isThisLabAMatch(
    ...
    if (systemOidMap != null && !systemOidMap.isEmpty()) {
      ...
      if (sendingFacilityName != null
          && !sendingFacilityName.isEmpty()
          && systemNameMap.containsKey(sendingFacilityName)) {
        nameMatched = true;
      } else {
        if (sendingFacilityName != null) {
          // logger.debug("Algorithm matches test code and Sending System OID but Sending System
          // Name of " + sendingFacilityName +"  not in list of Specified Sending Systems");
        }
        nameMatched = false;
      }
      if (oidMatched || nameMatched) // GST
      {
        // logger.debug("Algorithm matches either the Sending Facility Name or the Sending Facility
        // Oid");
      } else {
    ...
    try {
      wdsReport =
          testIfAlgorthmMatchesLab(
              resultedTestColl,
              resultedTestCodedValueList,
              resultedTestTextValueList,
              resultedTestNumericValueList);
    } catch (Exception e) {
      logger.error(e.getMessage());
    }
    return wdsReport;
  ...
  private WdsReport testIfAlgorthmMatchesLab(
    ...
    // TEXT VALUE
    var obsTextMatched = checkingObsTextMatched(resultedTestColl, testTextValueList, wdsReport);
    ...
    // NUMERIC
    var obsNumericMatched =
        checkingObsNumericMatched(resultedTestColl, testNumericValueList, wdsReport);
      ...
      for (ObservationContainer o : resultedTestColl) {
        ...
        if (algorithmNumericValue.getTestCode().equalsIgnoreCase(testCode)) {
          if (resultObsVO.getTheObsValueNumericDtoCollection() != null) {
            ...
            for (ObsValueNumericDto obsValueNumericDT :
                resultObsVO.getTheObsValueNumericDtoCollection()) {
              ...
              if (algorithmNumericValue.getUnitCode() != null) {
                ...
                if (labUnits == null) {
                  ...
                  // logger.debug("Algorithm units of " +algorithmNumericValue.getUnitCode() +"does
                  // not match with lab units of "+labUnits);
                  continue; // no units match here
                }
              }
              // if the unlikely case the incoming lab has a comparator that is not equal, can't
              // definitively match >,< >=, <= and <>
              if (obsValueNumericDT.getComparatorCd1() != null
                  && !obsValueNumericDT.getComparatorCd1().equals(NEDSSConstant.EQUAL_LOGIC)) {
                String labComparator = obsValueNumericDT.getComparatorCd1().trim();
                if (labComparator.equals(NEDSSConstant.LESS_THAN_LOGIC)
                    || labComparator.equals(NEDSSConstant.LESS_THAN_OR_EQUAL_LOGIC)
                    || labComparator.equals(NEDSSConstant.GREATER_THAN_LOGIC)
                    || labComparator.equals(NEDSSConstant.GREATER_THAN_OR_EQUAL_LOGIC)
              ...
              if (obsValueNumericDT.getSeparatorCd() != null
                  && !obsValueNumericDT.getSeparatorCd().trim().isEmpty()) {
                ...
                if (!labSeparator.equals(NEDSSConstant.COLON)) {
                  // logger.debug("Lab has numeric result with separator that is not a colon [ "
                  // +labSeparator + "]");
                  continue; // skip this result
                }
                if (obsValueNumericDT.getNumericValue2() == null) {
                  // logger.debug("Lab has numeric result with colon separator but no Numeric
                  // Value2?");
                  continue; // skip this result
                }
                ...
                if (obsValueNumericDT.getNumericValue1() != null) {
                  ...
                  if (obsValueNumericDT.getNumericValue1().compareTo(bdOne) == 0) {
                    ...
                    // logger.debug("Lab looks like titer but numeric value1 is [" +
                    // obsValueNumericDT.getNumericValue1() +"] ");
                    continue; // skip this result
                  }
                }
              }
              ...
              if (algorithmNumericValue.getComparatorCode().equals(NEDSSConstant.EQUAL_LOGIC)) {
                // For BigDecimal must use CompareTo and not Equals (using Equals 5.0 is not equal
                // to 5.00, using CompareTo they are equal)

                numericReport.setCodeType("OBS_NUMERIC_VALUE");
                numericReport.setWdsCode(algorithmNumericValue.getValue1().toString());
                numericReport.setInputCode1(
                    obsValueNumericDT.getNumericValue1() != null
                        ? obsValueNumericDT.getNumericValue1().toString()
                        : "");
                numericReport.setInputCode2(
                ...
                if (!isTiterLab
                    ...
                    && algorithmNumericValue
                            .getValue1()
                            .compareTo(obsValueNumericDT.getNumericValue1())
                        == 0) {
                  ...
                  numericAlgorithmMatched = true;
                    ...
                    && algorithmNumericValue
                            .getValue1()
                            .compareTo(obsValueNumericDT.getNumericValue2())
                        == 0) {
                  numericReport.setMatchedFound(true);
                  numericAlgorithmMatched = true;
                }

              } else if (algorithmNumericValue
                  .getComparatorCode()
                  .equals(NEDSSConstant.GREATER_THAN_LOGIC)) {
                // For BigDecimal must use CompareTo and not Equals (using Equals 5.0 is not equal
                // to 5.00, using CompareTo they are equal)
                numericReport.setCodeType("OBS_NUMERIC_VALUE");
                numericReport.setWdsCode(algorithmNumericValue.getValue1().toString());
                ...
                if (!isTiterLab
                    ...
                    && obsValueNumericDT
                            .getNumericValue1()
                            .compareTo(algorithmNumericValue.getValue1())
                        == 1) {
                  numericReport.setMatchedFound(true);
                  ...
                  .getComparatorCode()
                  .equals(NEDSSConstant.GREATER_THAN_OR_EQUAL_LOGIC)) {
                numericReport.setCodeType("OBS_NUMERIC_VALUE");
                numericReport.setWdsCode(algorithmNumericValue.getValue1().toString());
                numericReport.setInputCode1(
                    obsValueNumericDT.getNumericValue1() != null
                ...
                if (!isTiterLab
                  ...
                  .getComparatorCode()
                  .equals(NEDSSConstant.LESS_THAN_LOGIC)) {
                ...
                if (!isTiterLab
                  ...
                  .getComparatorCode()
                  .equals(NEDSSConstant.LESS_THAN_OR_EQUAL_LOGIC)) {
                ...
                if (!isTiterLab
                  ...
                  .getComparatorCode()
                  .equals(NEDSSConstant.NOT_EQUAL_LOGIC)) {
                numericReport.setCodeType("OBS_NUMERIC_VALUE");
                numericReport.setWdsCode(algorithmNumericValue.getValue1().toString());
                numericReport.setInputCode1(
                    obsValueNumericDT.getNumericValue1() != null
                ...
                if (!isTiterLab
                  ...
                  .getComparatorCode()
                  .equals(NEDSSConstant.BETWEEN_LOGIC)) {
                numericReport.setCodeType("OBS_NUMERIC_VALUE");
                numericReport.setWdsCode(algorithmNumericValue.getValue1().toString());
                numericReport.setInputCode1(
                    obsValueNumericDT.getNumericValue1() != null
                ...
                if (obsValueNumericDT.getNumericValue1() != null
                    && (obsValueNumericDT
                        ...
                        || obsValueNumericDT
                            ...
                            == 1)) {
                  if (obsValueNumericDT.getNumericValue1() != null
                      && algorithmNumericValue.getValue2() != null
                      && (obsValueNumericDT
                                  .getNumericValue1()
                                  .compareTo(algorithmNumericValue.getValue2())
                              == 0
                          || obsValueNumericDT
                                  .getNumericValue1()
                                  .compareTo(algorithmNumericValue.getValue2())
          ...
          if (!numericAlgorithmMatched) {
            // logger.debug("-------Algorithm Numeric Value did NOT match and lab Obs Value
            // Numeric-----------");
          }
        } // code matched
      } // end resulted tests
            ...
            for (ObsValueTxtDto obsValueTxtDT : resultObsVO.getTheObsValueTxtDtoCollection()) {
              ...
              if (obsValueTxtDT.getTxtTypeCd() == null
                  ...
                  || obsValueTxtDT
                      .getTxtTypeCd()
                      .equalsIgnoreCase(
                          "O")) { // NBSCentral #11984: to avoid comparing with the notes
                ...
                if (algorithmTextValue.getComparatorCode().equals(NEDSSConstant.EQUAL_LOGIC)) {
                  if (obsValueTxtDT.getValueTxt() != null
                      && obsValueTxtDT.getValueTxt().equals(algorithmTextValue.getTextValue())) {
                    textAlgorithmMatched = true;
                  }
                } else if (algorithmTextValue
                    .getComparatorCode()
                    .equals(NEDSSConstant.CONTAINS_LOGIC)) {
                  if (obsValueTxtDT.getValueTxt() != null
                      && obsValueTxtDT.getValueTxt().contains(algorithmTextValue.getTextValue())) {
                    textAlgorithmMatched = true;
                  }
                } else if (algorithmTextValue
                    .getComparatorCode()
                    .equals(NEDSSConstant.STARTS_WITH_LOGIC)) {
                  if (obsValueTxtDT.getValueTxt() != null
                      && obsValueTxtDT
                          .getValueTxt()
                          .startsWith(algorithmTextValue.getTextValue())) {
                    textAlgorithmMatched = true;
                  }
                } else if (algorithmTextValue
                    .getComparatorCode()
                    .equals(NEDSSConstant.NOT_EQUAL_LOGIC)) {
                  if (obsValueTxtDT.getValueTxt() != null
                      && obsValueTxtDT.getValueTxt().compareTo(algorithmTextValue.getTextValue())
                          != 0) {
                    textAlgorithmMatched = true;
                  }
                } else if (algorithmTextValue
                    .getComparatorCode()
                    .equals(NEDSSConstant.NOTNULL_LOGIC)) {
                  if (obsValueTxtDT.getValueTxt() != null
                      && (!obsValueTxtDT.getValueTxt().isEmpty())) {
                    textAlgorithmMatched = true;
                  }
                } else {
      ...
      for (ObservationContainer o : resultedTestColl) {
        ...
        if (algorithmCodedValue.getTestCode().equalsIgnoreCase(testCode)) {
          if (resultObsVO.getTheObsValueCodedDtoCollection() != null) {
            for (ObsValueCodedDto obsValueCodedDT :
                resultObsVO.getTheObsValueCodedDtoCollection()) {
              // Test code match?
              if (obsValueCodedDT.getCode() != null
                  && algorithmCodedValue
                      .getResultCode()
                      .equalsIgnoreCase(obsValueCodedDT.getCode())) {
                textAlgorithmMatched = true;
                if (algorithmIsOrLogic) {
  ...
  /**
   * Note negative logic - testsDoNotMatch Quickly rule out labs that don't have the tests the
   * algorithm seeks. If it is an OR, one must be there. If an AND, all must be there.
   *
   ...
   */
  private boolean testsDoNotMatch(
      Collection<String> resultedTestCodeColl,
      Map<String, String> resultedTestCodeMap2,
      String andOrLogic2) {
