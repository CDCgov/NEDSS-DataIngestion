...
public class ObservationSummaryService implements IObservationSummaryService {
  ...
  public ObservationSummaryService(
  ...
  public Collection<UidSummaryContainer> findAllActiveLabReportUidListForManage(
      Long investigationUid, String whereClause) {

    Collection<UidSummaryContainer> uidSummaryVOCollection = new ArrayList<>();
    var obsSums =
        observationSummaryRepository.findAllActiveLabReportUidListForManage(
            investigationUid, whereClause);
  ...
  public ProviderDataForPrintContainer getOrderingFacilityAddress(
    ...
    providerDataForPrintVO =
        customRepository.getOrderingFacilityAddress(providerDataForPrintVO, organizationUid);
  ...
  public ProviderDataForPrintContainer getOrderingFacilityPhone(
      ProviderDataForPrintContainer providerDataForPrintVO, Long organizationUid) {
    providerDataForPrintVO =
        customRepository.getOrderingFacilityPhone(providerDataForPrintVO, organizationUid);
    return providerDataForPrintVO;
  }
  ...
  public ProviderDataForPrintContainer getOrderingPersonAddress(
      ProviderDataForPrintContainer providerDataForPrintVO, Long organizationUid) {
    providerDataForPrintVO =
        customRepository.getOrderingPersonAddress(providerDataForPrintVO, organizationUid);
    return providerDataForPrintVO;
  }
  ...
  public ProviderDataForPrintContainer getOrderingPersonPhone(
      ProviderDataForPrintContainer providerDataForPrintVO, Long organizationUid) {
    providerDataForPrintVO =
        customRepository.getOrderingPersonPhone(providerDataForPrintVO, organizationUid);
    return providerDataForPrintVO;
  }

  public Long getProviderInformation(
      ArrayList<Object> providerDetails, LabReportSummaryContainer labRep) {
  ...
  public void getTestAndSusceptibilities(
      String typeCode,
      Long observationUid,
    ...
    testList =
        customRepository.getTestAndSusceptibilities(
            typeCode, observationUid, labRepEvent, labRepSumm);
    if (testList != null) {

      if (labRepEvent != null) labRepEvent.setTheResultedTestSummaryVOCollection(testList);
      if (labRepSumm != null) labRepSumm.setTheResultedTestSummaryVOCollection(testList);
  ...
  private void setSusceptibility(
    ...
    susList =
        customRepository.getSusceptibilityUidSummary(
            rvo, labRepEvent, labRepSumm, "REFR", sourceActUid);
