...
public class PublicHealthCaseService implements IPublicHealthCaseService {
  ...
  public PublicHealthCaseService(
      EntityHelper entityHelper, PublicHealthCaseRepositoryUtil publicHealthCaseRepositoryUtil) {

    this.entityHelper = entityHelper;
    this.publicHealthCaseRepositoryUtil = publicHealthCaseRepositoryUtil;
  }

  public Long setPublicHealthCase(PublicHealthCaseContainer publicHealthCaseContainer)
    ...
    Collection<ActivityLocatorParticipationDto> alpDTCol =
        publicHealthCaseContainer.getTheActivityLocatorParticipationDTCollection();
    Collection<ActRelationshipDto> arDTCol =
        publicHealthCaseContainer.getTheActRelationshipDTCollection();
    Collection<ParticipationDto> pDTCol =
        publicHealthCaseContainer.getTheParticipationDTCollection();
