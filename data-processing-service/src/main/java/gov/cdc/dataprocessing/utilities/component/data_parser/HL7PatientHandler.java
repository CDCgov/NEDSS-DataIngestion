...
public class HL7PatientHandler {
  ...
  /**
   * This method porcess and parse HL7 Patient Result into Object - Patient Identification - Patient
   * Next of Kin
   */
  ...
  public LabResultProxyContainer getPatient(
    ...
    PersonContainer personContainer =
        parseToPersonObject(labResultProxyContainer, edxLabInformationDto);
    ...
    for (int i = 0; i < hl7PIDType.getPatientIdentifierList().size(); i++) {
      ...
      if (entityIdDto.getTypeCd() != null
          && entityIdDto.getTypeCd().equals(EdxELRConstant.ELR_SS_TYPE)) {
    ...
    if (hl7PIDType.getDateTimeOfBirth() != null) {
      Timestamp timestamp =
          nbsObjectConverter.processHL7TSTypeForDOBWithoutTime(hl7PIDType.getDateTimeOfBirth());
    ...
    for (HL7CWEType ethnicType : ethnicArray) {
      PersonEthnicGroupDto personEthnicGroupDto =
          nbsObjectConverter.ethnicGroupType(ethnicType, personContainer);
      ElrXref elrXrefForEthnic;
      String keyEthnic =
          "ELR_LCA_ETHN_GRP_" + personEthnicGroupDto.getEthnicGroupCd() + "_P_ETHN_GRP";
      ElrXref resultEthnic =
          (ElrXref) cacheApiService.getSrteCacheObject(ObjectName.ELR_XREF.name(), keyEthnic);
      ...
      if (personEthnicGroupDto.getEthnicGroupCd() != null
        ...
        if (checkingValueService.checkCodedValue(
            "P_ETHN_GRP", personEthnicGroupDto.getEthnicGroupCd())) {
      ...
      if (personEthnicGroupDto.getEthnicGroupCd() != null
        ...
        personContainer
            .getThePersonDto()
            .setEthnicGroupInd(personEthnicGroupDto.getEthnicGroupCd());
      } else {
    ...
    if (maritalStatusType != null && maritalStatusType.getHL7Identifier() != null) {
      personContainer
          .getThePersonDto()
          .setMaritalStatusCd(maritalStatusType.getHL7Identifier().toUpperCase());
    ...
    if (hl7PIDType.getMothersIdentifier() != null) {
      for (int i = 0; i < hl7PIDType.getMothersIdentifier().size(); i++) {
        ...
        EntityIdDto entityIdDto =
            nbsObjectConverter.processEntityData(
                hl7CXType, personContainer, EdxELRConstant.ELR_MOTHER_IDENTIFIER, j);
        if (entityIdDto.getEntityUid() != null) {
          personContainer.getTheEntityIdDtoCollection().add(entityIdDto);
        }
      }
    ...
    if (hl7PIDType.getMothersMaidenName() != null
        && (!hl7PIDType.getMothersMaidenName().isEmpty())) {
      String surname = "";
    ...
    if (hl7PIDType.getBirthOrder() != null && hl7PIDType.getBirthOrder().getHL7Numeric() != null) {
      personContainer
          .getThePersonDto()
          .setBirthOrderNbr(hl7PIDType.getBirthOrder().getHL7Numeric().intValue());
    }
    ...
    if (hl7PIDType.getPatientAccountNumber() != null) {
      ...
      EntityIdDto entityIdDto =
          nbsObjectConverter.processEntityData(
              hl7PIDType.getPatientAccountNumber(),
              personContainer,
              EdxELRConstant.ELR_ACCOUNT_IDENTIFIER,
              j);
      if (entityIdDto.getEntityUid() != null) {
        personContainer.getTheEntityIdDtoCollection().add(entityIdDto);
      }
    ...
    if (!addressArray.isEmpty()) {
      ...
      nbsObjectConverter.personAddressType(
          addressType, EdxELRConstant.ELR_PATIENT_CD, personContainer);
    }
      ...
      personContainer
          ...
          .setDeceasedTime(
              nbsObjectConverter.processHL7TSType(
                  hl7PIDType.getPatientDeathDateAndTime(),
                  EdxELRConstant.DATE_VALIDATION_PATIENT_DEATH_DATE_AND_TIME_MSG));
    }
      ...
      if (phoneBusinessArray != null && !phoneBusinessArray.isEmpty()) {
        ...
        EntityLocatorParticipationDto elpDT =
            nbsObjectConverter.personTelePhoneType(
                phoneType, EdxELRConstant.ELR_PATIENT_CD, personContainer);
    ...
    if (hl7PIDType.getRace() != null) {
      ...
      for (HL7CWEType hl7CWEType : raceArray) {
        try {
          ...
          ElrXref resultRace =
              (ElrXref) cacheApiService.getSrteCacheObject(ObjectName.ELR_XREF.name(), keyRace);
          if (resultRace == null) {
   ...
   * Person Object - Role Object (part of Lab Result, this is a list)
   */
  @SuppressWarnings("java:S3776")
  public PersonContainer parseToPersonObject(
      LabResultProxyContainer labResultProxyContainer, EdxLabInformationDto edxLabInformationDto)
      throws DataProcessingException {
    ...
    try {
      ...
      personContainer
          .getThePersonDto()
          .setStatusTime(personContainer.getThePersonDto().getLastChgTime());
      ...
      if (edxLabInformationDto.getRole().equalsIgnoreCase(NEDSSConstant.PAT)) {
        ...
        addRole = true;
          ...
          .getRole()
          .equalsIgnoreCase(EdxELRConstant.ELR_SPECIMEN_PROCURER_CD)) {
  ...
  public LabResultProxyContainer getNextOfKinVO(
      HL7NK1Type hl7NK1Type,
      LabResultProxyContainer labResultProxyContainer,
      EdxLabInformationDto edxLabInformationDto)
      throws DataProcessingException {
    try {
      ...
      if (hl7NK1Type.getRelationship() != null) {
        ...
        String desc =
            checkingValueService.getCodeDescTxtForCd(
                edxLabInformationDto.getRelationship(), EdxELRConstant.ELR_NEXT_OF_KIN_RL_CLASS);
        if (desc != null
            && !desc.trim().isEmpty()
            && hl7NK1Type.getRelationship().getHL7Text() == null) {
      ...
      if (!addressArray.isEmpty()) {
        HL7XADType addressType = addressArray.getFirst();
        nbsObjectConverter.personAddressType(
            addressType, EdxELRConstant.ELR_NEXT_OF_KIN, personContainer);
      }
      ...
      if (!phoneHomeArray.isEmpty()) {
        ...
        EntityLocatorParticipationDto elpDT =
            nbsObjectConverter.personTelePhoneType(
                phoneType, EdxELRConstant.ELR_NEXT_OF_KIN, personContainer);
        addressCollection.add(elpDT);
      }
      labResultProxyContainer.getThePersonContainerCollection().add(personContainer);
    } catch (Exception e) {
