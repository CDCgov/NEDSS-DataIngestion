...
public class NbsDocumentRepositoryUtil {
  ...
  public NbsDocumentRepositoryUtil(
  ...
  public NbsDocumentContainer getNBSDocumentWithoutActRelationship(Long nbsDocUid)
  ...
  public Long updateDocumentWithOutthePatient(NbsDocumentContainer nbsDocVO)
      throws DataProcessingException {
    Long nbsDocUid = null;

    NbsDocumentContainer nbSOldDocumentVO =
        customRepository.getNbsDocument(nbsDocVO.getNbsDocumentDT().getNbsDocumentUid());
    ...
    if (nbSOldDocumentVO != null) {
      ...
      if (nbsDocumentDT.getRecordStatusCd() != null
          && nbsDocumentDT.getRecordStatusCd().equals(NEDSSConstant.RECORD_STATUS_LOGICAL_DELETE)) {
