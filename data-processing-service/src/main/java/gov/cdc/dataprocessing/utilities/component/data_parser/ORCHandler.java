...
public class ORCHandler {
  ...
  public void getORCProcessing(
      HL7ORCType hl7ORCType,
      ...
      if (hl7ORCType.getOrderEffectiveDateTime() != null) {
        edxLabInformationDto.setOrderEffectiveDate(
            nbsObjectConverter.processHL7TSType(
                hl7ORCType.getOrderEffectiveDateTime(),
                EdxELRConstant.DATE_VALIDATION_ORC_ORDER_EFFECTIVE_TIME_MSG));
      }
    } catch (Exception e) {
  ...
  private LabResultProxyContainer getOrderingProvider(
      HL7ORCType hl7ORCType,
      LabResultProxyContainer labResultProxyContainer,
      EdxLabInformationDto edxLabInformationDto)
      throws DataProcessingException {
    try {
      HL7XADType address;
      List<HL7XADType> addressArray = hl7ORCType.getOrderingProviderAddress();
  ...
  private OrganizationContainer getOrderingFacility(
      HL7ORCType hl7ORCType,
      LabResultProxyContainer labResultProxyContainer,
      EdxLabInformationDto edxLabInformationDto)
      throws DataProcessingException {
    ...
    try {
      ...
      if (addressArray != null && !addressArray.isEmpty()) {
        ...
        organizationDto.setStandardIndustryClassCd(
            EdxELRConstant.ELR_RECEIVING_STANDARD_INDUSTRY_CLASS_CD);
        organizationDto.setStandardIndustryDescTxt(
            EdxELRConstant.ELR_RECEIVING_STANDARD_INDUSTRY_CLASS_DESC);
        ...
        if (!phoneArray.isEmpty()) {
          ...
          if (phone != null) {
            EntityLocatorParticipationDto elpdt =
                nbsObjectConverter.orgTelePhoneType(
                    phone, EdxELRConstant.ELR_OP_CD, organizationContainer);
