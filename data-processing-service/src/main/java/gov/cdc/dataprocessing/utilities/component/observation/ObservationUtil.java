...
public class ObservationUtil {
    ...
    if (participationDtoCollection != null) {
      for (ParticipationDto partDT : participationDtoCollection) {
        if (((partDT.getSubjectClassCd() != null
            ...
            && (partDT.getTypeCd() != null && partDT.getTypeCd().equalsIgnoreCase(uidTypeCd))
      ...
      for (ActRelationshipDto actRelDT : actRelationshipDtoCollection) {
        if ((actRelDT.getSourceClassCd() != null
            ...
            && (actRelDT.getTypeCd() != null && actRelDT.getTypeCd().equalsIgnoreCase(uidTypeCd))
  ...
  /**
   * Description: Root OBS are one of these following - Ctrl Code Display Form = LabReport; - Obs
   * Domain Code St 1 = Order; - Ctrl Code Display Form = MorbReport;
   *
   * <p>Original Name: getRootDT
   */
  public ObservationDto getRootObservationDto(BaseContainer proxyVO)
  ...
  /**
   * Description: Root OBS are one of these following - Ctrl Code Display Form = LabReport; - Obs
   * Domain Code St 1 = Order; - Ctrl Code Display Form = MorbReport; Original Name:
   * getRootObservationContainer
   */
  public ObservationContainer getRootObservationContainer(BaseContainer proxy)
      throws DataProcessingException {
    ...
    ObservationContainer rootVO =
        getRootObservationContainerFromObsCollection(obsColl, isLabReport);
   ...
   * Domain Code St 1 = Order; - Ctrl Code Display Form = MorbReport;
   */
  protected ObservationContainer getRootObservationContainerFromObsCollection(
      Collection<ObservationContainer> obsColl, boolean isLabReport) {
    if (obsColl == null) {
      return null;
    }
    ...
    for (iterator = obsColl.iterator(); iterator.hasNext(); ) {
      ...
      if (observationContainer.getTheObservationDto() != null
          && ((observationContainer.getTheObservationDto().getCtrlCdDisplayForm() != null
              ...
              || (observationContainer.getTheObservationDto().getObsDomainCdSt1() != null
                  && observationContainer
                      .getTheObservationDto()
                      .getObsDomainCdSt1()
                      .equalsIgnoreCase(NEDSSConstant.ORDERED_TEST_OBS_DOMAIN_CD)
                  && isLabReport)
              || (observationContainer.getTheObservationDto().getCtrlCdDisplayForm() != null
                  && observationContainer
                      .getTheObservationDto()
