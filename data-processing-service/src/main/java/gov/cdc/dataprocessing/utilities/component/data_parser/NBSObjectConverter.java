...
public class NBSObjectConverter {
  ...
  public NBSObjectConverter(
      EntityIdUtil entityIdUtil, ICatchingValueDpService catchingValueService) {
    this.entityIdUtil = entityIdUtil;
    this.catchingValueService = catchingValueService;
  }

  public PersonContainer mapPersonNameType(HL7XPNType hl7XPNType, PersonContainer personContainer)
    ...
    /** Optional maxOccurs="1 */
    /** length"30 */
    String hl7SecondAndFurtherGivenNamesOrInitialsThereof =
        hl7XPNType.getHL7SecondAndFurtherGivenNamesOrInitialsThereof();
    /** Optional maxOccurs="1 */
    /** length"30 */
    ...
    personNameDto.setNmUseCd(
        Objects.requireNonNullElse(hl7NameTypeCode, EdxELRConstant.ELR_LEGAL_NAME));

    String toCode =
        catchingValueService.findToCode("ELR_LCA_NM_USE", personNameDto.getNmUseCd(), "P_NM_USE");
    ...
    Timestamp timestamp =
        processHL7TSType(
            hl7EffectiveDate, EdxELRConstant.DATE_VALIDATION_PERSON_NAME_FROM_TIME_MSG);
    personNameDto.setFromTime(timestamp);
    HL7TSType hl7ExpirationDate = hl7XPNType.getHL7ExpirationDate();
    /** Optional maxOccurs="1 */
    /** length"26 */
    Timestamp toTimestamp =
        processHL7TSType(hl7ExpirationDate, EdxELRConstant.DATE_VALIDATION_PERSON_NAME_TO_TIME_MSG);
    ...
    if (personNameDto.getNmUseCd() != null
        && personNameDto.getNmUseCd().equals(EdxELRConstant.ELR_LEGAL_NAME)) {
  ...
  public EntityIdDto processEntityData(
      HL7CXType hl7CXType, PersonContainer personContainer, String indicator, int j)
      throws DataProcessingException {
    ...
    if (hl7CXType != null) {
      ...
      if (hl7CXType.getHL7AssigningAuthority() != null) {
        entityIdDto.setAssigningAuthorityCd(
            hl7CXType.getHL7AssigningAuthority().getHL7UniversalID());
        entityIdDto.setAssigningAuthorityDescTxt(
            hl7CXType.getHL7AssigningAuthority().getHL7NamespaceID());
        entityIdDto.setAssigningAuthorityIdType(
            hl7CXType.getHL7AssigningAuthority().getHL7UniversalIDType());
      }
      if (indicator != null && indicator.equals(EdxELRConstant.ELR_PATIENT_ALTERNATE_IND)) {
        ...
        entityIdDto.setTypeDescTxt(EdxELRConstant.ELR_ACCOUNT_DESC);
          ...
          || hl7CXType.getHL7IdentifierTypeCode().trim().isEmpty()) {
        ...
        String typeCode =
            catchingValueService.getCodeDescTxtForCd(
                entityIdDto.getTypeCd(), EdxELRConstant.EI_TYPE);
      ...
      entityIdDto.setEffectiveFromTime(
          entityIdUtil.processHL7DTType(
              hl7CXType.getHL7EffectiveDate(),
              EdxELRConstant.DATE_VALIDATION_PID_PATIENT_IDENTIFIER_EFFECTIVE_DATE_TIME_MSG));
      entityIdDto.setValidFromTime(entityIdDto.getEffectiveFromTime());
      entityIdDto.setEffectiveToTime(
          entityIdUtil.processHL7DTType(
              hl7CXType.getHL7ExpirationDate(),
              EdxELRConstant.DATE_VALIDATION_PID_PATIENT_IDENTIFIER_EXPIRATION_DATE_TIME_MSG));
  ...
  public EntityLocatorParticipationDto personAddressType(
      HL7XADType hl7XADType, String role, PersonContainer personContainer) {
  ...
  public EntityLocatorParticipationDto organizationAddressType(
      HL7XADType hl7XADType, String role, OrganizationContainer organizationContainer) {
    EntityLocatorParticipationDto elp = addressType(hl7XADType, role);
    ...
    elp.getThePostalLocatorDto()
        .setAddUserId(organizationContainer.getTheOrganizationDto().getAddUserId());
  ...
  private EntityLocatorParticipationDto addressType(HL7XADType hl7XADType, String role) {
    ...
    try {
      ...
      if (hl7XADType.getHL7OtherDesignation() != null
          && (pl.getStreetAddr2() == null || pl.getStreetAddr2().trim().equalsIgnoreCase(""))) {
  ...
  public Timestamp processHL7TSTypeForDOBWithoutTime(HL7TSType time)
      throws DataProcessingException {
    ...
    try {
      ...
      if (time != null) {
        ...
        if (year >= 0 && month >= 0 && date >= 0) {
          ...
          toTimestamp =
              entityIdUtil.stringToStrutsTimestamp(toTime); // if can't process returns null
        }
      }
    } catch (Exception e) {
      logger.error(
          "Hl7ToNBSObjectConverter.processHL7TSTypeForDOBWithoutTime failed as the date format is not right. Please check.! {}",
          toTime);
      throw new DataProcessingException(
          "Hl7ToNBSObjectConverter.processHL7TSTypeForDOBWithoutTime failed as the date format is not right."
              + EdxELRConstant.DATE_VALIDATION_PID_PATIENT_BIRTH_DATE_NO_TIME_MSG
              + toTime
              + "<--");
    }
    ...
    if (entityIdUtil.isDateNotOkForDatabase(toTimestamp)) {
      throw new DataProcessingException(
          "Hl7ToNBSObjectConverter.processHL7TSTypeForDOBWithoutTime "
              + EdxELRConstant.DATE_VALIDATION_PID_PATIENT_BIRTH_DATE_NO_TIME_MSG
              + toTime
  ...
  public EntityLocatorParticipationDto setPersonBirthType(
      String countryOfBirth, PersonContainer personContainer) {
    EntityLocatorParticipationDto elp = new EntityLocatorParticipationDto();
  ...
  public PersonEthnicGroupDto ethnicGroupType(
      HL7CWEType hl7CWEType, PersonContainer personContainer) {
  ...
  @SuppressWarnings("java:S3776")
  public Timestamp processHL7TSType(HL7TSType time, String itemDescription)
      throws DataProcessingException {
    String timeStr = "";
    try {
      Timestamp toTimestamp = null;
      ...
      int second = 0;
      if (time != null) {
        if (time.getYear() != null) year = time.getYear().intValue();
        if (time.getMonth() != null) month = time.getMonth().intValue();
        if (time.getHours() != null) hourOfDay = time.getHours().intValue();
        if (time.getDay() != null) day = time.getDay().intValue();
        if (time.getMinutes() != null) minute = time.getMinutes().intValue();
        if (time.getSeconds() != null) second = time.getSeconds().intValue();
        ...
        if (entityIdUtil.isDateNotOkForDatabase(toTimestamp)) {
          throw new DataProcessingException(
              "Hl7ToNBSObjectConverter.processHL7TSType "
                  + itemDescription
                  + timeStr
                  + EdxELRConstant.DATE_INVALID_FOR_DATABASE);
        }
      ...
      logger.error(
          "Hl7ToNBSObjectConverter.processHL7TSType failed as the date format is not right. Please check.! {}",
          timeStr);
      throw new DataProcessingException(
          "Hl7ToNBSObjectConverter.processHL7TSType failed as the date format is not right. "
              + itemDescription
              + timeStr);
    }
  }
  ...
  public EntityLocatorParticipationDto telePhoneType(HL7XTNType hl7XTNType, String role) {
    ...
    if (areaCode != null && areaCode.equalsIgnoreCase("0")) areaCode = "";
  ...
  public boolean checkIfNumberMoreThan10Digits(ArrayList<String> areaAndNumber, HL7NMType hl7Type) {
    ...
    if (hl7Type != null && hl7Type.getHL7Numeric() != null) {
      ...
      // if the phone number contains the area code, it seems to work fine because everything goes
      // to the number and no math.round function is used, so the issue were the wrong number is
      // created does not happen
    }
  ...
  public String formatPhoneNbr(String phoneNbrTxt) {
    ...
    if (phoneNbrTxt != null) {
      ...
      if (nbrSize > 4) { // Add first dash
        newFormatedNbr = "-" + phoneNbrTxt.substring(nbrSize - 4, nbrSize);
        if (nbrSize > 7) { // Add a second dash
          newFormatedNbr =
              phoneNbrTxt.substring(0, nbrSize - 7)
                  + "-"
  ...
  @SuppressWarnings("java:S1319")
  public boolean checkIfAreaCodeMoreThan3Digits(
      ArrayList<String> areaAndNumber, HL7NMType hl7Type) {
  ...
  public ParticipationDto defaultParticipationDT(
      ParticipationDto participationDto, EdxLabInformationDto edxLabInformationDto) {
  ...
  public EntityLocatorParticipationDto orgTelePhoneType(
      HL7XTNType hl7XTNType, String role, OrganizationContainer organizationContainer) {
    EntityLocatorParticipationDto elp = telePhoneType(hl7XTNType, role);
    elp.setAddUserId(organizationContainer.getTheOrganizationDto().getAddUserId());
    elp.setEntityUid(organizationContainer.getTheOrganizationDto().getOrganizationUid());
    elp.setAsOfDate(organizationContainer.getTheOrganizationDto().getLastChgTime());
    ...
    elp.getTheTeleLocatorDto()
        .setAddUserId(organizationContainer.getTheOrganizationDto().getAddUserId());
    return elp;
  }

  public PersonContainer processCNNPersonName(
      HL7CNNType hl7CNNType, PersonContainer personContainer) {
    PersonNameDto personNameDto = new PersonNameDto();
  ...
  public PersonContainer personDtToPersonVO(
      PersonNameDto personNameDto, PersonContainer personContainer) {
    personContainer.getThePersonDto().setLastNm(personNameDto.getLastNm());
    personContainer.getThePersonDto().setFirstNm(personNameDto.getFirstNm());
    personContainer.getThePersonDto().setNmPrefix(personNameDto.getNmPrefix());
    personContainer.getThePersonDto().setNmSuffix(personNameDto.getNmSuffix());
  ...
  @SuppressWarnings("java:S3776")
  public Timestamp processHL7TSTypeWithMillis(HL7TSType time, String itemDescription)
      throws DataProcessingException {
    String dateStr = "";
    try {
      Timestamp toTimestamp = null;
      ...
      if (time != null) {
        ...
        if (time.getMinutes() != null) minute = time.getMinutes().intValue();
        if (time.getSeconds() != null) second = time.getSeconds().intValue();
        if (time.getMillis() != null) millis = time.getMillis().intValue();

        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
        java.util.Date date2;
        dateStr =
            year + "-" + month + "-" + day + " " + hourOfDay + ":" + minute + ":" + second + "."
                + millis;
        ...
        if (entityIdUtil.isDateNotOkForDatabase(toTimestamp)) {
          throw new DataProcessingException(
              "Hl7ToNBSObjectConverter.processHL7TSTypeWithMillis "
                  + itemDescription
                  + date2
                  + EdxELRConstant.DATE_INVALID_FOR_DATABASE);
        }
      ...
      logger.error(
          "Hl7ToNBSObjectConverter.processHL7TSTypeWithMillis failed as the date format is not right. Please check.! {}",
          dateStr);
      throw new DataProcessingException(
          "Hl7ToNBSObjectConverter.processHL7TSTypeWithMillis failed as the date format is not right."
              + itemDescription
              + dateStr);
    }
  }
