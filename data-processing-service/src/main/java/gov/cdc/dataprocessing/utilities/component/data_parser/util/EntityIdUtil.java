...
public class EntityIdUtil {
  ...
  public EntityIdDto processEntityData(
      HL7CXType hl7CXType, PersonContainer personContainer, String indicator, int index)
  ...
  public Timestamp processHL7DTType(HL7DTType time, String itemDescription)
      throws DataProcessingException {
    ...
    if (time != null) {
      ...
      if (time.getDay() != null) date = time.getDay().intValue();
      ...
      if (toTimestamp == null) {
        throw new DataProcessingException(
            "Hl7ToNBSObjectConverter.processHL7DTType: Timestamp value is Null");
      }
      if (isDateNotOkForDatabase(toTimestamp)) {
        throw new DataProcessingException(
            "Hl7ToNBSObjectConverter.processHL7DTType "
                + itemDescription
                + toTime
