...
public class ParticipationRepositoryUtil {
  ...
  public ParticipationRepositoryUtil(ParticipationJdbcRepository participationJdbcRepository) {
  ...
  public void storeParticipation(ParticipationDto dt) throws DataProcessingException {
    ...
    if (dt.isItNew()) {
      ...
      participationJdbcRepository.deleteParticipation(
          data.getSubjectEntityUid(), data.getActUid(), data.getTypeCode());
