...
public class HL7SpecimenUtil {
    ...
    try {
      ...
      if (hl7SPECIMENTypeArray != null && !hl7SPECIMENTypeArray.isEmpty()) {
        ...
        if (hl7SPECIMENType != null && hl7SPECIMENType.getSPECIMEN() != null) {
          ...
          if (hl7SPMType.getSpecimenCollectionAmount() != null
              && hl7SPMType.getSpecimenCollectionAmount().getHL7Quantity() != null) {
            materialDto.setQty(
                String.valueOf(
                    hl7SPMType.getSpecimenCollectionAmount().getHL7Quantity().getHL7Numeric()));
            if (hl7SPMType.getSpecimenCollectionAmount().getHL7Units() != null)
              materialDto.setQtyUnitCd(
                  hl7SPMType.getSpecimenCollectionAmount().getHL7Units().getHL7Identifier());
          }
          ...
          if (hl7SPMType.getSpecimenCollectionDateTime() != null) {
            observationDto.setEffectiveFromTime(
                nbsObjectConverter.processHL7TSTypeWithMillis(
                    hl7SPMType.getSpecimenCollectionDateTime().getHL7RangeStartDateTime(),
                    EdxELRConstant.DATE_VALIDATION_SPM_SPECIMEN_COLLECTION_DATE_MSG));
          }
          processMaterialVO(
              labResultProxyContainer, collectorVO, materialContainer, edxLabInformationDto);
          ...
          if (hl7SPMType.getSpecimenID() != null
            ...
            String specimenID =
                hl7SPMType
                    ...
                    .getHL7FillerAssignedIdentifier()
                    .getHL7EntityIdentifier();
            ArrayList<EntityIdDto> entityIdArrList =
                new ArrayList<>(materialContainer.getTheEntityIdDtoCollection());
            entityIdArrList.getFirst().setRootExtensionTxt(specimenID);
            if (hl7SPMType.getSpecimenID().getHL7FillerAssignedIdentifier().getHL7UniversalID()
                != null) {
              entityIdArrList
                  .getFirst()
                  .setAssigningAuthorityCd(
                      hl7SPMType
                          .getSpecimenID()
                          .getHL7FillerAssignedIdentifier()
                          .getHL7UniversalID());
            }
            if (hl7SPMType.getSpecimenID().getHL7FillerAssignedIdentifier().getHL7NamespaceID()
                != null) {
              entityIdArrList
                  .getFirst()
                  .setAssigningAuthorityDescTxt(
                      hl7SPMType
                          .getSpecimenID()
                          .getHL7FillerAssignedIdentifier()
                          .getHL7NamespaceID());
            }
            if (hl7SPMType.getSpecimenID().getHL7FillerAssignedIdentifier().getHL7UniversalIDType()
                != null) {
              entityIdArrList
                  .getFirst()
                  .setAssigningAuthorityIdType(
                      hl7SPMType
                          .getSpecimenID()
                          .getHL7FillerAssignedIdentifier()
                          .getHL7UniversalIDType());
            }
  ...
  private void processMaterialVO(
      LabResultProxyContainer labResultProxyContainer,
      PersonContainer collectorVO,
