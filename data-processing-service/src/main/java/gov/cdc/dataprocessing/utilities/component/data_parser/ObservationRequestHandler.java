...
public class ObservationRequestHandler {
  ...
  public ObservationRequestHandler(
  ...
  /** Description: This method parsing OBR and SPM into Lab result Object. OBR & SPM. */
  @SuppressWarnings({"java:S6541", "java:S3776"})
  public LabResultProxyContainer getObservationRequest(
      HL7OBRType hl7OBRType,
    ...
    try {
      ...
      if (hl7OBRType.getResultStatus() != null) {
        String toCode =
            checkingValueService.findToCode(
                "ELR_LCA_STATUS", hl7OBRType.getResultStatus(), "ACT_OBJ_ST");
      ...
      if (hl7OBRType.getSetIDOBR() != null
          && hl7OBRType.getSetIDOBR().getHL7SequenceID() != null
      ...
      } else if (hl7OBRType.getSetIDOBR() != null
          && !hl7OBRType.getSetIDOBR().getHL7SequenceID().equalsIgnoreCase("1")) {
      ...
      Collection<OrganizationContainer> orgCollection =
      ...
      for (OrganizationContainer organizationContainer : orgCollection) {
        ...
        Collection<EntityIdDto> entityCollection =
            sendingOrgVO != null ? sendingOrgVO.getTheEntityIdDtoCollection() : new ArrayList<>();
      ...
      actIdDto.setAssigningAuthorityCd(
          sendingFacilityId != null ? sendingFacilityId.getAssigningAuthorityCd() : "");
      actIdDto.setAssigningAuthorityDescTxt(
          sendingFacilityId != null ? sendingFacilityId.getAssigningAuthorityDescTxt() : "");
      ...
      act2IdDT.setAssigningAuthorityCd(
          sendingFacilityId != null ? sendingFacilityId.getAssigningAuthorityCd() : "");
      act2IdDT.setAssigningAuthorityDescTxt(
          sendingFacilityId != null ? sendingFacilityId.getAssigningAuthorityDescTxt() : "");
      ...
      if (hl7OBRType.getUniversalServiceIdentifier() == null) {
        ...
        if (hl7OBRType.getUniversalServiceIdentifier() != null
            ...
            && hl7OBRType
                ...
                .getHL7NameofCodingSystem()
                .equals(EdxELRConstant.ELR_LOINC_CD)) {
        ...
        if (observationDto.getCd() != null) {
          observationDto.setAltCd(
              hl7OBRType.getUniversalServiceIdentifier().getHL7AlternateIdentifier());
        } else {
          observationDto.setCd(
              hl7OBRType.getUniversalServiceIdentifier().getHL7AlternateIdentifier());
        }

        if (observationDto.getCdDescTxt() != null) {
          observationDto.setAltCdDescTxt(
              hl7OBRType.getUniversalServiceIdentifier().getHL7AlternateText());
        } else {
          observationDto.setCdDescTxt(
              hl7OBRType.getUniversalServiceIdentifier().getHL7AlternateText());
        }
        ...
        } else if ((observationDto.getCd() != null || observationDto.getCdDescTxt() != null)
            && observationDto.getCdSystemCd() == null) {
          observationDto.setCdSystemCd(EdxELRConstant.ELR_LOCAL_CD);
          observationDto.setCdSystemDescTxt(EdxELRConstant.ELR_LOCAL_DESC);
        }
        if ((observationDto.getCd() == null || observationDto.getCd().trim().equalsIgnoreCase(""))
            && (observationDto.getAltCd() == null
          ...
          String xmlElementName =
              commonLabUtil.getXMLElementNameForOBR(hl7OBRType) + ".UniversalServiceIdentifier";
          throw new DataProcessingException(
              EdxELRConstant.NO_ORDTEST_NAME + " XMLElementName: " + xmlElementName);
        }
      }
      ...
      observationDto.setActivityToTime(
          nbsObjectConverter.processHL7TSType(
              hl7OBRType.getResultsRptStatusChngDateTime(),
              EdxELRConstant.DATE_VALIDATION_OBR_RESULTS_RPT_STATUS_CHNG_TO_TIME_MSG));
      observationDto.setEffectiveFromTime(
          nbsObjectConverter.processHL7TSType(
              hl7OBRType.getObservationDateTime(),
              EdxELRConstant.DATE_VALIDATION_OBR_OBSERVATION_DATE_MSG));
      observationDto.setEffectiveToTime(
          nbsObjectConverter.processHL7TSType(
              hl7OBRType.getObservationEndDateTime(),
              EdxELRConstant.DATE_VALIDATION_OBR_OBSERVATION_END_DATE_MSG));
      ...
      for (HL7CWEType hl7CWEType : reasonArray) {
        ...
        if ((hl7CWEType.getHL7Identifier() == null
                || hl7CWEType.getHL7Identifier().trim().equalsIgnoreCase(""))
            && (hl7CWEType.getHL7AlternateIdentifier() == null
                || hl7CWEType.getHL7AlternateIdentifier().trim().equalsIgnoreCase(""))) {
          edxLabInformationDto.setReasonforStudyCdMissing(true);
          edxLabInformationDto.setErrorText(EdxELRConstant.ELR_MASTER_LOG_ID_19);
          String xmlElementName =
              commonLabUtil.getXMLElementNameForOBR(hl7OBRType) + ".ReasonforStudy";
          throw new DataProcessingException(
              EdxELRConstant.NO_REASON_FOR_STUDY + " XMLElementName: " + xmlElementName);
        }
      ...
      if (hl7OBRType.getResultCopiesTo() != null) {
        for (int i = 0; i < hl7OBRType.getResultCopiesTo().size(); i++) {
          ...
          PersonContainer personContainer =
              getProviderVO(providerType, null, labResultProxyContainer, edxLabInformationDto);
  ...
  @SuppressWarnings({"java:S6541", "java:S3776", "java:S2692"})
  private void processSusOBR(
      HL7OBRType hl7OBRType,
    ...
    try {
      ...
      if (hl7OBRType.getParentResult() == null
          ...
          || (hl7OBRType.getParentResult().getParentObservationIdentifier().getHL7Identifier()
                  == null
              && hl7OBRType
                      .getParentResult()
                      .getParentObservationIdentifier()
                      .getHL7AlternateIdentifier()
                  == null)) {
      ...
      if (edxLabInformationDto.getEdxLabIdentiferDTColl() != null) {
        for (EdxLabIdentiferDto labIdentiferDT : edxLabInformationDto.getEdxLabIdentiferDTColl()) {
          ...
          if (edxLabIdentiferDT.getIdentifer() != null
              ...
              && edxLabIdentiferDT
                  .getSubMapID()
                  .equals(hl7OBRType.getParentResult().getParentObservationSubidentifier())
          ...
          if (edxLabInformationDto.getFillerNumber() != null
              ...
              && edxLabInformationDto
                  ...
                  .equals(
                      hl7OBRType
                          .getParent()
                          .getHL7FillerAssignedIdentifier()
      ...
      if (edxLabInformationDto.getEdxSusLabDTMap() == null
          || edxLabInformationDto.getEdxSusLabDTMap().get(parentObservation) != null) {
        ...
        edxLabInformationDto
            .getEdxSusLabDTMap()
            .put(parentObservation, obsVO.getTheObservationDto().getObservationUid());
      }
  ...
  /** Processing PROVIDER info other obs info */
  @SuppressWarnings({"java:S6541", "java:S3776"})
  private void processRootOBR(
      HL7OBRType hl7OBRType,
      ObservationDto observationDto,
      LabResultProxyContainer labResultProxyContainer,
      HL7PatientResultSPMType hl7PatientResultSPMType,
    ...
    try {
      ...
      if (hl7PatientResultSPMType != null) {
        logger.debug(
            "ObservationRequest.getObservationRequest specimen is being processes for 2.5.1 message type");
        hl7SpecimenUtil.process251Specimen(
            hl7PatientResultSPMType,
            labResultProxyContainer,
            observationDto,
            collectorVO,
      ...
      if (orderingProviderArray != null && !orderingProviderArray.isEmpty()) {
        ...
        orderingProviderVO =
            getProviderVO(
                orderingProvider, entitylocatorColl, labResultProxyContainer, edxLabInformationDto);
        edxLabInformationDto.setOrderingProvider(true);

        if (hl7OBRType.getOrderCallbackPhoneNumber() != null
            && orderingProviderVO != null
            && !hl7OBRType.getOrderCallbackPhoneNumber().isEmpty()) {
          HL7XTNType orderingProvPhone = hl7OBRType.getOrderCallbackPhoneNumber().getFirst();
          EntityLocatorParticipationDto elpt =
              nbsObjectConverter.personTelePhoneType(
                  orderingProvPhone, EdxELRConstant.ELR_PROVIDER_CD, orderingProviderVO);
      ...
      if (edxLabInformationDto.isMissingOrderingProvider()
          && edxLabInformationDto.isMissingOrderingFacility()) {
        edxLabInformationDto.setMissingOrderingProviderandFacility(true);
        edxLabInformationDto.setErrorText(EdxELRConstant.ELR_MASTER_LOG_ID_13);
        throw new DataProcessingException(
            "HL7ORCProcessorget.getORCProcessing: Both Ordering Provider and Ordering facility are null. Please check!!!");
      }
      ...
      if (hl7OBRType.getAssistantResultInterpreter() != null) {
        for (int i = 0; i < hl7OBRType.getAssistantResultInterpreter().size(); i++) {
          ...
          getOtherProviderVO(
              assPrincResultInterpretor, labResultProxyContainer, edxLabInformationDto);
        }
      }
  ...
  private PersonContainer getCollectorVO(
      HL7XCNType collector,
      LabResultProxyContainer labResultProxyContainer,
      EdxLabInformationDto edxLabInformationDto)
      throws DataProcessingException {
    PersonContainer personContainer;
    try {
      ...
      personContainer =
          hl7PatientHandler.parseToPersonObject(labResultProxyContainer, edxLabInformationDto);

      personContainer.getTheEntityIdDtoCollection().add(entityIdDto);

      PersonNameDto personNameDto = new PersonNameDto();
      if (collector.getHL7FamilyName() != null
          && collector.getHL7FamilyName().getHL7Surname() != null) {
  ...
  private PersonContainer getOtherProviderVO(
      HL7NDLType providerType,
      LabResultProxyContainer labResultProxyContainer,
      EdxLabInformationDto edxLabInformationDto)
      throws DataProcessingException {
  ...
  private PersonContainer getProviderVO(
      HL7XCNType orderingProvider,
      Collection<EntityLocatorParticipationDto> entitylocatorColl,
      LabResultProxyContainer labResultProxyContainer,
      EdxLabInformationDto edxLabInformationDto)
      throws DataProcessingException {
    PersonContainer personContainer;
    ...
    try {
      ...
      PersonNameDto personNameDto = new PersonNameDto();
      if (orderingProvider.getHL7FamilyName() != null
          && orderingProvider.getHL7FamilyName().getHL7Surname() != null) {
      ...
      personNameDto.setMiddleNm(
          orderingProvider.getHL7SecondAndFurtherGivenNamesOrInitialsThereof());
