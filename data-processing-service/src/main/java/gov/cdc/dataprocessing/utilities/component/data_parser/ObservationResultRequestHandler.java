...
@Component
/**
 * Do not Attempt to refactor this Class Unless you know what need to be done Tightly coupling with
 * Data Parser - small error can mess up the entire Pipeline
 */
public class ObservationResultRequestHandler {
  private static final Logger logger =
      LoggerFactory.getLogger(ObservationResultRequestHandler.class);
  ...
  public LabResultProxyContainer getObservationResultRequest(
      List<HL7OBSERVATIONType> observationRequestArray,
      ...
      for (HL7OBSERVATIONType hl7OBSERVATIONType : observationRequestArray) {
        ObservationContainer observationContainer =
            getObservationResult(
                hl7OBSERVATIONType.getObservationResult(),
  ...
  private ObservationContainer getObservationResult(
    ...
    try {
      ...
      if (!edxLabInformationDto.isParentObsInd()
          && (hl7OBXType.getObservationIdentifier() == null
              || (hl7OBXType.getObservationIdentifier().getHL7Identifier() == null
                  && hl7OBXType.getObservationIdentifier().getHL7AlternateIdentifier() == null))) {
        ...
        String xmlElementName =
            commonLabUtil.getXMLElementNameForOBX(hl7OBXType) + ".ObservationIdentifier";
        throw new DataProcessingException(
            EdxELRConstant.NO_RESULT_NAME + " XMLElementName: " + xmlElementName);
      }
      ...
      if (hl7OBXType.getObservationIdentifier().getHL7Identifier() != null) {
        ...
        edxLabIdentiferDT.setIdentifer(
            hl7OBXType.getObservationIdentifier().getHL7AlternateIdentifier());
      }
      ...
      edxLabInformationDto
          .getEdxSusLabDTMap()
          .put(edxLabIdentiferDT.getObservationUid(), edxLabIdentiferDT);
      ...
      actRelationshipDto.setSourceActUid(
      ...
      if (obsIdentifier != null) {
        ...
        } else if (observationDto.getCd() != null
            && obsIdentifier.getHL7AlternateIdentifier() != null) {
        ...
        if (obsIdentifier.getHL7AlternateText() != null && observationDto.getCdDescTxt() == null) {
          observationDto.setCdDescTxt(obsIdentifier.getHL7AlternateText());
            ...
            && observationDto.getCdDescTxt() != null) {
        ...
        if (observationDto.getCdSystemCd() != null
          ...
          if (cacheApiService.getSrteCacheBool(
              ObjectName.LOINC_CODES.name(), observationDto.getCd())) {
            observationDto.setMethodCd(NEDSSConstant.AOE_OBS);
          }
        } else if (observationDto.getCdSystemCd() != null
            && observationDto.getCdSystemCd().equals(EdxELRConstant.ELR_SNOMED_CD)) {
          ...
          observationDto.setCdSystemDescTxt(EdxELRConstant.ELR_SNOMED_DESC);
            ...
            && observationDto.getCdSystemCd().equals(EdxELRConstant.ELR_LOCAL_CD)) {
          observationDto.setCdSystemCd(EdxELRConstant.ELR_LOCAL_CD);
          observationDto.setCdSystemDescTxt(EdxELRConstant.ELR_LOCAL_DESC);
        }

        if (observationDto.getAltCd() != null
            && observationDto.getAltCdSystemCd() != null
            && observationDto.getAltCdSystemCd().equals(EdxELRConstant.ELR_SNOMED_CD)) {
        ...
        if (edxLabInformationDto.isParentObsInd()
                && observationContainer.getTheObservationDto().getCd() == null
            || observationContainer.getTheObservationDto().getCd().trim().isEmpty()) {
        ...
        logger.error(
            "ObservationResultRequest.getObservationResult The Resulted Test ObservationCd  can't be set to null. Please check. {}",
            observationDto.getCd());
        throw new DataProcessingException(
            "ObservationResultRequest.getObservationResult The Resulted Test ObservationCd  can't be set to null. Please check."
                + observationDto.getCd());
      }
      ...
      observationContainer =
          processingAbnormalFlag(abnormalFlag, observationDto, observationContainer);

      if (hl7OBXType.getObservationResultStatus() != null) {
        String toCode =
            checkingValueService.findToCode(
                "ELR_LCA_STATUS", hl7OBXType.getObservationResultStatus(), "ACT_OBJ_ST");
      ...
      // It was decided to use only OBX19 for this field instead of OBX14(as in 2.3.1) - ER 1085 in
      // Rel4.4
      if (hl7OBXType.getDateTimeOftheAnalysis() != null) {
        observationDto.setActivityToTime(
            nbsObjectConverter.processHL7TSType(
                hl7OBXType.getDateTimeOftheAnalysis(),
                EdxELRConstant.DATE_VALIDATION_OBX_LAB_PERFORMED_DATE_MSG));
      }

      observationDto.setRptToStateTime(edxLabInformationDto.getLastChgTime());
      // 2.3.1 to 2.5.1 translation copies this filed from OBX-15(CWE data type) to OBX-23(XON data
      // type) which is required, so always reading it from OBX-23.
      HL7XONType hl7XONTypeName = hl7OBXType.getPerformingOrganizationName();
      if (hl7XONTypeName != null) {
        OrganizationContainer producerOrg =
      ...
      observationContainer =
          processingObservationMethod(methodArray, edxLabInformationDto, observationContainer);
  ...
  private OrganizationContainer getPerformingFacility(
      HL7OBXType hl7OBXType,
      long observationUid,
      LabResultProxyContainer labResultProxyContainer,
      EdxLabInformationDto edxLabInformationDto)
    ...
    try {
      ...
      if (hl7XONTypeName.getHL7AssigningAuthority() != null) {
        entityIdDto.setAssigningAuthorityCd(
            hl7XONTypeName.getHL7AssigningAuthority().getHL7UniversalID());
        entityIdDto.setAssigningAuthorityIdType(
            hl7XONTypeName.getHL7AssigningAuthority().getHL7UniversalIDType());
      }
      if (hl7XONTypeName.getHL7AssigningAuthority() != null
          && hl7XONTypeName.getHL7AssigningAuthority().getHL7NamespaceID() != null
          && hl7XONTypeName
              .getHL7AssigningAuthority()
              .getHL7NamespaceID()
              .equals(EdxELRConstant.ELR_CLIA_CD)) {
      ...
      roleDto.setSubjectEntityUid(
          organizationContainer.getTheOrganizationDto().getOrganizationUid());
      ...
      if (addressType != null) {
        EntityLocatorParticipationDto elpDT =
            nbsObjectConverter.organizationAddressType(
                addressType, EdxELRConstant.ELR_OP_CD, organizationContainer);
        ...
        switch (type) {
          case EdxELRConstant.ELR_CODED_WITH_EXC_CD, EdxELRConstant.ELR_CODED_EXEC_CD -> {
            if (text != null) {
              ...
              if ((obsvalueDT.getCode() == null || obsvalueDT.getCode().trim().isEmpty())
                  && (obsvalueDT.getAltCd() == null || obsvalueDT.getAltCd().trim().isEmpty())) {
                edxLabInformationDto.setReflexResultedTestCdMissing(true);
                edxLabInformationDto.setErrorText(EdxELRConstant.ELR_MASTER_LOG_ID_19);
                String xmlElementName =
                    commonLabUtil.getXMLElementNameForOBX(hl7OBXType) + "." + elementName;
                throw new DataProcessingException(
                    EdxELRConstant.NO_REFLEX_RESULT_NM + " XMLElementName: " + xmlElementName);
              }
              ...
              if (obsvalueDT.getCodeSystemCd() != null
                  && obsvalueDT.getCodeSystemCd().equalsIgnoreCase(EdxELRConstant.ELR_SNOMED_CD)) {
                obsvalueDT.setCodeSystemDescTxt(EdxELRConstant.ELR_SNOMED_DESC);
              } else if (obsvalueDT.getCodeSystemCd() != null
                  && obsvalueDT.getCodeSystemCd().equalsIgnoreCase(EdxELRConstant.ELR_LOCAL_CD)) {
                obsvalueDT.setCodeSystemDescTxt(EdxELRConstant.ELR_LOCAL_DESC);
              }
              if (obsvalueDT.getAltCdSystemCd() != null
                  && obsvalueDT.getAltCdSystemCd().equalsIgnoreCase(EdxELRConstant.ELR_SNOMED_CD)) {
                obsvalueDT.setAltCdSystemDescTxt(EdxELRConstant.ELR_SNOMED_DESC);
              } else if (obsvalueDT.getAltCdSystemCd() != null
                  && obsvalueDT.getAltCdSystemCd().equalsIgnoreCase(EdxELRConstant.ELR_LOCAL_CD)) {
                obsvalueDT.setAltCdSystemDescTxt(EdxELRConstant.ELR_LOCAL_DESC);
              }

              obsvalueDT.setObservationUid(
                  observationContainer.getTheObservationDto().getObservationUid());
          ...
          case EdxELRConstant.ELR_STUCTURED_NUMERIC_CD -> {
            ...
            while (st.hasMoreTokens()) {
              ...
              if (i == 1) {
                if (token != null && token.equals("&lt;")) obsValueNumericDto.setComparatorCd1("<");
                else if (token != null && token.equals("&gt;"))
                  obsValueNumericDto.setComparatorCd1(">");
                else obsValueNumericDto.setComparatorCd1(token);
              } else if (i == 2) {
            ...
            if (cEUnit != null) obsValueNumericDto.setNumericUnitCd(cEUnit.getHL7Identifier());
            obsValueNumericDto.setObservationUid(
                observationContainer.getTheObservationDto().getObservationUid());
          ...
          case EdxELRConstant.ELR_STRING_CD,
              EdxELRConstant.ELR_TEXT_CD,
              EdxELRConstant.ELR_TEXT_DT,
              EdxELRConstant.ELR_TEXT_TS -> {
            ...
            while (st.hasMoreTokens()) {
              ...
              obsValueTxtDto.setObservationUid(
                  observationContainer.getTheObservationDto().getObservationUid());
  ...
  protected ObservationContainer getObsReqNotes(
      List<HL7NTEType> noteArray, ObservationContainer observationContainer)
      throws DataProcessingException {
    try {
  ...
  protected Collection<ActIdDto> setEquipments(
      List<HL7EIType> equipmentIdType,
      ObservationDto observationDto,
      Collection<ActIdDto> actIdDtoColl) {
    int seq = 3;
  ...
  protected ObservationContainer processingAbnormalFlag(
      List<HL7CWEType> abnormalFlag,
      ObservationDto observationDto,
      ObservationContainer observationContainer)
      throws DataProcessingException {
    if (abnormalFlag != null && !abnormalFlag.isEmpty()) {
      ...
      String str =
          checkingValueService.getCodeDescTxtForCd(
              "OBS_INTRP", observationIntrepDT.getInterpretationCd());
      ...
      observationIntrepDT.setObservationUid(
          observationContainer.getTheObservationDto().getObservationUid());
  ...
  @SuppressWarnings("java:S3776")
  protected ObservationContainer processingReferringRange(
      HL7OBXType hl7OBXType, ObservationContainer observationContainer) {
    if (hl7OBXType.getReferencesRange() != null) {
      ...
      if (observationContainer.getTheObsValueNumericDtoCollection() != null) {
        ...
        obsValueNumericDto = arrlist.getFirst();
      } else {
      ...
      if (range.contains("^")) {
        ...
        while (st.hasMoreTokens()) {
          i++;
          String token = st.nextToken();
          if (i == 1) obsValueNumericDto.setLowRange(token);
          else if (i == 2) obsValueNumericDto.setHighRange(token);
        }
      } else {
  ...
  protected ObservationContainer processingObservationMethod(
    ...
    for (HL7CEType method : methodArray) {
      if (method.getHL7Identifier() != null) {
        ...
        String str =
            checkingValueService.getCodeDescTxtForCd("OBS_METH", method.getHL7Identifier());
        if (str == null || str.trim().isEmpty()) {
    ...
    if (methodDescTxt != null && methodDescTxt.lastIndexOf(delimiter) > 0) {
      methodDescTxt =
          new StringBuilder(methodDescTxt.substring(0, methodDescTxt.lastIndexOf(delimiter)));
    }
    observationContainer
        .getTheObservationDto()
        .setMethodCd(methodCd != null ? methodCd.toString() : "");
    observationContainer
        .getTheObservationDto()
        .setMethodDescTxt(methodDescTxt != null ? methodDescTxt.toString() : "");
