...
public class LabResultUtil {
  ...
  /**
   * Description: Update Lab Result Container. This method create these object in order. given value
   * from edxELRLabMap. These objects tightly associated with order 1 - Role Dto 2 - Participation
   * Dto 3 - Organization Dto 4 - Organization Name Dto 5 - Entity Id Dto
   */
  public LabResultProxyContainer getLabResultMessage(
      HL7MSHType hl7MSHType, EdxLabInformationDto edxLabInformationDto) {
    ...
    EdxELRLabMapDto edxELRLabMapDto =
        processingHL7SendingFacility(sendingFacility, edxLabInformationDto);
   ...
   * Dto 3 - Organization Dto 4 - Organization Name Dto 5 - Entity Id Dto
   */
  public EdxELRLabMapDto processingHL7SendingFacility(
      HL7HDType sendingFacility, EdxLabInformationDto edxLabInformationDto) {
   ...
   * Dto 3 - Organization Dto 4 - Organization Name Dto 5 - Entity Id Dto
   */
  public LabResultProxyContainer creatingOrganization(
      LabResultProxyContainer labResultProxy,
      EdxELRLabMapDto edxELRLabMap,
      EdxLabInformationDto edxLabInformation) {
    ...
    if (edxELRLabMap.getEntityIdTypeCd() != null && edxELRLabMap.getEntityIdTypeDescTxt() != null) {
      ...
      if (edxELRLabMap.getEntityIdRootExtensionTxt() != null
          && !edxELRLabMap.getEntityIdRootExtensionTxt().trim().isEmpty()) {
