...
public class EntityHelper {
   ...
   *
   * @param dtCol Collection<Object> NBSSecurityObj object
   * @return Collection<Object> EntityLocatoryParticipation collection object populated with system
   *     attributes
   */
  public Collection<EntityLocatorParticipationDto> iterateELPDTForEntityLocatorParticipation(
      Collection<EntityLocatorParticipationDto> dtCol) throws DataProcessingException {
  ...
  /**
   * This private method is used to populate the system attributes on the RoleDT Collection<Object>
   *
   * @param dtCol Collection<Object> NBSSecurityObj object
   * @return Collection<Object> RoleDT collection object populated with system attributes
   */
  public Collection<RoleDto> iterateRDT(Collection<RoleDto> dtCol) throws DataProcessingException {
    ...
    for (anIterator = collection.iterator(); anIterator.hasNext(); ) {
      ...
      if (rDT.isItDirty() || rDT.isItNew() || rDT.isItDelete()) {
        logger.debug(
            "EntityController:rdT.IsItDelete {} rdt.IsItNew: {} rdt.IsItDirty: {}",
            rDT.isItDelete(),
            rDT.isItNew(),
            rDT.isItDirty());
  ...
  /**
   * This private method is used to populate the system attributes on the ParticipationDto
   * Collection<Object>
   *
   * @param dtCol Collection<Object> NBSSecurityObj object
   * @return Collection<Object> ParticipationDto collection object populated with system attributes
   */
  public Collection<ParticipationDto> iteratePDTForParticipation(Collection<ParticipationDto> dtCol)
  ...
  public Collection<ActivityLocatorParticipationDto> iterateActivityParticipation(
      Collection<ActivityLocatorParticipationDto> dtCol) throws DataProcessingException {
  ...
  public Collection<ActRelationshipDto> iterateActRelationship(Collection<ActRelationshipDto> dtCol)
      throws DataProcessingException {
  ...
  public Collection<ActivityLocatorParticipationDto> iterateALPDTActivityLocatorParticipation(
      Collection<ActivityLocatorParticipationDto> dtCol) throws DataProcessingException {
  ...
  public Collection<ActRelationshipDto> iterateARDTActRelationship(
      Collection<ActRelationshipDto> dtCol) throws DataProcessingException {
