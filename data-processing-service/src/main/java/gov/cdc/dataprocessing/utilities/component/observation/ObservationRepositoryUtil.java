...
public class ObservationRepositoryUtil {
  ...
  public ObservationContainer loadObject(long obUID) throws DataProcessingException {
    ...
    Collection<ActivityLocatorParticipationDto> activityLocatorParticipationColl =
        selectActivityLocatorParticipations(obUID);
    ...
    Collection<ActRelationshipDto> actColl =
        actRelationshipRepositoryUtil.selectActRelationshipDTCollectionFromActUid(obUID);
  ...
  public Long saveObservation(ObservationContainer observationContainer)
      throws DataProcessingException {
    Long observationUid = -1L;

    Collection<ActivityLocatorParticipationDto> alpDTCol =
        observationContainer.getTheActivityLocatorParticipationDtoCollection();
    Collection<ActRelationshipDto> arDTCol =
        observationContainer.getTheActRelationshipDtoCollection();
    ...
    if (alpDTCol != null) {
      ...
      observationContainer.setTheActivityLocatorParticipationDtoCollection(
          colActLocatorParticipation);
    }
  ...
  public Long createNewObservation(ObservationContainer observationContainer)
      throws DataProcessingException {
    ...
    addActivityLocatorParticipations(
        obsId,
        observationContainer.getTheActivityLocatorParticipationDtoCollection(),
        OPERATION_CREATE);
    return obsId;
  ...
  public Long updateObservation(ObservationContainer observationContainer)
      throws DataProcessingException {
    Long uid;
    ...
    if (actRelationshipDto.isItNew()) {
      ...
      actRelationshipJdbcRepository.deleteActRelationship(actRelationship);
        ...
        && (actRelationshipDto.getTargetActUid() != null
            && actRelationshipDto.getSourceActUid() != null
            && actRelationshipDto.getTypeCd() != null)) {
  ...
  public void setObservationInfo(ObservationDto observationDto) throws DataProcessingException {
    ...
    if (observationVO != null) observationVO.setTheObservationDto(observationDto);
        ...
        if (previousTargetActUid == null
          ...
          if (previousObservationUid == null
            ...
            obsVO
                ...
                .setObservationUid(observation_question.getObservationUid());
            obsVO
                .getTheObservationDto()
                .setVersionCtrlNbr(observation_question.getVersionCtrlNbr());
            ...
            obsVO
                .getTheObservationDto()
                .setCtrlCdDisplayForm(observation_question.getCtrlCdDisplayForm());
            ...
            obsVO
                .getTheObservationDto()
                .setCdSystemDescTxt(observation_question.getCdSystemDescTxt());
          ...
          ObservationContainer innerObs = theObservationQuestionColl.getLast();
          Collection<ActRelationshipDto> actColl;
          ...
          theObservationQuestionColl.set(theObservationQuestionColl.size() - 1, innerObs);
        }
      }
    }
  ...
  protected Collection<ObservationReasonDto> selectObservationReasons(long aUID) {
    Collection<ObservationReason> observationReasons =
        observationJdbcRepository.findByObservationReasons(aUID);
  ...
  protected Collection<ActivityLocatorParticipationDto> selectActivityLocatorParticipations(
      long aUID) {
    Collection<ActLocatorParticipation> col =
        actLocatorParticipationJdbcRepository.findByActUid(aUID);
  ...
  protected Long saveNewObservation(ObservationDto observationDto) throws DataProcessingException {
    ...
    observation.setLocalId(
        uid.getClassTypeUid().getUidPrefixCd()
            + uid.getClassTypeUid().getSeedValueNbr()
            + uid.getClassTypeUid().getUidSuffixCd());
  ...
  protected void addObservationReasons(
      Long obsUid, Collection<ObservationReasonDto> observationReasonDtoCollection) {
  ...
  protected void updateObservationReason(
      Long obsUid, Collection<ObservationReasonDto> observationReasonDtoCollection) {
    ArrayList<ObservationReasonDto> arr = new ArrayList<>(observationReasonDtoCollection);
    for (var item : arr) {
      if (!item.isItDelete()) {
  ...
  protected void addActivityId(
      Long obsUid, Collection<ActIdDto> actIdDtoCollection, boolean updateApplied)
      throws DataProcessingException {
  ...
  protected void addObservationInterps(
      Long obsUid, Collection<ObservationInterpDto> observationInterpDtoCollection) {
  ...
  protected void updateObservationInterps(
      Long obsUid, Collection<ObservationInterpDto> collection) {
  ...
  protected void addObsValueCoded(
      Long obsUid, Collection<ObsValueCodedDto> obsValueCodedDtoCollection) {
  ...
  protected void addObsValueDates(
      Long obsUid, Collection<ObsValueDateDto> obsValueDateDtoCollection) {
  ...
  protected void addObsValueNumeric(
      Long obsUid, Collection<ObsValueNumericDto> obsValueNumericDtoCollection) {
  ...
  protected void addActivityLocatorParticipations(
      Long obsUid,
      Collection<ActivityLocatorParticipationDto> activityLocatorParticipationDtoCollection,
      String operation) {
    if (activityLocatorParticipationDtoCollection != null) {
      ArrayList<ActivityLocatorParticipationDto> arr =
          new ArrayList<>(activityLocatorParticipationDtoCollection);
      for (var item : arr) {
        item.setItNew(false);
        item.setItDirty(false);
        item.setItDelete(false);
