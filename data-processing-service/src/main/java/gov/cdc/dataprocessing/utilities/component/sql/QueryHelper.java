...
public class QueryHelper {
  ...
  public String getDataAccessWhereClause(
      String businessObjLookupName, String operation, String alias) {
    ...
    whereClause =
        buildWhereClause(ownerList, guestList, columnName, alias, true, businessObjLookupName);
  ...
  public String buildWhereClause(
    ...
    String whereClauseOwner =
        buildOwnerWhereClause(ownerList, columnName, alias, oIdFlag, businessObjLookupName);
    String whereClauseGuest =
        buildGuestWhereClause(guestList, columnName, alias, oIdFlag, businessObjLookupName);
  ...
  protected String buildOwnerWhereClause(
      String ownerList,
      String columnName,
      String alias,
      boolean oIdFlag,
    ...
    if (ownerList != null && !ownerList.trim().isEmpty()) {
      ...
      if (alias == null || alias.trim().isEmpty()) {
        ...
        whereClauseOwner = "(" + alias + "." + columnName + QUERY_HELPER_1 + ownerList + "))";
      }
    } else {
  ...
  @SuppressWarnings("java:S1172")
  protected String buildGuestWhereClause(
      String guestList,
      String columnName,
      String alias,
      boolean oIdFlag,
    ...
    if (guestList != null && !guestList.trim().isEmpty()) {
      if (alias == null || alias.trim().isEmpty()) {
        whereClauseGuest =
            "((" + columnName + QUERY_HELPER_1 + guestList + ")) and  shared_ind = '" + "T" + "')";
      } else {
        whereClauseGuest =
            "(("
                + alias
