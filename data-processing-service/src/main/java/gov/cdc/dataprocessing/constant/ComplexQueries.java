...
public class ComplexQueries {
  public static final String DMB_QUESTION_OID_METADATA_SQL =
      "SELECT "
          ...
          + "NBS_UI_METADATA.data_location dataLocation, " // + "NBS_UI_METADATA.data_location
          // dataLocation, "
  ...
  public static final String GENERIC_QUESTION_OID_METADATA_SQL =
      "SELECT "
  ...
  public static final String PAM_QUESTION_OID_METADATA_SQL =
      "SELECT "
  ...
  public static final String SELECT_PHCPAT_NAMED_BY_PATIENT_COLLECTION1 =
  ...
  public static final String SELECT_PHCPAT_NAMED_BY_PATIENT_COLLECTION3 =
  ...
  public static final String SELECT_PHCPAT_OTHER_NAMED_BY_CONTACT_COLLECTION =
      "select"
  ...
  public static final String SELECT_LABRESULTED_REFLEXTEST_SUMMARY_FORWORKUP_SQL =
      "SELECT distinct "
          ...
          + " obs1.status_cd \"resultedTestStatusCd\", "
          + // Added this line for ER16368
  ...
  public static final String GET_SOURCE_ACT_UID_FOR_SUSCEPTIBILITES_SQL =
      "SELECT distinct "
  ...
  public static final String TREATMENTS_FOR_A_PHC_ORACLE =
      "SELECT       "
          ...
          + NEDSSConstant.TREATMENT_CLASS_CODE
          + "' "
          + "AND          ar.target_class_cd = '"
  ...
  public static String SELECT_LDF =
      "SELECT "
          + " sf.ldf_uid \"ldfUid\", "
  ...
  public static final String GET_NBS_DOCUMENT =
      " SELECT"
          ...
          + " and particip.type_cd='"
          + NEDSSConstant.SUBJECT_OF_DOC
          + "' "
  ...
  public static final String GET_NBS_DOCUMENT_6_0_19_1 =
      " SELECT"
          + " nbsdoc.nbs_document_uid  \"nbsDocumentUid\", "
          + " nbsdoc.local_id  \"localId\","
          + " nbsdoc.doc_type_cd  \"docTypeCd\","
          ...
          + " per.person_parent_uid \"MPRUid\", "
          + " nbsdoc.last_chg_time \"lastChgTime\", "
          + " nbsdoc.received_time \"receivedTime\" "
          + " FROM nbs_document nbsdoc "
          + " inner join participation particip on "
          + " particip.act_uid = nbsdoc.nbs_document_uid "
          + " inner join person per on "
