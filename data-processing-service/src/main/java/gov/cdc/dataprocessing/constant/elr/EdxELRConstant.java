...
public class EdxELRConstant {
  ...
  public static final String LOG_RECORD_STATUS_CD_NOT_ACTIVE =
      "RecordStatusCd is not active or inactive";
  public static final String LOG_OBSERVATION_COLLECTION_ERROR =
      "Exception thrown at ObservationRequest.getCollectorVO:";
  public static final String LOG_RECORD_STATUS_CD_NOT_NULL =
      "RecordStatusCd or statusCode is not null";
  public static final String LOG_RECORD_MODIFIED_BY_OTHER_USER =
  ...
  public static final String ELR_RECEIVING_STANDARD_INDUSTRY_CLASS_DESC =
      "Offices of Misc. Health Providers";
  ...
  public static final NbsInterfaceStatus SUM_MSG_JURISDICTION_FAIL_STS = NbsInterfaceStatus.Success;
  ...
  public static final NbsInterfaceStatus SUM_MSG_ALGORITHM_FAIL_STS = NbsInterfaceStatus.Success;
  ...
  public static final NbsInterfaceStatus SUM_MSG_INVESTIGATION_FAIL_STS =
      NbsInterfaceStatus.Failure;
  public static final String SUM_MSG_INVESTIGATION_FAIL =
      "Error creating investigation.  See Activity Details.";

  public static final NbsInterfaceStatus SUM_MSG_MISSING_INVESTIGATION_FLDS_STS =
      NbsInterfaceStatus.Failure;
  public static final String SUM_MSG_MISSING_INVESTIGATION_FLDS =
      "Missing fields required to create investigation";

  public static final NbsInterfaceStatus SUM_MSG_NOTIFICATION_FAIL_STS = NbsInterfaceStatus.Failure;
  public static final String SUM_MSG_NOTIFICATION_FAIL =
      "Error creating notification.  See Activity Details.";

  public static final NbsInterfaceStatus SUM_MSG_MISSING_NOTIFICATION_FLDS_STS =
      NbsInterfaceStatus.Failure;
  public static final String SUM_MSG_MISSING_NOTIFICATION_FLDS =
      "Missing fields required to create notification";

  public static final NbsInterfaceStatus SUM_MSG_ERROR_LAB_REVIEWED_STS =
      NbsInterfaceStatus.Failure;
  public static final String SUM_MSG_ERROR_LAB_REVIEWED =
      "Error marking lab as reviewed.  See Activity Details.";

  public static final NbsInterfaceStatus SUM_MSG_CREATING_LAB_STS = NbsInterfaceStatus.Failure;
  public static final String SUM_MSG_CREATING_LAB = "Error creating lab.  See Activity Details.";

  public static final NbsInterfaceStatus SUM_MSG_UPDATING_LAB_STS = NbsInterfaceStatus.Failure;
  public static final String SUM_MSG_UPDATING_LAB = "Error updating Lab.  See Activity Details.";

  // Detail messages
  public static final String DET_MSG_PATIENT_FOUND = "Patient match found: %1, %2 (UID: %3).";
  ...
  public static final String LOG_ERROR_ENTITY_PATIENT =
  ...
  public static final String NO_ORDTEST_NAME = "The code for Ordered Test name is missing.";
  ...
  public static final String NO_RESULT_NAME = "The code for Result Test name is missing.";
  ...
  public static final String INFO_SSN_INVALID = "An invalid SSN is in the message.";
  public static final String NULL_CLIA = "The Reporting Facility did not have a CLIA number.";

  public static final String WDS_REPORT = "WDS Algorithm had been applied on ";
  public static final String FILLER_FAIL = "The Filler Order Number is missing.";
  public static final String NO_MATCHING_ALGORITHM = "Matching algorithm for lab report not found.";
  ...
  public static final String UNIVSRVCID = "The Universal Service Identifier is missing.";
  public static final String SYSTEM_EXCEPTION = "Unknown exception.  Please contact Support.";
  ...
  public static final String JURISDICTION_DERIVED = "Jurisdiction derived.";
  public static final String PROG_AREA_DERIVED = "Program Area derived.";
  public static final String IS_PROVIDER = "Provider derived";
  public static final String IS_NOT_PROVIDER = "Provider not derived";
  public static final String NO_JURISDICTION_DERIVED = "Jurisdiction not derived.";
  public static final String NO_PROG_AREA_DERIVED = "Program Area not derived.";
  public static final String LAB_CREATE_SUCCESS = "Lab %1 created and associated to Patient.";
  public static final String OBSERVATION_MATCH = "Observation match found";
  public static final String OBSERVATION_NOT_MATCH =
      "Observation match not found, Observation created with id: %1";
  public static final String DOC_CREATE_SUCCESS = "Document created and associated to Lab.";
  public static final String MISSING_ORD_PROV = "The Ordering Provider is missing.";
  public static final String MISSING_ORD_FAC = "The Ordering Facility is missing.";
  public static final String TRANSLATE_OBS_STATUS = "Observation Status not found in SRT.";
  ...
  public static final String SUBJECT_MATCH_FOUND = "Patient match found. (UID: %1, PUID: %2).";
  public static final String NO_REASON_FOR_STUDY = "The code for Reason For Study is missing.";
  public static final String MULTIPLE_OBR =
      "The ELR includes Multiple Ordered Tests (OBRs).  Child OBR(s) are missing Parent Result (OBR-26) and/or Parent (OBR-29) values.";
  ...
  public static final String INVALID_XML =
      "The XML does not include information required to process the ELR into NBS.";

  public static final String MISSING_ORD_PROV_AND_ORD_FAC =
      "The Ordering Provider and the Ordering Facility are missing.";
  ...
  public static final String ORDER_OBR_WITH_PARENT =
      "The Parent Ordered Test (OBR) includes a Parent Result (OBR 26) and/or Parent (OBR 29) values.";
  public static final String CHILD_OBR_WITHOUT_PARENT =
      "The ELR includes Multiple Ordered Tests (OBRs).  Child OBR(s) are missing Parent Result (OBR 26) and/or Parent (OBR 29) values.";
  ...
  public static final String UNEXPECTED_RESULT_TYPE =
      "The ELR includes an unexpected result Data Type (OBX-2). NBS expects ST, TX, CE, DT, TS or SN.";
  public static final String CHILD_SUSC_WITH_NO_PARENT_RESULT =
      "The ELR includes Multiple Ordered Tests (OBRs).  Child OBR(s) do not have the same Parent Result (OBR-26) and/or Parent (OBR-29) values as the Parent OBR.";

  public static final String ELR_MASTER_LOG_ID_1 =
      "1"; // "Jurisdiction and/or Program Area could not be derived.  The Lab Report is logged in
  // Documents Requiring Security Assignment queue.";
  public static final String ELR_MASTER_LOG_ID_2 =
      "2"; //	"A matching algorithm was not found.  The Lab Report is logged in Documents Requiring
  // Review queue.";
  public static final String ELR_MASTER_LOG_ID_3 = "3"; // 	"Successfully Create Investigation";
  public static final String ELR_MASTER_LOG_ID_4 =
      "4"; // "Error creating investigation.  See Activity Details.";
  public static final String ELR_MASTER_LOG_ID_5 =
      "5"; // "Missing fields required to create investigation.";
  public static final String ELR_MASTER_LOG_ID_6 = "6"; // "Successfully Create Notification";
  public static final String ELR_MASTER_LOG_ID_7 =
      "7"; // "Error creating notification.  See Activity Details.";
  public static final String ELR_MASTER_LOG_ID_8 =
      "8"; // "Missing fields required to create notification.";
  public static final String ELR_MASTER_LOG_ID_9 =
      "9"; // "Error creating investigation.  See Activity Details.";
  public static final String ELR_MASTER_LOG_ID_10 =
      "10"; // "Error creating notification.  See Activity Details.";
  public static final String ELR_MASTER_LOG_ID_11 = "11"; // "Successfully Mark Lab as Reviewed";
  public static final String ELR_MASTER_LOG_ID_12 =
      "12"; // "Error marking lab as reviewed.  See Activity Details.";
  public static final String ELR_MASTER_LOG_ID_13 =
      "13"; // "Error creating lab.  See Activity Details.";
  public static final String ELR_MASTER_LOG_ID_14 =
      "14"; // "Error updating Lab.  See Activity Details.";
  public static final String ELR_MASTER_LOG_ID_15 =
      "15"; // "Lab updated successfully and logged in Documents Requiring Review queue";
  public static final String ELR_MASTER_LOG_ID_16 = "16"; // "Unexpected exception.";
  public static final String ELR_MASTER_LOG_ID_17 =
      "17"; // "Error creating lab.  See Activity Details.";
  public static final String ELR_MASTER_LOG_ID_18 =
      "18"; // "String or binary data would be truncated.";
  ...
  public static final String ELR_MASTER_LOG_ID_21 =
      "21"; // "Successfully Mark Lab as Reviewed and associated to existing investigation";
  public static final String ELR_MASTER_LOG_ID_22 =
      "22"; // "Lab updated successfully and logged in Documents Requiring Security Assignment
  // queue";

  public static final String ELR_MASTER_MSG_ID_1 =
      "Jurisdiction and/or Program Area could not be derived.  The Lab Report is logged in Documents Requiring Security Assignment queue.";
  public static final String ELR_MASTER_MSG_ID_2 =
      "A matching algorithm was not found.  The Lab Report is logged in Documents Requiring Review queue.";
  public static final String ELR_MASTER_MSG_ID_3 = "Successfully Create Investigation";
  public static final String ELR_MASTER_MSG_ID_4 =
      "Error creating investigation.  See Activity Details.";
  public static final String ELR_MASTER_MSG_ID_5 =
      "Missing fields required to create investigation.";
  public static final String ELR_MASTER_MSG_ID_6 = "Successfully Create Notification";
  public static final String ELR_MASTER_MSG_ID_7 =
      "Error creating notification.  See Activity Details.";
  public static final String ELR_MASTER_MSG_ID_8 =
      "Missing fields required to create notification.";
  public static final String ELR_MASTER_MSG_ID_9 =
      "Error creating investigation.  See Activity Details.";
  public static final String ELR_MASTER_MSG_ID_10 =
      "Error creating notification.  See Activity Details.";
  public static final String ELR_MASTER_MSG_ID_11 = "Successfully Mark Lab as Reviewed";
  public static final String ELR_MASTER_MSG_ID_12 =
      "Error marking lab as reviewed.  See Activity Details.";
  ...
  public static final String ELR_MASTER_MSG_ID_15 =
      "Lab updated successfully and logged in Documents Requiring Review queue.";
  public static final String ELR_MASTER_MSG_ID_16 =
      "Error creating Lab.  See Activity Details."; // in case of "Unexpected exception." it
  // displays this message;
  public static final String ELR_MASTER_MSG_ID_17 = "Error creating lab.  See Activity Details.";
  public static final String ELR_MASTER_MSG_ID_18 =
      "Error creating lab. Input message length exceeds the field length in NBS, resulting in a truncation error. See Activity Details.";
  public static final String ELR_MASTER_MSG_ID_19 =
      "Error creating lab. Blank identifiers in CE or CWE segments 1 or 4. See Activity Details.";
  public static final String ELR_MASTER_MSG_ID_20 =
      "Error creating lab. Invalid Date encountered. See Activity Details.";
  public static final String ELR_MASTER_MSG_ID_21 =
      "Successfully Mark Lab as Reviewed and associated to existing investigation.";
  public static final String ELR_MASTER_MSG_ID_22 =
      "Lab updated successfully and logged in Documents Requiring Security Assignment queue.";
  public static final String ELR_MASTER_MSG_ID_23 = "";

  public static final String SQL_FIELD_TRUNCATION_ERROR_MSG =
  ...
  public static final String DATE_VALIDATION_PID_PATIENT_BIRTH_DATE_AND_TIME_MSG =
      DATE_VALIDATION + "PID-7 Patient Birth Date/Time " + DATE_VALIDATION_END_DELIMITER1;
  public static final String DATE_VALIDATION_PID_PATIENT_BIRTH_DATE_NO_TIME_MSG =
      DATE_VALIDATION + "PID-7 Patient Birth Date " + DATE_VALIDATION_END_DELIMITER1;
  public static final String DATE_VALIDATION_PERSON_NAME_FROM_TIME_MSG =
      DATE_VALIDATION + "Person Name From Date " + DATE_VALIDATION_END_DELIMITER1;
  public static final String DATE_VALIDATION_PERSON_NAME_TO_TIME_MSG =
      DATE_VALIDATION + "Person Name To Date " + DATE_VALIDATION_END_DELIMITER1;
  public static final String DATE_VALIDATION_OBR_SPECIMEN_RECEIVED_TIME_MSG =
      DATE_VALIDATION + "OBR-14 Specimen Received Date/Time " + DATE_VALIDATION_END_DELIMITER1;
  public static final String DATE_VALIDATION_ORC_ORDER_EFFECTIVE_TIME_MSG =
      DATE_VALIDATION + "ORC-15 Order Effective Date/Time " + DATE_VALIDATION_END_DELIMITER1;
  public static final String DATE_VALIDATION_OBR_RESULTS_RPT_STATUS_CHNG_TO_TIME_MSG =
      DATE_VALIDATION
          + "OBR-22 Results Rpt/Status Chng - Date/Time  "
          + DATE_VALIDATION_END_DELIMITER1;
  public static final String DATE_VALIDATION_OBR_OBSERVATION_DATE_MSG =
      DATE_VALIDATION
          + "OBR-7.0 or SPM-17.1 Observation Starting Date/Time "
          + DATE_VALIDATION_END_DELIMITER1;
  public static final String DATE_VALIDATION_OBR_OBSERVATION_END_DATE_MSG =
      DATE_VALIDATION
          + "OBR-8.0 or SPM-17.2 Observation Ending Date/Time "
          + DATE_VALIDATION_END_DELIMITER1;
  public static final String DATE_VALIDATION_OBX_LAB_PERFORMED_DATE_MSG =
      DATE_VALIDATION + "OBX-14 Analysis Date/Time " + DATE_VALIDATION_END_DELIMITER1;
  public static final String DATE_VALIDATION_SPM_SPECIMEN_COLLECTION_DATE_MSG =
      DATE_VALIDATION + "SPM-17 Specimen Collection Date/Time " + DATE_VALIDATION_END_DELIMITER1;
  public static final String DATE_VALIDATION_PATIENT_DEATH_DATE_AND_TIME_MSG =
      DATE_VALIDATION + "PID-29 Patient Death Date " + DATE_VALIDATION_END_DELIMITER1;
  public static final String DATE_VALIDATION_PID_PATIENT_IDENTIFIER_EFFECTIVE_DATE_TIME_MSG =
      DATE_VALIDATION + "PID-3 Patient Identifier Effective Date " + DATE_VALIDATION_END_DELIMITER1;
  public static final String DATE_VALIDATION_PID_PATIENT_IDENTIFIER_EXPIRATION_DATE_TIME_MSG =
      DATE_VALIDATION
          + "PID-3 Patient Identifier Expiration Date "
          + DATE_VALIDATION_END_DELIMITER1;

  public static final String DATE_INVALID_FOR_DATABASE =
      " is before or after the date allowed by the database.";

  public static final String MISSING_NOTF_REQ_FIELDS =
      "The following required Notification field(s) is(are) missing: ";
