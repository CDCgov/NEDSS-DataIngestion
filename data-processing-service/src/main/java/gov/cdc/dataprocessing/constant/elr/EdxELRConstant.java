...
public class EdxELRConstant {
    ...
    public static final NbsInterfaceStatus SUM_MSG_INVESTIGATION_FAIL_STS = NbsInterfaceStatus.Failure;
    public static final String SUM_MSG_INVESTIGATION_FAIL =
            "Error creating investigation.  See Activity Details.";

    public static final NbsInterfaceStatus SUM_MSG_MISSING_INVESTIGATION_FLDS_STS = NbsInterfaceStatus.Failure;
    ...
    public static final NbsInterfaceStatus SUM_MSG_MISSING_NOTIFICATION_FLDS_STS = NbsInterfaceStatus.Failure;
    public static final String SUM_MSG_MISSING_NOTIFICATION_FLDS =
            "Missing fields required to create notification";

    public static final NbsInterfaceStatus SUM_MSG_ERROR_LAB_REVIEWED_STS = NbsInterfaceStatus.Failure;
