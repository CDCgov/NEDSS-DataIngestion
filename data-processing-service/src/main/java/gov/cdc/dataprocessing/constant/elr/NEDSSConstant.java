...
//    public static final String CDC_FIELD_RECORD_FORM ="CDCFieldRecordForm";
     ...
     */
    public enum QuestionGroupCodes {
     ...
     * system.
     */
    public enum QuestionEntryMethod {
        USER, // entered by the user
        SYSTEM // predefined in the system
    }
    public enum CANADA {CAN, CA, PHVS_STATEPROVINCEOFEXPOSURE_CDC_CAN}
    public enum USA {USA, US, PHVS_STATEPROVINCEOFEXPOSURE_CDC_US}

    public enum MEXICO {MEX, MX, PHVS_STATEPROVINCEOFEXPOSURE_CDC_MEX}

    public enum CLOSURE_INVESTGR {ClosureInvestgrOfPHC, NBS197}
    public enum CURRENT_INVESTGR {InvestgrOfPHC, INV180}
