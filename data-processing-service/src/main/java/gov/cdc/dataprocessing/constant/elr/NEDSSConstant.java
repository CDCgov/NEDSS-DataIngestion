...
public class NEDSSConstant {
  ...
  /**
   * Begin to remove the following section ... The section below is no longer valid for NEDSS
   * project
   */
  ...
  /** End of the section The section above is no longer valid for NEDSS project */
  ...
  public static final String OBSERVATION_LAB_MICRO_SUBJECT_PERSON_TYPE_CODE_PART_DT =
      "SUBJOFLABMICRO";

  public static final String OBSERVATION_ORDER_PROVIDER_PERSON_TYPE_CODE_PART_DT = "ORDEROFLABTEST";

  public static final String OBSERVATION_ORDER_FACILITY_ORGANIZATION_TYPE_CODE_PART_DT =
      "ORDEROFLABTEST";

  public static final String OBSERVATION_SUBMIT_LAB_GEN_ORGANIZATION_TYPE_CODE_PART_DT =
      "SUBLABOFLABGEN";

  public static final String OBSERVATION_SUBMIT_LAB_MICRO_ORGANIZATION_TYPE_CODE_PART_DT =
      "SUBLABOFLABMICRO";
  ...
  public static final String OBSERVATION_LAB_TECHNICIAN_DRUG_SENSITIVITY_TYPE_CODE_PART_DT =
      "LABTECHOFABSENS";

  public static final String MATERIAL_SPECIMEN_INTERVENTION_TYPE_CODE_PART_DT =
      "SPECMNOFCOLLCTNINT";

  public static final String INTERVENTION_SPECIMEN_COLLECTOR_TYPE_CODE_PART_DT = "COLLCTROFSPECMN";

  public static final String INTERVENTION_SPECIMEN_SUBJECT_TYPE_CODE_PART_DT =
      "SUBJOFSPECMNCOLLCTN";
  ...
  //    public static final String SYSTEM_REFERENCE_TABLE = PropertyUtil
  //            .getInstance().getSystemReferenceTable();
  ...
  public static final String NND_NOTIFICATIONS_FOR_APPROVAL =
  ...
  public static final String ELRS_NEEDING_PROGRAM_OR_JURISDICTION_ASSIGNMENT =
      "ELR Program Area or Jurisdiction Assignment";

  public static final String NEW_LAB_REPORTS_FOR_REVIEW = "New Lab Reports For Review";

  public static final String INVESTIGATIONS_JURISDIC_ASSIGNMENT =
      "Investigations Needing Jurisdiction Assignment";

  public static final String OBSERVATIONS_ASSIGNMENT =
  ...
  public static final String ASSOCIATE_INVESTIGATIONS =
      "Associate Investigations to an Observation";
  ...
  public static final String BMIRD_BACTERIAL_SPECIES_ISOLATED =
      "Bacterial species isolated from normally site";
  ...
  /** Originally from EntityCodes.java Description: CMD Entity Codes */
  ...
  /** Originally from CdmConstantUtil.java Description: Constants for CDM module */
  ...
  public static final String GET_PERSON_SESSION = "GetPersonSession";

  public static final String PERSON_SEARCHER = "EJBPersonSearcher";
  ...
  /** Originally from WumConstants.java Description: Constants for WUM module */
  ...
  public static final String MATERIAL_CLASS_CODE = "MAT";

  public static final String PERSON_CLASS_CODE = "PSN";

  public static final String ORGANIZATION_CLASS_CODE = "ORG";

  public static final String TREATMENT_CLASS_CODE = "TRMT";
  ...
  /** Originally from WumConstantUtil.java Description: Constants for WUM module */
  ...
  // public static final String RECORD_STATUS_ACTIVE = "ACTIVE"; - a duplicate constant found in
  // this class
  ...
  */
  ...
  // General constants
  public static final String OBSERVATION_CODE = "ocd";

  public static final String LABRESULT_CODE = "LabReport";

  public static final String MORBIDITY_CODE = "MorbReport";

  public static final String MORBIDITY_REPORT = "MorbReport";

  public static final String CREATE_GEN_OBS = "general";

  public static final String MORBIDITY_FORM_Q = "MorbFrmQ";
  ...
  public static final String INIT_PARAMETER = "reports";

  public static final String SECURITY_OBJECT = "SecurityObject";

  public static final String NBS_SECURITY_OBJECT = "NBSSecurityObject";

  public static final String OBJECT_TYPE = "ObjectType";

  public static final String OPERATION_TYPE = "OperationType";

  public static final String OBSERVATION_UID = "observationUID";

  public static final String PERSON_FORM = "personForm";

  public static final String PERSON_UID = "personUID";

  public static final String PERSON_LOCALUID = "personLocalId";

  public static final String PERSON_DOB = "patientDateOfBirth";

  public static final String PERSON_SEX = "patientCurrentSex";

  public static final String VIEW_LABRESULT = "view";

  public static final String CREATE_LABRESULT = "create";

  public static final String EDIT_LABRESULT = "edit";

  public static final String ERROR_PAGE = "error";

  public static final String LOGIN_PAGE = "login";

  public static final String XSP_PAGE = "XSP";

  public static final String DELETE_PAGE = "viewDelete";

  public static final String DELETE_DENIED_PAGE = "deleteDenied";

  public static final String NEXT_PAGE = "next";

  public static final String POST_EDIT_VIEW = "viewLabResult";

  public static final String DS_PERSON_INFO = "DSPersonInfo";

  public static final String DS_PERSON_SUMMARY = "DSPersonSummary";

  public static final String DS_PERSON_MERGE_VO1 = "DSPersonMergeVO1";

  public static final String DS_PERSON_MERGE_VO2 = "DSPersonMergeVO2";

  public static final String DS_PERSON_MERGE_SURVIVING_VO = "DSPersonMergeSurvivingVO";

  public static final String DS_PERSON_MERGE_SUPERCEDED_VO = "DSPersonMergeSupercededVO";

  // ObservationProxy.setLabResultProxy Return constants
  public static final String SETLAB_RETURN_OBS_UID = "ObservationUid";

  public static final String SETLAB_RETURN_MPR_UID = "MPRUid";

  public static final String SETLAB_RETURN_OBS_LOCAL = "ObservationLocalId";
  public static final String SETLAB_RETURN_OBSDT = "ObservationDto";

  public static final String SETLAB_RETURN_MPR_LOCAL = "MPRLocalId";

  public static final String SETLAB_RETURN_JURISDICTION_ERRORS = "JurisdictionErrorCollection";

  public static final String SETLAB_RETURN_PROGRAM_AREA_ERRORS = "ProgramAreaErrorCollection";

  // program Area Code
  public static final String PROGRAM_AREA_CD = "S_PROGRA_C";

  public static final String ALLOWED_PROGRAM_AREAS = "AllowedProgramAreas";

  public static final String ALLOWED_JURISDICTIONS = "AllowedJurisdictions";

  public static final String ALLOWED_OBSERVATIONS = "AllowedObservations";

  public static final String LAB_TEST = "LAB_TEST";

  public static final String OBS_CTRL_FORM = "OBS_CTRL_FORM";

  // Obs ctrlCdDisplayForm
  public static final String LAB_CTRLCD_DISPLAY = "LabReport";

  public static final String MOB_CTRLCD_DISPLAY = "MorbReport";

  public static final String MOB_VACCINE_CONTAIN_ROW = "VaccinationContainRo";

  public static final String MOB_ITEM_TO_ROW = "ItemToRow";

  public static final String TREATMENT_TO_MORB_TYPE = "TreatmentToMorb";

  // morb participation constants
  public static final String MOB_SUBJECT_OF_MORB_REPORT = "SubjOfMorbReport";

  public static final String MOB_REPORTER_OF_MORB_REPORT = "ReporterOfMorbReport";

  public static final String MOB_PHYSICIAN_OF_MORB_REPORT = "PhysicianOfMorb";

  public static final String MOB_HOSP_OF_MORB_REPORT = "HospOfMorbObs";

  // LabReports Interpretation values
  public static final String QUALITATIVERESULTS = "QualitativeResults";
  ...
  //    public static final String NEDSSVO_CONFIG = PropertyUtil.propertiesDir +
  // "NEDSSVO_Config.xml";
  ...
  //    public static final String NEDSS_TRANSPORT_CONFIG_FILENAME = PropertyUtil.propertiesDir +
  // "NedssTransportConfig.xml";
  ...
  public static final String NND_REJECTED_NOTIFICATIONS_FOR_APPROVAL =
  ...
  public static final String MY_PROGRAM_AREAS_INVESTIGATIONS_QUEUE_SIZE =
      "MY_PROGRAM_AREAS_INVESTIGATIONS_QUEUE_SIZE";
  public static final String PAGE_MANAGEMENT_CONDITION_LIBRARY_QUEUE_SIZE =
      "PAGE_MANAGEMENT_CONDITION_LIBRARY_QUEUE_SIZE";
  public static final String PAGE_MANAGEMENT_VALUE_SET_LIBRARY_QUEUE_SIZE =
      "PAGE_MANAGEMENT_VALUE_SET_LIBRARY_QUEUE_SIZE";
  public static final String PAGE_MANAGEMENT_QUESTION_LIBRARY_QUEUE_SIZE =
      "PAGE_MANAGEMENT_QUESTION_LIBRARY_QUEUE_SIZE";
  public static final String PAGE_MANAGEMENT_PAGE_LIBRARY_QUEUE_SIZE =
      "PAGE_MANAGEMENT_PAGE_LIBRARY_QUEUE_SIZE";
  public static final String PAGE_MANAGEMENT_TEMPLATE_LIBRARY_QUEUE_SIZE =
      "PAGE_MANAGEMENT_TEMPLATE_LIBRARY_QUEUE_SIZE";
  public static final String MY_PROGRAM_AREAS_QUEUE_SORTBY_NEWEST_INV_STARTDATE =
  ...
  public static final String OBSERVATIONS_NEEDING_ASSIGNMENT_QUEUE_SIZE =
      "OBSERVATIONS_NEEDING_ASSIGNMENT_QUEUE_SIZE";
  public static final String OBSERVATIONS_NEEDING_REVIEW_QUEUE_SIZE =
      "OBSERVATIONS_NEEDING_REVIEW_QUEUE_SIZE";
  ...
  public static final String MANAGE_CONTACT_ASSOCIATIONS_QUEUE_SIZE =
      "MANAGE_CONTACT_ASSOCIATIONS_QUEUE_SIZE";
  public static final String MANAGE_COINFECTIONS_ASSOCIATIONS_QUEUE_SIZE =
      "MANAGE_COINFECTIONS_ASSOCIATIONS_QUEUE_SIZE";
  public static final String PAGE_MANAGEMENT_IMPORTEXPORT_LIBRARY_QUEUE_SIZE =
      "PAGE_MANAGEMENT_IMPORTEXPORT_LIBRARY_QUEUE_SIZE";
  public static final String MESSAGING_MANAGEMENT_ACTIVITYLOG_LIBRARY_QUEUE_SIZE =
      "MESSAGING_MANAGEMENT_ACTIVITYLOG_LIBRARY_QUEUE_SIZE";
  public static final String EPILINK_MANAGEMENT_ACTIVITYLOG_LIBRARY_QUEUE_SIZE =
      "EPILINK_MANAGEMENT_ACTIVITYLOG_LIBRARY_QUEUE_SIZE";
  public static final String ASSOCIATE_INVESTIGATIONS_QUEUE_SIZE =
      "ASSOCIATE_INVESTIGATIONS_QUEUE_SIZE";
  public static final String MESSAGE_QUEUE_SIZE = "MESSAGE_QUEUE_SIZE";
  public static final String PAGE_MANAGEMENT_PORT_PAGE_LIBRARY_QUEUE_SIZE =
      "PAGE_MANAGEMENT_PORT_PAGE_LIBRARY_QUEUE_SIZE";
  public static final String MANAGE_TRIGGERCODES_QUEUE_SIZE = "MANAGE_TRIGGERCODES_QUEUE_SIZE";
  public static final String IIS_PATIENT_SEARCH_RESULT_QUEUE_SIZE =
      "IIS_PATIENT_SEARCH_RESULT_QUEUE_SIZE";
  public static final String IIS_VACCINATION_SEARCH_RESULT_QUEUE_SIZE =
      "IIS_VACCINATION_SEARCH_RESULT_QUEUE_SIZE";
  ...
  public static final String NOTIFICATION_CODE_FILTER_ITEMS_COUNT =
      "NotificationCodeFilterItemsCount";
  ...
  public static final String RETURN_TO_ASSOCIATE_TO_INVESTIGATIONS =
  ...
  public static final String APPROVED_SHARED_NOTIFICATION_UID_LIST =
      "APPROVED_SHARED_NOTIFICATION_UID_LIST";
  public static final String APPROVED_TRANFERRED_NOTIFICATION_UID_LIST =
      "APPROVED_TRANFERRED_NOTIFICATION_UID_LIST";
  public static final String APPROVED_NND_NOTIFICATION_UID_LIST =
  ...
  /**
   * Question Entry Method - Denotes whether a question in the question library is created by the
   * user using the 'Add Question' user interface or predefined in the system.
   */
  ...
  public static enum CANADA {
    CAN,
    CA,
    PHVS_STATEPROVINCEOFEXPOSURE_CDC_CAN
  }

  public static String CANADA_124 = "124";

  public static enum USA {
    USA,
    US,
    PHVS_STATEPROVINCEOFEXPOSURE_CDC_US
  }

  public static String USA_840 = "840";

  public static enum MEXICO {
    MEX,
    MX,
    PHVS_STATEPROVINCEOFEXPOSURE_CDC_MEX
  }
  ...
  public static final String STD_PROCESSING_DECISION_LIST_LAB_SYPHILIS =
      "STD_LAB_SYPHILIS_PROC_DECISION";
  public static final String STD_PROCESSING_DECISION_LIST_MORB_SYPHILIS =
      "STD_MORB_SYPHILIS_PROC_DECISION";
  public static final String STD_PROCESSING_DECISION_LIST_NON_SYPHILIS =
      "STD_NONSYPHILIS_PROC_DECISION";
  public static final String STD_PROCESSING_DECISION_LIST_SYPHILIS_AND_NONSYPHILIS =
      "STD_UNKCOND_PROC_DECISION";
  ...
  public static final String STD_CREATE_INV_LAB_UNKCOND_PROC_DECISION =
      "STD_CREATE_INV_LAB_UNKCOND_PROC_DECISION";
  public static final String STD_CREATE_INV_LABMORB_NONSYPHILIS_PROC_DECISION =
      "STD_CREATE_INV_LABMORB_NONSYPHILIS_PROC_DECISION";
  public static final String STD_CREATE_INV_LABMORB_SYPHILIS_PROC_DECISION =
      "STD_CREATE_INV_LABMORB_SYPHILIS_PROC_DECISION";
  public static final String STD_CREATE_INV_LAB_SYPHILIS_PROC_DECISION =
      "STD_CREATE_INV_LAB_SYPHILIS_PROC_DECISION";
  public static final String STD_CREATE_INV_MORB_SYPHILIS_PROC_DECISION =
      "STD_CREATE_INV_MORB_SYPHILIS_PROC_DECISION";
  public static final String STD_NONSYPHILIS_PROC_DECISION = "STD_NONSYPHILIS_PROC_DECISION";
  public static final String STD_CONTACT_RCD_PROCESSING_DECISION =
      "STD_CONTACT_RCD_PROCESSING_DECISION";
  ...
  public static enum CLOSURE_INVESTGR {
    ClosureInvestgrOfPHC,
    NBS197
  };

  public static enum CURRENT_INVESTGR {
    InvestgrOfPHC,
    INV180
  };
  ...
  public static final String GENERIC_NO_POPUP_BUSINESS_OBJECT_TYPE =
      "GENERIC_NO_POPUP_BUSINESS_OBJECT_TYPE";
  ...
  // For fixing error when printing field follow-up form. If the param is "Filled" is shows Error
  // page. If we change the value to "NoBlank" we need to show on the frontend the value Filled for
  // making this change transparently to the user
  ...
  public static final String DATA_SOURCE_NOT_AVAILABLE =
      "The report or data source you are trying to access is not valid, because the data mart that feeds this report or data source is not currently available in the reporting database. Please contact your system administrator.";
  ...
  public static final String ERR109_PART2 =
      " since you have opened it. The system is unable to save your changes at this time. Please Cancel from this Edit and try again.";
