...
public class TreatmentContainer extends BaseContainer implements RootDtoInterface {
  ...
  /** index (Not for display purposes) */
  private String index;

  /** from per.person_uid (Not for display purposes) */
  ...
  /** from Treatment.treatmentUid (Not for display purposes) */
  ...
  /** from ar.target_act_uid PHC_uid (Not for display purposes) */
  private Long phcUid;

  /** from ar.target_act_uid parentUid (Not for display purposes) */
  ...
  /**
   * Populated by front-end to indicate if the isAssociated attribute may have been changed by the
   * user. (not for display purposes)
   */
  private boolean isTouched;

  /**
   * Set by back-end and front-end to indicate if an ActRelationship entry exists or should be
   * created to support associating the Vaccination with the Investigation. (not for display
   * purposes)
   */
  private boolean isAssociated;

  private Character
      isRadioBtnAssociated; // same as isAssociated but we need Character to be able to sort.
