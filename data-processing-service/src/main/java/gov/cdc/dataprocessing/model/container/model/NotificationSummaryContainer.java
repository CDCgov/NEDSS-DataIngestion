...
public class NotificationSummaryContainer extends BaseContainer implements RootDtoInterface {
  ...
  /** from NotificationDT.notificationtionUid (Not for display purposes) */
  ...
  /** from Code_Value_General.code_desc_txt where Code_Value_General.code_set_nm = 'S_JURDIC_C' */
  ...
  // The following variable is required to control the Special Character's of Recipient which is
  // coming from the manageSystems
