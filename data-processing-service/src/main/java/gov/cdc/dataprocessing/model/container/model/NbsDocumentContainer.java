...
@Getter
@Setter
public class NbsDocumentContainer extends BaseContainer
    implements ReportSummaryInterface, RootDtoInterface {
  ...
  private Map<String, EDXEventProcessCaseSummaryDto> eDXEventProcessCaseSummaryDTMap =
      new HashMap<String, EDXEventProcessCaseSummaryDto>();
