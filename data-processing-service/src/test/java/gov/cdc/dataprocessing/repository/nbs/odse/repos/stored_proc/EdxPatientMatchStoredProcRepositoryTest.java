...
class EdxPatientMatchStoredProcRepositoryTest {
  ...
  @InjectMocks private EdxPatientMatchStoredProcRepository repository;
  ...
  void testGetEdxPatientMatch() throws DataProcessingException {
    ...
    when(storedProcedureQuery.registerStoredProcedureParameter(
        ...
        .thenReturn(storedProcedureQuery);
    when(storedProcedureQuery.setParameter(anyString(), anyString()))
        .thenReturn(storedProcedureQuery);
  ...
  void testGetEdxPatientMatch_ThrowsException() {
    ...
    assertThrows(
        DataProcessingException.class, () -> repository.getEdxPatientMatch(typeCd, matchString));
  }
  ...
  void testGetEdxEntityMatch_ThrowsException() {
    ...
    assertThrows(
        DataProcessingException.class, () -> repository.getEdxEntityMatch(typeCd, matchString));
  }
}
