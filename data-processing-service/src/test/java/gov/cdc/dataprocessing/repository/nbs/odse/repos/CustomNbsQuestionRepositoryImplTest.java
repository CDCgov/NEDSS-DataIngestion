...
class CustomNbsQuestionRepositoryImplTest {
  ...
  @InjectMocks private CustomNbsQuestionRepositoryImpl customNbsQuestionRepository;
  ...
  void testRetrieveQuestionRequiredNnd() {
    ...
    mockResultList.add(new Object[] {1L, "questionIdentifier", "questionLabel", "dataLocation"});
