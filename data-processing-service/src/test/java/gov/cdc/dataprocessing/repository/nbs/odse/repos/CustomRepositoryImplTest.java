...
class CustomRepositoryImplTest {
  ...
  void getLdfCollection_shouldReturnListOfStateDefinedFieldDataDto_whenResultsAreNotEmpty() {
    ...
    String theQuery =
        "SELECT * FROM table WHERE businessObjUid = :businessObjUid AND conditionCd = :conditionCd";
    Query mockQuery = mock(Query.class);
    List<Object[]> mockResults = new ArrayList<>();
    mockResults.add(
        new Object[] {
          1L, "TestObject", "2021-01-01 10:00:00", 1L, "2021-01-02 10:00:00", "Value", 1
        });
    ...
    // Act
    List<StateDefinedFieldDataDto> result =
        customRepositoryImpl.getLdfCollection(busObjectUid, conditionCode, theQuery);
  ...
  void getAssociatedDocumentList_shouldReturnMapOfDocuments_whenResultsAreNotEmpty() {
    ...
    String theQuery =
        "SELECT * FROM documents WHERE TargetActUid = :TargetActUid AND SourceClassCd = :SourceClassCd AND TargetClassCd = :TargetClassCd";
    Query mockQuery = mock(Query.class);
    List<Object[]> mockResults =
        List.of(new Object[] {"doc1", "123"}, new Object[] {"doc2", "456"});
    when(entityManager.createNativeQuery(theQuery)).thenReturn(mockQuery);
    ...
    Map<Object, Object> result =
        customRepositoryImpl.getAssociatedDocumentList(uid, targetClassCd, sourceClassCd, theQuery);
  ...
  void getEDXEventProcessMapByCaseId_shouldReturnMapOfEDXEventProcessDto_whenResultsAreNotEmpty() {
    ...
    String docQuery =
        " SELECT"
            ...
            + " edx_event_process.add_user_id \"addUserId\", "
            + " edx_event_process.add_time \"addTime\", "
    ...
    // Act
    Map<String, EDXEventProcessDto> result =
        customRepositoryImpl.getEDXEventProcessMapByCaseId(publicHealthCaseUid);
  ...
  @Test
  void
      retrieveDocumentSummaryVOForInv_shouldReturnMapOfDocumentSummaryContainer_whenResultsAreNotEmpty() {
    ...
    // Act
    Map<Object, Object> result =
        customRepositoryImpl.retrieveDocumentSummaryVOForInv(publicHealthUID);
  ...
  @Test
  void
      retrieveNotificationSummaryListForInvestigation_shouldReturnListOfNotificationSummaryContainer_whenResultsAreNotEmpty() {
    // Arrange
    Long publicHealthUID = 1L;
    Query mockQuery = mock(Query.class);
    var objList =
    ...
    // Act
    List<NotificationSummaryContainer> result =
        customRepositoryImpl.retrieveNotificationSummaryListForInvestigation(
            publicHealthUID, any());
  ...
  @Test
  void
      retrieveTreatmentSummaryVOForInv_shouldReturnMapOfTreatmentContainer_whenResultsAreNotEmpty() {
    // Arrange
    Long publicHealthUID = 1L;
    Query mockQuery = mock(Query.class);
    var objList =
    ...
    // Act
    Map<Object, Object> result =
        customRepositoryImpl.retrieveTreatmentSummaryVOForInv(publicHealthUID, any());
  ...
  void getAssociatedInvList_shouldReturnMap_whenResultsAreNotEmptyAndSourceClassCdIsObs() {
    ...
    // Act
    Map<Object, Object> result =
        customRepositoryImpl.getAssociatedInvList(uid, sourceClassCd, any());
  ...
  @Test
  void
      getSusceptibilityResultedTestSummary_shouldReturnListOfResultedTestSummaryContainer_whenResultsAreNotEmpty() {
    // Arrange
    ...
    // Act
    ArrayList<ResultedTestSummaryContainer> result =
        customRepositoryImpl.getSusceptibilityResultedTestSummary(typeCode, observationUid);
  ...
  void getSusceptibilityUidSummary_shouldReturnListOfUidSummaryContainer_whenResultsAreNotEmpty() {
    ...
    // Act
    ArrayList<UidSummaryContainer> result =
        customRepositoryImpl.getSusceptibilityUidSummary(
            rvo, labRepEvent, labRepSumm, typeCode, observationUid);
  ...
  @Test
  void
      getTestAndSusceptibilities_shouldReturnListOfResultedTestSummaryContainer_whenResultsAreNotEmpty() {
    // Arrange
    String typeCode = "TypeCodeExample";
    Long observationUid = 1L;
    LabReportSummaryContainer labRepEvent = new LabReportSummaryContainer();
    ...
    // Act
    ArrayList<ResultedTestSummaryContainer> result =
        customRepositoryImpl.getTestAndSusceptibilities(
            typeCode, observationUid, labRepEvent, labRepSumm);
  ...
  void getOrderingPersonPhone_shouldSetProviderPhoneAndExtension_whenResultsAreNotEmpty() {
    ...
    // Act
    ProviderDataForPrintContainer result =
        customRepositoryImpl.getOrderingPersonPhone(providerDataForPrintVO, organizationUid);
  ...
  void getOrderingPersonAddress_shouldSetProviderAddress_whenResultsAreNotEmpty() {
    ...
    // Act
    ProviderDataForPrintContainer result =
        customRepositoryImpl.getOrderingPersonAddress(providerDataForPrintVO, organizationUid);
  ...
  void getOrderingFacilityPhone_shouldSetFacilityPhoneAndExtension_whenResultsAreNotEmpty() {
    ...
    // Act
    ProviderDataForPrintContainer result =
        customRepositoryImpl.getOrderingFacilityPhone(providerDataForPrintVO, organizationUid);
  ...
  void getOrderingFacilityAddress_shouldSetFacilityAddress_whenResultsAreNotEmpty() {
    ...
    // Act
    ProviderDataForPrintContainer result =
        customRepositoryImpl.getOrderingFacilityAddress(providerDataForPrintVO, organizationUid);
  ...
  @Test
  void
      getContactByPatientInfo_shouldReturnCollectionOfCTContactSummaryDto_whenResultsAreNotEmpty() {
    // Arrange
    ...
    var objList =
        new Object[] {
          ...
          "ProgAreaCd",
          4L,
          "ContactReferralBasisCd",
          5L,
          6L,
          "ContactProcessingDecision",
          "SourceDispositionCd",
          "SourceConditionCd",
          "SourceCurrentSexCd",
          "1",
    ...
    // Act
    Collection<CTContactSummaryDto> result =
        customRepositoryImpl.getContactByPatientInfo(queryString);
  ...
  @Test
  void getNbsDocument_shouldReturnNbsDocumentContainer_whenResultsAreNotEmpty()
  ...
  @Test
  void
      getInvListForCoInfectionId_shouldReturnListOfCoinfectionSummaryContainer_whenResultsAreNotEmpty() {
    // Arrange
    Long mprUid = 1L;
    ...
    ArrayList<Object> result =
        customRepositoryImpl.getInvListForCoInfectionId(mprUid, coInfectionId);
