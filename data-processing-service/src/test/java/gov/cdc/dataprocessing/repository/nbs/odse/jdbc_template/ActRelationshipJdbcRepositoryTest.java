...
class ActRelationshipJdbcRepositoryTest {
  ...
  @InjectMocks private ActRelationshipJdbcRepository repository;
  ...
  void testInsertActRelationship() {
    ...
    verify(jdbcTemplateOdse)
        .update(eq(INSERT_SQL_ACT_RELATIONSHIP), any(MapSqlParameterSource.class));
  }
  ...
  void testUpdateActRelationship() {
    ...
    verify(jdbcTemplateOdse)
        .update(eq(UPDATE_SQL_ACT_RELATIONSHIP), any(MapSqlParameterSource.class));
  }
  ...
  void testInsertActRelationshipHistory() {
    ...
    verify(jdbcTemplateOdse)
        .update(eq(CREATE_ACT_RELATIONSHIP_HISTORY), any(MapSqlParameterSource.class));
  }
  ...
  void testDeleteActRelationship() {
    ...
    verify(jdbcTemplateOdse)
        .update(eq(DELETE_SQL_ACT_RELATIONSHIP), any(MapSqlParameterSource.class));
  }
  ...
  void testFindBySourceActUidAndTypeCode() {
    ...
    when(jdbcTemplateOdse.query(
            eq(SELECT_BY_SOURCE_AND_TYPE_CODE),
            any(MapSqlParameterSource.class),
            any(BeanPropertyRowMapper.class)))
        .thenReturn(List.of(act));
