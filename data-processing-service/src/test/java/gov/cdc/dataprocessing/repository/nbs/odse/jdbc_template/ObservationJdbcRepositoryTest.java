...
class ObservationJdbcRepositoryTest {
  ...
  @InjectMocks private ObservationJdbcRepository repository;
  ...
  void testFindObservationByUid() {
    ...
    when(jdbcTemplate.queryForObject(
            anyString(), any(MapSqlParameterSource.class), any(BeanPropertyRowMapper.class)))
        .thenReturn(mockObs);
  ...
  void testFindByObservationInterp() {
    ...
    when(jdbcTemplate.query(
            any(String.class), any(MapSqlParameterSource.class), any(BeanPropertyRowMapper.class)))
