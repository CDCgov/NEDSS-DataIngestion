...
class NbsInterfaceStoredProcRepositoryTest {
  ...
  @InjectMocks private NbsInterfaceStoredProcRepository repository;
  ...
  void testUpdateSpecimenCollDateSP() throws DataProcessingException {
    ...
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("NBSInterfaceUid", Integer.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter(
            "specimentCollectionDate", Timestamp.class, ParameterMode.IN);
