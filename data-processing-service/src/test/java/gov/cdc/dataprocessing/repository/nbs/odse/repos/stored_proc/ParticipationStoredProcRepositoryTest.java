...
class ParticipationStoredProcRepositoryTest {
  ...
  @InjectMocks private ParticipationStoredProcRepository repository;
  ...
  void testInsertParticipation() {
    ...
    when(storedProcedureQuery.registerStoredProcedureParameter(
            anyString(), eq(Long.class), eq(ParameterMode.IN)))
        .thenReturn(storedProcedureQuery);
    when(storedProcedureQuery.registerStoredProcedureParameter(
            anyString(), eq(String.class), eq(ParameterMode.IN)))
        .thenReturn(storedProcedureQuery);
    when(storedProcedureQuery.registerStoredProcedureParameter(
            anyString(), eq(Timestamp.class), eq(ParameterMode.IN)))
        .thenReturn(storedProcedureQuery);
    when(storedProcedureQuery.registerStoredProcedureParameter(
            anyString(), eq(Integer.class), eq(ParameterMode.IN)))
        .thenReturn(storedProcedureQuery);
    ...
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("subject_entity_uid", Long.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("act_uid", Long.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("type_cd", String.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("add_reason_cd", String.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("addtime", Timestamp.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("add_user_id", Long.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("awareness_cd", String.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("awareness_desc_txt", String.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("cd", String.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("duration_amt", String.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("duration_unit_cd", String.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("from_time", Timestamp.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("last_chg_reason_cd", String.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("last_chg_time", Timestamp.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("last_chg_user_id", Long.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("record_status_cd", String.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("record_status_time", Timestamp.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("role_seq", Integer.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("status_cd", String.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("status_time", Timestamp.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("to_time", Timestamp.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("type_desc_txt", String.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("user_affiliation_txt", String.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("subject_class_cd", String.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("act_class_cd", String.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .setParameter("subject_entity_uid", participationDto.getSubjectEntityUid());
    ...
    verify(storedProcedureQuery)
        .setParameter("awareness_desc_txt", participationDto.getAwarenessDescTxt());
    ...
    verify(storedProcedureQuery)
        .setParameter("duration_unit_cd", participationDto.getDurationUnitCd());
    verify(storedProcedureQuery).setParameter("from_time", participationDto.getFromTime());
    verify(storedProcedureQuery)
        .setParameter("last_chg_reason_cd", participationDto.getLastChgReasonCd());
    verify(storedProcedureQuery).setParameter("last_chg_time", participationDto.getLastChgTime());
    verify(storedProcedureQuery)
        .setParameter("last_chg_user_id", participationDto.getLastChgUserId());
    verify(storedProcedureQuery)
        .setParameter("record_status_cd", participationDto.getRecordStatusCd());
    verify(storedProcedureQuery)
        .setParameter("record_status_time", participationDto.getRecordStatusTime());
    ...
    verify(storedProcedureQuery)
        .setParameter("user_affiliation_txt", participationDto.getUserAffiliationTxt());
    verify(storedProcedureQuery)
        .setParameter("subject_class_cd", participationDto.getSubjectClassCd());
