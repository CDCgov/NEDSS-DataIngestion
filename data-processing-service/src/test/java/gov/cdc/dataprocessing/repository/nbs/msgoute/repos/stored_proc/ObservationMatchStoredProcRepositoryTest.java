...
class ObservationMatchStoredProcRepositoryTest {
  ...
  @InjectMocks private ObservationMatchStoredProcRepository repository;
  ...
  void testGetMatchedObservation() throws DataProcessingException {
    ...
    when(storedProcedureQuery.registerStoredProcedureParameter(
        ...
        .thenReturn(storedProcedureQuery);
    when(storedProcedureQuery.registerStoredProcedureParameter(
            anyString(), eq(Long.class), eq(ParameterMode.OUT)))
        .thenReturn(storedProcedureQuery);
    ...
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("fillerNbr", String.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("labCLIA", String.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("orderedTestCd", String.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter(
            "specimenCollectionDate", Timestamp.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("numberOfGoBackYears", Integer.class, ParameterMode.IN);
    verify(storedProcedureQuery)
        .registerStoredProcedureParameter("Observation_uid", Long.class, ParameterMode.OUT);
    ...
    verify(storedProcedureQuery)
        .setParameter("specimenCollectionDate", observationDto.getEffectiveFromTime());
  ...
  void testGetMatchedObservation_ThrowsException() {
    ...
    assertThrows(
        ...
        () -> repository.getMatchedObservation(edxLabInformationDto));
  }
}
