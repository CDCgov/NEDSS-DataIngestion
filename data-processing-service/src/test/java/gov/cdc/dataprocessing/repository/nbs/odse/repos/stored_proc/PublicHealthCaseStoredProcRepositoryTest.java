...
class PublicHealthCaseStoredProcRepositoryTest {
  ...
  @InjectMocks private PublicHealthCaseStoredProcRepository repository;
  ...
  void testAssociatedPublicHealthCaseForMprForCondCd() throws DataProcessingException {
    ...
    Collection<PublicHealthCaseDto> result =
        repository.associatedPublicHealthCaseForMprForCondCd(mprUid, conditionCode);
  ...
  void testGetEDXEventProcessMap_ThrowsException() {
    ...
    assertThrows(
        DataProcessingException.class, () -> repository.getEDXEventProcessMap(nbsDocumentUid));
  }
}
