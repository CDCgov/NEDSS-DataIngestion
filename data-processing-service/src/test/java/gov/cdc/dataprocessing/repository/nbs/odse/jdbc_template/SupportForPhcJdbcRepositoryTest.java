...
class SupportForPhcJdbcRepositoryTest {
  ...
  @InjectMocks private SupportForPhcJdbcRepository repository;
  ...
  void testFindPlaceById() {
    ...
    when(jdbcTemplate.query(
            any(), any(MapSqlParameterSource.class), any(BeanPropertyRowMapper.class)))
  ...
  void testFindPatientEncounterById() {
    ...
    when(jdbcTemplate.query(
            eq(PatientEncounterQuery.FIND_BY_ID),
  ...
  void testFindReferralById() {
    ...
    when(jdbcTemplate.query(
            eq(ReferralDocQuery.FIND_BY_ID),
            any(MapSqlParameterSource.class),
            any(BeanPropertyRowMapper.class)))
  ...
  void testFindClinicalDocumentById() {
    ...
    when(jdbcTemplate.query(
            eq(ClinicalDocumentQuery.FIND_BY_ID),
            any(MapSqlParameterSource.class),
            any(BeanPropertyRowMapper.class)))
  ...
  void testFindNonPersonLivingSubjectById() {
    ...
    when(jdbcTemplate.query(
            eq(NonPersonLivingSubjectQuery.FIND_BY_ID),
            any(MapSqlParameterSource.class),
            any(BeanPropertyRowMapper.class)))
