...
class Observation_SummaryRepositoryImplTest {
  ...
  @Mock private TypedQuery<Observation_Lab_Summary_ForWorkUp_New> typedQuery;

  @InjectMocks private Observation_SummaryRepositoryImpl repository;
  ...
  void testFindAllActiveLabReportUidListForManage_NoResults() {
    ...
    Collection<Observation_Summary> result =
  ...
  void testFindLabSummaryForWorkupNew() {
    ...
    when(entityManager.createQuery(anyString(), eq(Observation_Lab_Summary_ForWorkUp_New.class)))
    ...
    Optional<Collection<Observation_Lab_Summary_ForWorkUp_New>> result =
        repository.findLabSummaryForWorkupNew(personParentUid, whereClause);
  ...
  void testFindAllActiveLabReportUidListForManage() {
    ...
    mockResultList.add(
        new Object[] {1L, new Timestamp(System.currentTimeMillis()), "addReasonCd1"});
    mockResultList.add(
        new Object[] {2L, new Timestamp(System.currentTimeMillis()), "addReasonCd2"});
