...
class ActLocatorParticipationJdbcRepositoryTest {
  ...
  @InjectMocks private ActLocatorParticipationJdbcRepository repository;
  ...
  void testInsertActLocatorParticipation_shouldCallUpdate() {
    ...
    verify(jdbcTemplateOdse)
        .update(eq(INSERT_SQL_ACT_LOCATOR_PAT), any(MapSqlParameterSource.class));
  }
  ...
  void testUpdateActLocatorParticipation_shouldCallUpdate() {
    ...
    verify(jdbcTemplateOdse)
        .update(eq(UPDATE_SQL_ACT_LOCATOR_PAT), any(MapSqlParameterSource.class));
  }
