...
class ObservationUtilTest {
  @InjectMocks private ObservationUtil observationUtil;
  ...
  void getUid_Test() {
    ...
    var res =
        observationUtil.getUid(
            participationDtoCollection,
            actRelationshipDtoCollection,
            uidListType,
            uidClassCd,
            uidTypeCd,
            uidActClassCd,
  ...
  void testGetRootObservationContainerFromObsCollection_returnsNull_whenCollectionIsNull() {
    ObservationContainer result =
        observationUtil.getRootObservationContainerFromObsCollection(null, true);
    assertNull(result);
  }
  ...
  void testGetRootObservationContainerFromObsCollection_returnsNull_whenNoMatch() {
    ...
    ObservationContainer result =
        observationUtil.getRootObservationContainerFromObsCollection(obsColl, true);
    assertNull(result);
  }
  ...
  void testReturnsContainerWhenCtrlCdIsLabReport() {
    ...
    ObservationContainer result =
        observationUtil.getRootObservationContainerFromObsCollection(
  ...
  void testReturnsContainerWhenObsDomainIsOrderedTestAndIsLabReportTrue() {
    ObservationContainer container =
        createObservation(null, NEDSSConstant.ORDERED_TEST_OBS_DOMAIN_CD);
    ObservationContainer result =
        observationUtil.getRootObservationContainerFromObsCollection(
  ...
  @Test
  void testGetRootObservationDto_returnsNullWhenRootContainerIsNull()
  ...
  void testGetUid_returnsNullWhenSubjectClassCdIsNull() {
    ...
    Long result =
        observationUtil.getUid(
            Collections.singletonList(dto), null, "ignored", "CLS", "TYPE", "ACT", "ACTIVE");
    assertNull(result);
  }
  ...
  private ActRelationshipDto createActRel(
      String sourceCls,
      String typeCd,
      String targetCls,
      String statusCd,
  ...
  void testGetUid_returnsTargetUidWhenAllActRelConditionsMatch() {
    ...
    Long result =
        observationUtil.getUid(
            ...
            NEDSSConstant.ACT_UID_LIST_TYPE,
            "SRC",
            "TYPE",
            "TRG",
            "ACTIVE");
  ...
  void testGetUid_returnsSourceUidWhenAllActRelConditionsMatchWithSourceType() {
    ...
    Long result =
        observationUtil.getUid(
            null,
            Collections.singletonList(dto),
            NEDSSConstant.SOURCE_ACT_UID_LIST_TYPE,
            "SRC",
            "TYPE",
            "TRG",
            "ACTIVE");
