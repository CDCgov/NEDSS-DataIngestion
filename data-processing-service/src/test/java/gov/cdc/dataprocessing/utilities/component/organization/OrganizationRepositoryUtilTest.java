...
class OrganizationRepositoryUtilTest {
  @Mock private OrganizationJdbcRepository organizationRepository;
  @Mock private OrganizationNameJdbcRepository organizationNameRepository;
  @Mock private EntityJdbcRepository entityRepository;
  @Mock private EntityIdJdbcRepository entityIdRepository;
  @Mock private EntityLocatorJdbcRepository entityLocatorParticipationRepository;
  @Mock private RoleJdbcRepository roleRepository;

  @Mock private IOdseIdGeneratorWCacheService odseIdGeneratorService;
  @Mock private EntityHelper entityHelper;
  @Mock private ParticipationJdbcRepository participationRepository;
  @Mock private PrepareAssocModelHelper prepareAssocModelHelper;
  @Mock private PrepareEntityStoredProcRepository prepareEntityStoredProcRepository;
  @Mock AuthUtil authUtil;
  @InjectMocks private OrganizationRepositoryUtil organizationRepositoryUtil;
  ...
  void createOrganization() throws DataProcessingException {
    ...
    when(odseIdGeneratorService.getValidLocalUid(LocalIdClass.ORGANIZATION, true))
        .thenReturn(localIdModel);
    ...
    EntityLocatorParticipationDto entityLocatorParticipationDtoPh =
        getEntityLocatorParticipationDto_ph();
    EntityLocatorParticipationDto entityLocatorParticipationDtoPo =
        getEntityLocatorParticipationDto_po();
    EntityLocatorParticipationDto entityLocatorParticipationDtoTel =
        getEntityLocatorParticipationDto_tel();

    organizationContainer
        .getTheEntityLocatorParticipationDtoCollection()
        .add(entityLocatorParticipationDtoPh);
    organizationContainer
        .getTheEntityLocatorParticipationDtoCollection()
        .add(entityLocatorParticipationDtoPo);
    organizationContainer
        .getTheEntityLocatorParticipationDtoCollection()
        .add(entityLocatorParticipationDtoTel);

    LocalUidModel localUidGenerator = getLocalUidGenerator();
    when(odseIdGeneratorService.getValidLocalUid(LocalIdClass.ORGANIZATION, true))
        .thenReturn(localUidGenerator);
  ...
  void setOrganization_throw_exp() {
    ...
    assertThrows(
        ...
        () -> organizationRepositoryUtil.setOrganization(organizationContainer, "TEST"));
  }
  ...
  void setOrganization_for_loadObj() throws DataProcessingException {
    ...
    EntityLocatorParticipation entityLocatorParticipationPh =
        new EntityLocatorParticipation(entityLocatorParticipationDtoPh, "UTC");
    EntityLocatorParticipation entityLocatorParticipationPo =
        new EntityLocatorParticipation(entityLocatorParticipationDtoPo, "UTC");
    EntityLocatorParticipation entityLocatorParticipationTel =
        new EntityLocatorParticipation(entityLocatorParticipationDtoTel, "UTC");
    ...
    when(entityLocatorParticipationRepository.findByEntityUid(123L))
        .thenReturn(entityLocatorParticipations);
    //
    ...
    when(prepareEntityStoredProcRepository.getPrepareEntity(any(), any(), any(), any()))
        .thenReturn(prepareEntity);
  ...
  void loadObject() {
    ...
    PhysicalLocator physicalLocator =
        new PhysicalLocator(entityLocatorParticipationDtoPh.getThePhysicalLocatorDto());
    PostalLocator postalLocator =
        new PostalLocator(entityLocatorParticipationDtoPo.getThePostalLocatorDto());
    TeleLocator teleLocator =
        new TeleLocator(entityLocatorParticipationDtoTel.getTheTeleLocatorDto());
    ...
    when(entityLocatorParticipationRepository.findByPhysicalLocatorUids(any()))
        .thenReturn(physicalLocatorList);
    when(entityLocatorParticipationRepository.findByPostalLocatorUids(any()))
        .thenReturn(postalLocatorList);
    when(entityLocatorParticipationRepository.findByTeleLocatorUids(any()))
        .thenReturn(teleLocatorList);
    ...
    when(participationRepository.selectParticipationBySubjectAndActUid(123L, 123L))
  ...
  void prepareVO_thow_exp() {
    ...
    assertThrows(
        DataProcessingException.class,
        () ->
            organizationRepositoryUtil.prepareVO(
                organizationDto, "TEST_BTCD", "ORG", "TEST_MODULE"));
  }

  @Test
  void getPrepareEntityForOrganization() throws DataProcessingException {
    when(organizationRepositoryUtil.getPrepareEntityForOrganization("TEST", "TEST", 123L, "TEST"))
        .thenThrow(Mockito.mock(DataProcessingException.class));
    assertThrows(
        DataProcessingException.class,
        () ->
            organizationRepositoryUtil.getPrepareEntityForOrganization(
                "TEST", "TEST", 123L, "TEST"));
  }
