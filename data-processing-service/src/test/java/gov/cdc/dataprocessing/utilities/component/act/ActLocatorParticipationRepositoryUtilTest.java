...
class ActLocatorParticipationRepositoryUtilTest {
  @InjectMocks private ActLocatorParticipationRepositoryUtil actLocatorParticipationRepositoryUtil;
  ...
  void testGetActLocatorParticipationCollection() {
    ...
    when(actLocatorParticipationRepository.findByActUid(actUid))
        .thenReturn(actLocatorParticipations);

    Collection<ActivityLocatorParticipationDto> result =
        actLocatorParticipationRepositoryUtil.getActLocatorParticipationCollection(actUid);
  ...
  void testInsertActLocatorParticipationCollection() {
    ...
    actLocatorParticipationRepositoryUtil.insertActLocatorParticipationCollection(
        uid, activityLocatorParticipationDtoCollection);

    verify(actLocatorParticipationRepository, times(1))
        .mergeActLocatorParticipation(any(ActLocatorParticipation.class));
  ...
  void testInsertActLocatorParticipationCollectionEmpty() {
    ...
    verify(actLocatorParticipationRepository, times(0))
        .mergeActLocatorParticipation(any(ActLocatorParticipation.class));
  }
}
