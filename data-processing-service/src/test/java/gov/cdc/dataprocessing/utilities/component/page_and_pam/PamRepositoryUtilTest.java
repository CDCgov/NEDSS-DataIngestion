...
class PamRepositoryUtilTest {
  ...
  @InjectMocks private PamRepositoryUtil pamRepositoryUtil;
  ...
  void getPamHistory_Test_Exp_1() {
    ...
    when(nbsActEntityRepository.getNbsActEntitiesByActUid(1L))
  ...
  void getPamHistory_Test_Exp_2() {
    ...
    when(nbsCaseAnswerRepository.getNbsCaseAnswerByActUid(1L))
        .thenThrow(new RuntimeException("TEST"));
