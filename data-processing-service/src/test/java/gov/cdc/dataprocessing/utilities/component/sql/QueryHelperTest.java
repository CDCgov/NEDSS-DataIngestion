...
class QueryHelperTest {
  ...
  @InjectMocks private QueryHelper queryHelper;

  @Mock private QueryHelper queryHelperMock;
  ...
  void testBuildWhereClause_BothNonEmpty() {
    // Arrange
    when(queryHelperMock.buildOwnerWhereClause(
            "ownerList", "columnName", "alias", true, "businessObjLookupName"))
        .thenReturn("ownerWhereClause");
    when(queryHelperMock.buildGuestWhereClause(
            "guestList", "columnName", "alias", true, "businessObjLookupName"))
        .thenReturn("guestWhereClause");

    // Act
    String result =
        queryHelper.buildWhereClause(
            "ownerList", "guestList", "columnName", "alias", true, "businessObjLookupName");
  ...
  void testBuildWhereClause_BothEmpty_2() {
    ...
    // Act
    String result =
        queryHelper.buildWhereClause("", "", "columnName", "alias", true, "businessObjLookupName");
  ...
  void getHashedPAJList_WithNonGuestRoles_ReturnsCorrectList() throws DataProcessingException {
    ...
    AuthUtil.authUserRealizedRoleCollection =
        Arrays.asList(guestRole, nonGuestRole1, nonGuestRole2);
