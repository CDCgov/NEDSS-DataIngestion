...
class ObservationRequestHandlerTest {
  ...
  @Mock private HL7SpecimenUtil hl7SpecimenUtil;
  @Mock private HL7PatientHandler hl7PatientHandler;
  @InjectMocks private ObservationRequestHandler observationRequestHandler;
  ...
  void getObservationRequest_Test() throws DataProcessingException {
    ...
    when(checkingValueService.findToCode(eq("ELR_LCA_STATUS"), any(), eq("ACT_OBJ_ST")))
        .thenReturn("TEST");
    ...
    var result =
        observationRequestHandler.getObservationRequest(
            hl7OBRType, hl7PatientResultSPMType, labResultProxyContainer, edxLabInformationDto);
  ...
  @Test
  void getObservationRequest_Test_MissingOrderingProviderAndFacility()
    ...
    assertNotNull(thrown);
    assertTrue(
        thrown.getMessage().contains("Both Ordering Provider and Ordering facility are null"));
  }
