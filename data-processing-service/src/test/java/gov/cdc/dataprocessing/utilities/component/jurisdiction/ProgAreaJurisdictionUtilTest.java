...
class ProgAreaJurisdictionUtilTest {
  ...
  @InjectMocks private ProgAreaJurisdictionUtil util;
  ...
  void testGetPAJHash_validInputs() throws DataProcessingException {
    when(cacheApiService.getSrteCacheString(
            ObjectName.PROGRAM_AREA_CODES_WITH_NBS_UID.name(), "PA01"))
        .thenReturn("101");
    when(cacheApiService.getSrteCacheString(
            ObjectName.JURISDICTION_CODE_WITH_NBS_UID.name(), "J01"))
        .thenReturn("202");
  ...
  void testGetPAJHashList_allJurisdictions() throws Exception {
    ...
    when(cacheApiService.getSrteCacheString(
        ...
        .thenReturn("201");
    when(cacheApiService.getSrteCacheString(
            ObjectName.JURISDICTION_CODE_WITH_NBS_UID.name(), "J02"))
        .thenReturn("202");
