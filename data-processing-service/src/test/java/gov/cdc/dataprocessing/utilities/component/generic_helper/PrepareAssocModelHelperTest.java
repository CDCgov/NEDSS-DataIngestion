...
class PrepareAssocModelHelperTest {
  @InjectMocks @Spy private PrepareAssocModelHelper prepareAssocModelHelper;

  @Mock private PrepareEntityStoredProcRepository prepareEntityStoredProcRepository;

  @Mock private ProgAreaJurisdictionUtil progAreaJurisdictionUtil;

  @Mock private ConcurrentCheck concurrentCheck;
  @Mock private ActivityLocatorParticipationDto activityLocatorParticipationInterface;

  @Mock private AuthUtil authUtil;

  @Mock private ActRelationshipDto assocDTInterface;
  @Mock private ParticipationDto participationInterface;

  @Mock private ActRelationshipDto actInterface;
  @Mock private RoleDto roleInterface;
  ...
  void testPrepareAssocDTForEntityLocatorParticipation() throws DataProcessingException {
    ...
    EntityLocatorParticipationDto result =
        prepareAssocModelHelper.prepareAssocDTForEntityLocatorParticipation(dto);
  ...
  void testPrepareActivityLocatorParticipationDT() throws DataProcessingException {
    ...
    ActivityLocatorParticipationDto result =
        prepareAssocModelHelper.prepareActivityLocatorParticipationDT(dto);
  ...
  void testPrepareVO_NewAct() throws DataProcessingException {
    ...
    when(prepareEntityStoredProcRepository.getPrepareEntity(
    ...
    RootDtoInterface result =
        prepareAssocModelHelper.prepareVO(
            rootDto, "businessObjLookupName", "businessTriggerCd", "tableName", "moduleCd", 1);
  ...
  void testPrepareNewActVO() throws DataProcessingException {
    ...
    RootDtoInterface result =
        prepareAssocModelHelper.prepareNewActVO(
            rootDto, "businessObjLookupName", "businessTriggerCd", "tableName", "moduleCd");
  ...
  void testPrepareNewEntityVO() throws DataProcessingException {
    ...
    RootDtoInterface result =
        prepareAssocModelHelper.prepareNewEntityVO(
            rootDto, "businessObjLookupName", "businessTriggerCd", "tableName", "moduleCd");
  ...
  void testPrepareDirtyActVO() throws DataProcessingException {
    ...
    RootDtoInterface result =
        prepareAssocModelHelper.prepareDirtyActVO(
            rootDto, "businessObjLookupName", "businessTriggerCd", "tableName", "moduleCd");
  ...
  void testPrepareDirtyEntityVO() throws DataProcessingException {
    ...
    RootDtoInterface result =
        prepareAssocModelHelper.prepareDirtyEntityVO(
            rootDto, "businessObjLookupName", "businessTriggerCd", "tableName", "moduleCd");
  ...
  void testPrepareAssocDTForActivityLocatorParticipation_RecordStatusCdNull() {
    ...
    DataProcessingException exception =
        assertThrows(
            ...
            () -> {
              prepareAssocModelHelper.prepareAssocDTForActivityLocatorParticipation(
                  assocDTInterface1);
            });

    assertTrue(
        exception.getMessage().contains("RecordStatusCd -----2----null   statusCode--------null"));
  }
  ...
  @Test
  void testPrepareAssocDTForActivityLocatorParticipation_ValidRecordStatusCd()
  ...
  void testPrepareDirtyEntityVO_PatientNoMerge() throws DataProcessingException {
    ...
    when(prepareEntityStoredProcRepository.getPrepareEntity(
            businessTriggerCd, moduleCd, theRootDTInterface.getUid(), tableName))
    ...
    verify(prepareEntityStoredProcRepository, times(1))
        .getPrepareEntity(businessTriggerCd, moduleCd, theRootDTInterface.getUid(), tableName);
  }
  ...
  void testPrepareAssocDTForEntityLocatorParticipation_RecordStatusCdNull() {
    ...
    DataProcessingException exception =
        assertThrows(
            DataProcessingException.class,
            () -> {
              prepareAssocModelHelper.prepareAssocDTForEntityLocatorParticipation(
                  assocDTInterface1);
            });
    ...
    assertTrue(
        exception
            .getMessage()
            .contains("RecordStatusCd -----2----null   statusCode--------ACTIVE"));
  }
  ...
  void testPrepareActivityLocatorParticipationDT_RecordStatusCdNull() {
    ...
    DataProcessingException exception =
        assertThrows(
            DataProcessingException.class,
            () -> {
              prepareAssocModelHelper.prepareActivityLocatorParticipationDT(
                  activityLocatorParticipationInterface);
            });
  ...
  void testPrepareActivityLocatorParticipationDT_UnhandledException() {
    // Arrange
    when(activityLocatorParticipationInterface.getRecordStatusCd())
        .thenReturn(NEDSSConstant.RECORD_STATUS_ACTIVE);
    when(activityLocatorParticipationInterface.getStatusCd()).thenReturn("ACTIVE");
    doThrow(new RuntimeException("Test Exception"))
        .when(activityLocatorParticipationInterface)
        .setAddUserId(null);
  ...
  void testPrepareActivityLocatorParticipationDT_InnerTryBlock() throws DataProcessingException {
    ...
    verify(activityLocatorParticipationInterface, never())
        .setItDirty(false); // Since isRealDirty is true
  }
