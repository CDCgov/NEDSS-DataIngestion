...
class PersonUtilTest {
  ...
  @Mock private PatientMatchingService patientMatchingService;
  @Mock private ProviderMatchingService providerMatchingService;
  @Mock private IUidService uidService;

  @InjectMocks private PersonUtil personUtil;
        ...
        assertThrows(
            ...
            () -> {
              personUtil.processLabPersonContainerCollection(
                  personContainerCollection, morbidityApplied, dataContainer);
            });
