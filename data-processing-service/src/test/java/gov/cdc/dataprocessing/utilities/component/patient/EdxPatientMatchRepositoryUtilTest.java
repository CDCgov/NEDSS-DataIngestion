...
class EdxPatientMatchRepositoryUtilTest {
  @Mock private EdxMatchJdbcRepository edxPatientMatchRepository;
  @Mock private DataModifierReposJdbc dataModifierReposJdbc;
  @Mock private EdxPatientMatchStoredProcRepository edxPatientMatchStoreProcRepository;
  @InjectMocks private EdxPatientMatchRepositoryUtil edxPatientMatchRepositoryUtil;
  ...
  void tearDown() {
    Mockito.reset(
        edxPatientMatchRepository,
        edxPatientMatchStoreProcRepository,
        authUtil,
  ...
  void getEdxPatientMatchOnMatchString_Test_2() throws DataProcessingException {
    ...
    when(edxPatientMatchStoreProcRepository.getEdxPatientMatch(any(), any()))
        .thenReturn(new EdxPatientMatchDto());
  ...
  void getEdxEntityMatchOnMatchString_Test_2() throws DataProcessingException {
    ...
    when(edxPatientMatchStoreProcRepository.getEdxEntityMatch(any(), any()))
        .thenReturn(new EdxEntityMatchDto());
