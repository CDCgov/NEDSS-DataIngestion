...
class NBSObjectConverterTest {
  @Mock private ICatchingValueDpService checkingValueService;
  @Mock private EntityIdUtil entityIdUtil;
  @InjectMocks private NBSObjectConverter nbsObjectConverter;
  ...
  void processEntityData_Test() throws JAXBException, DataProcessingException {
    ...
    var res =
        nbsObjectConverter.processEntityData(
            hl7CXType.get(0), personContainer, EdxELRConstant.ELR_PATIENT_ALTERNATE_IND, 1);
    assertNotNull(res);
  }
  ...
  void processEntityData_Test_2() throws JAXBException, DataProcessingException {
    ...
    var res =
        nbsObjectConverter.processEntityData(
            hl7CXType.get(0), personContainer, EdxELRConstant.ELR_MOTHER_IDENTIFIER, 1);
    assertNotNull(res);
  }
  ...
  void processEntityData_Test_3() throws JAXBException, DataProcessingException {
    ...
    var res =
        nbsObjectConverter.processEntityData(
            hl7CXType.get(0), personContainer, EdxELRConstant.ELR_ACCOUNT_IDENTIFIER, 1);
    assertNotNull(res);
  }
  ...
  void personAddressType_Test_3() throws JAXBException, DataProcessingException {
    ...
    var res =
        nbsObjectConverter.personAddressType(
            address, EdxELRConstant.ELR_NEXT_OF_KIN, personContainer);
    assertNotNull(res);
  }
  ...
  void organizationAddressType_1() throws JAXBException, DataProcessingException {
    ...
    var res =
        nbsObjectConverter.organizationAddressType(
            address, EdxELRConstant.ELR_OP_CD, personContainer);
    assertNotNull(res);
  }
  ...
  void processHL7TSTypeForDOBWithoutTime_Test() throws DataProcessingException {
    ...
    when(entityIdUtil.stringToStrutsTimestamp(any()))
        .thenReturn(TimeStampUtil.getCurrentTimeStamp("UTC"));
  ...
  void processEntityData_Test_WithEmptyIdentifierTypeCode() throws DataProcessingException {
    ...
    EntityIdDto result =
        nbsObjectConverter.processEntityData(hl7CXType, personContainer, "TEST", 1);
    assertNotNull(result);
