...
class CommonLabUtilTest {
  ...
  void testGetXMLElementNameForOBR_ThrowsException() throws JsonProcessingException {
    ...
    DataProcessingException exception =
        assertThrows(
            DataProcessingException.class, () -> commonLabUtil.getXMLElementNameForOBR(mockOBR));
  ...
  void testGetXMLElementNameForOBX_ThrowsException() throws JsonProcessingException {
    ...
    DataProcessingException exception =
        assertThrows(
            DataProcessingException.class, () -> commonLabUtil.getXMLElementNameForOBX(mockOBX));
