...
class PageRepositoryUtilTest {
  ...
  @Mock private PamRepositoryUtil pamRepositoryUtil;
  @Mock private PrepareAssocModelHelper prepareAssocModelHelper;
  @Mock private IPublicHealthCaseService publicHealthCaseService;
  ...
  @Mock private EdxEventProcessRepositoryUtil edxEventProcessRepositoryUtil;
  @Mock private NbsDocumentRepositoryUtil nbsDocumentRepositoryUtil;
  @Mock private ParticipationRepositoryUtil participationRepositoryUtil;
  @Mock private NbsNoteRepositoryUtil nbsNoteRepositoryUtil;
  @Mock private CustomRepository customRepository;
  @Mock private IPamService pamService;
  @Mock private PatientMatchingBaseService patientMatchingBaseService;

  @InjectMocks private PageRepositoryUtil pageRepositoryUtil;

  @Mock private PageActProxyContainer pageActProxyContainerMock;
  ...
  void tearDown() {
    Mockito.reset(
        ...
        publicHealthCaseService,
        retrieveSummaryService,
        actRelationshipRepositoryUtil,
        edxEventProcessRepositoryUtil,
        nbsDocumentRepositoryUtil,
        participationRepositoryUtil,
        nbsNoteRepositoryUtil,
        customRepository,
        pamService,
  ...
  void updateForConInfectionId_Test_1() throws DataProcessingException {
    ...
    pageActProxyContainer1
        .getPublicHealthCaseContainer()
        .getThePublicHealthCaseDto()
        .setInvestigationStatusCd(NEDSSConstant.STATUS_OPEN);
  ...
  void testProcessingNbsDocument_NullNbsDocumentDT_CallsUpdate() throws DataProcessingException {
    ...
    when(nbsDocumentRepositoryUtil.getNBSDocumentWithoutActRelationship(docUid))
  ...
  @Test
  void testProcessingNbsDocument_JurisdictionCdIsNull_SetsFromProxy()
  ...
  @Test
  void testProcessingNbsDocument_JurisdictionCdIsEmpty_SetsFromProxy()
      throws DataProcessingException {
    Long docUid = 102L;
    var docDto = new NBSDocumentDto();
  ...
  void testProcessingNotificationSummary_CollectionNull_NoOp() throws DataProcessingException {
    ...
    pageRepositoryUtil.processingNotificationSummaryForPageAct(
        pageActProxyContainerMock, new PublicHealthCaseDto());
    verifyNoInteractions(retrieveSummaryService);
  }

  @Test
  void testProcessingNotificationSummary_IsHistoryTrue_SkipsUpdate()
      throws DataProcessingException {
    NotificationSummaryContainer summary = new NotificationSummaryContainer();
    summary.setIsHistory("T");
    summary.setAutoResendInd("F");

    when(pageActProxyContainerMock.getTheNotificationSummaryVOCollection())
  ...
  @Test
  void testProcessingNotificationSummary_AutoResendTrue_SkipsUpdate()
      throws DataProcessingException {
    NotificationSummaryContainer summary = new NotificationSummaryContainer();
  ...
  @Test
  void testProcessingNotificationSummary_StatusApproved_CallsUpdate()
      throws DataProcessingException {
    NotificationSummaryContainer summary = new NotificationSummaryContainer();
    summary.setIsHistory("F");
    summary.setAutoResendInd("F");
    ...
    verify(retrieveSummaryService)
        .updateNotification(123L, NEDSSConstant.NOT_CR_APR, "phcCd", "classCd", "prog", "jur", "Y");
  }

  @Test
  void testProcessingNotificationSummary_StatusPending_CallsUpdate()
      throws DataProcessingException {
    NotificationSummaryContainer summary = new NotificationSummaryContainer();
    summary.setIsHistory("F");
    summary.setAutoResendInd("F");
  ...
  @Test
  void testProcessingParticipation_WithDeleteFlag_CallsInsertAndStore()
      throws DataProcessingException {
  ...
  @Test
  void testProcessingParticipation_WithoutDeleteFlag_CallsOnlyStore()
      throws DataProcessingException {
    ParticipationDto dto = mock(ParticipationDto.class);
  ...
  @Test
  void testProcessingPhcContainer_NewWithCoInfectionAndNegativeUid()
      throws DataProcessingException {
    // Mocks and Setup
    ...
    // Execute
    PageActPhc result =
        pageRepositoryUtil.processingPhcContainerForPageAct(pageActProxyContainerMock, true);
  ...
  void testProcessingPersonContainer_NewPatientWithNegativeUid() throws DataProcessingException {
    ...
    when(patientMatchingBaseService.setPatientRevision(
            any(), eq(NEDSSConstant.PAT_CR), eq(NEDSSConstant.PAT)))
        .thenReturn(8888L);

    // Setup pageActProxy
    when(pageActProxyContainerMock.getThePersonContainerCollection())
        .thenReturn(List.of(personContainer));

    // Input PHC DTO
    PublicHealthCaseDto phcDto = new PublicHealthCaseDto();

    // Execute
    PageActPatient result =
  ...
  void testProcessingPersonContainer_DirtyPatient() throws DataProcessingException {
    ...
    when(patientMatchingBaseService.setPatientRevision(
            personContainer, NEDSSConstant.PAT_EDIT, NEDSSConstant.PAT))
        .thenReturn(456L);
    ...
    verify(patientMatchingBaseService)
        .setPatientRevision(personContainer, NEDSSConstant.PAT_EDIT, NEDSSConstant.PAT);
  }
  ...
  @Test
  void testProcessingParticipationPatType_NewNotDirty_NonPersonClassCd_NoLookup()
      throws DataProcessingException {
    ParticipationDto dto = new ParticipationDto();
  ...
  @Test
  void testUpdateForConInfectionId_CoinfectionSummaryNull_FetchesFromRepo()
      throws DataProcessingException {
    String coinfectionId = "COINF-001";
    Long mprUid = 100L;
    ...
    pageRepositoryUtil.updateForConInfectionId(
        pageActProxyContainerMock,
        mock(PageActProxyContainer.class),
        mprUid,
        new HashMap<>(),
        currentPhclUid,
        null,
  ...
  @Test
  void testUpdateForConInfectionId_CoinfectionSummaryEmpty_NoUpdateCall()
      throws DataProcessingException {
    String coinfectionId = "COINF-002";
    Long mprUid = 200L;
  ...
  @Test
  void testUpdateForConInfectionId_CoinfectionIdToUpdateIsNull_CallsUpdateWithoutSuperseded()
      throws DataProcessingException {
    Long mprUid = 123L;
    Long currentPhclUid = 999L;
    ...
    spyUtil.updateForConInfectionId(
        pageActProxyContainerMock,
        mock(PageActProxyContainer.class),
        mprUid,
        new HashMap<>(),
  ...
  @Test
  void testSetPageActProxyVO_UpdateAutoResendNotificationsThrowsException_HandledGracefully()
      throws DataProcessingException {
    when(pageActProxyContainerMock.isItNew()).thenReturn(false);
    ...
    doThrow(new RuntimeException("Simulated"))
        ...
        .updateAutoResendNotificationsAsync(pageActProxyContainerMock);
  ...
  @Test
  void testSetPageActProxyVO_MessageLogMap_SkipDispositionSpecifiedKey()
      throws DataProcessingException {
    when(pageActProxyContainerMock.isItNew()).thenReturn(true);
    when(pageActProxyContainerMock.isItDirty()).thenReturn(false);
  ...
  private void setupMinimalPhcAndPersonMocks() throws DataProcessingException {
    ...
    when(prepareAssocModelHelper.prepareVO(any(), any(), any(), any(), any(), anyInt()))
        .thenReturn(phcDto);
  ...
  void testSetPageActProxyVO_MessageLogDTMap_ProcessedCorrectly() throws DataProcessingException {
    ...
    logMap.put(
        "skip." + MessageConstants.DISPOSITION_SPECIFIED_KEY,
        new MessageLogDto()); // should be skipped
