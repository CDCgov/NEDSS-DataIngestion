...
class HL7SpecimenUtilTest {
  ...
  @InjectMocks private HL7SpecimenUtil hl7SpecimenUtil;
  ...
  void process251Specimen_Test() throws JAXBException, DataProcessingException {
    ...
    hL7PatientResultSPMType =
        xmlConn
            ...
            .getORDEROBSERVATION()
            .get(0)
            .getPatientResultOrderSPMObservation();
  ...
  void process251Specimen_Test_Exp_1() throws JAXBException {
    ...
    when(nbsObjectConverter.defaultParticipationDT(any(), any()))
  ...
  void process251Specimen_Test_Exp_2() throws JAXBException, DataProcessingException {
    ...
    when(nbsObjectConverter.processHL7TSTypeWithMillis(any(), any()))
        .thenThrow(new RuntimeException("TEST"));
