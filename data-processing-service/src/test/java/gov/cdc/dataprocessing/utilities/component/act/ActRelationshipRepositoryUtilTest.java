...
class ActRelationshipRepositoryUtilTest {
  @InjectMocks private ActRelationshipRepositoryUtil actRelationshipRepositoryUtil;
  ...
  void testGetActRelationshipCollectionFromSourceId() {
    ...
    Collection<ActRelationshipDto> result =
        actRelationshipRepositoryUtil.getActRelationshipCollectionFromSourceId(actUid);
  ...
  void testSelectActRelationshipDTCollectionFromActUidException() {
    long actUid = 1L;
    when(actRelationshipRepository.findByTargetActUid(actUid))
  ...
  void testInsertActRelationshipHist() {
    ...
    verify(actRelationshipRepository, times(1))
        .insertActRelationshipHistory(any(ActRelationshipHistory.class));
  }
