...
class ObservationResultRequestHandlerTest {
  ...
  @Mock private NBSObjectConverter nbsObjectConverter;
  @Mock private CommonLabUtil commonLabUtil;

  @Mock private ICacheApiService cacheApiService;

  @InjectMocks private ObservationResultRequestHandler observationResultRequestHandler;
  ...
  void getObservationResultRequest_Test() throws DataProcessingException {
    ...
    var res =
        observationResultRequestHandler.getObservationResultRequest(
            observation, labResultProxyContainer, edxLabInformationDt);
  ...
  void setEquipments_Test() {
    ...
    var res =
        observationResultRequestHandler.setEquipments(
            equipmentIdType, observationDto, actIdDtoColl);
  ...
  void processingAbnormalFlag_Test() throws DataProcessingException {
    ...
    var res =
        observationResultRequestHandler.processingAbnormalFlag(
            abnormalFlag, observationDto, observationContainer);
    assertNotNull(res);
  ...
  void processingObservationMethod_Test() throws DataProcessingException {
    ...
    var res =
        observationResultRequestHandler.processingObservationMethod(
            methodArray, edxLabInformationDto, observationContainer);
    assertNotNull(res);
  ...
  void formatValue_Test() throws DataProcessingException {
    ...
    observationResultRequestHandler.formatValue(
        text, hl7OBXType, observationContainer, edxLabInformationDto, elementName);
  }
