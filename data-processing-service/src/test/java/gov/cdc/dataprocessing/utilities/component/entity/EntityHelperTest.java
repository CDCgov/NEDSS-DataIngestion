...
class EntityHelperTest {
  @InjectMocks private EntityHelper entityHelper;

  @Mock private PrepareAssocModelHelper prepareAssocModel;
  ...
  void testIterateELPDTForEntityLocatorParticipation() throws DataProcessingException {
    ...
    when(prepareAssocModel.prepareAssocDTForEntityLocatorParticipation(
            any(EntityLocatorParticipationDto.class)))
        .thenReturn(elpDto);

    Collection<EntityLocatorParticipationDto> result =
        entityHelper.iterateELPDTForEntityLocatorParticipation(dtCol);

    assertEquals(1, result.size());
    verify(prepareAssocModel, times(1))
        .prepareAssocDTForEntityLocatorParticipation(any(EntityLocatorParticipationDto.class));
  }
  ...
  void testIterateRDT_Exp() throws DataProcessingException {
    ...
    when(prepareAssocModel.prepareAssocDTForRole(any(RoleDto.class)))
        .thenThrow(new RuntimeException("TEST"));
  ...
  void testIteratePDTForParticipation() throws DataProcessingException {
    ...
    when(prepareAssocModel.prepareAssocDTForParticipation(any(ParticipationDto.class)))
  ...
  void testIterateActivityParticipation() throws DataProcessingException {
    ...
    when(prepareAssocModel.prepareActivityLocatorParticipationDT(
            any(ActivityLocatorParticipationDto.class)))
        .thenReturn(alpDto);

    Collection<ActivityLocatorParticipationDto> result =
        entityHelper.iterateActivityParticipation(dtCol);

    assertEquals(1, result.size());
    verify(prepareAssocModel, times(1))
        .prepareActivityLocatorParticipationDT(any(ActivityLocatorParticipationDto.class));
  }
  ...
  void testIterateActRelationship() throws DataProcessingException {
    ...
    when(prepareAssocModel.prepareActRelationshipDT(any(ActRelationshipDto.class)))
        .thenReturn(actRelationshipDto);
  ...
  void testIterateALPDTActivityLocatorParticipation() throws DataProcessingException {
    ...
    when(prepareAssocModel.prepareAssocDTForActivityLocatorParticipation(
            any(ActivityLocatorParticipationDto.class)))
        .thenReturn(alpDto);
    ...
    assertEquals(1, result.size());
    verify(prepareAssocModel, times(1))
        .prepareAssocDTForActivityLocatorParticipation(any(ActivityLocatorParticipationDto.class));
  }
  ...
  void testIterateARDTActRelationship() throws DataProcessingException {
    ...
    when(prepareAssocModel.prepareAssocDTForActRelationship(any(ActRelationshipDto.class)))
        .thenReturn(actRelationshipDto);
    ...
    assertEquals(1, result.size());
    verify(prepareAssocModel, times(1))
        .prepareAssocDTForActRelationship(any(ActRelationshipDto.class));
  }
