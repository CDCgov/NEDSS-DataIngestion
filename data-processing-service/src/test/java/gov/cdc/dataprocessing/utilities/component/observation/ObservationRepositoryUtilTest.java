...
class ObservationRepositoryUtilTest {
  @Mock private ObservationJdbcRepository observationRepository;
  @Mock private ObservationReasonRepository observationReasonRepository;
  @Mock private ActIdJdbcRepository actIdRepository;
  @Mock private ObservationInterpRepository observationInterpRepository;
  @Mock private ObsValueCodedRepository obsValueCodedRepository;
  @Mock private ObsValueTxtRepository obsValueTxtRepository;
  @Mock private ObsValueDateRepository obsValueDateRepository;
  @Mock private ObsValueNumericRepository obsValueNumericRepository;
  @Mock private ActLocatorParticipationJdbcRepository actLocatorParticipationRepository;
  @Mock private ActRelationshipJdbcRepository actRelationshipRepository;
  ...
  @InjectMocks private ObservationRepositoryUtil observationRepositoryUtil;
  ...
  void tearDown() {
    Mockito.reset(
        ...
        observationReasonRepository,
        authUtil,
        actIdRepository,
        observationInterpRepository,
        obsValueCodedRepository,
        obsValueTxtRepository,
        obsValueDateRepository,
        obsValueNumericRepository,
        actLocatorParticipationRepository,
        actRelationshipRepository,
  ...
  void loadObject_Test() throws DataProcessingException {
    ...
    actReCol.add(actRe);
    when(actRelationshipRepositoryUtil.selectActRelationshipDTCollectionFromActUid(obUid))
        .thenReturn(actReCol);
  ...
  void saveObservation_Test() throws DataProcessingException {
    ...
    when(odseIdGeneratorService.getValidLocalUid(LocalIdClass.OBSERVATION, true))
        .thenReturn(localId);
  ...
  void addActivityLocatorParticipations_Test() {
    Long obsUid = 10L;
    ArrayList<ActivityLocatorParticipationDto> activityLocatorParticipationDtoCollection =
        new ArrayList<>();
    ActivityLocatorParticipationDto activityLocatorParticipationDto =
        new ActivityLocatorParticipationDto();
    activityLocatorParticipationDtoCollection.add(activityLocatorParticipationDto);

    observationRepositoryUtil.addActivityLocatorParticipations(
        obsUid, activityLocatorParticipationDtoCollection, "CREATE");
  ...
  void testSelectObsValueDates_returnsDtosWhenRepositoryReturnsData() {
    ...
    when(observationRepository.findByObservationDateUid(101L)).thenReturn(List.of(date1, date2));
  ...
  void testSelectObsValueTxts_returnsDtosWhenRepositoryReturnsData() {
    ...
    when(observationRepository.findByObservationTxtUid(102L)).thenReturn(List.of(txt1, txt2));
  ...
  void testSelectObsValueCodeds_returnsDtosWhenRepositoryReturnsData() {
    ...
    when(observationRepository.findByObservationCodedUid(103L)).thenReturn(List.of(c1, c2));
  ...
  void testSelectObservationInterps_returnsDtosWhenRepositoryReturnsData() {
    ...
    when(observationRepository.findByObservationInterp(104L)).thenReturn(List.of(i1, i2));
  ...
  void testSelectObservationReasons_returnsDtosWhenRepositoryReturnsData() {
    ...
    when(observationRepository.findByObservationReasons(203L)).thenReturn(List.of(r1, r2));
  ...
  @Test
  void testSetObservationInfo_loadObjectReturnsNull_newContainerCreatedAndSaved()
    ...
    // Assert
    ArgumentCaptor<ObservationContainer> captor =
        ArgumentCaptor.forClass(ObservationContainer.class);
  ...
  @Test
  void testSetObservationInfo_whenDtoUidIsNull_createsNewContainerAndSaves()
      throws DataProcessingException {
    // Arrange
    ...
    verify(spyUtil)
        .saveObservation(
            argThat(container -> container.getTheObservationDto() == dto && container.isItDirty()));
  }

  @Test
  void testSetObservationInfo_whenLoadReturnsNonNull_setsDtoOnLoadedObject()
      throws DataProcessingException {
    ObservationDto dto = new ObservationDto();
    dto.setObservationUid(123L);
  ...
  @Test
  void testSetObservationInfo_whenLoadReturnsNull_createsNewContainerAndSetsDto()
      throws DataProcessingException {
    ObservationDto dto = new ObservationDto();
  ...
  @Test
  void testUpdateObservation_whenUidIsNull_callsSaveNewObservation()
      throws DataProcessingException {
    // Arrange
    ObservationDto dto = new ObservationDto(); // UID is null
  ...
  @Test
  void testSaveObservation_whenNotNewAndDtoNotNull_callsUpdateObservation()
      throws DataProcessingException {
    // Arrange
    ...
    // Act
    Long result =
        observationRepositoryUtil.saveObservation(
            container); // fails here unless mockUtil is partial
