...
class ManagerUtilTest {
  @InjectMocks private ManagerUtil managerUtil;

  @Mock private IPersonService personService;
  ...
  void testGetObservationWithOrderDomainCode() {
    ...
    ObservationContainer result =
        managerUtil.getObservationWithOrderDomainCode(labResultProxyContainer);
  ...
  void testPatientAggregation() throws DataProcessingConsumerException, DataProcessingException {
    ...
    when(personService.processingNextOfKin(labResultProxyContainer, personContainer))
        .thenReturn(null);

    PersonAggContainer result =
        managerUtil.patientAggregation(labResultProxyContainer, edxLabInformationDto);
  ...
  @Test
  void testPatientAggregation_ElseFlow()
    ...
    when(personService.processingPatient(any(), any(), eq(patientPersonContainer)))
        .thenReturn(processedPatient);
    when(personService.processingProvider(any(), any(), eq(providerPersonContainer), anyBoolean()))
        .thenReturn(processedProvider);
    ...
    verify(personService, times(1))
        .processingProvider(any(), any(), eq(providerPersonContainer), anyBoolean());
  }

  @Test
  void testPersonAggregationAsync_PatientProcessing()
  ...
  @Test
  void testPersonAggregationAsync_MultipleNextOfKinAndPatientProcessing()
      throws DataProcessingException, DataProcessingConsumerException {
    // Arrange
    LabResultProxyContainer labResult = new LabResultProxyContainer();
    EdxLabInformationDto edxLabInformationDto = new EdxLabInformationDto();
  ...
  @SuppressWarnings("java:S5778")
  @Test
  void testPersonAggregationAsync_NextOfKinDataProcessingException()
    ...
    personContainer.setThePersonDto(new PersonDto());
    labResult.setThePersonContainerCollection(Collections.singletonList(personContainer));
    doThrow(new DataProcessingException("Test Data Processing Exception"))
        .when(personService)
        .processingNextOfKin(any(), any());
  ...
  @Test
  void testPersonAggregationAsync_PatientDataProcessingConsumerException()
      throws DataProcessingException, DataProcessingConsumerException {
    // Arrange
    LabResultProxyContainer labResult = new LabResultProxyContainer();
    PersonContainer personContainer = new PersonContainer();
    ...
    labResult.setThePersonContainerCollection(Collections.singletonList(personContainer));
    when(personService.processingPatient(any(), any(), any()))
        .thenThrow(new DataProcessingConsumerException("Test Data Processing Consumer Exception"));

    // Act & Assert
    DataProcessingConsumerException exception =
        assertThrows(
            DataProcessingConsumerException.class,
            () -> {
              managerUtil.patientAggregation(labResult, new EdxLabInformationDto());
            });
  ...
  @Test
  void testPersonAggregationAsync_ProviderDataProcessingConsumerException()
      throws DataProcessingException, DataProcessingConsumerException {
    // Arrange
    LabResultProxyContainer labResult = new LabResultProxyContainer();
    PersonContainer personContainer = new PersonContainer();
    ...
    personContainer.setThePersonDto(personDto);
    labResult.setThePersonContainerCollection(Collections.singletonList(personContainer));
    when(personService.processingProvider(any(), any(), any(), anyBoolean()))
        .thenThrow(new DataProcessingConsumerException("Test Data Processing Consumer Exception"));
  ...
  @Test
  void testPersonAggregationAsync_ProviderDataProcessingException()
      throws DataProcessingException, DataProcessingConsumerException {
    // Arrange
    LabResultProxyContainer labResult = new LabResultProxyContainer();
    PersonContainer personContainer = new PersonContainer();
    ...
    labResult.setThePersonContainerCollection(Collections.singletonList(personContainer));
    when(personService.processingProvider(any(), any(), any(), anyBoolean()))
        .thenThrow(new DataProcessingException("Test Data Processing Exception"));
  ...
  @Test
  void testPersonAggregationAsync_ProviderProcessing()
      throws DataProcessingException, DataProcessingConsumerException {
    // Arrange
    LabResultProxyContainer labResult = new LabResultProxyContainer();
    PersonContainer personContainer = new PersonContainer();
    ...
    when(personService.processingProvider(any(), any(), any(), anyBoolean()))
        .thenReturn(expectedProviderContainer);
