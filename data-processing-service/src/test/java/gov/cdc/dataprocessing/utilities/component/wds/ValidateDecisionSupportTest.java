...
class ValidateDecisionSupportTest {
  ...
  @InjectMocks private ValidateDecisionSupport validateDecisionSupport;
  @Mock private InvestigationDefaultValuesType investigationDefaultValuesType;
  @Mock private EdxRuleManageDto edxRuleManageDTMock;
  @Mock private NbsQuestionMetadata metaDataMock;
  ...
  void processNBSObjectDT_shouldSetValue_whenDataTypeIsTextAndOverwriteIsTrue() {
    ...
    // Act
    validateDecisionSupport.processNBSObjectDT(
        edxRuleManageDT, publicHealthCaseContainer, object, metaData);
  ...
  @Test
  void
      processNBSObjectDT_shouldNotSetValue_whenDataTypeIsTextAndOverwriteIsFalseAndValueIsNotNull() {
    // Arrange
    EdxRuleManageDto edxRuleManageDT = new EdxRuleManageDto();
  ...
  void parseInvestigationDefaultValuesType_Test() {
    ...
    validateDecisionSupport.parseInvestigationDefaultValuesType(
        map, investigationDefaultValuesType);
  ...
  void processConfirmationMethodTimeDT_Test_WithNullTime() throws DataProcessingException {
    ...
    // Act
    PublicHealthCaseContainer result =
        validateDecisionSupport.processConfirmationMethodTimeDT(
            edxRuleManageDT, publicHealthCaseContainer, metaData);
