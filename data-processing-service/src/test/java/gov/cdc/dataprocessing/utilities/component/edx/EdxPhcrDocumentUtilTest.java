...
class EdxPhcrDocumentUtilTest {
  @InjectMocks private EdxPhcrDocumentUtil edxPhcrDocumentUtil;
  ...
  void testRequiredFieldCheck() {
    ...
    String result =
        edxPhcrDocumentUtil.requiredFieldCheck(requiredQuestionIdentifierMap, nbsCaseAnswerMap);
  ...
  void testSetStandardNBSCaseAnswerVals() {
    ...
    publicHealthCaseContainer
        ...
        .setAddTime(TimeStampUtil.getCurrentTimeStamp("UTC"));
    publicHealthCaseContainer
        .getThePublicHealthCaseDto()
        .setLastChgTime(TimeStampUtil.getCurrentTimeStamp("UTC"));
    ...
    assertEquals(
        ...
        result.getActUid());
    assertEquals(
        publicHealthCaseContainer.getThePublicHealthCaseDto().getAddTime(), result.getAddTime());
    assertEquals(
        publicHealthCaseContainer.getThePublicHealthCaseDto().getLastChgTime(),
        result.getLastChgTime());
    assertEquals(
  ...
  void testSetStandardNBSCaseAnswerVals_WhenSeqNbrIsNegative_ShouldSetToZero() {
    ...
    // Act
    NbsCaseAnswerDto result =
        edxPhcrDocumentUtil.setStandardNBSCaseAnswerVals(phcContainer, answerDto);
  ...
  void testRequiredFieldCheck_WhenExceptionThrown_ShouldCatchAndLog() {
    ...
    requiredQuestionIdentifierMap.put(
        reqdKey, "This is not a NbsQuestionMetadata"); // will cause ClassCastException
