...
class PatientMatchingBaseServiceTest {
  ...
  @Mock private EdxPatientMatchRepositoryUtil edxPatientMatchRepositoryUtil;
  ...
  @InjectMocks @Spy private PatientMatchingBaseService patientMatchingBaseService;
  ...
  void setPatientRevision_new_pat() throws DataProcessingException {
    ...
    when(prepareAssocModelHelper.prepareVO(any(), any(), any(), eq("PERSON"), eq("BASE"), any()))
    ...
    when(patientRepositoryUtil.preparePersonNameBeforePersistence(any()))
        .thenReturn(personContainerPrepare);
  ...
  void updateExistingPerson_Test_2() {
    ...
    when(patientRepositoryUtil.findPersonByParentUid(any())).thenReturn(new ArrayList<>());
    when(patientRepositoryUtil.findExistingPersonByUid(any()))
  ...
  void testProcess_Success() {
    ...
    EntityLocatorParticipationDto entityLocatorParticipationDto1 =
        mock(EntityLocatorParticipationDto.class);
    EntityLocatorParticipationDto entityLocatorParticipationDto2 =
        mock(EntityLocatorParticipationDto.class);
    ...
    Collection<EntityLocatorParticipationDto> entityLocatorParticipationDtoCollection =
        new ArrayList<>();
    ...
    when(personContainer.getTheEntityLocatorParticipationDtoCollection())
        .thenReturn(entityLocatorParticipationDtoCollection);
  ...
  void testProcessingPersonName_ValidInputs() {
    ...
    // Act
    String result =
        patientMatchingBaseService.processingPersonName(
            personNameDto, personDto, asofDate, namedobcursexStr);
  ...
  void testSetPersonHashCdPatient_RecordStatusActive() {
    ...
    doNothing()
        .when(edxPatientMatchRepositoryUtil)
        .deleteEdxPatientMatchDTColl(personDto.getPersonParentUid());

    // Act
    patientMatchingBaseService.setPersonHashCdPatient(personContainer);

    // Assert
    verify(edxPatientMatchRepositoryUtil, times(1))
        .deleteEdxPatientMatchDTColl(personDto.getPersonParentUid());
  }
  ...
  void testSetPersonToMatchEntityPatient_ValidInputs() throws DataProcessingException {
    ...
    doReturn("lastname^firstname^dob^sex")
        .when(patientMatchingBaseService)
        .getLNmFnmDobCurSexStr(personContainer);
    ...
    // Assert
    verify(edxPatientMatchRepositoryUtil, times(1))
        .setEdxPatientMatchDT(
            argThat(
                dto ->
                    dto.getPatientUid().equals(12345L)
                        && dto.getMatchString().equals("IDENTIFIER1")
                        && dto.getMatchStringHashCode() == "IDENTIFIER1".hashCode()));
    verify(edxPatientMatchRepositoryUtil, times(1))
        .setEdxPatientMatchDT(
            argThat(
                dto ->
                    dto.getPatientUid().equals(12345L)
                        && dto.getMatchString().equals("IDENTIFIER2")
                        && dto.getMatchStringHashCode() == "IDENTIFIER2".hashCode()));
    verify(edxPatientMatchRepositoryUtil, times(1))
        .setEdxPatientMatchDT(
            argThat(
                dto ->
                    dto.getPatientUid().equals(12345L)
                        && dto.getMatchString().equals("LASTNAME^FIRSTNAME^DOB^SEX")
                        && dto.getMatchStringHashCode()
                            == "LASTNAME^FIRSTNAME^DOB^SEX".hashCode()));
  }
  ...
  void testSetPersonToMatchEntityPatient_NullIdentifierStr() throws DataProcessingException {
    ...
    // Assert
    verify(edxPatientMatchRepositoryUtil, times(0))
        .setEdxPatientMatchDT(argThat(dto -> dto.getMatchString() == null));
    verify(edxPatientMatchRepositoryUtil, times(1))
        .setEdxPatientMatchDT(
            argThat(
                dto ->
  ...
  void testSetPersonHashCdNok_InnerExceptionHandling() {
    ...
    doNothing()
        .when(edxPatientMatchRepositoryUtil)
        .deleteEdxPatientMatchDTColl(personDto.getPersonParentUid());
    doThrow(new RuntimeException("Inner exception"))
        .when(patientMatchingBaseService)
  ...
  void testSetPersonToMatchEntityNok_ValidInputs() {
    ...
    doReturn(nameAddressStreetOneStrList)
        .when(patientMatchingBaseService)
        .nameAddressStreetOneNOK(personContainer);
    doReturn(nameTelePhoneStrList)
        .when(patientMatchingBaseService)
        .telePhoneTxtNOK(personContainer);
    ...
    verify(edxPatientMatchRepositoryUtil, times(1))
        .setEdxPatientMatchDT(
            argThat(
                dto ->
                    dto.getPatientUid().equals(12345L)
                        && dto.getMatchString().equals("ADDRESS1")
                        && dto.getMatchStringHashCode() == "ADDRESS1".hashCode()));
    verify(edxPatientMatchRepositoryUtil, times(1))
        .setEdxPatientMatchDT(
            argThat(
                dto ->
                    dto.getPatientUid().equals(12345L)
                        && dto.getMatchString().equals("ADDRESS2")
                        && dto.getMatchStringHashCode() == "ADDRESS2".hashCode()));
    verify(edxPatientMatchRepositoryUtil, times(1))
        .setEdxPatientMatchDT(
            argThat(
                dto ->
                    dto.getPatientUid().equals(12345L)
                        && dto.getMatchString().equals("1234567890")
                        && dto.getMatchStringHashCode() == "1234567890".hashCode()));
    verify(edxPatientMatchRepositoryUtil, times(1))
        .setEdxPatientMatchDT(
            argThat(
                dto ->
                    dto.getPatientUid().equals(12345L)
                        && dto.getMatchString().equals("0987654321")
                        && dto.getMatchStringHashCode() == "0987654321".hashCode()));
  }
