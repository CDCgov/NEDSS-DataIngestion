...
class ObservationSummaryServiceTest {
  ...
  @InjectMocks private ObservationSummaryService observationSummaryService;
  ...
  void getLabParticipations_Success() {
    long uid = 10L;
    when(customRepository.getLabParticipations(10L)).thenReturn(new HashMap<>());
  ...
  void getLabParticipations_Exception() {
    long uid = 10L;
    when(customRepository.getLabParticipations(10L)).thenThrow(new RuntimeException("TEST"));
  ...
  void getPatientPersonInfo_Success() {
    long uid = 10L;
    when(customRepository.getPatientPersonInfo(10L)).thenReturn(new ArrayList<>());
  ...
  void getPatientPersonInfo_Exception() {
    long uid = 10L;
    when(customRepository.getPatientPersonInfo(10L)).thenThrow(new RuntimeException("TEST"));
  ...
  void getProviderInfo_Success() {
    long uid = 10L;
    when(customRepository.getProviderInfo(10L, "Type")).thenReturn(new ArrayList<>());
  ...
  void getProviderInfo_Exception() {
    long uid = 10L;
    when(customRepository.getProviderInfo(10L, "Type")).thenThrow(new RuntimeException("TEST"));
  ...
  void getActIdDetails_Success() {
    long uid = 10L;
    when(customRepository.getActIdDetails(10L)).thenReturn(new ArrayList<>());
  ...
  void getActIdDetails_Exception() {
    long uid = 10L;
    when(customRepository.getActIdDetails(10L)).thenThrow(new RuntimeException("TEST"));
  ...
  void getReportingFacilityName_Success() {
    long uid = 10L;
    when(customRepository.getReportingFacilityName(10L)).thenReturn("");
  ...
  void getReportingFacilityName_Exception() {
    long uid = 10L;
    when(customRepository.getReportingFacilityName(10L)).thenThrow(new RuntimeException("TEST"));
  ...
  void getSpecimanSource_Success() {
    long uid = 10L;
    when(customRepository.getSpecimanSource(10L)).thenReturn("");
  ...
  void getSpecimanSource_Exception() {
    long uid = 10L;
    when(customRepository.getSpecimanSource(10L)).thenThrow(new RuntimeException("TEST"));
  ...
  void getTestAndSusceptibilities_Sucess() {
    ...
    when(customRepository.getSusceptibilityUidSummary(
            eq(testListCol.get(0)),
    ...
    verify(customRepository, times(1))
        .getTestAndSusceptibilities(typeCode, 10L, labRepEvent, labRepSumm);
  }
