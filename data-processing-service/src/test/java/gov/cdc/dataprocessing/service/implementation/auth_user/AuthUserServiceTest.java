...
class AuthUserServiceTest {
  ...
  @Mock private CustomAuthUserRepository customAuthUserRepository;
  @Mock private JdbcTemplate jdbcTemplateOdse;
  ...
  void getAuthUserInfo_Success() throws DataProcessingException {
    ...
    when(jdbcTemplateOdse.queryForObject(anyString(), any(Object[].class), any(RowMapper.class)))
        .thenReturn(authUser);
  ...
  void getAuthUserInfo_Exception() {
    ...
    when(jdbcTemplateOdse.query(
            anyString(), any(Object[].class), (ResultSetExtractor<Object>) any()))
        .thenAnswer(
            invocation -> {
