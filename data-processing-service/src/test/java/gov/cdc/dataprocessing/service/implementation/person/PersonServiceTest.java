...
class PersonServiceTest {
  @Mock private PatientMatchingService patientMatchingServiceMock;
  @Mock private INokMatchingService nokMatchingServiceMock;
  @Mock private IProviderMatchingService providerMatchingServiceMock;
  @Mock private IUidService uidServiceMock;
  ...
  void processingNextOfKin() throws DataProcessingException {
    ...
    PersonContainer personContainerResult =
        personService.processingNextOfKin(labResultProxyContainer, personContainer);
  ...
  void processingPatient_personid_PatientMatchedFound() throws DataProcessingException {
    ...
    when(patientMatchingServiceMock.getMatchingPatient(personContainer))
  ...
  void processingProvider() throws DataProcessingException {
    ...
    when(providerMatchingServiceMock.getMatchingProvider(personContainer))
        .thenReturn(eDXActivityDetailLogDto);

    PersonContainer personContainerResult =
        personService.processingProvider(
    ...
    when(providerMatchingServiceMock.getMatchingProvider(personContainer))
        .thenReturn(eDXActivityDetailLogDto);
    PersonContainer personContainerResult1 =
        personService.processingProvider(
            labResultProxyContainer,
            edxLabInformationDto,
            personContainer,
