...
class NokMatchingServiceTest {
  ...
  @InjectMocks private NokMatchingService nokMatchingService;
  ...
  void getMatchingNextOfKin_name_addr_street() throws DataProcessingException {
    ...
    EdxPatientMatchDto edxPatientMatchResult =
  ...
  void getMatchingNextOfKin_name_addr_street_throw_exp() {
    ...
    assertThrows(
        NullPointerException.class, () -> nokMatchingService.getMatchingNextOfKin(personContainer));
  }
