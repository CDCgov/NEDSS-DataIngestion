...
class UidServiceTest {
  @InjectMocks private UidService uidService;
  ...
  void testSetFalseToNewForPageAct_ParticipationCollNull() {
    ...
    when(publicHealthCaseContainer.getTheActRelationshipDTCollection())
  ...
  void testSetFalseToNewForNotification_ActRelationShipCollNull() {
    ...
    ActRelationshipDto result =
        uidService.setFalseToNewForNotification(notificationProxyVO, 1L, 2L);
  ...
  void testSetFalseToNewForNotification_ActRelationShipCollEmpty() {
    NotificationProxyContainer notificationProxyVO = mock(NotificationProxyContainer.class);
    when(notificationProxyVO.getTheActRelationshipDTCollection())
        .thenReturn(Collections.emptyList());
