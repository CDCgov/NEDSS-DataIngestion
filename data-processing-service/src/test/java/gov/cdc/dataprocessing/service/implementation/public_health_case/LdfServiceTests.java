...
class LdfServiceTests {
  ...
  @InjectMocks private LdfService ldfService;
  ...
  void getLDFCollection_Success() {
    ...
    when(customRepository.getLdfCollection(eq(busObjUid), eq(condCode), any())).thenReturn(list);
  ...
  void getLDFCollection_Exception() {
    ...
    when(customRepository.getLdfCollection(any(), any(), any()))
