...
class EdxLogServiceTest {
  @Mock private EdxActivityLogRepository edxActivityLogRepository;
  @Mock private EdxActivityDetailLogRepository edxActivityDetailLogRepository;
  @Mock private EDXActivityLogDto edxActivityLogDto1;
  @Mock private EdxLabInformationDto edxLabInformationDto;
  @InjectMocks private EdxLogService edxLogService;
  ...
  void updateActivityLogDT_Test() {
    ...
    edxLabInformationDto1.setFillerNumber(
  ...
  void testWdsReportsNotEmpty() {
    setCommonExpectations();
    setCommonExpectations2();
    when(edxLabInformationDto.getWdsReports())
        .thenReturn(
            new ArrayList<>() {
              {
  ...
  void testWdsReportsNotEmpty_Numeric() {
    ...
    wds.setWdsValueNumericReportList(
        new ArrayList<>() {
          {
  ...
  void testExceptionHandling() {
    when(edxLabInformationDto.getEdxActivityLogDto())
  ...
  void testSetActivityLogExceptionTxt_Case10() {
    EDXActivityLogDto edxActivityLogDto = new EDXActivityLogDto();
    edxLogService.setActivityLogExceptionTxt(
        edxActivityLogDto, EdxELRConstant.ELR_MASTER_LOG_ID_10);
  ...
  void testSetActivityLogExceptionTxt_Case11() {
    EDXActivityLogDto edxActivityLogDto = new EDXActivityLogDto();
    edxLogService.setActivityLogExceptionTxt(
        edxActivityLogDto, EdxELRConstant.ELR_MASTER_LOG_ID_11);
  ...
  void testSetActivityLogExceptionTxt_Case12() {
    EDXActivityLogDto edxActivityLogDto = new EDXActivityLogDto();
    edxLogService.setActivityLogExceptionTxt(
        edxActivityLogDto, EdxELRConstant.ELR_MASTER_LOG_ID_12);
  ...
  void testSetActivityLogExceptionTxt_Case13() {
    EDXActivityLogDto edxActivityLogDto = new EDXActivityLogDto();
    edxLogService.setActivityLogExceptionTxt(
        edxActivityLogDto, EdxELRConstant.ELR_MASTER_LOG_ID_13);
  ...
  void testSetActivityLogExceptionTxt_Case14() {
    EDXActivityLogDto edxActivityLogDto = new EDXActivityLogDto();
    edxLogService.setActivityLogExceptionTxt(
        edxActivityLogDto, EdxELRConstant.ELR_MASTER_LOG_ID_14);
  ...
  void testSetActivityLogExceptionTxt_Case15() {
    EDXActivityLogDto edxActivityLogDto = new EDXActivityLogDto();
    edxLogService.setActivityLogExceptionTxt(
        edxActivityLogDto, EdxELRConstant.ELR_MASTER_LOG_ID_15);
  ...
  void testSetActivityLogExceptionTxt_Case16() {
    EDXActivityLogDto edxActivityLogDto = new EDXActivityLogDto();
    edxLogService.setActivityLogExceptionTxt(
        edxActivityLogDto, EdxELRConstant.ELR_MASTER_LOG_ID_16);
  ...
  void testSetActivityLogExceptionTxt_Case17() {
    EDXActivityLogDto edxActivityLogDto = new EDXActivityLogDto();
    edxLogService.setActivityLogExceptionTxt(
        edxActivityLogDto, EdxELRConstant.ELR_MASTER_LOG_ID_17);
  ...
  void testSetActivityLogExceptionTxt_Case18() {
    EDXActivityLogDto edxActivityLogDto = new EDXActivityLogDto();
    edxLogService.setActivityLogExceptionTxt(
        edxActivityLogDto, EdxELRConstant.ELR_MASTER_LOG_ID_18);
  ...
  void testSetActivityLogExceptionTxt_Case19() {
    EDXActivityLogDto edxActivityLogDto = new EDXActivityLogDto();
    edxLogService.setActivityLogExceptionTxt(
        edxActivityLogDto, EdxELRConstant.ELR_MASTER_LOG_ID_19);
  ...
  void testSetActivityLogExceptionTxt_Case20() {
    EDXActivityLogDto edxActivityLogDto = new EDXActivityLogDto();
    edxLogService.setActivityLogExceptionTxt(
        edxActivityLogDto, EdxELRConstant.ELR_MASTER_LOG_ID_20);
  ...
  void testSetActivityLogExceptionTxt_Case21() {
    EDXActivityLogDto edxActivityLogDto = new EDXActivityLogDto();
    edxLogService.setActivityLogExceptionTxt(
        edxActivityLogDto, EdxELRConstant.ELR_MASTER_LOG_ID_21);
  ...
  void testSetActivityLogExceptionTxt_Case22() {
    EDXActivityLogDto edxActivityLogDto = new EDXActivityLogDto();
    edxLogService.setActivityLogExceptionTxt(
        edxActivityLogDto, EdxELRConstant.ELR_MASTER_LOG_ID_22);
