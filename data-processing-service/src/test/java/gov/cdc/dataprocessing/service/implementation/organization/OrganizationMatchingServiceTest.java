...
class OrganizationMatchingServiceTest {
  ...
  @Mock private EdxEntityMatchRepository edxEntityMatchRepositoryMock;
  @Mock private OrganizationRepositoryUtil organizationRepositoryUtilMock;

  @InjectMocks private OrganizationMatchingService organizationMatchingService;
  ...
  void getMatchingOrganization() throws DataProcessingException {
    ...
    when(edxPatientMatchRepositoryUtil.getEdxEntityMatchOnMatchString(anyString(), anyString()))
        .thenReturn(edxEntityMatchDto);

    EDXActivityDetailLogDto edxActivityDetailLogDtoResult =
  ...
  void getMatchingOrganization_for_setOrganization_throwExp() throws DataProcessingException {
    ...
    when(edxPatientMatchRepositoryUtil.getEdxEntityMatchOnMatchString(anyString(), anyString()))
        .thenReturn(edxEntityMatchDto);
    when(organizationRepositoryUtilMock.setOrganization(
            any(OrganizationContainer.class), anyString()))
  ...
  @Test
  void getMatchingOrganization_entitymatch_for_identifier_throws_exception()
  ...
  @Test
  void getMatchingOrganization_entitymatch_for_identifier_throws_exception1()
      throws DataProcessingException {
    OrganizationContainer organizationContainer = new OrganizationContainer();
  ...
  void getMatchingOrganization_no_entitymatch_for_nameAddStr() throws DataProcessingException {
    ...
    doNothing()
        ...
        .saveEdxEntityMatch(isA(EdxEntityMatchDto.class));
  ...
  @Test
  void getMatchingOrganization_entitymatch_for_telephoneTxt_throwExp()
      throws DataProcessingException {
    OrganizationContainer organizationContainer = new OrganizationContainer();
    // Org name
    OrganizationNameDto organizationNameDto = new OrganizationNameDto("UTC");
