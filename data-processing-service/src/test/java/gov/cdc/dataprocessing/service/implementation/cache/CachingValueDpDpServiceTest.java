...
class CachingValueDpDpServiceTest {
  ...
  @InjectMocks private CachingValueDpDpService cachingService;
  ...
  void testFindToCode() throws DataProcessingException {
    when(cacheApiService.getSrteCacheString(ObjectName.FIND_TO_CODE.name(), "A~B~C"))
        .thenReturn("X");
  ...
  void testGetCodeDescTxtForCd() throws DataProcessingException {
    when(cacheApiService.getSrteCacheString(ObjectName.GET_CODE_DESC_TXT_FOR_CD.name(), "code~set"))
  ...
  void testGetCountyCdByDesc() throws DataProcessingException {
    when(cacheApiService.getSrteCacheString(
            ObjectName.GET_COUNTY_CD_BY_DESC.name(), "county~state"))
        .thenReturn("countyCode");
  ...
  void testFindStateCodeByStateNm() {
    ...
    when(cacheApiService.getSrteCacheObject(ObjectName.FIND_STATE_CODE_BY_STATE_NM.name(), "NY"))
        .thenReturn(stateCode);
  ...
  void testGetCodedValueWithKey() throws DataProcessingException {
    when(cacheApiService.getSrteCacheString(ObjectName.CODED_VALUE.name(), "type~key"))
        .thenReturn("value");
  ...
  void testCheckCodedValue() throws DataProcessingException {
    when(cacheApiService.getSrteCacheBool(ObjectName.CODED_VALUE.name(), "type~key"))
        .thenReturn(true);
  ...
  void testGetCodedValuesCallRepos() throws DataProcessingException {
    when(cacheApiService.getSrteCacheString(ObjectName.GET_CODED_VALUES_CALL_REPOS.name(), "type"))
        .thenReturn("repos");
  ...
  void testGetCodedValueByCodeOnly() throws DataProcessingException {
    when(cacheApiService.getSrteCacheString(ObjectName.GET_CODED_VALUE.name(), "val"))
        .thenReturn("result");
