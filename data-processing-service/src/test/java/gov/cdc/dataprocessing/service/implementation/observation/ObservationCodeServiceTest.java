...
class ObservationCodeServiceTest {
  @Mock private ISrteCodeObsService srteCodeObsService;
  @Mock private OrganizationRepositoryUtil organizationRepositoryUtil;
  @Mock private ObservationUtil observationUtil;
  @InjectMocks private ObservationCodeService observationCodeService;
  ...
  void deriveTheConditionCodeList_Test_3() throws DataProcessingException {
    ...
    when(observationUtil.getUid(any(), any(), any(), any(), any(), any(), any())).thenReturn(10L);
  ...
  void deriveTheConditionCodeList_Test_4() throws DataProcessingException {
    ...
    when(observationUtil.getUid(any(), any(), any(), any(), any(), any(), any())).thenReturn(-1L);
  ...
  void deriveTheConditionCodeList_Test_Empty_2() throws DataProcessingException {
    ...
    when(srteCodeObsService.getDefaultConditionForLocalResultCode(eq("CODE"), any()))
        .thenReturn("CODE");
