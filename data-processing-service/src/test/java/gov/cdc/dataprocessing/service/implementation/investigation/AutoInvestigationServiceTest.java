...
class AutoInvestigationServiceTest {
  ...
  @InjectMocks private AutoInvestigationService autoInvestigationService;
  ...
  void autoCreateInvestigation_Success() throws DataProcessingException {
    ...
    when(conditionCodeRepository.findProgramAreaConditionCodeByConditionCode(
  ...
  void autoCreateInvestigation_Success2_InvestigationTypeIsNull() throws DataProcessingException {
    ...
    when(lookupService.getToPrePopFormMapping("FORM")).thenReturn(toPrePopMap);
  ...
  void populateProxyFromPrePopMapping_Test() throws DataProcessingException {
    ...
    when(lookupService.getToPrePopFormMapping("INVES")).thenReturn(prePop);

    autoInvestigationService.populateProxyFromPrePopMapping(
        pageActProxyContainer, edxLabInformationDT);
