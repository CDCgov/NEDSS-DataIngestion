...
class ManagerCacheServiceTest {
  ...
  @Mock private ICatchingValueService cachingValueService;

  @InjectMocks private ManagerCacheService managerCacheService;
  ...
  void testLoadCache() throws DataProcessingException {
    ...
    when(cachingValueService.getAllLabResultJoinWithLabCodingSystemWithOrganismNameInd())
