...
class InvestigationNotificationServiceTest {
  ...
  @InjectMocks private InvestigationNotificationService service;

  @BeforeEach
  void setUp() {
    service =
        new InvestigationNotificationService(
  ...
  @Test
  void testValidatePAMNotficationRequiredFieldsGivenPageProxy_WithNBSAnswer()
    ...
    Map<Object, Object> result =
        service.validatePAMNotficationRequiredFieldsGivenPageProxy(
  ...
  @Test
  void testValidatePAMNotficationRequiredFieldsGivenPageProxy_WithPublicHealthCase()
      throws DataProcessingException {
    // Arrange
    PamProxyContainer pageObj = new PamProxyContainer();
  ...
  @Test
  void testValidatePAMNotficationRequiredFieldsGivenPageProxy_WithPerson()
      throws DataProcessingException {
    // Arrange
    PamProxyContainer pageObj = new PamProxyContainer();
  ...
  @Test
  void testValidatePAMNotficationRequiredFieldsGivenPageProxy_WithPostalLocator()
      throws DataProcessingException {
    // Arrange
    PamProxyContainer pageObj = new PamProxyContainer();
    PersonContainer personContainer = new PersonContainer();
  ...
  @Test
  void testValidatePAMNotficationRequiredFieldsGivenPageProxy_WithPersonRace()
      throws DataProcessingException {
    // Arrange
    PamProxyContainer pageObj = new PamProxyContainer();
    PersonContainer personContainer = new PersonContainer();
  ...
  @Test
  void testValidatePAMNotficationRequiredFieldsGivenPageProxy_WithActId()
      throws DataProcessingException {
    // Arrange
    PamProxyContainer pageObj = new PamProxyContainer();
    PublicHealthCaseContainer phcContainer = new PublicHealthCaseContainer();
  ...
  @Test
  void testValidatePAMNotficationRequiredFieldsGivenPageProxy_WithNoMissingFields()
      throws DataProcessingException {
    // Arrange
    PamProxyContainer pageObj = new PamProxyContainer();
    BasePamContainer pamVO = new BasePamContainer();
  ...
  void validatePAM_shouldProcess_whenDLocationIsNotEmpty() throws Exception {
    ...
    InvestigationNotificationService.ValidationContext mockContext =
        new InvestigationNotificationService.ValidationContext();
  ...
  void validatePAM_shouldThrow_whenReflectionFails() throws Exception {
    ...
    doThrow(new RuntimeException("reflection failure"))
        .when(spyService)
        .reflectGet(any(), eq("person.badField"));
  ...
  void validateNbsAnswer_shouldNotAddMissing_whenAnswerExists() {
    ...
    InvestigationNotificationService.ValidationContext context =
        new InvestigationNotificationService.ValidationContext();
  ...
  void validatePostalLocator_shouldCheckObjectWhenPersonVOAndCollectionIsNull() throws Exception {
    ...
    doReturn(PostalLocatorDto.class.getMethod("getStreetAddr1"))
        .when(spyService)
        .getMethod(eq(PostalLocatorDto.class), eq("getStreetAddr1"));
  ...
  void validatePersonRace_shouldCheckNull_whenPersonVOorCollectionIsNull() throws Exception {
    ...
    doReturn(PersonRaceDto.class.getMethod("getRaceCd"))
        .when(spyService)
        .getMethod(eq(PersonRaceDto.class), eq("getRaceCd"));
    doNothing().when(spyService).checkObject(null, missingFields, meta);
  ...
  void validateActId_shouldCheckObject_whenFormCdIsRvctAndLabelContainsState() throws Exception {
    ...
    doReturn(ActIdDto.class.getMethod("getRootExtensionTxt"))
        .when(spyService)
        .getMethod(eq(ActIdDto.class), eq("getRootExtensionTxt"));
    ...
    spyService.validateActId(
        context,
        "act_id.rootExtensionTxt",
        "State name",
        NEDSSConstant.INV_FORM_RVCT,
        meta,
        missingFields);
  ...
  @Test
  void validateActId_shouldAddMissing_whenActIdCollIsNullAndFormCdRvctAndLabelHasState()
      throws Exception {
    InvestigationNotificationService.ValidationContext context =
        new InvestigationNotificationService.ValidationContext();
  ...
  void validateActId_shouldNotCheckObject_whenShouldValidateIsFalse() throws Exception {
    ...
    spyService.validateActId(
        context, "act_id.rootExtensionTxt", "Zip Code", "ANY_FORM", meta, missingFields);
