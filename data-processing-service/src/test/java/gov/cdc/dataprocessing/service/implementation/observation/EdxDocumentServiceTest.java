...
class EdxDocumentServiceTest {
  ...
  @InjectMocks private EdxDocumentService edxDocumentService;
  ...
  void selectEdxDocumentCollectionByActUid_Success() {
    ...
    edxCol.add(edx);
    when(edxDocumentRepository.selectEdxDocumentCollectionByActUid(10L))
        .thenReturn(Optional.of(edxCol));
