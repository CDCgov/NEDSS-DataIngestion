...
class PageServiceTests {
  ...
  @Mock private PageRepositoryUtil pageRepositoryUtil;
  ...
  void setPageProxyWithAutoAssoc_Success() throws DataProcessingException {
    ...
    var test =
        pageService.setPageProxyWithAutoAssoc(
            typeCd, pageProxyVO, observationUid, observationTypeCd, processingDecision);
