...
class InvestigationNotificationServiceTests {
  ...
  @Mock private CustomNbsQuestionRepository customNbsQuestionRepository;
  @Mock private CacheApiService cacheApiService;
  @InjectMocks private InvestigationNotificationService investigationNotificationService;
  ...
  void sendNotification_Exception() {
    ...
    assertEquals(
        "Cannot create Notification for unknown page type: gov.cdc.dataprocessing.repository.nbs.odse.model.person.Person",
        thrown.getMessage());
  }
  ...
  void sendNotification_Success_PHC() throws DataProcessingException {
    ...
    when(customNbsQuestionRepository.retrieveQuestionRequiredNnd("investigationFormCd"))
        .thenReturn(colRetriQuest);
  ...
  @Test
  void validatePAMNotficationRequiredFieldsGivenPageProxy_Success_PAM_1stCond()
    ...
    var test =
        investigationNotificationService.validatePAMNotficationRequiredFieldsGivenPageProxy(
            pageObj, publicHealthCaseUid, reqFields, formCd);
  ...
  void testSendProxyToEJB_ExceptionThrown() throws DataProcessingException {
    ...
    EDXActivityDetailLogDto result =
        investigationNotificationService.sendProxyToEJB(proxy, dummyPageObj);
  ...
  void sendProxyToEJB_Success_NoValidationErrors() throws DataProcessingException {
    // Setup test data
    NotificationProxyContainer notificationProxyVO =
        createNotificationProxy("TEST_CODE", "PROG_AREA", 1L);

    // Mock dependencies
    when(cacheApiService.getSrteCacheString(any(), any())).thenReturn("investigationFormCd");
    when(customNbsQuestionRepository.retrieveQuestionRequiredNnd(any()))
    ...
    // Execute
    EDXActivityDetailLogDto result =
        spyService.sendProxyToEJB(notificationProxyVO, new PageActProxyContainer());
  ...
  void sendProxyToEJB_WithException() throws DataProcessingException {
    ...
    // Execute
    EDXActivityDetailLogDto result =
        investigationNotificationService.sendProxyToEJB(
            notificationProxyVO, new PageActProxyContainer());
  ...
  private NotificationProxyContainer createNotificationProxy(
      String conditionCd, String progAreaCd, Long phcUid) {
  ...
  void sendNotification_UnknownType_ThrowsException() {
    ...
    assertNotNull(thrown);
    assertEquals(
        "Cannot create Notification for unknown page type: java.lang.Object", thrown.getMessage());
  }

  @Test
  void validatePAMNotficationRequiredFieldsGivenPageProxy_RVCTForm_Success()
      throws DataProcessingException {
    // Setup test data
    PamProxyContainer pageObj = new PamProxyContainer();
  ...
  @Test
  void validatePAMNotficationRequiredFieldsGivenPageProxy_RVCTForm_MissingNBSAnswer()
      throws DataProcessingException {
    // Setup test data
    PamProxyContainer pageObj = new PamProxyContainer();
    Long publicHealthCaseUid = 1L;
  ...
  @Test
  void validatePAMNotficationRequiredFieldsGivenPageProxy_WithPublicHealthCaseFields()
      throws DataProcessingException {
    // Setup test data
  ...
  @Test
  void validatePAMNotficationRequiredFieldsGivenPageProxy_WithPersonFields()
      throws DataProcessingException {
    // Setup test data
    PageActProxyContainer pageObj = new PageActProxyContainer();
    Long publicHealthCaseUid = 1L;
  ...
  @Test
  void validatePAMNotficationRequiredFieldsGivenPageProxy_WithPostalLocatorFields()
      throws DataProcessingException {
    // Setup test data
    PageActProxyContainer pageObj = new PageActProxyContainer();
    Long publicHealthCaseUid = 1L;
  ...
  @Test
  void validatePAMNotficationRequiredFieldsGivenPageProxy_WithPersonRaceFields()
      throws DataProcessingException {
    // Setup test data
    PageActProxyContainer pageObj = new PageActProxyContainer();
    Long publicHealthCaseUid = 1L;
  ...
  @Test
  void validatePAMNotficationRequiredFieldsGivenPageProxy_WithNbsCaseAnswerFields()
      throws DataProcessingException {
    // Setup test data
    PageActProxyContainer pageObj = new PageActProxyContainer();
    Long publicHealthCaseUid = 1L;
  ...
  @Test
  void validatePAMNotficationRequiredFieldsGivenPageProxy_WithMultipleDataLocations()
      throws DataProcessingException {
    // Setup test data
    PageActProxyContainer pageObj = new PageActProxyContainer();
    Long publicHealthCaseUid = 1L;
  ...
  @Test
  void validatePAMNotficationRequiredFieldsGivenPageProxy_WithInvalidDataLocation()
      throws DataProcessingException {
    // Setup test data
    PageActProxyContainer pageObj = new PageActProxyContainer();
    Long publicHealthCaseUid = 1L;
  ...
  @Test
  void validatePAMNotficationRequiredFieldsGivenPageProxy_WithMatchingPostalLocator()
      throws DataProcessingException {
    // Setup test data
    PageActProxyContainer pageObj = new PageActProxyContainer();
    Long publicHealthCaseUid = 1L;
  ...
  @Test
  void validatePAMNotficationRequiredFieldsGivenPageProxy_WithNullPostalLocator()
      throws DataProcessingException {
    // Setup test data
    PageActProxyContainer pageObj = new PageActProxyContainer();
    Long publicHealthCaseUid = 1L;
  ...
  @Test
  void validatePAMNotficationRequiredFieldsGivenPageProxy_WithMultiplePostalLocators()
      throws DataProcessingException {
    // Setup test data
    PageActProxyContainer pageObj = new PageActProxyContainer();
    Long publicHealthCaseUid = 1L;
