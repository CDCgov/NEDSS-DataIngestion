...
class AnswerServiceTest {
  @Mock private NbsAnswerJdbcRepository nbsAnswerRepository;
  @Mock private NbsActJdbcRepository nbsActEntityRepository;
  ...
  void storePageAnswer_Success() {
    ...
    when(nbsAnswerRepository.findByActUid(15L)).thenReturn(nbsAnswerForDeleteCol);
    ...
    when(nbsActEntityRepository.getNbsActEntitiesByActUid(15L)).thenReturn(nbsActForDeleteCol);
  ...
  void getNbsAnswerAndAssociation_Exception() {
    ...
    when(nbsActEntityRepository.getNbsActEntitiesByActUid(any()))
        .thenThrow(new RuntimeException("TEST"));
  ...
  void testProcessingPageAnswerMapSeqNbrGreaterThanZeroCollSizeGreaterThanZero() {
    ...
    Long result =
        answerService.processingPageAnswerMap(
