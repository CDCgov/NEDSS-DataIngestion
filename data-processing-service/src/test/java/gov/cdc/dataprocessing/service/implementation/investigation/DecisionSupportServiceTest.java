...
class DecisionSupportServiceTest {
    ...
    @Test
    void validateProxyContainer_Success_MarkedAsReview() throws DataProcessingException, RtiCacheException {
    ...
    @Test
    void validateProxyContainer_Success_Investigation() throws DataProcessingException, RtiCacheException {
    ...
    @Test
    void validateProxyContainer_Success_Notification() throws DataProcessingException, RtiCacheException {
    ...
    @Test
    void updateObservationBasedOnAction_Test() throws DataProcessingException, RtiCacheException {
    ...
    @Test
    void updateObservationBasedOnAction_Test_2() throws DataProcessingException, RtiCacheException {
        Algorithm algorithmDocument = new Algorithm();
        var actionType = new ActionType();
    ...
    @Test
    void updateObservationBasedOnAction_Test_3() throws DataProcessingException, RtiCacheException {
        Algorithm algorithmDocument = new Algorithm();
        var actionType = new ActionType();
        var review = new CreateInvestigationType();
        var code = new CodedType();
