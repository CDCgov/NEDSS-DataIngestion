...
class ActRelationshipServiceTest {
  @Mock private ActRelationshipJdbcRepository actRelationshipJdbcRepository;
  @Mock private DataModifierReposJdbc dataModifierReposJdbc;
  @InjectMocks private ActRelationshipService actRelationshipService;
  ...
  void loadActRelationshipBySrcIdAndTypeCode_Success() {
    ...
    actCol.add(act);
    when(actRelationshipJdbcRepository.findBySourceActUidAndTypeCode(10L, type)).thenReturn(actCol);
