...
class ActRelationshipServiceTest {
    ...
    void saveActRelationship_Success_New() throws DataProcessingException {
        ...
        dto.setAddTime(TimeStampUtil.getCurrentTimeStamp());
        dto.setAddUserId(1L);
        dto.setDurationAmt("5");
        dto.setDurationUnitCd("days");
        dto.setFromTime(TimeStampUtil.getCurrentTimeStamp());
        dto.setLastChgReasonCd("Updated");
        dto.setLastChgTime(TimeStampUtil.getCurrentTimeStamp());
        dto.setLastChgUserId(2L);
        dto.setRecordStatusCd("Active");
        dto.setRecordStatusTime(TimeStampUtil.getCurrentTimeStamp());
        dto.setSequenceNbr(1);
        dto.setStatusCd("Completed");
        dto.setStatusTime(TimeStampUtil.getCurrentTimeStamp());
        dto.setToTime(TimeStampUtil.getCurrentTimeStamp());
