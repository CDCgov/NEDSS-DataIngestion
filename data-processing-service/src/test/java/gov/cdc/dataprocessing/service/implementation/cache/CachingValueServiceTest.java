...
class CachingValueServiceTest {
  ...
  @Mock private CodeValueJdbcRepository codeValueJdbcRepository;
  @Mock private ElrXrefRepository elrXrefRepository;
  @Mock private RaceCodeRepository raceCodeRepository;
  @Mock private StateCountyCodeValueRepository stateCountyCodeValueRepository;
  @Mock private StateCodeRepository stateCodeRepository;
  ...
  @Mock private JurisdictionCodeRepository jurisdictionCodeRepository;
  @Mock private SrteCustomRepository srteCustomRepository;
  @Mock private IProgramAreaService programAreaService;
  @Mock private IJurisdictionService jurisdictionService;

  @InjectMocks private CachingValueService cachingValueService;
  ...
  void testGetAllOnInfectionConditionCode() {
    ...
    when(conditionCodeRepository.findCoInfectionConditionCode())
  ...
  void testFindCodeValuesByCodeSetNmAndCode() {
    ...
    cv.setCode("C1");
    when(codeValueJdbcRepository.findCodeValuesByCodeSetNmAndCode("set", "C1"))
  ...
  void testGetLabResultDesc() {
    ...
    when(labResultRepository.findLabResultByDefaultLabAndOrgNameN())
        .thenReturn(Optional.of(List.of(lab)));
  ...
  void testGetCodedValues() {
    ...
    when(codeValueJdbcRepository.findCodeValuesByCodeSetNm("type1")).thenReturn(List.of(codeValue));
  ...
  void testFindCodeValuesByCodeSetNmAndCodeEmpty() {
    ...
    List<CodeValueGeneral> result =
        cachingValueService.findCodeValuesByCodeSetNmAndCode("set", "X");
