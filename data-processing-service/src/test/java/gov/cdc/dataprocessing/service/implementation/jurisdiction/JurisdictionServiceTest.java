...
class JurisdictionServiceTest {
  ...
  @Mock private JurisdictionParticipationRepository jurisdictionParticipationRepository;
  @Mock private JurisdictionCodeRepository jurisdictionCodeRepository;
  @Mock AuthUtil authUtil;
  @InjectMocks private JurisdictionService jurisdictionService;
  ...
  void assignJurisdiction_patient() throws DataProcessingException {
    ...
    when(jurisdictionParticipationRepository.findJurisdictionForCity(any(), any(), any()))
        .thenReturn(Optional.of(jurisdictionsList));

    jurisdictionService.assignJurisdiction(
        patientContainer, providerContainer, organizationContainer, observationRequest);
