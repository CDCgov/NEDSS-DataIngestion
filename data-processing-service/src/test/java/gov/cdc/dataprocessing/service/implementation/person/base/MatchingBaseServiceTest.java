...
class MatchingBaseServiceTest {
  ...
  @InjectMocks @Spy private MatchingBaseService matchingBaseService;
  ...
  private void mockPersonWithName(String nmUseCd, String recordStatusCd) {
    ...
    doReturn("User^Test")
        .when(matchingBaseService)
        .processingPersonNameBasedOnAsOfDate(any(), any(), any());
  }
