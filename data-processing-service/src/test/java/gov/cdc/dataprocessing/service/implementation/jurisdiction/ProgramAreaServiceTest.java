...
class ProgramAreaServiceTest {
  ...
  @Mock private ProgramAreaCodeRepository programAreaCodeRepository;
  @Mock private IObservationCodeService observationCodeService;
  @InjectMocks private ProgramAreaService programAreaService;
  ...
  void getProgramArea_multi_PA() throws DataProcessingException {
    ...
    when(srteCodeObsService.getPAFromSNOMEDCodes(
            any(), eq(observationContainer1.getTheObsValueCodedDtoCollection())))
        .thenReturn("TEST_PA2");
