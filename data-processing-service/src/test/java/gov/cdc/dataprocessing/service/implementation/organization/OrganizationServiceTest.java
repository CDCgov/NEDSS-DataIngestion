...
class OrganizationServiceTest {
  @Mock private IOrganizationMatchingService iOrganizationMatchingServiceMock;
  ...
  void processingOrganization_with_role_sf() throws DataProcessingException {
    ...
    labResultProxyContainer.setTheOrganizationContainerCollection(
        theOrganizationContainerCollection);

    OrganizationContainer organizationContainerResult =
        organizationService.processingOrganization(labResultProxyContainer);
  ...
  void processingOrganization_with_role_op() throws DataProcessingException {
    ...
    when(iOrganizationMatchingServiceMock.getMatchingOrganization(organizationContainer))
