...
class DsmAlgorithmServiceTest {
  @Mock private DsmAlgorithmRepository dsmAlgorithmRepository;
  @InjectMocks private DsmAlgorithmService dsmAlgorithmService;
  ...
  void findActiveDsmAlgorithm_Success() {
    when(dsmAlgorithmRepository.findDsmAlgorithmByStatusCode("A"))
        .thenReturn(Optional.of(new ArrayList<DsmAlgorithm>()));
