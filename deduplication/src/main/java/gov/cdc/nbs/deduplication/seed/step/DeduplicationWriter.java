...
public class DeduplicationWriter implements ItemWriter<DeduplicationEntry> {
  ...
  public void write(@NonNull Chunk<? extends DeduplicationEntry> chunk) {
    ...
    Map<String, LocalDateTime> patientNameAndTimeMap =
        patientRecordService.fetchPersonAddTimeMap(
    ...
    template.batchUpdate(
        QueryConstants.NBS_MPI_QUERY, batchParams.toArray(new SqlParameterSource[0]));
  }
