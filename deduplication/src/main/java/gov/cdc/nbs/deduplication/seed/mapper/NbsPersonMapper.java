...
public class NbsPersonMapper implements RowMapper<NbsPerson> {
  ...
  /**
   * Returns the first Drivers-License entry found. If none is found, creates and returns a new DriversLicense with the
   * given license value and an empty string as the authority if the authority is null or blank.
   */
