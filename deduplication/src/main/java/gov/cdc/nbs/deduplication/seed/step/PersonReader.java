...
public class PersonReader extends JdbcPagingItemReader<NbsPerson> {
  ...
  public PersonReader(@Qualifier("nbs") DataSource dataSource, final LoggingService loggingService) throws Exception {
    ...
    try {
      ...
      loggingService.logError("PersonReader", "Error during batch reading of NBS persons.", e);
      throw e;
    }
  }
}
