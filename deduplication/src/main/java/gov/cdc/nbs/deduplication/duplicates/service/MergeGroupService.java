...
public class MergeGroupService {
    ...
    public void writeMatchesRequiringReviewPDF(HttpServletResponse response, List<MatchesRequireReviewResponse.MatchRequiringReview> matches, String timestampForFilename, String timestampForFooter) throws IOException {
        response.setContentType("application/pdf");
        response.setHeader("Content-Disposition", "attachment; filename=matches_requiring_review_" + timestampForFilename + ".pdf");
