...
class DeduplicationExceptionHandlerTest {
  ...
  void should_set_message_data_elements() {
    ResponseEntity<ExceptionMessage> response =
        handler.handleBadRequestExceptions(
            new DataElementModificationException("Data elements exception"));
  ...
  void should_set_message_pass() {
    ResponseEntity<ExceptionMessage> response =
        handler.handleBadRequestExceptions(new PassModificationException("Pass exception"));
  ...
  void should_set_message_algorithm() {
    ResponseEntity<ExceptionMessage> response =
        handler.handleBadRequestExceptions(new AlgorithmException("Algorithm exception"));
  ...
  void should_set_message_internal() {
    ResponseEntity<ExceptionMessage> response =
        handler.handleInternalServerExceptions(new PersonMapException("Failed to map person data"));
