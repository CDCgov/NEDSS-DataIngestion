...
class DataElementsServiceTest {
  ...
  @InjectMocks private DataElementsService service;
  ...
  void should_get_current_data_elements() throws JsonProcessingException {
    ...
    when(mockTemplate.queryForList(DataElementsService.SELECT_CURRENT_DATA_ELEMENTS, String.class))
  ...
  void should_throw_when_parsing_fails() throws JsonProcessingException {
    ...
    DataElementModificationException ex =
        assertThrows(
            DataElementModificationException.class, () -> service.getCurrentDataElements());
  ...
  void should_throw_when_serializing_fails() throws JsonProcessingException {
    // mock
    when(mapper.writeValueAsString(TestData.DATA_ELEMENTS))
        .thenThrow(JsonProcessingException.class);

    // act
    DataElementModificationException ex =
        assertThrows(
            DataElementModificationException.class, () -> service.save(TestData.DATA_ELEMENTS));
