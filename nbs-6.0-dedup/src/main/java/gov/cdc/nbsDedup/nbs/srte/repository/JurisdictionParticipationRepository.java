...
import gov.cdc.nbsDedup.nbs.srte.model.JurisdictionParticipation;
import gov.cdc.nbsDedup.nbs.srte.model.id_class.JurisdictionParticipationId;
...
@Repository
public interface JurisdictionParticipationRepository extends
    JpaRepository<JurisdictionParticipation, JurisdictionParticipationId> {
