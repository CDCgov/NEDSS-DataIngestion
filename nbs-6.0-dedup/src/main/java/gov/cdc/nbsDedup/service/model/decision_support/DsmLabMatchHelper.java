...
import gov.cdc.nbsDedup.constant.DecisionSupportConstants;
import gov.cdc.nbsDedup.constant.elr.NEDSSConstant;
import gov.cdc.nbsDedup.exception.DataProcessingException;
import gov.cdc.nbsDedup.model.container.model.ObservationContainer;
import gov.cdc.nbsDedup.model.dsma_algorithm.Algorithm;
import gov.cdc.nbsDedup.model.dsma_algorithm.CodedType;
import gov.cdc.nbsDedup.model.dsma_algorithm.ElrCriteriaType;
import gov.cdc.nbsDedup.model.dsma_algorithm.SendingSystemType;
import gov.cdc.nbsDedup.model.dto.observation.ObsValueCodedDto;
import gov.cdc.nbsDedup.model.dto.observation.ObsValueNumericDto;
import gov.cdc.nbsDedup.model.dto.observation.ObsValueTxtDto;
import gov.cdc.nbsDedup.service.model.wds.WdsReport;
import gov.cdc.nbsDedup.service.model.wds.WdsValueCodedReport;
import gov.cdc.nbsDedup.service.model.wds.WdsValueNumericReport;
import gov.cdc.nbsDedup.service.model.wds.WdsValueTextReport;
                ...
                if (algorithmNumericValue.getTestCode().equalsIgnoreCase(testCode))
                {
                    if (resultObsVO.getTheObsValueNumericDtoCollection() != null) {
                        ...
                        for (ObsValueNumericDto obsValueNumericDT : resultObsVO.getTheObsValueNumericDtoCollection()) {
                            ...
                            if (obsValueNumericDT.getComparatorCd1() != null && !obsValueNumericDT.getComparatorCd1().equals(
                                NEDSSConstant.EQUAL_LOGIC)) {
