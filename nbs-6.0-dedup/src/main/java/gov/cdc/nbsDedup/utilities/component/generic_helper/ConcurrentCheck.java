...
import gov.cdc.nbsDedup.constant.elr.DataTables;
...
public class ConcurrentCheck {
    ...
    public boolean dataConcurrenceCheck(RootDtoInterface theRootDTInterface, String tableName, Integer existingVersion) throws
