...
import gov.cdc.nbsDedup.model.dto.matching.EdxEntityMatchDto;
...
import gov.cdc.nbsDedup.nbs.odse.model.matching.EdxPatientMatch;
import gov.cdc.nbsDedup.nbs.odse.repos.matching.EdxEntityMatchRepository;
import gov.cdc.nbsDedup.nbs.odse.repos.matching.EdxPatientMatchRepository;
import gov.cdc.nbsDedup.nbs.odse.repos.stored_proc.EdxPatientMatchStoredProcRepository;
...
public class EdxPatientMatchRepositoryUtil {
    ...
    @Transactional
    public EdxPatientMatchDto getEdxPatientMatchOnMatchString(String typeCd, String matchString) throws
