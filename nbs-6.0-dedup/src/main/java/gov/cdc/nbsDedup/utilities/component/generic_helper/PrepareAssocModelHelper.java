package gov.cdc.nbsDedup.utilities.component.generic_helper;
...
import gov.cdc.nbsDedup.nbs.odse.model.generic_helper.PrepareEntity;
import gov.cdc.nbsDedup.nbs.odse.repos.stored_proc.PrepareEntityStoredProcRepository;
import gov.cdc.nbsDedup.utilities.auth.AuthUtil;
import gov.cdc.nbsDedup.utilities.component.jurisdiction.ProgAreaJurisdictionUtil;
...
public class PrepareAssocModelHelper {
     ...
     */
    public EntityLocatorParticipationDto prepareAssocDTForEntityLocatorParticipation(EntityLocatorParticipationDto assocDTInterface) throws
...
//                }
            ...
            throws DataProcessingException
    {
        try
        {
            ...
            PrepareEntity
                prepareVOUtilsHelper = prepareEntityStoredProcRepository.getPrepareEntity(businessTriggerCd, moduleCd, uid, tableName);
