...
public class OrderObservation {
    ...
    public OrderObservation(ca.uhn.hl7v2.model.v251.group.ORU_R01_ORDER_OBSERVATION oruR01OrderObservation) {
        ...
        this.financialTransaction = new FinancialTransaction(oruR01OrderObservation.getFT1());
        this.clinicalTrialIdentification = new ClinicalTrialIdentification(oruR01OrderObservation.getCTI());
    }
}
